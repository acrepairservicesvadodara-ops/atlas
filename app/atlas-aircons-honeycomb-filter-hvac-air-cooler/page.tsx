...
export const metadata: Metadata = {
  title: "Atlas Aircons™ Honeycomb Filter | Atlas Aircon Gujarat",
  description: "Experience unparalleled efficiency and durability with the Atlas Aircons™ High-Efficiency HVAC and Air Cooler Ho...",
  alternates: { canonical: "https://atlasaircons.com/atlas-aircons-honeycomb-filter-hvac-air-cooler" },
  openGraph: {
    title: "Atlas Aircons™ Honeycomb Filter | Atlas Aircon",
    description: "Experience unparalleled efficiency and durability with the Atlas Aircons™ High-Efficiency HVAC and Air Cooler Ho...",
    url: "https://atlasaircons.com/atlas-aircons-honeycomb-filter-hvac-air-cooler",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Atlas Aircons™ Honeycomb Filter",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Atlas Aircons™ Honeycomb Filter</h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Experience unparalleled efficiency and durability with the Atlas Aircons™ High-Efficiency HVAC and Air Cooler Ho...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Experience unparalleled efficiency and durability with the Atlas Aircons™ High-Efficiency HVAC and Air Cooler Ho...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/honeycomb-filters.webp" alt="Atlas Aircons™ Honeycomb Filter" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/honeycomb-filters.webp" alt="Atlas Aircons™ Honeycomb Filter" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/honeycomb-filter-of-air-cooler-ahu.webp" alt="Atlas Aircons™ Honeycomb Filter" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/honeycomb-filter.webp" alt="Atlas Aircons™ Honeycomb Filter" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVatlas aircons honeycomb filter hvac air coolers?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial atlas aircons honeycomb filter hvac air cooler?", a: "Industrial atlas aircons honeycomb filter hvac air cooler costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVatlas aircons honeycomb filter hvac air coolers?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial atlas aircons honeycomb filter hvac air cooler?", acceptedAnswer: { "@type": "Answer", text: "Industrial atlas aircons honeycomb filter hvac air cooler costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
