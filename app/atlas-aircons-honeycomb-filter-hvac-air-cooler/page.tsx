...
export const metadata: Metadata = {
  title: "Hitech Aircool Engineerss™ Honeycomb Filter | Hitech Aircool Engineers Gujarat",
  description: "Experience unparalleled efficiency and durability with the Hitech Aircool Engineerss™ High-Efficiency HVAC and Air Cooler Ho...",
  alternates: { canonical: "https://hitechairconditioning.in/atlas-aircons-honeycomb-filter-hvac-air-cooler" },
  openGraph: {
    title: "Hitech Aircool Engineerss™ Honeycomb Filter | Hitech Aircool Engineers",
    description: "Experience unparalleled efficiency and durability with the Hitech Aircool Engineerss™ High-Efficiency HVAC and Air Cooler Ho...",
    url: "https://hitechairconditioning.in/atlas-aircons-honeycomb-filter-hvac-air-cooler",
    type: "website",
    images: ["/images/products/honeycomb-filters.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Hitech Aircool Engineerss™ Honeycomb Filter",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageatlasairconshoneycombfilterhvacaircooler() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Hitech Aircool Engineerss™ Honeycomb Filter</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Experience unparalleled efficiency and durability with the Hitech Aircool Engineerss™ High-Efficiency HVAC and Air Cooler Ho...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Experience unparalleled efficiency and durability with the Hitech Aircool Engineerss™ High-Efficiency HVAC and Air Cooler Ho...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/honeycomb-filters.webp" alt="Hitech Aircool Engineerss™ Honeycomb Filter" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/honeycomb-filters.webp" alt="Hitech Aircool Engineerss™ Honeycomb Filter" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/honeycomb-filter-of-air-cooler-ahu.webp" alt="Hitech Aircool Engineerss™ Honeycomb Filter" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/honeycomb-filter.webp" alt="Hitech Aircool Engineerss™ Honeycomb Filter" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVhitech aircool engineerss honeycomb filter hvac air coolers?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial hitech aircool engineerss honeycomb filter hvac air cooler?", a: "Industrial hitech aircool engineerss honeycomb filter hvac air cooler costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVhitech aircool engineerss honeycomb filter hvac air coolers?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial hitech aircool engineerss honeycomb filter hvac air cooler?", acceptedAnswer: { "@type": "Answer", text: "Industrial hitech aircool engineerss honeycomb filter hvac air cooler costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
