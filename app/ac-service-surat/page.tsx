...
export const metadata: Metadata = {
  title: "💎 AC Service Surat | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-surat" },
  openGraph: {
    title: "💎 AC Service Surat | Atlas Aircon",
    description: "Surat's finest AC service! Expert maintenance, repair & AMC plans for Diamond City homes & businesses. Free health check-up & genuine parts guarantee. Book fast",
    url: "https://atlasaircons.com/ac-service-surat",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Surat&apos;s finest AC service! Expert maintenance, repair &amp; AMC plans for Diamond City homes &amp; businesses. Free health check-up &amp; genuine parts guarantee. Book fast service!</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/cropped-AtlasAircon-Logo.webp" alt="💎 AC Service Surat" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
