...
export const metadata: Metadata = {
  title: "Split AC Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Split AC repair service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Split AC Repair Vadodara",
    "split ac repair",
    "Split AC Repair installation",
    "Split AC Repair service",
    "Split AC Repair repair",
    "best Split AC Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/split-ac-repair-vadodara",
  },
};
...
const keywordData = {
  ...
  description: "Split AC repair service",
  category: "ACTypes"
};
...
export default function SplitACRepairPage() {
  return (
    <>
      {/* Hero Section */}
