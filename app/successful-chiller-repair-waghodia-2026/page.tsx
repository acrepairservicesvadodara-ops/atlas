...
export const metadata: Metadata = {
  title: "Successful Chiller Repair At Waghodia GIDC: Feb 2026 Case | Atlas Aircon Gujarat",
  description: "Professional successful chiller repair at waghodia gidc: feb 2026 case by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/successful-chiller-repair-waghodia-2026" },
  openGraph: {
    title: "Successful Chiller Repair At Waghodia GIDC: Feb 2026 Case | Atlas Aircon",
    description: "Professional successful chiller repair at waghodia gidc: feb 2026 case by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/successful-chiller-repair-waghodia-2026",
    type: "website",
  ...
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVsuccessful chiller repair waghodia 2026s?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVsuccessful chiller repair waghodia 2026s?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
