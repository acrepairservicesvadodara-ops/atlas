...
export const metadata: Metadata = {
  title: "AC Repair Vadodara Charges 2025 | Hitech Aircool Engineers Gujarat",
  description: "Affordable and Expert ...",
  alternates: { canonical: "https://hitechairconditioning.in/ac-repair-vadodara-charges" },
  openGraph: {
    title: "AC Repair Vadodara Charges 2025 | Hitech Aircool Engineers",
    description: "Affordable and Expert ...",
    url: "https://hitechairconditioning.in/ac-repair-vadodara-charges",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "AC Repair Vadodara Charges 2025",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageacrepairvadodaracharges() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">AC Repair Vadodara Charges 2025</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Affordable and Expert ...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Affordable and Expert ...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/walkin-freezer-repair.webp" alt="AC Repair Vadodara Charges 2025" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="AC Repair Vadodara Charges 2025" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="AC Repair Vadodara Charges 2025" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Ac Repair Vadodara Charges in Vadodara?", a: "Ac Repair Vadodara Charges cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Ac Repair Vadodara Charges?", a: "Hitech Aircool Engineers offers same-day Ac Repair Vadodara Charges across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Ac Repair Vadodara Chargess?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Ac Repair Vadodara Chargess depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Ac Repair Vadodara Charges available on holidays?", a: "Yes, Hitech Aircool Engineers provides Ac Repair Vadodara Charges 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Ac Repair Vadodara Charges take?", a: "Most Ac Repair Vadodara Chargess are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Ac Repair Vadodara Charges in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Ac Repair Vadodara Charges cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Ac Repair Vadodara Charges?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Ac Repair Vadodara Charges across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Ac Repair Vadodara Chargess?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Ac Repair Vadodara Chargess depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Ac Repair Vadodara Charges available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Ac Repair Vadodara Charges 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Ac Repair Vadodara Charges take?", acceptedAnswer: { "@type": "Answer", text: "Most Ac Repair Vadodara Chargess are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
