...
export const metadata: Metadata = {
  title: "Refrigerator Circuit & PCB Repair In Vadodara | Hitech Aircool Engineers Gujarat",
  description: "Professional refrigerator circuit & pcb repair in vadodara by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/refrigerator-circuit-repair-vadodara" },
  openGraph: {
    title: "Refrigerator Circuit & PCB Repair In Vadodara | Hitech Aircool Engineers",
    description: "Professional refrigerator circuit & pcb repair in vadodara by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/refrigerator-circuit-repair-vadodara",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Refrigerator Circuit & PCB Repair In Vadodara",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagerefrigeratorcircuitrepairvadodara() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Refrigerator Circuit &amp; PCB Repair In Vadodara</h1>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Ac-circuit.webp" alt="Refrigerator Circuit & PCB Repair In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Refrigerator Circuit & PCB Repair In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Refrigerator Circuit & PCB Repair In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Refrigerator Circuit Repair Vadodara in Vadodara?", a: "Refrigerator Circuit Repair Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Refrigerator Circuit Repair Vadodara?", a: "Hitech Aircool Engineers offers same-day Refrigerator Circuit Repair Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Refrigerator Circuit Repair Vadodaras?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Refrigerator Circuit Repair Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Refrigerator Circuit Repair Vadodara available on holidays?", a: "Yes, Hitech Aircool Engineers provides Refrigerator Circuit Repair Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Refrigerator Circuit Repair Vadodara take?", a: "Most Refrigerator Circuit Repair Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Refrigerator Circuit Repair Vadodara in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Refrigerator Circuit Repair Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Refrigerator Circuit Repair Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Refrigerator Circuit Repair Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Refrigerator Circuit Repair Vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Refrigerator Circuit Repair Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Refrigerator Circuit Repair Vadodara available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Refrigerator Circuit Repair Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Refrigerator Circuit Repair Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Most Refrigerator Circuit Repair Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
