...
export const metadata: Metadata = {
  title: "Haier AC Service Center Vadodara | Out-of-Warranty Repair Expert | Atlas Aircon",
  description: "Independent Haier AC service center in Vadodara. Expert out-of-warranty split AC repair, gas charging, PCB repair, deep cleaning & compressor overhaul. Same-day service. Call +91 97272 57141.",
  keywords: [
    "haier ac service center vadodara",
    "haier ac repair vadodara",
    "haier ac service vadodara",
    "haier split ac repair vadodara",
    "haier ac gas charging vadodara",
    "haier ac pcb repair vadodara",
    "haier ac installation vadodara",
    "haier ac not cooling vadodara",
    "ac service center vadodara",
    "best ac repair vadodara",
  ],
  alternates: { canonical: "https://atlasaircons.com/haier-ac-service-center-in-rc-dutt-road" },
  openGraph: {
    title: "Haier AC Service Center Vadodara | Atlas Aircon",
    description: "Independent out-of-warranty Haier AC repair specialist in Vadodara. Same-day service, 90-day guarantee.",
    url: "https://atlasaircons.com/haier-ac-service-center-in-rc-dutt-road",
    type: "website",
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Haier AC Service Center Vadodara",
  ...
  description: "Independent, out-of-warranty Haier AC repair, maintenance and installation in Vadodara, Gujarat.",
};
...
const faqJsonLd = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "Is Atlas Aircon an authorized Haier service center in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "No. Atlas Aircon is an independent service provider specializing in high-quality out-of-warranty repairs. If your Haier AC is under official warranty, contact Haier directly." } },
    { "@type": "Question", name: "How quickly can you repair my Haier AC in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "We offer same-day service across Vadodara. Our technicians typically arrive within 45-60 minutes of your call for emergency repairs." } },
    { "@type": "Question", name: "What is the cost of Haier AC gas refilling in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Gas refilling for Haier ACs starts at \u20B92,500 including leak detection. Final cost depends on the refrigerant type (R32/R410A) and quantity needed." } },
...
export default function HaierServiceCenterVadodaraPage() {
  return (
    <>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                <span className="text-yellow-400">Haier AC Service Center</span> Vadodara
              </h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                Expert independent repair solutions for Haier air conditioners in Vadodara. Specializing in out-of-warranty service with same-day dispatch and a full satisfaction guarantee.
              </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">Haier AC Repair Price List — Vadodara</h2>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Haier AC Service FAQs — Vadodara</h2>
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              ...
              { q: "How quickly can you repair my Haier AC in Vadodara?", a: "Same-day service is standard. Emergency calls are attended within 45-60 minutes across Vadodara." },
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Need Haier AC Repair in Vadodara?</h2>
