...
export const metadata: Metadata = {
  title: "Air Conditioner (AC) Condenser Repair » Call Now 9727257141 [2026 Updated] | Atlas Aircon Gujarat",
  description: "Need to repair or replace an air conditioner (ac) condenser? Save Money with Atlas A...",
  alternates: { canonical: "https://atlasaircons.com/air-conditioner-condenser-repair" },
  openGraph: {
    title: "Air Conditioner (AC) Condenser Repair » Call Now 9727257141 [2026 Updated] | Atlas Aircon",
    description: "Need to repair or replace an air conditioner (ac) condenser? Save Money with Atlas A...",
    url: "https://atlasaircons.com/air-conditioner-condenser-repair",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Air Conditioner (AC) Condenser Repair » Call Now 9727257141 [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Air Conditioner (AC) Condenser Repair » Call Now 9727257141 [2026 Updated]</h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Need to repair or replace an air conditioner (ac) condenser? Save Money with Atlas A...</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Air-Conditioning-Condenser-Repair.webp" alt="Air Conditioner (AC) Condenser Repair » Call Now 9727257141 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Air Conditioner (AC) Condenser Repair » Call Now 9727257141 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Air Conditioner (AC) Condenser Repair » Call Now 9727257141 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Air-Conditioning-Condenser-Repair.webp" alt="Air Conditioner (AC) Condenser Repair » Call Now 9727257141 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Air-Conditioning-Condenser-Repair.webp" alt="Air Conditioner (AC) Condenser Repair » Call Now 9727257141 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Air-Conditioning-Condenser-Repair.webp" alt="Air Conditioner (AC) Condenser Repair » Call Now 9727257141 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Air Conditioner Condenser Repair in Vadodara?", a: "Air Conditioner Condenser Repair cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Air Conditioner Condenser Repair?", a: "Atlas Aircon offers same-day Air Conditioner Condenser Repair across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Air Conditioner Condenser Repairs?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Air Conditioner Condenser Repairs depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Air Conditioner Condenser Repair available on holidays?", a: "Yes, Atlas Aircon provides Air Conditioner Condenser Repair 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Air Conditioner Condenser Repair?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Air Conditioner Condenser Repair across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Air Conditioner Condenser Repairs?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Air Conditioner Condenser Repairs depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Air Conditioner Condenser Repair available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Air Conditioner Condenser Repair 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
