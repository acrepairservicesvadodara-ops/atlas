...
export const metadata: Metadata = {
  title: "Fast Ducting Repair Services Ahmedabad: Stop 5+ Leaks [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ducting-repair-services-ahmedabad" },
  openGraph: {
    title: "Fast Ducting Repair Services Ahmedabad: Stop 5+ Leaks [2026 Updated] | Atlas Aircon",
    description: "Professional HVAC & ducting repair services Ahmedabad. We fix leaks, damage & insulation issues for better airflow & AC efficiency. ✅ Free inspection & same-day",
    url: "https://atlasaircons.com/ducting-repair-services-ahmedabad",
    type: "website",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Professional HVAC &amp; ducting repair services Ahmedabad. We fix leaks, damage &amp; insulation issues for better airflow &amp; AC efficiency. ✅ Free inspection &amp; same-day service available.</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/cropped-AtlasAircon-Logo.webp" alt="Fast Ducting Repair Services Ahmedabad: Stop 5+ Leaks [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Ducting Repair Services Ahmedabad in Vadodara?", a: "Ducting Repair Services Ahmedabad cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Ducting Repair Services Ahmedabad?", a: "Atlas Aircon offers same-day Ducting Repair Services Ahmedabad across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Ducting Repair Services Ahmedabads?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Ducting Repair Services Ahmedabads depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Ducting Repair Services Ahmedabad available on holidays?", a: "Yes, Atlas Aircon provides Ducting Repair Services Ahmedabad 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Ducting Repair Services Ahmedabad?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Ducting Repair Services Ahmedabad across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Ducting Repair Services Ahmedabads?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Ducting Repair Services Ahmedabads depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Ducting Repair Services Ahmedabad available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Ducting Repair Services Ahmedabad 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
