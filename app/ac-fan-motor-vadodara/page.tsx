...
export const metadata: Metadata = {
  title: "AC Fan Motor in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC fan motor repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC Fan Motor Vadodara",
    "ac fan motor",
    "AC Fan Motor installation",
    "AC Fan Motor service",
    "AC Fan Motor repair",
    "best AC Fan Motor service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-fan-motor-vadodara",
  },
};
...
const keywordData = {
  title: "AC Fan Motor",
  slug: "ac-fan-motor",
  description: "AC fan motor repair",
  category: "Problems"
};
...
export default function ACFanMotorPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What ac fan motor vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides ac fan motor vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book ac fan motor vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency ac fan motor vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What ac fan motor vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides ac fan motor vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book ac fan motor vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency ac fan motor vadodara available. Call +91 93289 53665 for immediate assistance." } },
