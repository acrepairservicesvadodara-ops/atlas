...
export const metadata: Metadata = {
  title: "AC Stand Installation in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC stand fitting in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC Stand Installation Vadodara",
    "ac stand installation",
    "AC Stand Installation installation",
    "AC Stand Installation service",
    "AC Stand Installation repair",
    "best AC Stand Installation service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-stand-installation-vadodara",
  },
};

const keywordData = {
  title: "AC Stand Installation",
  slug: "ac-stand-installation",
  description: "AC stand fitting",
  category: "Parts"
};
...
export default function ACStandInstallationPage() {
  return (
    <>
      {/* Hero Section */}
