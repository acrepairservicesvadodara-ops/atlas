...
export const metadata: Metadata = {
  title: "AC Installation Surat | Hitech Aircool Engineers Gujarat",
  description: "Professional AC installation in Surat. Expert split & window AC fitting, gas charging & electrical wiring for homes & offices. Same-day service. Free estimate!",
  alternates: { canonical: "https://hitechairconditioning.in/ac-installation-surat" },
  openGraph: {
    title: "AC Installation Surat | Hitech Aircool Engineers",
    description: "Professional AC installation in Surat. Expert split & window AC fitting, gas charging & electrical wiring for homes & offices. Same-day service. Free estimate!",
    url: "https://hitechairconditioning.in/ac-installation-surat",
    type: "website",
...
export default function Pageacinstallationsurat() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">AC Installation Surat</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Professional AC installation in Surat. Expert split &amp; window AC fitting, gas charging &amp; electrical wiring for homes &amp; offices. Same-day service. Free estimate!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Professional AC installation in Surat. Expert split &amp; window AC fitting, gas charging &amp; electrical wiring for homes &amp; offices. Same-day service. Free estimate!</p>
          </div>
        </div>
      </section>
