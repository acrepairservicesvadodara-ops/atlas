...
export const metadata: Metadata = {
  title: "AC Installation Surat | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-installation-surat" },
  openGraph: {
    title: "AC Installation Surat | Atlas Aircon",
    description: "Professional AC installation in Surat. Expert split & window AC fitting, gas charging & electrical wiring for homes & offices. Same-day service. Free estimate!",
    url: "https://atlasaircons.com/ac-installation-surat",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Professional AC installation in Surat. Expert split &amp; window AC fitting, gas charging &amp; electrical wiring for homes &amp; offices. Same-day service. Free estimate!</p>
