...
export const metadata: Metadata = {
  title: "✅ Guaranteed 24/7 Refrigerator Service In Godhra [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/refrigerator-service-center-godhra" },
  openGraph: {
    title: "✅ Guaranteed 24/7 Refrigerator Service In Godhra [2026 Updated] | Atlas Aircon",
    description: "Urgent fridge repair in Godhra? Our certified experts fix cooling, noise & leaks with genuine parts at your doorstep. Get 30% off first service & a 100-day warr",
    url: "https://atlasaircons.com/refrigerator-service-center-godhra",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Urgent fridge repair in Godhra? Our certified experts fix cooling, noise &amp; leaks with genuine parts at your doorstep. Get 30% off first service &amp; a 100-day warranty!</p>
