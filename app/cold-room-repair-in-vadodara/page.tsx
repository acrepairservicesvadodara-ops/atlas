...
export const metadata: Metadata = {
  title: "Cold Room (Cold Storage) Repair In Vadodara &raquo; Call Now [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Professional cold room (cold storage) repair in vadodara &raquo; call now [2026 updated] by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/cold-room-repair-in-vadodara" },
  openGraph: {
    title: "Cold Room (Cold Storage) Repair In Vadodara &raquo; Call Now [2026 Updated] | Hitech Aircool Engineers",
    description: "Professional cold room (cold storage) repair in vadodara &raquo; call now [2026 updated] by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/cold-room-repair-in-vadodara",
    type: "website",
    images: ["/images/products/Minimalist-Baby-Its-Cold-Outside-Winter-Facebook-Post.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Cold Room (Cold Storage) Repair In Vadodara &raquo; Call Now [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagecoldroomrepairinvadodara() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Cold Room (Cold Storage) Repair In Vadodara &amp;raquo; Call Now [2026 Updated]</h1>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Minimalist-Baby-Its-Cold-Outside-Winter-Facebook-Post.webp" alt="Cold Room (Cold Storage) Repair In Vadodara &raquo; Call Now [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Cold Room (Cold Storage) Repair In Vadodara &raquo; Call Now [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Cold Room (Cold Storage) Repair In Vadodara &raquo; Call Now [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVcold room repair in vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial cold room repair in vadodara?", a: "Industrial cold room repair in vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVcold room repair in vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial cold room repair in vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial cold room repair in vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
