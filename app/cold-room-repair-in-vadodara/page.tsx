...
export const metadata: Metadata = {
  title: "Cold Room (Cold Storage) Repair In Vadodara &raquo; Call Now [2026 Updated] | Atlas Aircon Gujarat",
  description: "Professional cold room (cold storage) repair in vadodara &raquo; call now [2026 updated] by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/cold-room-repair-in-vadodara" },
  openGraph: {
    title: "Cold Room (Cold Storage) Repair In Vadodara &raquo; Call Now [2026 Updated] | Atlas Aircon",
    description: "Professional cold room (cold storage) repair in vadodara &raquo; call now [2026 updated] by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/cold-room-repair-in-vadodara",
    type: "website",
  ...
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVcold room repair in vadodaras?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVcold room repair in vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
