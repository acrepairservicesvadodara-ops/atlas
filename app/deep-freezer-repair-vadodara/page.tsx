...
export const metadata: Metadata = {
  title: "Deep Freezer Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Deep freezer service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Deep Freezer Repair Vadodara",
    "deep freezer repair",
    "Deep Freezer Repair installation",
    "Deep Freezer Repair service",
    "Deep Freezer Repair repair",
    "best Deep Freezer Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/deep-freezer-repair-vadodara",
  },
};
...
const keywordData = {
  ...
  description: "Deep freezer service",
...
export default function DeepFreezerRepairPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVdeep freezer repair vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial deep freezer repair vadodara?", a: "Industrial deep freezer repair vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVdeep freezer repair vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial deep freezer repair vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial deep freezer repair vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
