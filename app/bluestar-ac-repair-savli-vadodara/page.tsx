...
export const metadata: Metadata = {
  title: "Bluestar AC Repair Savli in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Blue Star repair Savli in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Bluestar AC Repair Savli Vadodara",
    "bluestar ac repair savli",
    "Bluestar AC Repair Savli installation",
    "Bluestar AC Repair Savli service",
    "Bluestar AC Repair Savli repair",
    "best Bluestar AC Repair Savli service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/bluestar-ac-repair-savli-vadodara",
  },
};

const keywordData = {
  title: "Bluestar AC Repair Savli",
  slug: "bluestar-ac-repair-savli",
  description: "Blue Star repair Savli",
  category: "Area"
};
...
export default function BluestarACRepairSavliPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Bluestar Ac Repair Savli Vadodara in Vadodara?", a: "Bluestar Ac Repair Savli Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Bluestar Ac Repair Savli Vadodara?", a: "Hitech Aircool Engineers offers same-day Bluestar Ac Repair Savli Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Bluestar Ac Repair Savli Vadodaras?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Bluestar Ac Repair Savli Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Bluestar Ac Repair Savli Vadodara available on holidays?", a: "Yes, Hitech Aircool Engineers provides Bluestar Ac Repair Savli Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Bluestar Ac Repair Savli Vadodara take?", a: "Most Bluestar Ac Repair Savli Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Bluestar Ac Repair Savli Vadodara in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Bluestar Ac Repair Savli Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Bluestar Ac Repair Savli Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Bluestar Ac Repair Savli Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Bluestar Ac Repair Savli Vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Bluestar Ac Repair Savli Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Bluestar Ac Repair Savli Vadodara available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Bluestar Ac Repair Savli Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Bluestar Ac Repair Savli Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Most Bluestar Ac Repair Savli Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
