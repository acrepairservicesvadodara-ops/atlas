...
export const metadata: Metadata = {
  title: "AC Service Center Anand | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-center-anand" },
  openGraph: {
    title: "AC Service Center Anand | Atlas Aircon",
    description: "Reliable AC service center in Anand offering expert repair, maintenance & gas charging services. Local technicians, honest pricing & satisfaction guarantee. Cal",
    url: "https://atlasaircons.com/ac-service-center-anand",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Reliable AC service center in Anand offering expert repair, maintenance &amp; gas charging services. Local technicians, honest pricing &amp; satisfaction guarantee. Call us!</p>
