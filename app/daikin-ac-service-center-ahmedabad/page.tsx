...
export const metadata: Metadata = {
  title: "Daikin AC Service Center Ahmedabad | Out-of-Warranty Repair Expert | Atlas Aircon",
  description: "Independent Daikin AC service center in Ahmedabad. Expert out-of-warranty split AC repair, gas charging, PCB repair, deep cleaning & compressor overhaul. Same-day service. Call +91 97272 57141.",
  keywords: [
    "daikin ac service center ahmedabad",
    "daikin ac repair ahmedabad",
    "daikin ac service ahmedabad",
    "daikin split ac repair ahmedabad",
    "daikin ac gas charging ahmedabad",
    "daikin ac pcb repair ahmedabad",
    "daikin ac installation ahmedabad",
    "daikin ac not cooling ahmedabad",
    "ac service center ahmedabad",
    "best ac repair ahmedabad",
  ],
  alternates: { canonical: "https://atlasaircons.com/daikin-ac-service-center-ahmedabad" },
  openGraph: {
    title: "Daikin AC Service Center Ahmedabad | Atlas Aircon",
    description: "Independent out-of-warranty Daikin AC repair specialist in Ahmedabad. Same-day service, 90-day guarantee.",
    url: "https://atlasaircons.com/daikin-ac-service-center-ahmedabad",
    type: "website",
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Daikin AC Service Center Ahmedabad",
  ...
  description: "Independent, out-of-warranty Daikin AC repair, maintenance and installation in Ahmedabad, Gujarat.",
};
...
const faqJsonLd = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "Is Atlas Aircon an authorized Daikin service center in Ahmedabad?", acceptedAnswer: { "@type": "Answer", text: "No. Atlas Aircon is an independent service provider specializing in high-quality out-of-warranty repairs. If your Daikin AC is under official warranty, contact Daikin directly." } },
    { "@type": "Question", name: "How quickly can you repair my Daikin AC in Ahmedabad?", acceptedAnswer: { "@type": "Answer", text: "We offer same-day service across Ahmedabad. Our technicians typically arrive within 45-60 minutes of your call for emergency repairs." } },
    { "@type": "Question", name: "What is the cost of Daikin AC gas refilling in Ahmedabad?", acceptedAnswer: { "@type": "Answer", text: "Gas refilling for Daikin ACs starts at \u20B92,500 including leak detection. Final cost depends on the refrigerant type (R32/R410A) and quantity needed." } },
...
export default function DaikinServiceCenterAhmedabadPage() {
  return (
    <>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                <span className="text-yellow-400">Daikin AC Service Center</span> Ahmedabad
              </h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                Expert independent repair solutions for Daikin air conditioners in Ahmedabad. Specializing in out-of-warranty service with same-day dispatch and a full satisfaction guarantee.
              </p>
            ...
            <div className="hidden md:block">
              <BookingForm title={"Book Daikin AC Service"} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Our Daikin AC Service Offerings</h2>
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              { icon: ThermometerSnowflake, t: "Split & Window AC Repair", d: "Gas charging, sensor replacement, PCB repair, and complete overhaul for all Daikin models including inverter series.", color: "blue" },
              ...
              { icon: Factory, t: "Industrial Panel AC", d: "Rittal and Daikin panel cooler maintenance for GIDC factories and automation panels.", color: "red" },
              { icon: Wrench, t: "Compressor Repair", d: "Expert diagnosis and repair of Daikin rotary and scroll compressors. Motor rewinding available.", color: "orange" },
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">Daikin AC Repair Price List — Ahmedabad</h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-600 text-center mb-8 text-sm max-w-3xl mx-auto">
            While we specialize as a Daikin AC service center, our team is equally proficient with all major brands.
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Daikin AC Service FAQs — Ahmedabad</h2>
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              ...
              { q: "How quickly can you repair my Daikin AC in Ahmedabad?", a: "Same-day service is standard. Emergency calls are attended within 45-60 minutes across Ahmedabad." },
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Need Daikin AC Repair in Ahmedabad?</h2>
