...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "ac installation ankodiya",
    "ac gas refilling ankodiya",
    "split ac repair ankodiya",
    "window ac service ankodiya",
    "ac deep cleaning ankodiya",
    "best ac service near me ankodiya",
    "ac mechanic ankodiya vadodara",
...
const jsonLd = {
  ...
  areaServed: { "@type": "Place", name: "Ankodiya, Vadodara" },
...
export default function ACServiceInAnkodiyaPage() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden md:block">
              <BookingForm title={"Book AC Service in Ankodiya"} />
            </div>
          </div>
        </div>
      </section>

      {/* About Ankodiya Service Area — SEO Content */}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8 max-w-5xl mx-auto">
            {[
              ...
              { icon: Clock, t: "45-Min Response Time", d: "Fastest dispatch in Ankodiya & all Vadodara" },
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-6">Common AC Problems We Solve in Ankodiya</h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Frequently Asked Questions — AC Service in Ankodiya</h2>
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "How much does AC service cost in Ankodiya?", a: "Standard AC service costs \u20B9499-\u20B9799. Deep cleaning starts at \u20B9499. Visit charge of \u20B9299 is deducted from the repair bill." },
              { q: "Do you provide 24/7 emergency AC repair in Ankodiya?", a: "Yes! Our technicians are available round the clock. We can reach Ankodiya within 45-60 minutes for emergency calls." },
              ...
              { q: "Do you offer AMC plans for Ankodiya residents?", a: "Yes, we offer Comprehensive and Non-Comprehensive AMCs with quarterly servicing, priority support, and discounted parts." },
              ...
              { q: "Can you install a new split AC in Ankodiya?", a: "Absolutely. We handle end-to-end installation including site survey, copper piping, wiring, wall mounting, gas charging, and testing." },
