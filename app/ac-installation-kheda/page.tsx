...
export const metadata: Metadata = {
  title: "AC Installation Kheda | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-installation-kheda" },
  openGraph: {
    title: "AC Installation Kheda | Atlas Aircon",
    description: "Professional AC installation service in Kheda. Expert split & window AC fitting, gas charging & electrical work for homes & shops. Free consultation. Call now!",
    url: "https://atlasaircons.com/ac-installation-kheda",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Professional AC installation service in Kheda. Expert split &amp; window AC fitting, gas charging &amp; electrical work for homes &amp; shops. Free consultation. Call now!</p>
