...
export const metadata: Metadata = {
  title: "Air Handling Unit Services Morbi | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/air-handling-unit-services-morbi" },
  openGraph: {
    title: "Air Handling Unit Services Morbi | Atlas Aircon",
    description: "Specialized Air Handling Unit Services in Morbi for Ceramic & Tile Plants. Combat glaze dust, ensure perfect kiln air supply & prevent production stoppages. 24/",
    url: "https://atlasaircons.com/air-handling-unit-services-morbi",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Specialized Air Handling Unit Services in Morbi for Ceramic &amp; Tile Plants. Combat glaze dust, ensure perfect kiln air supply &amp; prevent production stoppages. 24/7 expert repair &amp; maintenance. Call Now!</p>
