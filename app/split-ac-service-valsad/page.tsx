...
export const metadata: Metadata = {
  title: "Fast Split AC Repair & Service In Valsad | Hitech Aircool Engineers Gujarat",
  description: "Expert split AC service in Valsad. Reliable repair, gas refill & installation for homes & businesses. Genuine spare parts, certified technicians & affordable AM",
  alternates: { canonical: "https://hitechairconditioning.in/split-ac-service-valsad" },
  openGraph: {
    title: "Fast Split AC Repair & Service In Valsad | Hitech Aircool Engineers",
    description: "Expert split AC service in Valsad. Reliable repair, gas refill & installation for homes & businesses. Genuine spare parts, certified technicians & affordable AM",
    url: "https://hitechairconditioning.in/split-ac-service-valsad",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Fast Split AC Repair & Service In Valsad",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagesplitacservicevalsad() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Fast Split AC Repair &amp; Service In Valsad</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Expert split AC service in Valsad. Reliable repair, gas refill &amp; installation for homes &amp; businesses. Genuine spare parts, certified technicians &amp; affordable AMC. Call now!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Expert split AC service in Valsad. Reliable repair, gas refill &amp; installation for homes &amp; businesses. Genuine spare parts, certified technicians &amp; affordable AMC. Call now!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/Split-Air-Conditioner.webp" alt="Fast Split AC Repair & Service In Valsad" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Fast Split AC Repair & Service In Valsad" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
