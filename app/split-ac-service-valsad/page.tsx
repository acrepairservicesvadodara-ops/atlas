...
export const metadata: Metadata = {
  title: "Fast Split AC Repair & Service In Valsad | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/split-ac-service-valsad" },
  openGraph: {
    title: "Fast Split AC Repair & Service In Valsad | Atlas Aircon",
    description: "Expert split AC service in Valsad. Reliable repair, gas refill & installation for homes & businesses. Genuine spare parts, certified technicians & affordable AM",
    url: "https://atlasaircons.com/split-ac-service-valsad",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert split AC service in Valsad. Reliable repair, gas refill &amp; installation for homes &amp; businesses. Genuine spare parts, certified technicians &amp; affordable AMC. Call now!</p>
