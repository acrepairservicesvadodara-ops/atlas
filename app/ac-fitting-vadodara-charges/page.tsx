...
export const metadata: Metadata = {
  title: "AC Fitting In Vadodara & Charges | Hitech Aircool Engineers Gujarat",
  description: "AC Fitting In Vadodara & Charges - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/ac-fitting-vadodara-charges" },
  openGraph: {
    title: "AC Fitting In Vadodara & Charges | Hitech Aircool Engineers",
    description: "AC Fitting In Vadodara & Charges - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/ac-fitting-vadodara-charges",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "AC Fitting In Vadodara & Charges",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageacfittingvadodaracharges() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">AC Fitting In Vadodara &amp; Charges</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">/* Custom CSS for theme and advanced styling */ :root ...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">/* Custom CSS for theme and advanced styling */ :root ...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/hvac-service.webp" alt="AC Fitting In Vadodara & Charges" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="AC Fitting In Vadodara & Charges" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="AC Fitting In Vadodara & Charges" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
