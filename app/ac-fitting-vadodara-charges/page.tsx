...
export const metadata: Metadata = {
  title: "AC Fitting In Vadodara & Charges | Atlas Aircon Gujarat",
  description: "AC Fitting In Vadodara & Charges - Atlas Aircon Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/ac-fitting-vadodara-charges" },
  openGraph: {
    title: "AC Fitting In Vadodara & Charges | Atlas Aircon",
    description: "AC Fitting In Vadodara & Charges - Atlas Aircon Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/ac-fitting-vadodara-charges",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">/* Custom CSS for theme and advanced styling */ :root ...</p>
