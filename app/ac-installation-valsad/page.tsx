...
export const metadata: Metadata = {
  title: "AC Installation Valsad | Hitech Aircool Engineers Gujarat",
  description: "Expert AC installation services in Valsad. Professional split AC fitting, gas charging & bracket fixing. Free site survey & same-day service available. Call now",
  alternates: { canonical: "https://hitechairconditioning.in/ac-installation-valsad" },
  openGraph: {
    title: "AC Installation Valsad | Hitech Aircool Engineers",
    description: "Expert AC installation services in Valsad. Professional split AC fitting, gas charging & bracket fixing. Free site survey & same-day service available. Call now",
    url: "https://hitechairconditioning.in/ac-installation-valsad",
    type: "website",
...
export default function Pageacinstallationvalsad() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">AC Installation Valsad</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Expert AC installation services in Valsad. Professional split AC fitting, gas charging &amp; bracket fixing. Free site survey &amp; same-day service available. Call now!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Expert AC installation services in Valsad. Professional split AC fitting, gas charging &amp; bracket fixing. Free site survey &amp; same-day service available. Call now!</p>
          </div>
        </div>
      </section>
