...
export const metadata: Metadata = {
  title: "AC Installation Valsad | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-installation-valsad" },
  openGraph: {
    title: "AC Installation Valsad | Atlas Aircon",
    description: "Expert AC installation services in Valsad. Professional split AC fitting, gas charging & bracket fixing. Free site survey & same-day service available. Call now",
    url: "https://atlasaircons.com/ac-installation-valsad",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert AC installation services in Valsad. Professional split AC fitting, gas charging &amp; bracket fixing. Free site survey &amp; same-day service available. Call now!</p>
