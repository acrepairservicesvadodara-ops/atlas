...
export const metadata: Metadata = {
  title: "#1 HVAC Contractors In Vadodara | Atlas Aircon Gujarat",
  description: "Your Trusted Partner for Reliable & Efficient HVAC Contractors in Vadodara <!...",
  alternates: { canonical: "https://atlasaircons.com/hvac-contractors-in-vadodara" },
  openGraph: {
    title: "#1 HVAC Contractors In Vadodara | Atlas Aircon",
    description: "Your Trusted Partner for Reliable & Efficient HVAC Contractors in Vadodara <!...",
    url: "https://atlasaircons.com/hvac-contractors-in-vadodara",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Your Trusted Partner for Reliable &amp; Efficient HVAC Contractors in Vadodara &lt;!...</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVhvac contractors in vadodaras?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVhvac contractors in vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
