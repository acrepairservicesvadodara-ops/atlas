...
export const metadata: Metadata = {
  title: "Deep Cleaning AC Service In Vadodara: Keep Your AC Running [2026 Updated] | Atlas Aircon Gujarat",
  description: "Deep Cleaning AC Service in Vad...",
  alternates: { canonical: "https://atlasaircons.com/deep-cleaning-ac-service-in-vadodara" },
  openGraph: {
    title: "Deep Cleaning AC Service In Vadodara: Keep Your AC Running [2026 Updated] | Atlas Aircon",
    description: "Deep Cleaning AC Service in Vad...",
    url: "https://atlasaircons.com/deep-cleaning-ac-service-in-vadodara",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Deep Cleaning AC Service in Vad...</p>
