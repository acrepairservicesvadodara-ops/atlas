...
export const metadata: Metadata = {
  title: "Samsung Refrigerator Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Samsung fridge service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Samsung Refrigerator Repair Vadodara",
    "samsung refrigerator repair",
    "Samsung Refrigerator Repair installation",
    "Samsung Refrigerator Repair service",
    "Samsung Refrigerator Repair repair",
    "best Samsung Refrigerator Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/samsung-refrigerator-repair-vadodara",
  },
};
...
const keywordData = {
  ...
  description: "Samsung fridge service",
...
export default function SamsungRefrigeratorRepairPage() {
  return (
    <>
      {/* Hero Section */}
