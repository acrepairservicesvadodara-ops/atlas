...
export const metadata: Metadata = {
  title: "🚨 Emergency AC Repair Morbi | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-repair-morbi" },
  openGraph: {
    title: "🚨 Emergency AC Repair Morbi | Atlas Aircon",
    description: "AC breakdown in Morbi? Get fast, reliable repair for all brands. Expert technicians, same-day service & 100% satisfaction guarantee. Call now for immediate help",
    url: "https://atlasaircons.com/ac-repair-morbi",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">AC breakdown in Morbi? Get fast, reliable repair for all brands. Expert technicians, same-day service &amp; 100% satisfaction guarantee. Call now for immediate help!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Ac Repair Morbi in Vadodara?", a: "Ac Repair Morbi cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Ac Repair Morbi?", a: "Atlas Aircon offers same-day Ac Repair Morbi across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Ac Repair Morbis?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Ac Repair Morbis depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Ac Repair Morbi available on holidays?", a: "Yes, Atlas Aircon provides Ac Repair Morbi 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Ac Repair Morbi in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Ac Repair Morbi cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Ac Repair Morbi?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Ac Repair Morbi across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Ac Repair Morbis?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Ac Repair Morbis depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Ac Repair Morbi available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Ac Repair Morbi 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
