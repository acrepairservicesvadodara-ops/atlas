...
export const metadata: Metadata = {
  title: "Dahej AC Installation in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC installation Dahej in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Dahej AC Installation Vadodara",
    "dahej ac installation",
    "Dahej AC Installation installation",
    "Dahej AC Installation service",
    "Dahej AC Installation repair",
    "best Dahej AC Installation service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/dahej-ac-installation-vadodara",
  },
};

const keywordData = {
  title: "Dahej AC Installation",
  slug: "dahej-ac-installation",
  description: "AC installation Dahej",
  category: "OutCity"
};
...
export default function DahejACInstallationPage() {
  return (
    <>
      {/* Hero Section */}
