...
export const metadata: Metadata = {
  title: "Expert Symphony Air Cooler Repair Service In Vadodara | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/symphony-air-cooler-repair-service" },
  openGraph: {
    title: "Expert Symphony Air Cooler Repair Service In Vadodara | Atlas Aircon",
    description: "Expert Guide to Symphony Air Cooler Repair Service in Vadodara: Everything You Need to Know Looking for reliable Symphony air cooler repair se...",
    url: "https://atlasaircons.com/symphony-air-cooler-repair-service",
    type: "website",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert Guide to Symphony Air Cooler Repair Service in Vadodara: Everything You Need to Know Looking for reliable Symphony air cooler repair se...</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Symphony Air Cooler Repair Service in Vadodara?", a: "Symphony Air Cooler Repair Service cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Symphony Air Cooler Repair Service?", a: "Atlas Aircon offers same-day Symphony Air Cooler Repair Service across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Symphony Air Cooler Repair Services?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Symphony Air Cooler Repair Services depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Symphony Air Cooler Repair Service available on holidays?", a: "Yes, Atlas Aircon provides Symphony Air Cooler Repair Service 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Symphony Air Cooler Repair Service?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Symphony Air Cooler Repair Service across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Symphony Air Cooler Repair Services?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Symphony Air Cooler Repair Services depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Symphony Air Cooler Repair Service available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Symphony Air Cooler Repair Service 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
