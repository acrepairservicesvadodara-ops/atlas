...
export const metadata: Metadata = {
  title: "New AC Installation in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "New AC fitting in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "New AC Installation Vadodara",
    "new ac installation",
    "New AC Installation installation",
    "New AC Installation service",
    "New AC Installation repair",
    "best New AC Installation service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/new-ac-installation-vadodara",
  },
};

const keywordData = {
  title: "New AC Installation",
  slug: "new-ac-installation",
  description: "New AC fitting",
...
export default function NewACInstallationPage() {
  return (
    <>
      {/* Hero Section */}
