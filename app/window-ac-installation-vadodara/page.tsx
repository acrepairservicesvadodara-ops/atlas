...
export const metadata: Metadata = {
  title: "Window AC Installation in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Window AC fitting in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Window AC Installation Vadodara",
    "window ac installation",
    "Window AC Installation installation",
    "Window AC Installation service",
    "Window AC Installation repair",
    "best Window AC Installation service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/window-ac-installation-vadodara",
  },
};
