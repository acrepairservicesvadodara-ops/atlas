...
export const metadata: Metadata = {
  title: "🔧 AC Service Center Rajpipla | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-center-rajpipla" },
  openGraph: {
    title: "🔧 AC Service Center Rajpipla | Atlas Aircon",
    description: "Expert AC service center Rajpipla offering complete repair & maintenance for all AC brands. Our 7-step quality check ensures perfect cooling. Free diagnosis ava",
    url: "https://atlasaircons.com/ac-service-center-rajpipla",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert AC service center Rajpipla offering complete repair &amp; maintenance for all AC brands. Our 7-step quality check ensures perfect cooling. Free diagnosis available!</p>
