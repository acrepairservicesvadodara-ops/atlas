...
export const metadata: Metadata = {
  title: "🔧 AC Service Center Rajpipla | Hitech Aircool Engineers Gujarat",
  description: "Expert AC service center Rajpipla offering complete repair & maintenance for all AC brands. Our 7-step quality check ensures perfect cooling. Free diagnosis ava",
  alternates: { canonical: "https://hitechairconditioning.in/ac-service-center-rajpipla" },
  openGraph: {
    title: "🔧 AC Service Center Rajpipla | Hitech Aircool Engineers",
    description: "Expert AC service center Rajpipla offering complete repair & maintenance for all AC brands. Our 7-step quality check ensures perfect cooling. Free diagnosis ava",
    url: "https://hitechairconditioning.in/ac-service-center-rajpipla",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "🔧 AC Service Center Rajpipla",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageacservicecenterrajpipla() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">🔧 AC Service Center Rajpipla</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Expert AC service center Rajpipla offering complete repair &amp; maintenance for all AC brands. Our 7-step quality check ensures perfect cooling. Free diagnosis available!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Expert AC service center Rajpipla offering complete repair &amp; maintenance for all AC brands. Our 7-step quality check ensures perfect cooling. Free diagnosis available!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Atlas-Aircon-Vehicle.webp" alt="🔧 AC Service Center Rajpipla" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="🔧 AC Service Center Rajpipla" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Ac Service Center Rajpipla include?", a: "Ac Service Center Rajpipla includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Ac Service Center Rajpipla cost?", a: "Ac Service Center Rajpipla starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Ac Service Center Rajpipla improve cooling?", a: "Yes, proper Ac Service Center Rajpipla can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Ac Service Center Rajpipla reduce electricity bills?", a: "Regular Ac Service Center Rajpipla can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Ac Service Center Rajpipla take?", a: "Basic Ac Service Center Rajpipla takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Ac Service Center Rajpipla remove bad smell?", a: "Yes, Ac Service Center Rajpipla includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Ac Service Center Rajpipla?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Ac Service Center Rajpipla include?", acceptedAnswer: { "@type": "Answer", text: "Ac Service Center Rajpipla includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Ac Service Center Rajpipla cost?", acceptedAnswer: { "@type": "Answer", text: "Ac Service Center Rajpipla starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Ac Service Center Rajpipla improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Ac Service Center Rajpipla can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Ac Service Center Rajpipla reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Ac Service Center Rajpipla can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Ac Service Center Rajpipla take?", acceptedAnswer: { "@type": "Answer", text: "Basic Ac Service Center Rajpipla takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Ac Service Center Rajpipla remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Ac Service Center Rajpipla includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Ac Service Center Rajpipla?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
