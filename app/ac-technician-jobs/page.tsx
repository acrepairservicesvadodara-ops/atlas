...
export const metadata: Metadata = {
  title: "URGENT AC Technician Jobs In Vadodara | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-technician-jobs" },
  openGraph: {
    title: "URGENT AC Technician Jobs In Vadodara | Atlas Aircon",
    description: "Ac Technician Jobs for Engineers who lives in Gujarat, we provide work on commission also so anybody can join us. Accommodation and food allowance provided",
    url: "https://atlasaircons.com/ac-technician-jobs",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Ac Technician Jobs for Engineers who lives in Gujarat, we provide work on commission also so anybody can join us. Accommodation and food allowance provided</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What ac technician jobss does Atlas Aircon provide?", a: "Atlas Aircon provides ac technician jobs, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book ac technician jobs?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency ac technician jobs available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What ac technician jobss does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides ac technician jobs, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book ac technician jobs?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency ac technician jobs available. Call +91 97272 57141 for immediate assistance." } },
