...
export const metadata: Metadata = {
  title: "Chiller Plant Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Chiller plant maintenance in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Chiller Plant Service Vadodara",
    "chiller plant service",
    "Chiller Plant Service installation",
    "Chiller Plant Service service",
    "Chiller Plant Service repair",
    "best Chiller Plant Service service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/chiller-plant-service-vadodara",
  },
};

const keywordData = {
  title: "Chiller Plant Service",
  slug: "chiller-plant-service",
  description: "Chiller plant maintenance",
  category: "Commercial"
};
...
export default function ChillerPlantServicePage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVchiller plant service vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial chiller plant service vadodara?", a: "Industrial chiller plant service vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVchiller plant service vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial chiller plant service vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial chiller plant service vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
