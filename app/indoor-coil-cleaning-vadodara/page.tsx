...
export const metadata: Metadata = {
  title: "Indoor Coil Cleaning in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC indoor coil cleaning in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Indoor Coil Cleaning Vadodara",
    "indoor coil cleaning",
    "Indoor Coil Cleaning installation",
    "Indoor Coil Cleaning service",
    "Indoor Coil Cleaning repair",
    "best Indoor Coil Cleaning service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/indoor-coil-cleaning-vadodara",
  },
};

const keywordData = {
  title: "Indoor Coil Cleaning",
  slug: "indoor-coil-cleaning",
  description: "AC indoor coil cleaning",
  category: "Problems"
};
...
export default function IndoorCoilCleaningPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Indoor Coil Cleaning Vadodara include?", a: "Indoor Coil Cleaning Vadodara includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Indoor Coil Cleaning Vadodara cost?", a: "Indoor Coil Cleaning Vadodara starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Indoor Coil Cleaning Vadodara improve cooling?", a: "Yes, proper Indoor Coil Cleaning Vadodara can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Indoor Coil Cleaning Vadodara reduce electricity bills?", a: "Regular Indoor Coil Cleaning Vadodara can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Indoor Coil Cleaning Vadodara take?", a: "Basic Indoor Coil Cleaning Vadodara takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Indoor Coil Cleaning Vadodara remove bad smell?", a: "Yes, Indoor Coil Cleaning Vadodara includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Indoor Coil Cleaning Vadodara?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Indoor Coil Cleaning Vadodara include?", acceptedAnswer: { "@type": "Answer", text: "Indoor Coil Cleaning Vadodara includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Indoor Coil Cleaning Vadodara cost?", acceptedAnswer: { "@type": "Answer", text: "Indoor Coil Cleaning Vadodara starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Indoor Coil Cleaning Vadodara improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Indoor Coil Cleaning Vadodara can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Indoor Coil Cleaning Vadodara reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Indoor Coil Cleaning Vadodara can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Indoor Coil Cleaning Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Basic Indoor Coil Cleaning Vadodara takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Indoor Coil Cleaning Vadodara remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Indoor Coil Cleaning Vadodara includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Indoor Coil Cleaning Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
