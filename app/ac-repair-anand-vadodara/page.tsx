...
export const metadata: Metadata = {
  title: "AC Repair Anand in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC repair service in Anand in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC Repair Anand Vadodara",
    "ac repair anand",
    "AC Repair Anand installation",
    "AC Repair Anand service",
    "AC Repair Anand repair",
    "best AC Repair Anand service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-repair-anand-vadodara",
  },
};

const keywordData = {
  title: "AC Repair Anand",
  slug: "ac-repair-anand",
  description: "AC repair service in Anand",
  category: "OutCity"
};
...
export default function ACRepairAnandPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Ac Repair Anand Vadodara in Vadodara?", a: "Ac Repair Anand Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Ac Repair Anand Vadodara?", a: "Hitech Aircool Engineers offers same-day Ac Repair Anand Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Ac Repair Anand Vadodaras?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Ac Repair Anand Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Ac Repair Anand Vadodara available on holidays?", a: "Yes, Hitech Aircool Engineers provides Ac Repair Anand Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Ac Repair Anand Vadodara take?", a: "Most Ac Repair Anand Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Ac Repair Anand Vadodara in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Ac Repair Anand Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Ac Repair Anand Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Ac Repair Anand Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Ac Repair Anand Vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Ac Repair Anand Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Ac Repair Anand Vadodara available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Ac Repair Anand Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Ac Repair Anand Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Most Ac Repair Anand Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
