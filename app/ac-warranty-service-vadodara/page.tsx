...
export const metadata: Metadata = {
  title: "AC Warranty Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC warranty claim service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC Warranty Service Vadodara",
    "ac warranty service",
    "AC Warranty Service installation",
    "AC Warranty Service service",
    "AC Warranty Service repair",
    "best AC Warranty Service service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-warranty-service-vadodara",
  },
};

const keywordData = {
  title: "AC Warranty Service",
  slug: "ac-warranty-service",
  description: "AC warranty claim service",
  category: "Core"
};
...
export default function ACWarrantyServicePage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Ac Warranty Service Vadodara include?", a: "Ac Warranty Service Vadodara includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Ac Warranty Service Vadodara cost?", a: "Ac Warranty Service Vadodara starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Ac Warranty Service Vadodara improve cooling?", a: "Yes, proper Ac Warranty Service Vadodara can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Ac Warranty Service Vadodara reduce electricity bills?", a: "Regular Ac Warranty Service Vadodara can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Ac Warranty Service Vadodara take?", a: "Basic Ac Warranty Service Vadodara takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Ac Warranty Service Vadodara remove bad smell?", a: "Yes, Ac Warranty Service Vadodara includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Ac Warranty Service Vadodara?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Ac Warranty Service Vadodara include?", acceptedAnswer: { "@type": "Answer", text: "Ac Warranty Service Vadodara includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Ac Warranty Service Vadodara cost?", acceptedAnswer: { "@type": "Answer", text: "Ac Warranty Service Vadodara starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Ac Warranty Service Vadodara improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Ac Warranty Service Vadodara can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Ac Warranty Service Vadodara reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Ac Warranty Service Vadodara can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Ac Warranty Service Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Basic Ac Warranty Service Vadodara takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Ac Warranty Service Vadodara remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Ac Warranty Service Vadodara includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Ac Warranty Service Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
