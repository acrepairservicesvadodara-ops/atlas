...
export const metadata: Metadata = {
  title: "Blue Star AC Service in Vadodara | Installation, Service & Repair | Atlas Aircon",
  ...
  keywords: [
    ...
    "Blue Star AC service",
    "Blue Star AC repair",
    "best Blue Star AC service",
  ],
  alternates: {
    canonical: "https://atlasaircons.com/blue-star-ac-service-vadodara",
  },
};

const keywordData = {
  title: "Blue Star AC Service",
  slug: "blue-star-ac-service",
