    ...
    <>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              ...
              { q: "What is cost of industrial water chiller?", a: "Industrial water chiller costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "What is cost of industrial water chiller?", acceptedAnswer: { "@type": "Answer", text: "Industrial water chiller costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
