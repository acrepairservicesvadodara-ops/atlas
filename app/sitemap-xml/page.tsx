...
export const metadata: Metadata = {
  title: "Bot Verification | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/sitemap-xml" },
  openGraph: {
    title: "Bot Verification | Atlas Aircon",
    description: "Atlas Aircon - Vadodara's trusted AC repair & HVAC service company. Professional air conditioning solutions across Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/sitemap-xml",
    type: "website",
  ...
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What sitemap xmls does Atlas Aircon provide?", a: "Atlas Aircon provides sitemap xml, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book sitemap xml?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency sitemap xml available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What sitemap xmls does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides sitemap xml, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book sitemap xml?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency sitemap xml available. Call +91 97272 57141 for immediate assistance." } },
