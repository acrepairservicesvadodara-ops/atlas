...
export const metadata: Metadata = {
  title: "Bot Verification | Hitech Aircool Engineers Gujarat",
  description: "Hitech Aircool Engineers - Vadodara's trusted AC repair & HVAC service company. Professional air conditioning solutions across Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/sitemap-xml" },
  openGraph: {
    title: "Bot Verification | Hitech Aircool Engineers",
    description: "Hitech Aircool Engineers - Vadodara's trusted AC repair & HVAC service company. Professional air conditioning solutions across Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/sitemap-xml",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Bot Verification</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Professional HVAC service by Hitech Aircool Engineers. Certified technicians, genuine parts, same-day service across Vadodara and Gujarat.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Professional HVAC and air conditioning service by Hitech Aircool Engineers. Our certified engineers serve Vadodara and all of Gujarat with 20+ years of hands-on experience.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What sitemap xmls does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides sitemap xml, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book sitemap xml?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency sitemap xml available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What sitemap xmls does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides sitemap xml, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book sitemap xml?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency sitemap xml available. Call +91 93289 53665 for immediate assistance." } },
