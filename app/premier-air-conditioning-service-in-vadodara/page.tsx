...
export const metadata: Metadata = {
  title: "Get The Best #1 Air Conditioning Service In Vadodara | Hitech Aircool Engineers Blog",
  ...
  alternates: { canonical: "https://hitechairconditioning.in/premier-air-conditioning-service-in-vadodara" },
  openGraph: {
    title: "Get The Best #1 Air Conditioning Service In Vadodara | Hitech Aircool Engineers",
    description: "Vadodara, known for its warm climate, places a premium on effective air conditioning service solutions. As the temperature rises, residents are turning ...",
    url: "https://hitechairconditioning.in/premier-air-conditioning-service-in-vadodara",
    type: "article",
...
const jsonLd = {
  ...
  mainEntityOfPage: "https://hitechairconditioning.in/premier-air-conditioning-service-in-vadodara",
