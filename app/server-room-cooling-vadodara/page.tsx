...
export const metadata: Metadata = {
  title: "Server Room Cooling in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Server room AC in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Server Room Cooling Vadodara",
    "server room cooling",
    "Server Room Cooling installation",
    "Server Room Cooling service",
    "Server Room Cooling repair",
    "best Server Room Cooling service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/server-room-cooling-vadodara",
  },
};
...
export default function ServerRoomCoolingPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What server room cooling vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides server room cooling vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book server room cooling vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency server room cooling vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What server room cooling vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides server room cooling vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book server room cooling vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency server room cooling vadodara available. Call +91 93289 53665 for immediate assistance." } },
