...
export const metadata: Metadata = {
  title: "Air Handling Unit Services Valsad | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/air-handling-unit-services-valsad" },
  openGraph: {
    title: "Air Handling Unit Services Valsad | Atlas Aircon",
    description: "Expert Air Handling Unit Services in Valsad. Specialized AHU repair, maintenance & installation for GIDC, ports & businesses. Ensure 100% compliance, prevent co",
    url: "https://atlasaircons.com/air-handling-unit-services-valsad",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert Air Handling Unit Services in Valsad. Specialized AHU repair, maintenance &amp; installation for GIDC, ports &amp; businesses. Ensure 100% compliance, prevent costly downtime &amp; save energy. Call Now!</p>
