...
export const metadata: Metadata = {
  title: "Advanced Electrolux AC Repair Maintenance Solution Vadodara [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Comprehensive Electrolux AC Repair and Maintenance Services in Vadodara: Your Ultimate Cooling Solution</s...",
  alternates: { canonical: "https://hitechairconditioning.in/electrolux-ac-repair" },
  openGraph: {
    title: "Advanced Electrolux AC Repair Maintenance Solution Vadodara [2026 Updated] | Hitech Aircool Engineers",
    description: "Comprehensive Electrolux AC Repair and Maintenance Services in Vadodara: Your Ultimate Cooling Solution</s...",
    url: "https://hitechairconditioning.in/electrolux-ac-repair",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Comprehensive Electrolux AC Repair and Maintenance Services in Vadodara: Your Ultimate Cooling Solution&lt;/s...</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Electrolux Ac Repair in Vadodara?", a: "Electrolux Ac Repair cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Electrolux Ac Repair?", a: "Hitech Aircool Engineers offers same-day Electrolux Ac Repair across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Electrolux Ac Repairs?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Electrolux Ac Repairs depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Electrolux Ac Repair available on holidays?", a: "Yes, Hitech Aircool Engineers provides Electrolux Ac Repair 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Electrolux Ac Repair in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Electrolux Ac Repair cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Electrolux Ac Repair?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Electrolux Ac Repair across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Electrolux Ac Repairs?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Electrolux Ac Repairs depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Electrolux Ac Repair available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Electrolux Ac Repair 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
