...
export const metadata: Metadata = {
  title: "AC Repair Dabhoi in Vadodara | Installation, Service & Repair | Atlas Aircon",
  description: "AC repair in Dabhoi in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 97272 57141",
  keywords: [
  ...
  alternates: {
    canonical: "https://atlasaircons.com/ac-repair-dabhoi-vadodara",
  },
};
    ...
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Ac Repair Dabhoi Vadodara in Vadodara?", a: "Ac Repair Dabhoi Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Ac Repair Dabhoi Vadodara?", a: "Atlas Aircon offers same-day Ac Repair Dabhoi Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Ac Repair Dabhoi Vadodaras?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Ac Repair Dabhoi Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Ac Repair Dabhoi Vadodara available on holidays?", a: "Yes, Atlas Aircon provides Ac Repair Dabhoi Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Ac Repair Dabhoi Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Ac Repair Dabhoi Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Ac Repair Dabhoi Vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Ac Repair Dabhoi Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Ac Repair Dabhoi Vadodara available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Ac Repair Dabhoi Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
