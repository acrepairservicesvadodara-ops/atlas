...
export const metadata: Metadata = {
  title: "Factory Chiller Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Factory chiller service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Factory Chiller Repair Vadodara",
    "factory chiller repair",
    "Factory Chiller Repair installation",
    "Factory Chiller Repair service",
    "Factory Chiller Repair repair",
    "best Factory Chiller Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/factory-chiller-repair-vadodara",
  },
};

const keywordData = {
  title: "Factory Chiller Repair",
  slug: "factory-chiller-repair",
  description: "Factory chiller service",
  category: "Commercial"
};
...
export default function FactoryChillerRepairPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVfactory chiller repair vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial factory chiller repair vadodara?", a: "Industrial factory chiller repair vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVfactory chiller repair vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial factory chiller repair vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial factory chiller repair vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
