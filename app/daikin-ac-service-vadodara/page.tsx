...
export const metadata: Metadata = {
  title: "Daikin AC Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Daikin AC repair and service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    ...
    "Daikin AC service",
    "Daikin AC repair",
    "best Daikin AC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/daikin-ac-service-vadodara",
  },
};

const keywordData = {
  title: "Daikin AC Service",
  slug: "daikin-ac-service",
  description: "Daikin AC repair and service",
  category: "Brands"
};
...
export default function DaikinACServicePage() {
  return (
    <>
      {/* Hero Section */}
