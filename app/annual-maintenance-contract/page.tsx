...
export const metadata: Metadata = {
  title: "Annual Maintenance Contract (AMC) | Hitech Aircool Engineers Gujarat",
  description: "Get a comprehensive Annual Maintenance Contract (AMC) for predictable costs & peak performance. Includes scheduled visits, priority support, parts discounts & h",
  alternates: { canonical: "https://hitechairconditioning.in/annual-maintenance-contract" },
  openGraph: {
    title: "Annual Maintenance Contract (AMC) | Hitech Aircool Engineers",
    description: "Get a comprehensive Annual Maintenance Contract (AMC) for predictable costs & peak performance. Includes scheduled visits, priority support, parts discounts & h",
    url: "https://hitechairconditioning.in/annual-maintenance-contract",
    type: "website",
    images: ["/images/products/AC-Repair-AMC-in-Vadodara-Gujarat.webp"],
  },
};
...
export default function Pageannualmaintenancecontract() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Annual Maintenance Contract (AMC)</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Get a comprehensive Annual Maintenance Contract (AMC) for predictable costs &amp; peak performance. Includes scheduled visits, priority support, parts discounts &amp; hassle-free upkeep. Request a Custom Quote!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Get a comprehensive Annual Maintenance Contract (AMC) for predictable costs &amp; peak performance. Includes scheduled visits, priority support, parts discounts &amp; hassle-free upkeep. Request a Custom Quote!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/AC-Repair-AMC-in-Vadodara-Gujarat.webp" alt="Annual Maintenance Contract (AMC)" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Annual Maintenance Contract (AMC)" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Annual Maintenance Contract include?", a: "Annual Maintenance Contract includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Annual Maintenance Contract cost?", a: "Annual Maintenance Contract starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Annual Maintenance Contract improve cooling?", a: "Yes, proper Annual Maintenance Contract can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Annual Maintenance Contract reduce electricity bills?", a: "Regular Annual Maintenance Contract can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Annual Maintenance Contract take?", a: "Basic Annual Maintenance Contract takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Annual Maintenance Contract remove bad smell?", a: "Yes, Annual Maintenance Contract includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Annual Maintenance Contract?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Annual Maintenance Contract include?", acceptedAnswer: { "@type": "Answer", text: "Annual Maintenance Contract includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Annual Maintenance Contract cost?", acceptedAnswer: { "@type": "Answer", text: "Annual Maintenance Contract starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Annual Maintenance Contract improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Annual Maintenance Contract can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Annual Maintenance Contract reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Annual Maintenance Contract can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Annual Maintenance Contract take?", acceptedAnswer: { "@type": "Answer", text: "Basic Annual Maintenance Contract takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Annual Maintenance Contract remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Annual Maintenance Contract includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Annual Maintenance Contract?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
