...
export const metadata: Metadata = {
  title: "Annual Maintenance Contract (AMC) | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/annual-maintenance-contract" },
  openGraph: {
    title: "Annual Maintenance Contract (AMC) | Atlas Aircon",
    description: "Get a comprehensive Annual Maintenance Contract (AMC) for predictable costs & peak performance. Includes scheduled visits, priority support, parts discounts & h",
    url: "https://atlasaircons.com/annual-maintenance-contract",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Get a comprehensive Annual Maintenance Contract (AMC) for predictable costs &amp; peak performance. Includes scheduled visits, priority support, parts discounts &amp; hassle-free upkeep. Request a Custom Quote!</p>
