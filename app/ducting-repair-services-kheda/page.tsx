...
export const metadata: Metadata = {
  title: "Local Ducting Repair Services Kheda District: Fix 6+ Problem [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Trusted ducting repair services across Kheda district - Nadiad, Matar, Mehmedabad & more. We solve home & farm AC duct issues for better airflow. ✅ Free inspect",
  alternates: { canonical: "https://hitechairconditioning.in/ducting-repair-services-kheda" },
  openGraph: {
    title: "Local Ducting Repair Services Kheda District: Fix 6+ Problem [2026 Updated] | Hitech Aircool Engineers",
    description: "Trusted ducting repair services across Kheda district - Nadiad, Matar, Mehmedabad & more. We solve home & farm AC duct issues for better airflow. ✅ Free inspect",
    url: "https://hitechairconditioning.in/ducting-repair-services-kheda",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Local Ducting Repair Services Kheda District: Fix 6+ Problem [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageductingrepairserviceskheda() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Local Ducting Repair Services Kheda District: Fix 6+ Problem [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Trusted ducting repair services across Kheda district - Nadiad, Matar, Mehmedabad &amp; more. We solve home &amp; farm AC duct issues for better airflow. ✅ Free inspection.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Trusted ducting repair services across Kheda district - Nadiad, Matar, Mehmedabad &amp; more. We solve home &amp; farm AC duct issues for better airflow. ✅ Free inspection.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/hitech-logo.webp" alt="Local Ducting Repair Services Kheda District: Fix 6+ Problem [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Local Ducting Repair Services Kheda District: Fix 6+ Problem [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Ducting Repair Services Kheda in Vadodara?", a: "Ducting Repair Services Kheda cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Ducting Repair Services Kheda?", a: "Hitech Aircool Engineers offers same-day Ducting Repair Services Kheda across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Ducting Repair Services Khedas?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Ducting Repair Services Khedas depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Ducting Repair Services Kheda available on holidays?", a: "Yes, Hitech Aircool Engineers provides Ducting Repair Services Kheda 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Ducting Repair Services Kheda take?", a: "Most Ducting Repair Services Khedas are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Ducting Repair Services Kheda in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Ducting Repair Services Kheda cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Ducting Repair Services Kheda?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Ducting Repair Services Kheda across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Ducting Repair Services Khedas?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Ducting Repair Services Khedas depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Ducting Repair Services Kheda available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Ducting Repair Services Kheda 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Ducting Repair Services Kheda take?", acceptedAnswer: { "@type": "Answer", text: "Most Ducting Repair Services Khedas are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
