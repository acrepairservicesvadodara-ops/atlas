...
export const metadata: Metadata = {
  title: "AC Stabilizer Installation in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC stabilizer fitting in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC Stabilizer Installation Vadodara",
    "ac stabilizer installation",
    "AC Stabilizer Installation installation",
    "AC Stabilizer Installation service",
    "AC Stabilizer Installation repair",
    "best AC Stabilizer Installation service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-stabilizer-installation-vadodara",
  },
};

const keywordData = {
  title: "AC Stabilizer Installation",
  slug: "ac-stabilizer-installation",
  description: "AC stabilizer fitting",
  category: "Parts"
};
...
export default function ACStabilizerInstallationPage() {
  return (
    <>
      {/* Hero Section */}
