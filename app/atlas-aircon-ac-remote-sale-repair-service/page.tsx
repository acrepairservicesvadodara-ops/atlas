...
export const metadata: Metadata = {
  title: "HVAC & AC Remote Controllers (1-22 Ton) | Hitech Aircool Engineers Gujarat",
  description: "Professional hvac & ac remote controllers (1-22 ton) by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/atlas-aircon-ac-remote-sale-repair-service" },
  openGraph: {
    title: "HVAC & AC Remote Controllers (1-22 Ton) | Hitech Aircool Engineers",
    description: "Professional hvac & ac remote controllers (1-22 ton) by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/atlas-aircon-ac-remote-sale-repair-service",
    type: "website",
    images: ["/images/products/air-conditioner-remote.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "HVAC & AC Remote Controllers (1-22 Ton)",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageatlasairconacremotesalerepairservice() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">HVAC &amp; AC Remote Controllers (1-22 Ton)</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">&lt;span style=&quot;font-size:...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">&lt;span style=&quot;font-size:...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/air-conditioner-remote.webp" alt="HVAC & AC Remote Controllers (1-22 Ton)" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Ac-remote-Controllers.webp" alt="HVAC & AC Remote Controllers (1-22 Ton)" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/ac-remote.webp" alt="HVAC & AC Remote Controllers (1-22 Ton)" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Ac-remote-Controller.webp" alt="HVAC & AC Remote Controllers (1-22 Ton)" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Hitech Aircool Engineers Ac Remote Sale Repair Service in Vadodara?", a: "Hitech Aircool Engineers Ac Remote Sale Repair Service cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Hitech Aircool Engineers Ac Remote Sale Repair Service?", a: "Hitech Aircool Engineers offers same-day Hitech Aircool Engineers Ac Remote Sale Repair Service across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Hitech Aircool Engineers Ac Remote Sale Repair Services?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Hitech Aircool Engineers Ac Remote Sale Repair Services depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Hitech Aircool Engineers Ac Remote Sale Repair Service available on holidays?", a: "Yes, Hitech Aircool Engineers provides Hitech Aircool Engineers Ac Remote Sale Repair Service 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Hitech Aircool Engineers Ac Remote Sale Repair Service take?", a: "Most Hitech Aircool Engineers Ac Remote Sale Repair Services are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Hitech Aircool Engineers Ac Remote Sale Repair Service in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers Ac Remote Sale Repair Service cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Hitech Aircool Engineers Ac Remote Sale Repair Service?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Hitech Aircool Engineers Ac Remote Sale Repair Service across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Hitech Aircool Engineers Ac Remote Sale Repair Services?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Hitech Aircool Engineers Ac Remote Sale Repair Services depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Hitech Aircool Engineers Ac Remote Sale Repair Service available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Hitech Aircool Engineers Ac Remote Sale Repair Service 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Hitech Aircool Engineers Ac Remote Sale Repair Service take?", acceptedAnswer: { "@type": "Answer", text: "Most Hitech Aircool Engineers Ac Remote Sale Repair Services are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
