...
export const metadata: Metadata = {
  title: "Trusted 24/7 Refrigerator Repair Services In Ahmedabad | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/refrigerator-repair-services-ahmedabad" },
  openGraph: {
    title: "Trusted 24/7 Refrigerator Repair Services In Ahmedabad | Atlas Aircon",
    description: "Your fridge stopped in Ahmedabad? Get same-day, expert repair for all brands at home. Free diagnosis, genuine parts & warranty. Call now for reliable 24/7 servi",
    url: "https://atlasaircons.com/refrigerator-repair-services-ahmedabad",
    type: "website",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Your fridge stopped in Ahmedabad? Get same-day, expert repair for all brands at home. Free diagnosis, genuine parts &amp; warranty. Call now for reliable 24/7 service!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Refrigerator Repair Services Ahmedabad in Vadodara?", a: "Refrigerator Repair Services Ahmedabad cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Refrigerator Repair Services Ahmedabad?", a: "Atlas Aircon offers same-day Refrigerator Repair Services Ahmedabad across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Refrigerator Repair Services Ahmedabads?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Refrigerator Repair Services Ahmedabads depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Refrigerator Repair Services Ahmedabad available on holidays?", a: "Yes, Atlas Aircon provides Refrigerator Repair Services Ahmedabad 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Refrigerator Repair Services Ahmedabad?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Refrigerator Repair Services Ahmedabad across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Refrigerator Repair Services Ahmedabads?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Refrigerator Repair Services Ahmedabads depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Refrigerator Repair Services Ahmedabad available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Refrigerator Repair Services Ahmedabad 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
