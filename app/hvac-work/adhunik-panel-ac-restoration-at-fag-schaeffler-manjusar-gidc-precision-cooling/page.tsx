...
export const metadata: Metadata = {
  title: "Adhunik Panel AC Restoration At FAG Schaeffler | Hitech Aircool Engineers Blog",
  description: "Adhunik Panel AC Restoration At FAG Schaeffler - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/hvac-work/adhunik-panel-ac-restoration-at-fag-schaeffler-manjusar-gidc-precision-cooling" },
  openGraph: {
    title: "Adhunik Panel AC Restoration At FAG Schaeffler | Hitech Aircool Engineers",
    description: "Adhunik Panel AC Restoration At FAG Schaeffler - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/hvac-work/adhunik-panel-ac-restoration-at-fag-schaeffler-manjusar-gidc-precision-cooling",
    type: "article",
    images: ["/images/products/IMG_20251213_143444.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Article",
  headline: "Adhunik Panel AC Restoration At FAG Schaeffler",
  ...
  mainEntityOfPage: "https://hitechairconditioning.in/hvac-work/adhunik-panel-ac-restoration-at-fag-schaeffler-manjusar-gidc-precision-cooling",
  image: "/images/products/IMG_20251213_143444.webp",
};

export default function Pagehvacworkadhunikpanelacrestorationatfagsc() {
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-gray-900 via-gray-800 to-teal-900 text-white py-12 md:py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">Adhunik Panel AC Restoration At FAG Schaeffler</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <img src="/images/products/IMG_20251213_143444.webp" alt="Adhunik Panel AC Restoration At FAG Schaeffler" className="w-full h-auto rounded-xl mb-8" />
