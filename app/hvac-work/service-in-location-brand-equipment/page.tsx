...
export const metadata: Metadata = {
  title: "[Service] In [Location] | Hitech Aircool Engineers Blog",
  description: "Professional [service] in [location] by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/hvac-work/service-in-location-brand-equipment" },
  openGraph: {
    title: "[Service] In [Location] | Hitech Aircool Engineers",
    description: "Professional [service] in [location] by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/hvac-work/service-in-location-brand-equipment",
    type: "article",
...
const jsonLd = {
  ...
  mainEntityOfPage: "https://hitechairconditioning.in/hvac-work/service-in-location-brand-equipment",
