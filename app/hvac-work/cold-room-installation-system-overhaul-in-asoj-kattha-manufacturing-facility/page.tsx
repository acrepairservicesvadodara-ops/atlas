...
export const metadata: Metadata = {
  title: "Cold Room Installation & System Overhaul In Asoj | Hitech Aircool Engineers Blog",
  description: "Professional cold room installation & system overhaul in asoj by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/hvac-work/cold-room-installation-system-overhaul-in-asoj-kattha-manufacturing-facility" },
  openGraph: {
    title: "Cold Room Installation & System Overhaul In Asoj | Hitech Aircool Engineers",
    description: "Professional cold room installation & system overhaul in asoj by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/hvac-work/cold-room-installation-system-overhaul-in-asoj-kattha-manufacturing-facility",
    type: "article",
    images: ["/images/products/IMG_20251103_204357.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Article",
  headline: "Cold Room Installation & System Overhaul In Asoj",
  ...
  mainEntityOfPage: "https://hitechairconditioning.in/hvac-work/cold-room-installation-system-overhaul-in-asoj-kattha-manufacturing-facility",
  image: "/images/products/IMG_20251103_204357.webp",
};

export default function Pagehvacworkcoldroominstallationsystemoverha() {
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-gray-900 via-gray-800 to-teal-900 text-white py-12 md:py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">Cold Room Installation &amp; System Overhaul In Asoj</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <img src="/images/products/IMG_20251103_204357.webp" alt="Cold Room Installation & System Overhaul In Asoj" className="w-full h-auto rounded-xl mb-8" />
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVcold room installation system overhaul in asoj kattha manufacturing facilitys?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial cold room installation system overhaul in asoj kattha manufacturing facility?", a: "Industrial cold room installation system overhaul in asoj kattha manufacturing facility costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVcold room installation system overhaul in asoj kattha manufacturing facilitys?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial cold room installation system overhaul in asoj kattha manufacturing facility?", acceptedAnswer: { "@type": "Answer", text: "Industrial cold room installation system overhaul in asoj kattha manufacturing facility costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
