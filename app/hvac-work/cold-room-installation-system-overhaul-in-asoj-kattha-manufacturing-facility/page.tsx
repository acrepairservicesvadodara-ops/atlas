...
export const metadata: Metadata = {
  title: "Cold Room Installation & System Overhaul In Asoj | Atlas Aircon Blog",
  description: "Professional cold room installation & system overhaul in asoj by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/hvac-work/cold-room-installation-system-overhaul-in-asoj-kattha-manufacturing-facility" },
  openGraph: {
    title: "Cold Room Installation & System Overhaul In Asoj | Atlas Aircon",
    description: "Professional cold room installation & system overhaul in asoj by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/hvac-work/cold-room-installation-system-overhaul-in-asoj-kattha-manufacturing-facility",
    type: "article",
...
const jsonLd = {
  ...
  mainEntityOfPage: "https://atlasaircons.com/hvac-work/cold-room-installation-system-overhaul-in-asoj-kattha-manufacturing-facility",
  ...
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVcold room installation system overhaul in asoj kattha manufacturing facilitys?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVcold room installation system overhaul in asoj kattha manufacturing facilitys?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
