...
export const metadata: Metadata = {
  title: "Lg – Da 130 / Da 150 – 1.5 Ton (Variable) | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "LG's variable-speed rotary compressor models for 1.5-ton inverter ACs. LG is known for its advanced compressor technology. These models provide wide mod...",
  keywords: ["lg – da 130 / da 150 – 1.5 ton (variable) | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "lg"],
  alternates: { canonical: "https://atlasaircons.com/lg-da-130-da-150-1-5-ton-variable-hitech-aircool-engineers" },
  openGraph: {
    title: "Lg – Da 130 / Da 150 – 1.5 Ton (Variable) | Hitech Aircool Engineers",
    description: "LG's variable-speed rotary compressor models for 1.5-ton inverter ACs. LG is known for its advanced compressor technology. These models provide wide mod...",
    url: "https://atlasaircons.com/lg-da-130-da-150-1-5-ton-variable-hitech-aircool-engineers",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Lg – Da 130 / Da 150 – 1.5 Ton (Variable) | Hitech Aircool Engineers",
  description: "LG’s variable-speed rotary compressor models for 1.5-ton inverter ACs. LG is known for its advanced compressor technology. These models provide wide modulation range, allowing the AC to run at very low capacities for dehumidification and steady temperature maintenance.",
...
export default function Pagelgda130da15015tonvariablehitechaircoolen() {
  return (
    <>
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  ...
                  alt="Lg – Da 130 / Da 150 – 1.5 Ton (Variable) | Hitech Aircool Engineers"
                ...
                <img
                  ...
                  alt="Lg – Da 130 / Da 150 – 1.5 Ton (Variable) | Hitech Aircool Engineers - Image 2"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Lg – Da 130 / Da 150 – 1.5 Ton (Variable) | Hitech Aircool Engineers - Image 3"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Lg – Da 130 / Da 150 – 1.5 Ton (Variable) | Hitech Aircool Engineers - Image 4"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="bg-blue-500/20 text-blue-300 px-3 py-1 rounded-full text-xs font-semibold">LG</span>
              </div>
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Lg – Da 130 / Da 150 – 1.5 Ton (Variable) | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">LG’s variable-speed rotary compressor models for 1.5-ton inverter ACs. LG is known for its advanced compressor technology. These models provide wide m</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%20Lg%20%E2%80%93%20Da%20130%20%2F%20Da%20150%20%E2%80%93%201.5%20Ton%20(Variable)%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Energy-saving applications</span>
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Lg - Da 130 / Da 150 - 1.5 Ton (Variable)</span>
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Residential/Commercial</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>LG’s variable-speed rotary compressor models for 1.5-ton inverter ACs. LG is known for its advanced compressor technology. These models provide wide modulation range, allowing the AC to run at very low capacities for dehumidification and steady temperature maintenance.</p>
            </div>
            ...
            <div className="mt-8 bg-gray-50 rounded-xl p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                ...
                <div className="flex justify-between py-2 border-b border-gray-200"><span className="text-gray-500">Category</span><span className="font-medium">LG</span></div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[{"url":"https://www.atlasaircons.com/air-curtains-hitech-aircool-engineers/","title":"Air Curtains | Hitech Aircool Engineers","price":""},{"url":"https://www.atlasaircons.com/heated-air-curtains-hitech-aircool-engineers/","title":"Heated Air Curtains | Hitech Aircool Engineers","price":""}].map((p: { url: string; title: string; price: string }) => (
