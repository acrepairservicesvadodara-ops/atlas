...
export const metadata: Metadata = {
  title: "AC Installation Get Your Ac Installed Ease Free Guidance 1996 [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "AC Installation Get Y...",
  alternates: { canonical: "https://hitechairconditioning.in/ac-installation-in-vadodara-get-your-air-conditioner-installed-with-ease" },
  openGraph: {
    title: "AC Installation Get Your Ac Installed Ease Free Guidance 1996 [2026 Updated] | Hitech Aircool Engineers",
    description: "AC Installation Get Y...",
    url: "https://hitechairconditioning.in/ac-installation-in-vadodara-get-your-air-conditioner-installed-with-ease",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">AC Installation Get Y...</p>
