...
export const metadata: Metadata = {
  title: "Deep Freezer Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Deep freezer repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Deep Freezer Service Vadodara",
    "deep freezer service",
    "Deep Freezer Service installation",
    "Deep Freezer Service service",
    "Deep Freezer Service repair",
    "best Deep Freezer Service service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/deep-freezer-service-vadodara",
  },
};

const keywordData = {
  title: "Deep Freezer Service",
  slug: "deep-freezer-service",
  description: "Deep freezer repair",
...
export default function DeepFreezerServicePage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVdeep freezer service vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial deep freezer service vadodara?", a: "Industrial deep freezer service vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVdeep freezer service vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial deep freezer service vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial deep freezer service vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
