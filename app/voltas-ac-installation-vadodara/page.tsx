...
export const metadata: Metadata = {
  title: "Voltas AC Installation in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Voltas AC installation in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Voltas AC Installation Vadodara",
    "voltas ac installation",
    "Voltas AC Installation installation",
    "Voltas AC Installation service",
    "Voltas AC Installation repair",
    "best Voltas AC Installation service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/voltas-ac-installation-vadodara",
  },
};

const keywordData = {
  title: "Voltas AC Installation",
  slug: "voltas-ac-installation",
  description: "Voltas AC installation",
  category: "Brands"
};
...
export default function VoltasACInstallationPage() {
  return (
    <>
      {/* Hero Section */}
