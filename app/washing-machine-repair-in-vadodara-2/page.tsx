...
export const metadata: Metadata = {
  title: "#1 Washing Machine Repair In Vadodara | Atlas Aircon Gujarat",
  description: "Professional #1 washing machine repair in vadodara by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/washing-machine-repair-in-vadodara-2" },
  openGraph: {
    title: "#1 Washing Machine Repair In Vadodara | Atlas Aircon",
    description: "Professional #1 washing machine repair in vadodara by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/washing-machine-repair-in-vadodara-2",
    type: "website",
    ...
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Washing Machine Repair In Vadodara 2 in Vadodara?", a: "Washing Machine Repair In Vadodara 2 cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Washing Machine Repair In Vadodara 2?", a: "Atlas Aircon offers same-day Washing Machine Repair In Vadodara 2 across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Washing Machine Repair In Vadodara 2s?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Washing Machine Repair In Vadodara 2s depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Washing Machine Repair In Vadodara 2 available on holidays?", a: "Yes, Atlas Aircon provides Washing Machine Repair In Vadodara 2 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "Is emergency Washing Machine Repair In Vadodara 2 available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Washing Machine Repair In Vadodara 2 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
