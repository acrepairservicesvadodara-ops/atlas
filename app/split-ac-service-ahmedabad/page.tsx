...
export const metadata: Metadata = {
  title: "Fix Now! Expert Split AC Repair & Full Service Across Ahmedabad [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Need urgent split AC service in Ahmedabad? Our certified technicians provide same-day repair, installation & gas refilling. 100% genuine spare parts & 90-day se",
  alternates: { canonical: "https://hitechairconditioning.in/split-ac-service-ahmedabad" },
  openGraph: {
    title: "Fix Now! Expert Split AC Repair & Full Service Across Ahmedabad [2026 Updated] | Hitech Aircool Engineers",
    description: "Need urgent split AC service in Ahmedabad? Our certified technicians provide same-day repair, installation & gas refilling. 100% genuine spare parts & 90-day se",
    url: "https://hitechairconditioning.in/split-ac-service-ahmedabad",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Fix Now! Expert Split AC Repair & Full Service Across Ahmedabad [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagesplitacserviceahmedabad() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Fix Now! Expert Split AC Repair &amp; Full Service Across Ahmedabad [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Need urgent split AC service in Ahmedabad? Our certified technicians provide same-day repair, installation &amp; gas refilling. 100% genuine spare parts &amp; 90-day service warranty. Book now!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Need urgent split AC service in Ahmedabad? Our certified technicians provide same-day repair, installation &amp; gas refilling. 100% genuine spare parts &amp; 90-day service warranty. Book now!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/hitech-logo.webp" alt="Fix Now! Expert Split AC Repair & Full Service Across Ahmedabad [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Fix Now! Expert Split AC Repair & Full Service Across Ahmedabad [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
