...
export const metadata: Metadata = {
  title: "Fix Now! Expert Split AC Repair & Full Service Across Ahmedabad [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/split-ac-service-ahmedabad" },
  openGraph: {
    title: "Fix Now! Expert Split AC Repair & Full Service Across Ahmedabad [2026 Updated] | Atlas Aircon",
    description: "Need urgent split AC service in Ahmedabad? Our certified technicians provide same-day repair, installation & gas refilling. 100% genuine spare parts & 90-day se",
    url: "https://atlasaircons.com/split-ac-service-ahmedabad",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Need urgent split AC service in Ahmedabad? Our certified technicians provide same-day repair, installation &amp; gas refilling. 100% genuine spare parts &amp; 90-day service warranty. Book now!</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/cropped-AtlasAircon-Logo.webp" alt="Fix Now! Expert Split AC Repair & Full Service Across Ahmedabad [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
