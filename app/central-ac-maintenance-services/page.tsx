...
export const metadata: Metadata = {
  title: "Central AC Maintenance Services » Call Us For Free Estimate [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "body { font-family: 'Inter...",
  alternates: { canonical: "https://hitechairconditioning.in/central-ac-maintenance-services" },
  openGraph: {
    title: "Central AC Maintenance Services » Call Us For Free Estimate [2026 Updated] | Hitech Aircool Engineers",
    description: "body { font-family: 'Inter...",
    url: "https://hitechairconditioning.in/central-ac-maintenance-services",
    type: "website",
