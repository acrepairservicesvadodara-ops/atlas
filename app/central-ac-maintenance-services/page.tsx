...
export const metadata: Metadata = {
  title: "Central AC Maintenance Services » Call Us For Free Estimate [2026 Updated] | Atlas Aircon Gujarat",
  description: "body { font-family: 'Inter...",
  alternates: { canonical: "https://atlasaircons.com/central-ac-maintenance-services" },
  openGraph: {
    title: "Central AC Maintenance Services » Call Us For Free Estimate [2026 Updated] | Atlas Aircon",
    description: "body { font-family: 'Inter...",
    url: "https://atlasaircons.com/central-ac-maintenance-services",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Central AC Maintenance Services » Call Us For Free Estimate [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
...
export default function Pagecentralacmaintenanceservices() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Central AC Maintenance Services » Call Us For Free Estimate [2026 Updated]</h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">body &#123; font-family: &apos;Inter...</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Central-Air-Conditioning-Repair-Services.webp" alt="Central AC Maintenance Services » Call Us For Free Estimate [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Central AC Maintenance Services » Call Us For Free Estimate [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Central AC Maintenance Services » Call Us For Free Estimate [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Atlas-Aircon-Ac-Service-in-vadodara-2.webp" alt="Central AC Maintenance Services » Call Us For Free Estimate [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Atlas-Aircon-Ac-Service-in-vadodara-2.webp" alt="Central AC Maintenance Services » Call Us For Free Estimate [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Atlas-Aircon-Ac-Service-in-vadodara-2.webp" alt="Central AC Maintenance Services » Call Us For Free Estimate [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
