...
export const metadata: Metadata = {
  title: "AC Service Center Ahmedabad | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-center-ahmedabad" },
  openGraph: {
    title: "AC Service Center Ahmedabad | Atlas Aircon",
    description: "Looking for AC service center in Ahmedabad? We provide expert repair, maintenance & AMC plans at our center. Walk-in service available. Free diagnosis for all A",
    url: "https://atlasaircons.com/ac-service-center-ahmedabad",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Looking for AC service center in Ahmedabad? We provide expert repair, maintenance &amp; AMC plans at our center. Walk-in service available. Free diagnosis for all AC brands.</p>
