...
export const metadata: Metadata = {
  title: "Cold Room Repair Services Vadodara [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/cold-room-repair-services-vadodara" },
  openGraph: {
    title: "Cold Room Repair Services Vadodara [2026 Updated] | Atlas Aircon",
    description: "Your trusted local experts for cold room repair services Vadodara. We offer same-day emergency repair, preventive maintenance, and commercial refrigeration solu",
    url: "https://atlasaircons.com/cold-room-repair-services-vadodara",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Your trusted local experts for cold room repair services Vadodara. We offer same-day emergency repair, preventive maintenance, and commercial refrigeration solutions at the best prices.</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVcold room repair services vadodaras?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVcold room repair services vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
