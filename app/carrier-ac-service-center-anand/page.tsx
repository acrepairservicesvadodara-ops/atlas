...
export const metadata: Metadata = {
  title: "Carrier AC Service Center Anand | Out-of-Warranty Repair Expert | Atlas Aircon",
  description: "Independent Carrier AC service center in Anand. Expert out-of-warranty split AC repair, gas charging, PCB repair, deep cleaning & compressor overhaul. Same-day service. Call +91 97272 57141.",
  keywords: [
  ...
  alternates: { canonical: "https://atlasaircons.com/carrier-ac-service-center-anand" },
  openGraph: {
    title: "Carrier AC Service Center Anand | Atlas Aircon",
    description: "Independent out-of-warranty Carrier AC repair specialist in Anand. Same-day service, 90-day guarantee.",
    url: "https://atlasaircons.com/carrier-ac-service-center-anand",
    type: "website",
  },
};
...
const faqJsonLd = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "Is Atlas Aircon an authorized Carrier service center in Anand?", acceptedAnswer: { "@type": "Answer", text: "No. Atlas Aircon is an independent service provider specializing in high-quality out-of-warranty repairs. If your Carrier AC is under official warranty, contact Carrier directly." } },
