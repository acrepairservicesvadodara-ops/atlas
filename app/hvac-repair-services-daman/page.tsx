...
export const metadata: Metadata = {
  title: "Top 10 HVAC Repair Services Daman | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/hvac-repair-services-daman" },
  openGraph: {
    title: "Top 10 HVAC Repair Services Daman | Atlas Aircon",
    description: "Get professional HVAC repair services Daman with 24/7 emergency support. Trusted local technicians offer affordable AC, heating & ventilation solutions. Call no",
    url: "https://atlasaircons.com/hvac-repair-services-daman",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Get professional HVAC repair services Daman with 24/7 emergency support. Trusted local technicians offer affordable AC, heating &amp; ventilation solutions. Call now!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVhvac repair services damans?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVhvac repair services damans?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
