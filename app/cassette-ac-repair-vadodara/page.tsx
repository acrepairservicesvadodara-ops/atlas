...
export const metadata: Metadata = {
  title: "Cassette AC Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Cassette AC repair service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Cassette AC Repair Vadodara",
    "cassette ac repair",
    "Cassette AC Repair installation",
    "Cassette AC Repair service",
    "Cassette AC Repair repair",
    "best Cassette AC Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/cassette-ac-repair-vadodara",
  },
};
...
const keywordData = {
  ...
  description: "Cassette AC repair service",
  category: "ACTypes"
};
...
export default function CassetteACRepairPage() {
  return (
    <>
      {/* Hero Section */}
