...
export const metadata: Metadata = {
  title: "Daikin Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Daikin AC service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Daikin Service Vadodara",
    "daikin service",
    "Daikin Service installation",
    "Daikin Service service",
    "Daikin Service repair",
    "best Daikin Service service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/daikin-service-vadodara",
  },
};

const keywordData = {
  title: "Daikin Service",
  slug: "daikin-service",
  description: "Daikin AC service",
  category: "Brands"
};
...
export default function DaikinServicePage() {
  return (
    <>
      {/* Hero Section */}
