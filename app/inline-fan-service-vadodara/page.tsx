...
export const metadata: Metadata = {
  title: "Inline Fan Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Inline fan repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Inline Fan Service Vadodara",
    "inline fan service",
    "Inline Fan Service installation",
    "Inline Fan Service service",
    "Inline Fan Service repair",
    "best Inline Fan Service service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/inline-fan-service-vadodara",
  },
};

const keywordData = {
  title: "Inline Fan Service",
  slug: "inline-fan-service",
  description: "Inline fan repair",
  category: "Parts"
};
...
export default function InlineFanServicePage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Inline Fan Service Vadodara include?", a: "Inline Fan Service Vadodara includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Inline Fan Service Vadodara cost?", a: "Inline Fan Service Vadodara starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Inline Fan Service Vadodara improve cooling?", a: "Yes, proper Inline Fan Service Vadodara can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Inline Fan Service Vadodara reduce electricity bills?", a: "Regular Inline Fan Service Vadodara can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Inline Fan Service Vadodara take?", a: "Basic Inline Fan Service Vadodara takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Inline Fan Service Vadodara remove bad smell?", a: "Yes, Inline Fan Service Vadodara includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Inline Fan Service Vadodara?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Inline Fan Service Vadodara include?", acceptedAnswer: { "@type": "Answer", text: "Inline Fan Service Vadodara includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Inline Fan Service Vadodara cost?", acceptedAnswer: { "@type": "Answer", text: "Inline Fan Service Vadodara starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Inline Fan Service Vadodara improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Inline Fan Service Vadodara can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Inline Fan Service Vadodara reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Inline Fan Service Vadodara can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Inline Fan Service Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Basic Inline Fan Service Vadodara takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Inline Fan Service Vadodara remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Inline Fan Service Vadodara includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Inline Fan Service Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
