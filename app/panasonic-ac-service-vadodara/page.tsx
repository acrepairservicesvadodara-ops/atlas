...
export const metadata: Metadata = {
  title: "Panasonic AC Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Panasonic AC repair and service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    ...
    "Panasonic AC service",
    "Panasonic AC repair",
    "best Panasonic AC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/panasonic-ac-service-vadodara",
  },
};

const keywordData = {
  title: "Panasonic AC Service",
  slug: "panasonic-ac-service",
  description: "Panasonic AC repair and service",
  category: "Brands"
};
...
export default function PanasonicACServicePage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-teal-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Need {keywordData.title} in Vadodara?
          </h2>
