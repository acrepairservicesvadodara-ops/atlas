...
export const metadata: Metadata = {
  title: "Industrial & Commercial Ducting Repair Services Gujarat: 50+ [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Leading provider across ducting repair services Gujarat. We offer industrial, commercial & residential solutions in Ahmedabad, Vadodara, Surat, Rajkot & more. G",
  alternates: { canonical: "https://hitechairconditioning.in/ducting-repair-services-gujarat" },
  openGraph: {
    title: "Industrial & Commercial Ducting Repair Services Gujarat: 50+ [2026 Updated] | Hitech Aircool Engineers",
    description: "Leading provider across ducting repair services Gujarat. We offer industrial, commercial & residential solutions in Ahmedabad, Vadodara, Surat, Rajkot & more. G",
    url: "https://hitechairconditioning.in/ducting-repair-services-gujarat",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Industrial & Commercial Ducting Repair Services Gujarat: 50+ [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageductingrepairservicesgujarat() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Industrial &amp; Commercial Ducting Repair Services Gujarat: 50+ [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Leading provider across ducting repair services Gujarat. We offer industrial, commercial &amp; residential solutions in Ahmedabad, Vadodara, Surat, Rajkot &amp; more. Get a state-wide quote.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Leading provider across ducting repair services Gujarat. We offer industrial, commercial &amp; residential solutions in Ahmedabad, Vadodara, Surat, Rajkot &amp; more. Get a state-wide quote.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/hitech-logo.webp" alt="Industrial & Commercial Ducting Repair Services Gujarat: 50+ [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Industrial & Commercial Ducting Repair Services Gujarat: 50+ [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Ducting Repair Services Gujarat in Vadodara?", a: "Ducting Repair Services Gujarat cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Ducting Repair Services Gujarat?", a: "Hitech Aircool Engineers offers same-day Ducting Repair Services Gujarat across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Ducting Repair Services Gujarats?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Ducting Repair Services Gujarats depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Ducting Repair Services Gujarat available on holidays?", a: "Yes, Hitech Aircool Engineers provides Ducting Repair Services Gujarat 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Ducting Repair Services Gujarat take?", a: "Most Ducting Repair Services Gujarats are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Ducting Repair Services Gujarat in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Ducting Repair Services Gujarat cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Ducting Repair Services Gujarat?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Ducting Repair Services Gujarat across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Ducting Repair Services Gujarats?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Ducting Repair Services Gujarats depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Ducting Repair Services Gujarat available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Ducting Repair Services Gujarat 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Ducting Repair Services Gujarat take?", acceptedAnswer: { "@type": "Answer", text: "Most Ducting Repair Services Gujarats are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
