...
export const metadata: Metadata = {
  title: "Chill With Confidence: Premier Refrigerator Gas Refilling @1 [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Professional chill with confidence: premier refrigerator gas refilling @1 [2026 updated] by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/gas-refilling-services" },
  openGraph: {
    title: "Chill With Confidence: Premier Refrigerator Gas Refilling @1 [2026 Updated] | Hitech Aircool Engineers",
    description: "Professional chill with confidence: premier refrigerator gas refilling @1 [2026 updated] by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/gas-refilling-services",
    type: "website",
    images: ["/images/products/Best-Refrigerator-Repair-Service-Vadodara.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Chill With Confidence: Premier Refrigerator Gas Refilling @1 [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagegasrefillingservices() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Chill With Confidence: Premier Refrigerator Gas Refilling @1 [2026 Updated]</h1>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Best-Refrigerator-Repair-Service-Vadodara.webp" alt="Chill With Confidence: Premier Refrigerator Gas Refilling @1 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Chill With Confidence: Premier Refrigerator Gas Refilling @1 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Chill With Confidence: Premier Refrigerator Gas Refilling @1 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Gas Refilling Services include?", a: "Gas Refilling Services includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Gas Refilling Services cost?", a: "Gas Refilling Services starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Gas Refilling Services improve cooling?", a: "Yes, proper Gas Refilling Services can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Gas Refilling Services reduce electricity bills?", a: "Regular Gas Refilling Services can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Gas Refilling Services take?", a: "Basic Gas Refilling Services takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Gas Refilling Services remove bad smell?", a: "Yes, Gas Refilling Services includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Gas Refilling Services?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Gas Refilling Services include?", acceptedAnswer: { "@type": "Answer", text: "Gas Refilling Services includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Gas Refilling Services cost?", acceptedAnswer: { "@type": "Answer", text: "Gas Refilling Services starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Gas Refilling Services improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Gas Refilling Services can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Gas Refilling Services reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Gas Refilling Services can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Gas Refilling Services take?", acceptedAnswer: { "@type": "Answer", text: "Basic Gas Refilling Services takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Gas Refilling Services remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Gas Refilling Services includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Gas Refilling Services?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
