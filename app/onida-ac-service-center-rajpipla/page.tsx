...
export const metadata: Metadata = {
  title: "Onida AC Service Center Rajpipla | Professional HVAC Service | Atlas Aircon",
  description: "Onida AC Service Center Rajpipla — Professional service service by Atlas Aircon. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 97272 57141.",
  keywords: ["onida ac service center rajpipla", "service service", "hvac service vadodara", "atlas aircon", "ac service gujarat"],
  alternates: { canonical: "https://atlasaircons.com/onida-ac-service-center-rajpipla" },
  openGraph: { title: "Onida AC Service Center Rajpipla | Atlas Aircon", description: "Professional service service by Atlas Aircon Gujarat.", url: "https://atlasaircons.com/onida-ac-service-center-rajpipla", type: "website" },
};
