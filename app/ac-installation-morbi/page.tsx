...
export const metadata: Metadata = {
  title: "AC Installation Morbi | Hitech Aircool Engineers Gujarat",
  description: "Expert AC installation service in Morbi. Professional split & window AC fitting for homes & ceramic showrooms. Free site survey & best price. Call for service!",
  alternates: { canonical: "https://hitechairconditioning.in/ac-installation-morbi" },
  openGraph: {
    title: "AC Installation Morbi | Hitech Aircool Engineers",
    description: "Expert AC installation service in Morbi. Professional split & window AC fitting for homes & ceramic showrooms. Free site survey & best price. Call for service!",
    url: "https://hitechairconditioning.in/ac-installation-morbi",
    type: "website",
...
export default function Pageacinstallationmorbi() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">AC Installation Morbi</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Expert AC installation service in Morbi. Professional split &amp; window AC fitting for homes &amp; ceramic showrooms. Free site survey &amp; best price. Call for service!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Expert AC installation service in Morbi. Professional split &amp; window AC fitting for homes &amp; ceramic showrooms. Free site survey &amp; best price. Call for service!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/emergency-ac-repairing.webp" alt="AC Installation Morbi" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="AC Installation Morbi" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
