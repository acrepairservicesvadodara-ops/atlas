...
export const metadata: Metadata = {
  title: "AC Installation Morbi | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-installation-morbi" },
  openGraph: {
    title: "AC Installation Morbi | Atlas Aircon",
    description: "Expert AC installation service in Morbi. Professional split & window AC fitting for homes & ceramic showrooms. Free site survey & best price. Call for service!",
    url: "https://atlasaircons.com/ac-installation-morbi",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert AC installation service in Morbi. Professional split &amp; window AC fitting for homes &amp; ceramic showrooms. Free site survey &amp; best price. Call for service!</p>
