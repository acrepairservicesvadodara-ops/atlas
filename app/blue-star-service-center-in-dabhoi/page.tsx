...
export const metadata: Metadata = {
  title: "Blue Star Service Center In Dabhoi &raquo; Feel Free To Call Us #1 [2026 Updated] | Hitech Aircool Engineers Gujarat",
  ...
  alternates: { canonical: "https://hitechairconditioning.in/blue-star-service-center-in-dabhoi" },
  openGraph: {
    title: "Blue Star Service Center In Dabhoi &raquo; Feel Free To Call Us #1 [2026 Updated] | Hitech Aircool Engineers",
    description: "Blue Star Service Center In Dabhoi, Welcome to the Blue Star Service Center in Dabhoi, your trusted destination for all your cooling appliance needs. Our certif",
    url: "https://hitechairconditioning.in/blue-star-service-center-in-dabhoi",
    type: "website",
