...
export const metadata: Metadata = {
  title: "Blue Star Service Center In Dabhoi &raquo; Feel Free To Call Us #1 [2026 Updated] | Atlas Aircon Gujarat",
  description: "Blue Star Service Center In Dabhoi, Welcome to the Blue Star Service Center in Dabhoi, your trusted destination for all your cooling appliance needs. Our certif",
  alternates: { canonical: "https://atlasaircons.com/blue-star-service-center-in-dabhoi" },
  openGraph: {
    title: "Blue Star Service Center In Dabhoi &raquo; Feel Free To Call Us #1 [2026 Updated] | Atlas Aircon",
    description: "Blue Star Service Center In Dabhoi, Welcome to the Blue Star Service Center in Dabhoi, your trusted destination for all your cooling appliance needs. Our certif",
    url: "https://atlasaircons.com/blue-star-service-center-in-dabhoi",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Blue Star Service Center In Dabhoi &raquo; Feel Free To Call Us #1 [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
...
export default function Pagebluestarservicecenterindabhoi() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Blue Star Service Center In Dabhoi &amp;raquo; Feel Free To Call Us #1 [2026 Updated]</h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Blue Star Service Center In Dabhoi, Welcome to the Blue Star Service Center in Dabhoi, your trusted destination for all your cooling appliance needs. Our certified technicians are dedicated to providing professional HVAC services and ensuring that your Blue Star appliances run efficiently. Whether y</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Blue Star Service Center In Dabhoi, Welcome to the Blue Star Service Center in Dabhoi, your trusted destination for all your cooling appliance needs. Our certified technicians are dedicated to providing professional HVAC services and ensuring that your Blue Star appliances run efficiently. Whether you&apos;re in need of repairs, routine maintenance, or emergency services, we&apos;ve got you covered.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Most-Secure-Cloud-Solution-for-Companies-to-Store-Computer-Files.webp" alt="Blue Star Service Center In Dabhoi &raquo; Feel Free To Call Us #1 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Blue Star Service Center In Dabhoi &raquo; Feel Free To Call Us #1 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
