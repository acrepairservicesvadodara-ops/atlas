...
export const metadata: Metadata = {
  title: "Trusted 24/7 Refrigerator Repair Services In Morbi | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/refrigerator-repair-services-morbi" },
  openGraph: {
    title: "Trusted 24/7 Refrigerator Repair Services In Morbi | Atlas Aircon",
    description: "Fridge not working in Morbi? Get expert same-day repair at home for all brands. Our reliable technicians offer free diagnosis, genuine LG, Samsung parts & warra",
    url: "https://atlasaircons.com/refrigerator-repair-services-morbi",
    type: "website",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Fridge not working in Morbi? Get expert same-day repair at home for all brands. Our reliable technicians offer free diagnosis, genuine LG, Samsung parts &amp; warranty. Call now for service!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Refrigerator Repair Services Morbi in Vadodara?", a: "Refrigerator Repair Services Morbi cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Refrigerator Repair Services Morbi?", a: "Atlas Aircon offers same-day Refrigerator Repair Services Morbi across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Refrigerator Repair Services Morbis?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Refrigerator Repair Services Morbis depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Refrigerator Repair Services Morbi available on holidays?", a: "Yes, Atlas Aircon provides Refrigerator Repair Services Morbi 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Refrigerator Repair Services Morbi?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Refrigerator Repair Services Morbi across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Refrigerator Repair Services Morbis?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Refrigerator Repair Services Morbis depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Refrigerator Repair Services Morbi available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Refrigerator Repair Services Morbi 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
