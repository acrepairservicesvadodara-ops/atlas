...
export const metadata: Metadata = {
  title: "Trusted 24/7 Refrigerator Repair Services In Morbi | Hitech Aircool Engineers Gujarat",
  description: "Fridge not working in Morbi? Get expert same-day repair at home for all brands. Our reliable technicians offer free diagnosis, genuine LG, Samsung parts & warra",
  alternates: { canonical: "https://hitechairconditioning.in/refrigerator-repair-services-morbi" },
  openGraph: {
    title: "Trusted 24/7 Refrigerator Repair Services In Morbi | Hitech Aircool Engineers",
    description: "Fridge not working in Morbi? Get expert same-day repair at home for all brands. Our reliable technicians offer free diagnosis, genuine LG, Samsung parts & warra",
    url: "https://hitechairconditioning.in/refrigerator-repair-services-morbi",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Trusted 24/7 Refrigerator Repair Services In Morbi",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagerefrigeratorrepairservicesmorbi() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Trusted 24/7 Refrigerator Repair Services In Morbi</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Fridge not working in Morbi? Get expert same-day repair at home for all brands. Our reliable technicians offer free diagnosis, genuine LG, Samsung parts &amp; warranty. Call now for service!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Fridge not working in Morbi? Get expert same-day repair at home for all brands. Our reliable technicians offer free diagnosis, genuine LG, Samsung parts &amp; warranty. Call now for service!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/b7914dbe-da32-4479-9b2b-db1f88b6410f.webp" alt="Trusted 24/7 Refrigerator Repair Services In Morbi" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Trusted 24/7 Refrigerator Repair Services In Morbi" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Refrigerator Repair Services Morbi in Vadodara?", a: "Refrigerator Repair Services Morbi cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Refrigerator Repair Services Morbi?", a: "Hitech Aircool Engineers offers same-day Refrigerator Repair Services Morbi across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Refrigerator Repair Services Morbis?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Refrigerator Repair Services Morbis depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Refrigerator Repair Services Morbi available on holidays?", a: "Yes, Hitech Aircool Engineers provides Refrigerator Repair Services Morbi 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Refrigerator Repair Services Morbi take?", a: "Most Refrigerator Repair Services Morbis are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Refrigerator Repair Services Morbi in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Refrigerator Repair Services Morbi cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Refrigerator Repair Services Morbi?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Refrigerator Repair Services Morbi across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Refrigerator Repair Services Morbis?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Refrigerator Repair Services Morbis depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Refrigerator Repair Services Morbi available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Refrigerator Repair Services Morbi 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Refrigerator Repair Services Morbi take?", acceptedAnswer: { "@type": "Answer", text: "Most Refrigerator Repair Services Morbis are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
