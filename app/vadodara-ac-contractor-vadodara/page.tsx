...
export const metadata: Metadata = {
  title: "Vadodara AC Contractor in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC contractor Vadodara in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Vadodara AC Contractor Vadodara",
    "vadodara ac contractor",
    "Vadodara AC Contractor installation",
    "Vadodara AC Contractor service",
    "Vadodara AC Contractor repair",
    "best Vadodara AC Contractor service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/vadodara-ac-contractor-vadodara",
  },
};

const keywordData = {
  title: "Vadodara AC Contractor",
  slug: "vadodara-ac-contractor",
  description: "AC contractor Vadodara",
  category: "Brand"
};
...
export default function VadodaraACContractorPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What vadodara ac contractor vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides vadodara ac contractor vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book vadodara ac contractor vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency vadodara ac contractor vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What vadodara ac contractor vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides vadodara ac contractor vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book vadodara ac contractor vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency vadodara ac contractor vadodara available. Call +91 93289 53665 for immediate assistance." } },
