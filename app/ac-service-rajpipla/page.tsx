...
export const metadata: Metadata = {
  title: "🌿 AC Service Rajpipla | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-rajpipla" },
  openGraph: {
    title: "🌿 AC Service Rajpipla | Atlas Aircon",
    description: "Rajpipla's eco-conscious AC service! Expert maintenance with environmental care. Special monsoon-proofing for Narmada valley climate. Free energy audit. Call lo",
    url: "https://atlasaircons.com/ac-service-rajpipla",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Rajpipla&apos;s eco-conscious AC service! Expert maintenance with environmental care. Special monsoon-proofing for Narmada valley climate. Free energy audit. Call local experts!</p>
