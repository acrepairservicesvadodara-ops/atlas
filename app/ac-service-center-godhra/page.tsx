...
export const metadata: Metadata = {
  title: "🚨 AC Service Center Godhra | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-center-godhra" },
  openGraph: {
    title: "🚨 AC Service Center Godhra | Atlas Aircon",
    description: "Got AC problems? Visit our Godhra service center for same-day repair, gas charging & deep cleaning. Local experts with honest pricing & satisfaction guarantee. ",
    url: "https://atlasaircons.com/ac-service-center-godhra",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Got AC problems? Visit our Godhra service center for same-day repair, gas charging &amp; deep cleaning. Local experts with honest pricing &amp; satisfaction guarantee. Call now!</p>
