...
export const metadata: Metadata = {
  title: "🌴 AC Service Daman | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-daman" },
  openGraph: {
    title: "🌴 AC Service Daman | Atlas Aircon",
    description: "Expert AC service in coastal Daman! Specialized maintenance for beachside homes & hotels. Salt-air resistant care, 24/7 repair & affordable AMC plans. Call toda",
    url: "https://atlasaircons.com/ac-service-daman",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert AC service in coastal Daman! Specialized maintenance for beachside homes &amp; hotels. Salt-air resistant care, 24/7 repair &amp; affordable AMC plans. Call today!</p>
