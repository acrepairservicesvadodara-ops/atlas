...
export const metadata: Metadata = {
  title: "Panel AC Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Electrical panel AC in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Panel AC Repair Vadodara",
    "panel ac repair",
    "Panel AC Repair installation",
    "Panel AC Repair service",
    "Panel AC Repair repair",
    "best Panel AC Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/panel-ac-repair-vadodara",
  },
};

const keywordData = {
  title: "Panel AC Repair",
  slug: "panel-ac-repair",
  description: "Electrical panel AC",
  category: "Commercial"
};
...
export default function PanelACRepairPage() {
  return (
    <>
      {/* Hero Section */}
