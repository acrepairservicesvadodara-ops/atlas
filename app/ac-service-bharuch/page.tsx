...
export const metadata: Metadata = {
  title: "⚓ AC Service Bharuch | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-bharuch" },
  openGraph: {
    title: "⚓ AC Service Bharuch | Atlas Aircon",
    description: "Bharuch's premier AC service for homes & industries near the Golden Bridge. Expert maintenance, industrial AC care, and AMC plans from local certified technicia",
    url: "https://atlasaircons.com/ac-service-bharuch",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Bharuch&apos;s premier AC service for homes &amp; industries near the Golden Bridge. Expert maintenance, industrial AC care, and AMC plans from local certified technicians. Call!</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/cropped-AtlasAircon-Logo.webp" alt="⚓ AC Service Bharuch" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
