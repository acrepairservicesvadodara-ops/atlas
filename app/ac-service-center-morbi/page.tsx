...
export const metadata: Metadata = {
  title: "🔧 AC Service Center Morbi [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-center-morbi" },
  openGraph: {
    title: "🔧 AC Service Center Morbi [2026 Updated] | Atlas Aircon",
    description: "Your AC acting up? Morbi's most trusted AC service center provides expert repair & maintenance. Same-day service, transparent pricing & genuine parts. Get insta",
    url: "https://atlasaircons.com/ac-service-center-morbi",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Your AC acting up? Morbi&apos;s most trusted AC service center provides expert repair &amp; maintenance. Same-day service, transparent pricing &amp; genuine parts. Get instant help!</p>
