...
export const metadata: Metadata = {
  title: "🔧 AC Service Center Morbi [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Your AC acting up? Morbi's most trusted AC service center provides expert repair & maintenance. Same-day service, transparent pricing & genuine parts. Get insta",
  alternates: { canonical: "https://hitechairconditioning.in/ac-service-center-morbi" },
  openGraph: {
    title: "🔧 AC Service Center Morbi [2026 Updated] | Hitech Aircool Engineers",
    description: "Your AC acting up? Morbi's most trusted AC service center provides expert repair & maintenance. Same-day service, transparent pricing & genuine parts. Get insta",
    url: "https://hitechairconditioning.in/ac-service-center-morbi",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "🔧 AC Service Center Morbi [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageacservicecentermorbi() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">🔧 AC Service Center Morbi [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Your AC acting up? Morbi&apos;s most trusted AC service center provides expert repair &amp; maintenance. Same-day service, transparent pricing &amp; genuine parts. Get instant help!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Your AC acting up? Morbi&apos;s most trusted AC service center provides expert repair &amp; maintenance. Same-day service, transparent pricing &amp; genuine parts. Get instant help!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/24X7-ac-repairing.webp" alt="🔧 AC Service Center Morbi [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="🔧 AC Service Center Morbi [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Ac Service Center Morbi include?", a: "Ac Service Center Morbi includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Ac Service Center Morbi cost?", a: "Ac Service Center Morbi starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Ac Service Center Morbi improve cooling?", a: "Yes, proper Ac Service Center Morbi can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Ac Service Center Morbi reduce electricity bills?", a: "Regular Ac Service Center Morbi can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Ac Service Center Morbi take?", a: "Basic Ac Service Center Morbi takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Ac Service Center Morbi remove bad smell?", a: "Yes, Ac Service Center Morbi includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Ac Service Center Morbi?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Ac Service Center Morbi include?", acceptedAnswer: { "@type": "Answer", text: "Ac Service Center Morbi includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Ac Service Center Morbi cost?", acceptedAnswer: { "@type": "Answer", text: "Ac Service Center Morbi starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Ac Service Center Morbi improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Ac Service Center Morbi can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Ac Service Center Morbi reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Ac Service Center Morbi can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Ac Service Center Morbi take?", acceptedAnswer: { "@type": "Answer", text: "Basic Ac Service Center Morbi takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Ac Service Center Morbi remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Ac Service Center Morbi includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Ac Service Center Morbi?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
