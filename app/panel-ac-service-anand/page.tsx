...
export const metadata: Metadata = {
  title: "Expert Panel AC Service Anand | Hitech Aircool Engineers Gujarat",
  description: "Specialized Rittal & Schneider panel AC service Anand for dairy plants, colleges & industrial units. We provide 24/7 emergency repair, genuine parts, and reliab",
  alternates: { canonical: "https://hitechairconditioning.in/panel-ac-service-anand" },
  openGraph: {
    title: "Expert Panel AC Service Anand | Hitech Aircool Engineers",
    description: "Specialized Rittal & Schneider panel AC service Anand for dairy plants, colleges & industrial units. We provide 24/7 emergency repair, genuine parts, and reliab",
    url: "https://hitechairconditioning.in/panel-ac-service-anand",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Expert Panel AC Service Anand",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagepanelacserviceanand() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Expert Panel AC Service Anand</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Specialized Rittal &amp; Schneider panel AC service Anand for dairy plants, colleges &amp; industrial units. We provide 24/7 emergency repair, genuine parts, and reliable AMCs.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Specialized Rittal &amp; Schneider panel AC service Anand for dairy plants, colleges &amp; industrial units. We provide 24/7 emergency repair, genuine parts, and reliable AMCs.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/panel-ac-repair-service.webp" alt="Expert Panel AC Service Anand" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Expert Panel AC Service Anand" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
