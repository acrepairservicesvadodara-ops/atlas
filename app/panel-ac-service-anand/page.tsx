...
export const metadata: Metadata = {
  title: "Expert Panel AC Service Anand | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/panel-ac-service-anand" },
  openGraph: {
    title: "Expert Panel AC Service Anand | Atlas Aircon",
    description: "Specialized Rittal & Schneider panel AC service Anand for dairy plants, colleges & industrial units. We provide 24/7 emergency repair, genuine parts, and reliab",
    url: "https://atlasaircons.com/panel-ac-service-anand",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Specialized Rittal &amp; Schneider panel AC service Anand for dairy plants, colleges &amp; industrial units. We provide 24/7 emergency repair, genuine parts, and reliable AMCs.</p>
