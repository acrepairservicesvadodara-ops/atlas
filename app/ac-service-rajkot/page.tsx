...
export const metadata: Metadata = {
  title: "⚙️ AC Service Rajkot | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-rajkot" },
  openGraph: {
    title: "⚙️ AC Service Rajkot | Atlas Aircon",
    description: "Rajkot's toughest AC service! Industrial-grade maintenance, repair & AMC from Saurashtra's most robust technicians. Built for Rajkot's climate. Free system audi",
    url: "https://atlasaircons.com/ac-service-rajkot",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Rajkot&apos;s toughest AC service! Industrial-grade maintenance, repair &amp; AMC from Saurashtra&apos;s most robust technicians. Built for Rajkot&apos;s climate. Free system audit. Call!</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/cropped-AtlasAircon-Logo.webp" alt="⚙️ AC Service Rajkot" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
