...
export const metadata: Metadata = {
  title: "GI Duct Fabrication in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "GI duct work in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "GI Duct Fabrication Vadodara",
    "gi duct fabrication",
    "GI Duct Fabrication installation",
    "GI Duct Fabrication service",
    "GI Duct Fabrication repair",
    "best GI Duct Fabrication service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/gi-duct-fabrication-vadodara",
  },
};

const keywordData = {
  title: "GI Duct Fabrication",
  slug: "gi-duct-fabrication",
  description: "GI duct work",
  category: "HVAC"
};
...
export default function GIDuctFabricationPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What gi duct fabrication vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides gi duct fabrication vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book gi duct fabrication vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency gi duct fabrication vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What gi duct fabrication vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides gi duct fabrication vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book gi duct fabrication vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency gi duct fabrication vadodara available. Call +91 93289 53665 for immediate assistance." } },
