...
export const metadata: Metadata = {
  title: "AC & HVAC Installation Service | Hitech Aircool Engineers Gujarat",
  description: "Professional ac & hvac installation service by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/installation-and-fitting-ac" },
  openGraph: {
    title: "AC & HVAC Installation Service | Hitech Aircool Engineers",
    description: "Professional ac & hvac installation service by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/installation-and-fitting-ac",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "AC & HVAC Installation Service",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageinstallationandfittingac() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">AC &amp; HVAC Installation Service</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">&#123; &quot;@context&quot;: &quot;https://schema.org&quot;, &quot;@type&quot;: &quot;Lo...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">&#123; &quot;@context&quot;: &quot;https://schema.org&quot;, &quot;@type&quot;: &quot;Lo...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/installation-of-air-conditioner.webp" alt="AC & HVAC Installation Service" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="AC & HVAC Installation Service" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="AC & HVAC Installation Service" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Atlas-aircon-vehicle.webp" alt="AC & HVAC Installation Service" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Atlas-aircon-vehicle.webp" alt="AC & HVAC Installation Service" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Atlas-aircon-vehicle.webp" alt="AC & HVAC Installation Service" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
