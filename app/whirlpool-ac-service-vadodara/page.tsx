...
export const metadata: Metadata = {
  title: "Whirlpool AC Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Whirlpool AC service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Whirlpool AC Service Vadodara",
    "whirlpool ac service",
    "Whirlpool AC Service installation",
    "Whirlpool AC Service service",
    "Whirlpool AC Service repair",
    "best Whirlpool AC Service service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/whirlpool-ac-service-vadodara",
  },
};

const keywordData = {
  title: "Whirlpool AC Service",
  slug: "whirlpool-ac-service",
  description: "Whirlpool AC service",
  category: "Brands"
};
...
export default function WhirlpoolACServicePage() {
  return (
    <>
      {/* Hero Section */}
