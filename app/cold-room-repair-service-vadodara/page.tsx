...
export const metadata: Metadata = {
  title: "#1 Cold Room Repair Service In Vadodara | Hitech Aircool Engineers Gujarat",
  description: "Professional #1 cold room repair service in vadodara by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/cold-room-repair-service-vadodara" },
  openGraph: {
    title: "#1 Cold Room Repair Service In Vadodara | Hitech Aircool Engineers",
    description: "Professional #1 cold room repair service in vadodara by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/cold-room-repair-service-vadodara",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "#1 Cold Room Repair Service In Vadodara",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagecoldroomrepairservicevadodara() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">#1 Cold Room Repair Service In Vadodara</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">body &#123; ...</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/walkin-freezer-repair.webp" alt="#1 Cold Room Repair Service In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="#1 Cold Room Repair Service In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="#1 Cold Room Repair Service In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVcold room repair service vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial cold room repair service vadodara?", a: "Industrial cold room repair service vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVcold room repair service vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial cold room repair service vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial cold room repair service vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
