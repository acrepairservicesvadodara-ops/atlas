...
export const metadata: Metadata = {
  title: "AC Por Ramangamdi in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC service in Por in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC Por Ramangamdi Vadodara",
    "ac por ramangamdi",
    "AC Por Ramangamdi installation",
    "AC Por Ramangamdi service",
    "AC Por Ramangamdi repair",
    "best AC Por Ramangamdi service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-por-ramangamdi-vadodara",
  },
};

const keywordData = {
  title: "AC Por Ramangamdi",
  slug: "ac-por-ramangamdi",
  description: "AC service in Por",
  category: "Area"
};
...
export default function ACPorRamangamdiPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What ac por ramangamdi vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides ac por ramangamdi vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book ac por ramangamdi vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency ac por ramangamdi vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What ac por ramangamdi vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides ac por ramangamdi vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book ac por ramangamdi vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency ac por ramangamdi vadodara available. Call +91 93289 53665 for immediate assistance." } },
