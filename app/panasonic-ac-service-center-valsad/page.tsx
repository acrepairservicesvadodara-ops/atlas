...
export const metadata: Metadata = {
  title: "Panasonic AC Service Center Valsad | Professional HVAC Service | Hitech Aircool Engineers",
  description: "Panasonic AC Service Center Valsad — Professional service service by Hitech Aircool Engineers. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 93289 53665.",
  keywords: ["panasonic ac service center valsad", "service service", "hvac service vadodara", "hitech aircool engineers", "ac service gujarat"],
  alternates: { canonical: "https://hitechairconditioning.in/panasonic-ac-service-center-valsad" },
  openGraph: { title: "Panasonic AC Service Center Valsad | Hitech Aircool Engineers", description: "Professional service service by Hitech Aircool Engineers Gujarat.", url: "https://hitechairconditioning.in/panasonic-ac-service-center-valsad", type: "website" },
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Panasonic AC Service Center Valsad",
  provider: { "@type": "LocalBusiness", name: "Hitech Aircool Engineers", telephone: "+919328953665" },
  areaServed: { "@type": "State", name: "Gujarat" },
  serviceType: "Panasonic AC Service Center Valsad",
};

export default function PanasonicACServiceCenterValsadPage() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Panasonic AC Service Center Valsad</h1>
