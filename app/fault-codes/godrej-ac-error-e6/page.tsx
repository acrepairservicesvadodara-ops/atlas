...
export const metadata: Metadata = {
  title: "Godrej AC Error E6 | Communication Error | Diagnostic Guide | Hitech Aircool Engineers",
  description: "Godrej AC Error E6 indicates communication error. Learn causes, DIY checks, professional repair costs. Expert Godrej AC repair in Vadodara. Call +91 93289 53665.",
  keywords: [
    "godrej ac error e6",
  ...
  alternates: { canonical: "https://hitechairconditioning.in/fault-codes/godrej-ac-error-e6" },
  openGraph: {
    title: "Godrej AC Error E6 — Communication Error | Hitech Aircool Engineers",
    description: "Diagnostic protocol & repair guide for Godrej AC Error E6. Suspects: Signal Cable or Outdoor PCB.",
    url: "https://hitechairconditioning.in/fault-codes/godrej-ac-error-e6",
    type: "article",
  },
};
...
const jsonLd = {
  ...
  mainEntityOfPage: "https://hitechairconditioning.in/fault-codes/godrej-ac-error-e6",
};
      ...
      <section className="py-16 bg-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href={`https://wa.me/919328953665?text=${encodeURIComponent("HELP: My Godrej AC is showing error E6. I need support.")}`} className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-400 text-white px-8 py-4 rounded-full font-bold text-lg transition">
