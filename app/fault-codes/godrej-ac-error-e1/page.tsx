...
export const metadata: Metadata = {
  title: "Godrej AC Error E1 | Indoor Temperature Sensor Failure | Diagnostic Guide | Atlas Aircon",
  description: "Godrej AC Error E1 indicates indoor temperature sensor failure. Learn causes, DIY checks, professional repair costs. Expert Godrej AC repair in Vadodara. Call +91 97272 57141.",
  keywords: [
    "godrej ac error e1",
  ...
  alternates: { canonical: "https://atlasaircons.com/fault-codes/godrej-ac-error-e1" },
  openGraph: {
    title: "Godrej AC Error E1 — Indoor Temperature Sensor Failure | Atlas Aircon",
    description: "Diagnostic protocol & repair guide for Godrej AC Error E1. Suspects: Thermistor or PCB Circuit.",
    url: "https://atlasaircons.com/fault-codes/godrej-ac-error-e1",
    type: "article",
  },
};
...
const jsonLd = {
  ...
  mainEntityOfPage: "https://atlasaircons.com/fault-codes/godrej-ac-error-e1",
};
      ...
      <section className="py-16 bg-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href={`https://wa.me/919727257141?text=${encodeURIComponent("HELP: My Godrej AC is showing error E1. I need support.")}`} className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-400 text-white px-8 py-4 rounded-full font-bold text-lg transition">
