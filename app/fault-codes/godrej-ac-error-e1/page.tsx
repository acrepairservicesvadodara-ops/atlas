...
export const metadata: Metadata = {
  title: "Godrej AC Error E1 | Indoor Temperature Sensor Failure | Diagnostic Guide | Hitech Aircool Engineers",
  description: "Godrej AC Error E1 indicates indoor temperature sensor failure. Learn causes, DIY checks, professional repair costs. Expert Godrej AC repair in Vadodara. Call +91 93289 53665.",
  keywords: [
    "godrej ac error e1",
    "godrej ac error code e1",
    "godrej ac e1 fault",
    "godrej ac indoor temperature sensor failure",
    "godrej ac troubleshooting",
    "ac error e1 meaning",
    "godrej ac repair vadodara",
    "ac error code fix",
  ],
  alternates: { canonical: "https://hitechairconditioning.in/fault-codes/godrej-ac-error-e1" },
  openGraph: {
    title: "Godrej AC Error E1 — Indoor Temperature Sensor Failure | Hitech Aircool Engineers",
    description: "Diagnostic protocol & repair guide for Godrej AC Error E1. Suspects: Thermistor or PCB Circuit.",
    url: "https://hitechairconditioning.in/fault-codes/godrej-ac-error-e1",
    type: "article",
  },
};
...
const jsonLd = {
  ...
  "@type": "TechArticle",
  headline: "Godrej AC Error E1 — Indoor Temperature Sensor Failure",
  description: "Complete diagnostic protocol and repair guide for Godrej AC Error Code E1.",
  ...
  mainEntityOfPage: "https://hitechairconditioning.in/fault-codes/godrej-ac-error-e1",
};

export default function GodrejErrorE1Page() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              <span className="text-red-400">Godrej AC Error E1</span>
            </h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-6">Understanding Godrej Error E1</h2>
            ...
            <p className="text-gray-600 mb-4">
              Our certified technicians follow a systematic approach to diagnose and resolve the E1 error efficiently. We carry diagnostic tools and common Godrej spare parts in our service vehicles, enabling single-visit repairs in most cases.
            </p>
...
{/* CTA */}
      <section className="py-16 bg-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl font-bold mb-4">Can&apos;t Fix Godrej Error E1?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href={`https://wa.me/919328953665?text=${encodeURIComponent("HELP: My Godrej AC is showing error E1. I need support.")}`} className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-400 text-white px-8 py-4 rounded-full font-bold text-lg transition">
