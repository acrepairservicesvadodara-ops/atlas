...
export const metadata: Metadata = {
  title: "Blue Star AC Error F1 | Indoor Sensor Circuit Error | Diagnostic Guide | Atlas Aircon",
  description: "Blue Star AC Error F1 indicates indoor sensor circuit error. Learn causes, DIY checks, professional repair costs. Expert Blue Star AC repair in Vadodara. Call +91 97272 57141.",
  keywords: [
    "blue star ac error f1",
    "blue star ac error code f1",
    "blue star ac f1 fault",
    "blue star ac indoor sensor circuit error",
    "blue star ac troubleshooting",
    "ac error f1 meaning",
    "blue star ac repair vadodara",
    "ac error code fix",
  ],
  alternates: { canonical: "https://atlasaircons.com/fault-codes/blue-star-ac-error-f1" },
  openGraph: {
    title: "Blue Star AC Error F1 — Indoor Sensor Circuit Error | Atlas Aircon",
    description: "Diagnostic protocol & repair guide for Blue Star AC Error F1. Suspects: Thermistor or PCB Input.",
    url: "https://atlasaircons.com/fault-codes/blue-star-ac-error-f1",
    type: "article",
  },
};
...
const jsonLd = {
  ...
  "@type": "TechArticle",
  headline: "Blue Star AC Error F1 — Indoor Sensor Circuit Error",
  description: "Complete diagnostic protocol and repair guide for Blue Star AC Error Code F1.",
  author: { "@type": "Organization", name: "Atlas Aircon" },
  publisher: { "@type": "Organization", name: "Atlas Aircon", url: "https://atlasaircons.com" },
  mainEntityOfPage: "https://atlasaircons.com/fault-codes/blue-star-ac-error-f1",
};

export default function BlueStarErrorF1Page() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              <span className="text-red-400">Blue Star AC Error F1</span>
            </h1>
            <p className="text-2xl text-gray-300 mb-8">Indoor Sensor Circuit Error</p>
            <div className="grid grid-cols-3 gap-4 max-w-lg">
              <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center">
                <p className="text-xs text-gray-400 uppercase mb-1">Symptom</p>
                <p className="font-bold text-yellow-400">Indoor Sensor</p>
              </div>
              <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center">
              ...
              <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center">
                ...
                <p className="font-bold text-red-400">PCB Input</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-6">Understanding Blue Star Error F1</h2>
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-8">
              <p className="text-gray-700">Similar to E1 — the room temperature sensor circuit on the indoor PCB is reading abnormal values. Could be a sensor or PCB issue.</p>
              <p className="text-gray-700 mt-3">
                <strong>Impact:</strong> If left unaddressed, this error can lead to compressor damage, increased energy consumption, and complete system shutdown. It is critical to resolve F1 promptly to avoid costly repairs.
              </p>
            </div>
            ...
            <div className="space-y-4 mb-12">
              {[
                { step: "Step 1", desc: "Measure sensor resistance at connector pins" },
                { step: "Step 2", desc: "Check PCB solder joints around sensor input IC" },
                { step: "Step 3", desc: "Replace sensor or repair PCB cold solder joints" },
              ].map((item) => (
            ...
            <p className="text-gray-600 mb-4">
              Our certified technicians follow a systematic approach to diagnose and resolve the F1 error efficiently. We carry diagnostic tools and common Blue Star spare parts in our service vehicles, enabling single-visit repairs in most cases.
            </p>
...
{/* CTA */}
      <section className="py-16 bg-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl font-bold mb-4">Can&apos;t Fix Blue Star Error F1?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href={`https://wa.me/919727257141?text=${encodeURIComponent("HELP: My Blue Star AC is showing error F1. I need support.")}`} className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-400 text-white px-8 py-4 rounded-full font-bold text-lg transition">
