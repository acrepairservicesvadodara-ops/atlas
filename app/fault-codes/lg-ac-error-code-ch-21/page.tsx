...
export const metadata: Metadata = {
  title: "LG AC Error CH21 | Indoor Temperature Sensor Failure | Diagnostic Guide | Atlas Aircon",
  description: "LG AC Error CH21 indicates indoor temperature sensor failure. Learn causes, DIY checks, professional repair costs. Expert LG AC repair in Vadodara. Call +91 97272 57141.",
  keywords: [
    "lg ac error ch21",
  ...
  alternates: { canonical: "https://atlasaircons.com/fault-codes/lg-ac-error-code-ch-21" },
  openGraph: {
    title: "LG AC Error CH21 — Indoor Temperature Sensor Failure | Atlas Aircon",
    description: "Diagnostic protocol & repair guide for LG AC Error CH21. Suspects: Thermistor or PCB Circuit.",
    url: "https://atlasaircons.com/fault-codes/lg-ac-error-code-ch-21",
    type: "article",
  },
};
...
const jsonLd = {
  ...
  mainEntityOfPage: "https://atlasaircons.com/fault-codes/lg-ac-error-code-ch-21",
};
      ...
      <section className="py-16 bg-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href={`https://wa.me/919727257141?text=${encodeURIComponent("HELP: My LG AC is showing error CH21. I need support.")}`} className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-400 text-white px-8 py-4 rounded-full font-bold text-lg transition">
