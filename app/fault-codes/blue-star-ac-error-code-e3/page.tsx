...
export const metadata: Metadata = {
  title: "Blue Star AC Error E3 | Indoor Coil Sensor Error | Diagnostic Guide | Atlas Aircon",
  description: "Blue Star AC Error E3 indicates indoor coil sensor error. Learn causes, DIY checks, professional repair costs. Expert Blue Star AC repair in Vadodara. Call +91 97272 57141.",
  keywords: [
    "blue star ac error e3",
    "blue star ac error code e3",
    "blue star ac e3 fault",
    "blue star ac indoor coil sensor error",
    "blue star ac troubleshooting",
    "ac error e3 meaning",
    "blue star ac repair vadodara",
    "ac error code fix",
  ],
  alternates: { canonical: "https://atlasaircons.com/fault-codes/blue-star-ac-error-code-e3" },
  openGraph: {
    title: "Blue Star AC Error E3 — Indoor Coil Sensor Error | Atlas Aircon",
    description: "Diagnostic protocol & repair guide for Blue Star AC Error E3. Suspects: Evaporator Sensor or Frozen Coil.",
    url: "https://atlasaircons.com/fault-codes/blue-star-ac-error-code-e3",
    type: "article",
  },
};
...
const jsonLd = {
  ...
  "@type": "TechArticle",
  headline: "Blue Star AC Error E3 — Indoor Coil Sensor Error",
  description: "Complete diagnostic protocol and repair guide for Blue Star AC Error Code E3.",
  author: { "@type": "Organization", name: "Atlas Aircon" },
  publisher: { "@type": "Organization", name: "Atlas Aircon", url: "https://atlasaircons.com" },
  mainEntityOfPage: "https://atlasaircons.com/fault-codes/blue-star-ac-error-code-e3",
};

export default function BlueStarErrorE3Page() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              <span className="text-red-400">Blue Star AC Error E3</span>
            </h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-6">Understanding Blue Star Error E3</h2>
            ...
            <p className="text-gray-600 mb-4">
              Our certified technicians follow a systematic approach to diagnose and resolve the E3 error efficiently. We carry diagnostic tools and common Blue Star spare parts in our service vehicles, enabling single-visit repairs in most cases.
            </p>
...
{/* CTA */}
      <section className="py-16 bg-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl font-bold mb-4">Can&apos;t Fix Blue Star Error E3?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href={`https://wa.me/919727257141?text=${encodeURIComponent("HELP: My Blue Star AC is showing error E3. I need support.")}`} className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-400 text-white px-8 py-4 rounded-full font-bold text-lg transition">
