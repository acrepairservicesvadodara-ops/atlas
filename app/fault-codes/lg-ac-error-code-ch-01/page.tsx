...
export const metadata: Metadata = {
  title: "LG AC Error CH01 | Indoor Temperature Sensor Failure | Diagnostic Guide | Hitech Aircool Engineers",
  description: "LG AC Error CH01 indicates indoor temperature sensor failure. Learn causes, DIY checks, professional repair costs. Expert LG AC repair in Vadodara. Call +91 93289 53665.",
  keywords: [
    "lg ac error ch01",
  ...
  alternates: { canonical: "https://hitechairconditioning.in/fault-codes/lg-ac-error-code-ch-01" },
  openGraph: {
    title: "LG AC Error CH01 — Indoor Temperature Sensor Failure | Hitech Aircool Engineers",
    description: "Diagnostic protocol & repair guide for LG AC Error CH01. Suspects: Thermistor or PCB Circuit.",
    url: "https://hitechairconditioning.in/fault-codes/lg-ac-error-code-ch-01",
    type: "article",
  },
};
...
const jsonLd = {
  ...
  mainEntityOfPage: "https://hitechairconditioning.in/fault-codes/lg-ac-error-code-ch-01",
};
      ...
      <section className="py-16 bg-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href={`https://wa.me/919328953665?text=${encodeURIComponent("HELP: My LG AC is showing error CH01. I need support.")}`} className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-400 text-white px-8 py-4 rounded-full font-bold text-lg transition">
