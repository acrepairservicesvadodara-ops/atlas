...
export const metadata: Metadata = {
  title: "Hitachi AC Error S | Indoor Temperature Sensor Failure | Diagnostic Guide | Atlas Aircon",
  description: "Hitachi AC Error S indicates indoor temperature sensor failure. Learn causes, DIY checks, professional repair costs. Expert Hitachi AC repair in Vadodara. Call +91 97272 57141.",
  keywords: [
    "hitachi ac error s",
  ...
  alternates: { canonical: "https://atlasaircons.com/fault-codes/hitachi-ac-error-codes" },
  openGraph: {
    title: "Hitachi AC Error S — Indoor Temperature Sensor Failure | Atlas Aircon",
    description: "Diagnostic protocol & repair guide for Hitachi AC Error S. Suspects: Thermistor or PCB Circuit.",
    url: "https://atlasaircons.com/fault-codes/hitachi-ac-error-codes",
    type: "article",
  },
};
...
const jsonLd = {
  ...
  mainEntityOfPage: "https://atlasaircons.com/fault-codes/hitachi-ac-error-codes",
};
      ...
      <section className="py-16 bg-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href={`https://wa.me/919727257141?text=${encodeURIComponent("HELP: My Hitachi AC is showing error S. I need support.")}`} className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-400 text-white px-8 py-4 rounded-full font-bold text-lg transition">
