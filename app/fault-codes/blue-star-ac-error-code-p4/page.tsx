...
export const metadata: Metadata = {
  title: "Blue Star AC Error P4 | Inverter Compressor Error | Diagnostic Guide | Atlas Aircon",
  description: "Blue Star AC Error P4 indicates inverter compressor error. Learn causes, DIY checks, professional repair costs. Expert Blue Star AC repair in Vadodara. Call +91 97272 57141.",
  keywords: [
    "blue star ac error p4",
    "blue star ac error code p4",
    "blue star ac p4 fault",
    "blue star ac inverter compressor error",
    "blue star ac troubleshooting",
    "ac error p4 meaning",
    "blue star ac repair vadodara",
    "ac error code fix",
  ],
  alternates: { canonical: "https://atlasaircons.com/fault-codes/blue-star-ac-error-code-p4" },
  openGraph: {
    title: "Blue Star AC Error P4 — Inverter Compressor Error | Atlas Aircon",
    description: "Diagnostic protocol & repair guide for Blue Star AC Error P4. Suspects: IPM Module or Compressor Winding.",
    url: "https://atlasaircons.com/fault-codes/blue-star-ac-error-code-p4",
    type: "article",
  },
};
...
const jsonLd = {
  ...
  "@type": "TechArticle",
  headline: "Blue Star AC Error P4 — Inverter Compressor Error",
  description: "Complete diagnostic protocol and repair guide for Blue Star AC Error Code P4.",
  author: { "@type": "Organization", name: "Atlas Aircon" },
  publisher: { "@type": "Organization", name: "Atlas Aircon", url: "https://atlasaircons.com" },
  mainEntityOfPage: "https://atlasaircons.com/fault-codes/blue-star-ac-error-code-p4",
};

export default function BlueStarErrorP4Page() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              <span className="text-red-400">Blue Star AC Error P4</span>
            </h1>
            <p className="text-2xl text-gray-300 mb-8">Inverter Compressor Error</p>
            <div className="grid grid-cols-3 gap-4 max-w-lg">
              <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center">
                <p className="text-xs text-gray-400 uppercase mb-1">Symptom</p>
                <p className="font-bold text-yellow-400">Inverter Compressor</p>
              </div>
              <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center">
                <p className="text-xs text-gray-400 uppercase mb-1">Suspect #1</p>
                <p className="font-bold text-orange-400">IPM Module</p>
              </div>
              <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center">
                <p className="text-xs text-gray-400 uppercase mb-1">Suspect #2</p>
                <p className="font-bold text-red-400">Compressor Winding</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-6">Understanding Blue Star Error P4</h2>
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-8">
              <p className="text-gray-700">The inverter drive module has detected a fault with the compressor. Could be an IPM (Intelligent Power Module) failure or compressor winding issue.</p>
              <p className="text-gray-700 mt-3">
                <strong>Impact:</strong> If left unaddressed, this error can lead to compressor damage, increased energy consumption, and complete system shutdown. It is critical to resolve P4 promptly to avoid costly repairs.
              </p>
            </div>
            ...
            <div className="space-y-4 mb-12">
              {[
                { step: "Step 1", desc: "Check compressor winding resistance (balanced across all 3 phases)" },
                { step: "Step 2", desc: "Test IPM module for shorted transistors" },
                { step: "Step 3", desc: "Replace IPM module or compressor as needed" },
              ].map((item) => (
            ...
            <p className="text-gray-600 mb-4">
              Our certified technicians follow a systematic approach to diagnose and resolve the P4 error efficiently. We carry diagnostic tools and common Blue Star spare parts in our service vehicles, enabling single-visit repairs in most cases.
            </p>
            <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-8 rounded-xl border border-blue-200 mb-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white p-4 rounded-lg">
                  <p className="text-sm text-gray-500 mb-1">{("IPM module: ₹3,000-₹6,000").split(":")[0]}</p>
                  <p className="text-xl font-bold text-blue-700">{("IPM module: ₹3,000-₹6,000").split(": ")[1]}</p>
                </div>
                <div className="bg-white p-4 rounded-lg">
                  <p className="text-sm text-gray-500 mb-1">{("Compressor: ₹8,000+").split(":")[0]}</p>
                  <p className="text-xl font-bold text-blue-700">{("Compressor: ₹8,000+").split(": ")[1]}</p>
                </div>
              </div>
            </div>

            {/* Extra SEO content */}
            <h3 className="text-2xl font-bold mb-4">When to Call a Professional for Error P4</h3>
            <p className="text-gray-600 mb-4">
              While the basic checks above can help you identify obvious issues, Blue Star AC systems use sophisticated electronics that require professional diagnostic equipment. If the DIY steps don&apos;t resolve the P4 code, attempting further repairs without proper tools can cause additional damage — turning a ₹500 sensor replacement into a ₹8,000+ PCB replacement.
            </p>
...
{/* CTA */}
      <section className="py-16 bg-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl font-bold mb-4">Can&apos;t Fix Blue Star Error P4?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href={`https://wa.me/919727257141?text=${encodeURIComponent("HELP: My Blue Star AC is showing error P4. I need support.")}`} className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-400 text-white px-8 py-4 rounded-full font-bold text-lg transition">
