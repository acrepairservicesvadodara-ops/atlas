...
export const metadata: Metadata = {
  title: "Blue Star AC Error P4 | Inverter Compressor Error | Diagnostic Guide | Hitech Aircool Engineers",
  description: "Blue Star AC Error P4 indicates inverter compressor error. Learn causes, DIY checks, professional repair costs. Expert Blue Star AC repair in Vadodara. Call +91 93289 53665.",
  keywords: [
  ...
  alternates: { canonical: "https://hitechairconditioning.in/fault-codes/blue-star-ac-error-code-p4" },
  openGraph: {
    title: "Blue Star AC Error P4 — Inverter Compressor Error | Hitech Aircool Engineers",
    description: "Diagnostic protocol & repair guide for Blue Star AC Error P4. Suspects: IPM Module or Compressor Winding.",
    url: "https://hitechairconditioning.in/fault-codes/blue-star-ac-error-code-p4",
    type: "article",
  },
};
...
const jsonLd = {
  ...
  mainEntityOfPage: "https://hitechairconditioning.in/fault-codes/blue-star-ac-error-code-p4",
};
            ...
            <div className="bg-gradient-to-r from-teal-50 to-teal-100 p-8 rounded-xl border border-teal-200 mb-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white p-4 rounded-lg">
                  ...
                  <p className="text-xl font-bold text-teal-700">{("IPM module: ₹3,000-₹6,000").split(": ")[1]}</p>
                </div>
                <div className="bg-white p-4 rounded-lg">
                  <p className="text-sm text-gray-500 mb-1">{("Compressor: ₹8,000+").split(":")[0]}</p>
                  <p className="text-xl font-bold text-teal-700">{("Compressor: ₹8,000+").split(": ")[1]}</p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href={`https://wa.me/919328953665?text=${encodeURIComponent("HELP: My Blue Star AC is showing error P4. I need support.")}`} className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-400 text-white px-8 py-4 rounded-full font-bold text-lg transition">
