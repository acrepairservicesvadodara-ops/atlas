...
export const metadata: Metadata = {
  title: "Carrier AC Error E1 | Indoor Temperature Sensor Failure | Diagnostic Guide | Hitech Aircool Engineers",
  description: "Carrier AC Error E1 indicates indoor temperature sensor failure. Learn causes, DIY checks, professional repair costs. Expert Carrier AC repair in Vadodara. Call +91 93289 53665.",
  keywords: [
    "carrier ac error e1",
    "carrier ac error code e1",
    "carrier ac e1 fault",
    "carrier ac indoor temperature sensor failure",
    "carrier ac troubleshooting",
    "ac error e1 meaning",
    "carrier ac repair vadodara",
    "ac error code fix",
  ],
  alternates: { canonical: "https://hitechairconditioning.in/fault-codes/carrier-ac-error-e1" },
  openGraph: {
    title: "Carrier AC Error E1 — Indoor Temperature Sensor Failure | Hitech Aircool Engineers",
    description: "Diagnostic protocol & repair guide for Carrier AC Error E1. Suspects: Thermistor or PCB Circuit.",
    url: "https://hitechairconditioning.in/fault-codes/carrier-ac-error-e1",
    type: "article",
  },
};
...
const jsonLd = {
  ...
  "@type": "TechArticle",
  headline: "Carrier AC Error E1 — Indoor Temperature Sensor Failure",
  description: "Complete diagnostic protocol and repair guide for Carrier AC Error Code E1.",
  ...
  mainEntityOfPage: "https://hitechairconditioning.in/fault-codes/carrier-ac-error-e1",
};

export default function CarrierErrorE1Page() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              <span className="text-red-400">Carrier AC Error E1</span>
            </h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-6">Understanding Carrier Error E1</h2>
            ...
            <p className="text-gray-600 mb-4">
              Our certified technicians follow a systematic approach to diagnose and resolve the E1 error efficiently. We carry diagnostic tools and common Carrier spare parts in our service vehicles, enabling single-visit repairs in most cases.
            </p>
...
{/* CTA */}
      <section className="py-16 bg-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl font-bold mb-4">Can&apos;t Fix Carrier Error E1?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href={`https://wa.me/919328953665?text=${encodeURIComponent("HELP: My Carrier AC is showing error E1. I need support.")}`} className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-400 text-white px-8 py-4 rounded-full font-bold text-lg transition">
