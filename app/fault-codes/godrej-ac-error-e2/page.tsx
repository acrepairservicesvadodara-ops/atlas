...
export const metadata: Metadata = {
  title: "Godrej AC Error E2 | Outdoor Coil Sensor Fault | Diagnostic Guide | Hitech Aircool Engineers",
  description: "Godrej AC Error E2 indicates outdoor coil sensor fault. Learn causes, DIY checks, professional repair costs. Expert Godrej AC repair in Vadodara. Call +91 93289 53665.",
  keywords: [
    "godrej ac error e2",
    "godrej ac error code e2",
    "godrej ac e2 fault",
    "godrej ac outdoor coil sensor fault",
    "godrej ac troubleshooting",
    "ac error e2 meaning",
    "godrej ac repair vadodara",
    "ac error code fix",
  ],
  alternates: { canonical: "https://hitechairconditioning.in/fault-codes/godrej-ac-error-e2" },
  openGraph: {
    title: "Godrej AC Error E2 — Outdoor Coil Sensor Fault | Hitech Aircool Engineers",
    description: "Diagnostic protocol & repair guide for Godrej AC Error E2. Suspects: Coil Sensor or Wiring Harness.",
    url: "https://hitechairconditioning.in/fault-codes/godrej-ac-error-e2",
    type: "article",
  },
};
...
const jsonLd = {
  ...
  "@type": "TechArticle",
  headline: "Godrej AC Error E2 — Outdoor Coil Sensor Fault",
  description: "Complete diagnostic protocol and repair guide for Godrej AC Error Code E2.",
  ...
  mainEntityOfPage: "https://hitechairconditioning.in/fault-codes/godrej-ac-error-e2",
};

export default function GodrejErrorE2Page() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              <span className="text-red-400">Godrej AC Error E2</span>
            </h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-6">Understanding Godrej Error E2</h2>
            ...
            <p className="text-gray-600 mb-4">
              Our certified technicians follow a systematic approach to diagnose and resolve the E2 error efficiently. We carry diagnostic tools and common Godrej spare parts in our service vehicles, enabling single-visit repairs in most cases.
            </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Are you an authorized service center for GODREJ?", a: "Hitech Aircool Engineers provides multi-brand AC service. While not an authorized center, our technicians are trained on GODREJ and use genuine parts." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Are you an authorized service center for GODREJ?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides multi-brand AC service. While not an authorized center, our technicians are trained on GODREJ and use genuine parts." } },
...
{/* CTA */}
      <section className="py-16 bg-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl font-bold mb-4">Can&apos;t Fix Godrej Error E2?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href={`https://wa.me/919328953665?text=${encodeURIComponent("HELP: My Godrej AC is showing error E2. I need support.")}`} className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-400 text-white px-8 py-4 rounded-full font-bold text-lg transition">
