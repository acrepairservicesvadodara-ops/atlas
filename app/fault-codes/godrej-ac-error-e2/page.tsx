...
export const metadata: Metadata = {
  title: "Godrej AC Error E2 | Outdoor Coil Sensor Fault | Diagnostic Guide | Atlas Aircon",
  description: "Godrej AC Error E2 indicates outdoor coil sensor fault. Learn causes, DIY checks, professional repair costs. Expert Godrej AC repair in Vadodara. Call +91 97272 57141.",
  keywords: [
    "godrej ac error e2",
  ...
  alternates: { canonical: "https://atlasaircons.com/fault-codes/godrej-ac-error-e2" },
  openGraph: {
    title: "Godrej AC Error E2 — Outdoor Coil Sensor Fault | Atlas Aircon",
    description: "Diagnostic protocol & repair guide for Godrej AC Error E2. Suspects: Coil Sensor or Wiring Harness.",
    url: "https://atlasaircons.com/fault-codes/godrej-ac-error-e2",
    type: "article",
  },
};
...
const jsonLd = {
  ...
  mainEntityOfPage: "https://atlasaircons.com/fault-codes/godrej-ac-error-e2",
};
      ...
      <section className="py-16 bg-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href={`https://wa.me/919727257141?text=${encodeURIComponent("HELP: My Godrej AC is showing error E2. I need support.")}`} className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-400 text-white px-8 py-4 rounded-full font-bold text-lg transition">
