...
export const metadata: Metadata = {
  title: "Blue Star AC Error EC | Refrigerant Leak Detected | Diagnostic Guide | Atlas Aircon",
  description: "Blue Star AC Error EC indicates refrigerant leak detected. Learn causes, DIY checks, professional repair costs. Expert Blue Star AC repair in Vadodara. Call +91 97272 57141.",
  keywords: [
    "blue star ac error ec",
    "blue star ac error code ec",
    "blue star ac ec fault",
    "blue star ac refrigerant leak detected",
    "blue star ac troubleshooting",
    "ac error ec meaning",
    "blue star ac repair vadodara",
    "ac error code fix",
  ],
  alternates: { canonical: "https://atlasaircons.com/fault-codes/blue-star-ac-error-code-ec" },
  openGraph: {
    title: "Blue Star AC Error EC — Refrigerant Leak Detected | Atlas Aircon",
    description: "Diagnostic protocol & repair guide for Blue Star AC Error EC. Suspects: Pipe Joints or Coil Micro-Leak.",
    url: "https://atlasaircons.com/fault-codes/blue-star-ac-error-code-ec",
    type: "article",
  },
};
...
const jsonLd = {
  ...
  "@type": "TechArticle",
  headline: "Blue Star AC Error EC — Refrigerant Leak Detected",
  description: "Complete diagnostic protocol and repair guide for Blue Star AC Error Code EC.",
  author: { "@type": "Organization", name: "Atlas Aircon" },
  publisher: { "@type": "Organization", name: "Atlas Aircon", url: "https://atlasaircons.com" },
  mainEntityOfPage: "https://atlasaircons.com/fault-codes/blue-star-ac-error-code-ec",
};

export default function BlueStarErrorECPage() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              <span className="text-red-400">Blue Star AC Error EC</span>
            </h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-6">Understanding Blue Star Error EC</h2>
            ...
            <p className="text-gray-600 mb-4">
              Our certified technicians follow a systematic approach to diagnose and resolve the EC error efficiently. We carry diagnostic tools and common Blue Star spare parts in our service vehicles, enabling single-visit repairs in most cases.
            </p>
            ...
            <p className="text-gray-600 mb-4">
              While the basic checks above can help you identify obvious issues, Blue Star AC systems use sophisticated electronics that require professional diagnostic equipment. If the DIY steps don&apos;t resolve the EC code, attempting further repairs without proper tools can cause additional damage — turning a ₹500 sensor replacement into a ₹8,000+ PCB replacement.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center max-w-4xl mx-auto">
            <Link href="/ac-error-codes" className="text-blue-600 hover:text-blue-800 font-medium transition flex items-center gap-2">
              <ArrowLeft className="w-5 h-5" /> View All Blue Star Error Codes
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Are you an authorized service center for BLUE STAR?", a: "Atlas Aircon provides multi-brand AC service. While not an authorized center, our technicians are trained on BLUE STAR and use genuine parts." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Are you an authorized service center for BLUE STAR?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides multi-brand AC service. While not an authorized center, our technicians are trained on BLUE STAR and use genuine parts." } },
...
{/* CTA */}
      <section className="py-16 bg-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl font-bold mb-4">Can&apos;t Fix Blue Star Error EC?</h2>
          <p className="text-red-100 mb-8 max-w-2xl mx-auto">
            Don&apos;t risk further damage. Our expert technicians have resolved this exact error across hundreds of Blue Star units. We can dispatch to your location immediately.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href={`https://wa.me/919727257141?text=${encodeURIComponent("HELP: My Blue Star AC is showing error EC. I need support.")}`} className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-400 text-white px-8 py-4 rounded-full font-bold text-lg transition">
