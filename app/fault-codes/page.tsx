...
export const metadata: Metadata = {
  title: "Fault Codes Archive &raquo; Hitech Aircool Engineers | Hitech Aircool Engineers Gujarat",
  description: "Fault Codes Archive &raquo; Hitech Aircool Engineers - AC Repair in Vadodara",
  alternates: { canonical: "https://hitechairconditioning.in/fault-codes" },
  openGraph: {
    title: "Fault Codes Archive &raquo; Hitech Aircool Engineers | Hitech Aircool Engineers",
    description: "Fault Codes Archive &raquo; Hitech Aircool Engineers - AC Repair in Vadodara",
    url: "https://hitechairconditioning.in/fault-codes",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Fault Codes Archive &raquo; Hitech Aircool Engineers",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagefaultcodes() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Fault Codes Archive &amp;raquo; Hitech Aircool Engineers</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Fault Codes Archive &amp;raquo; Hitech Aircool Engineers - AC Repair in Vadodara</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Fault Codes Archive &amp;raquo; Hitech Aircool Engineers - AC Repair in Vadodara</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What fault codess does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides fault codes, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book fault codes?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency fault codes available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What fault codess does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides fault codes, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book fault codes?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency fault codes available. Call +91 93289 53665 for immediate assistance." } },
