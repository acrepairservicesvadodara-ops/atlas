...
export const metadata: Metadata = {
  title: "Blue Star AC Error EE | Indoor Temperature Sensor Failure | Diagnostic Guide | Hitech Aircool Engineers",
  description: "Blue Star AC Error EE indicates indoor temperature sensor failure. Learn causes, DIY checks, professional repair costs. Expert Blue Star AC repair in Vadodara. Call +91 93289 53665.",
  keywords: [
  ...
  alternates: { canonical: "https://hitechairconditioning.in/fault-codes/blue-star-ac-error-code-ee" },
  openGraph: {
    title: "Blue Star AC Error EE — Indoor Temperature Sensor Failure | Hitech Aircool Engineers",
    description: "Diagnostic protocol & repair guide for Blue Star AC Error EE. Suspects: Thermistor or PCB Circuit.",
    url: "https://hitechairconditioning.in/fault-codes/blue-star-ac-error-code-ee",
    type: "article",
  },
};
...
const jsonLd = {
  ...
  mainEntityOfPage: "https://hitechairconditioning.in/fault-codes/blue-star-ac-error-code-ee",
};
      ...
      <section className="py-16 bg-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href={`https://wa.me/919328953665?text=${encodeURIComponent("HELP: My Blue Star AC is showing error EE. I need support.")}`} className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-400 text-white px-8 py-4 rounded-full font-bold text-lg transition">
