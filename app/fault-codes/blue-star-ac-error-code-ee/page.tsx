...
export const metadata: Metadata = {
  title: "Blue Star AC Error EE | Indoor Temperature Sensor Failure | Diagnostic Guide | Atlas Aircon",
  description: "Blue Star AC Error EE indicates indoor temperature sensor failure. Learn causes, DIY checks, professional repair costs. Expert Blue Star AC repair in Vadodara. Call +91 97272 57141.",
  keywords: [
    "blue star ac error ee",
    "blue star ac error code ee",
    "blue star ac ee fault",
  ...
  alternates: { canonical: "https://atlasaircons.com/fault-codes/blue-star-ac-error-code-ee" },
  openGraph: {
    title: "Blue Star AC Error EE — Indoor Temperature Sensor Failure | Atlas Aircon",
    description: "Diagnostic protocol & repair guide for Blue Star AC Error EE. Suspects: Thermistor or PCB Circuit.",
    url: "https://atlasaircons.com/fault-codes/blue-star-ac-error-code-ee",
    type: "article",
  },
};
...
const jsonLd = {
  ...
  "@type": "TechArticle",
  headline: "Blue Star AC Error EE — Indoor Temperature Sensor Failure",
  description: "Complete diagnostic protocol and repair guide for Blue Star AC Error Code EE.",
  author: { "@type": "Organization", name: "Atlas Aircon" },
  publisher: { "@type": "Organization", name: "Atlas Aircon", url: "https://atlasaircons.com" },
  mainEntityOfPage: "https://atlasaircons.com/fault-codes/blue-star-ac-error-code-ee",
};

export default function BlueStarErrorEEPage() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              <span className="text-red-400">Blue Star AC Error EE</span>
            </h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-6">Understanding Blue Star Error EE</h2>
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-8">
              ...
              <p className="text-gray-700 mt-3">
                <strong>Impact:</strong> If left unaddressed, this error can lead to compressor damage, increased energy consumption, and complete system shutdown. It is critical to resolve EE promptly to avoid costly repairs.
              </p>
            </div>
            ...
            <p className="text-gray-600 mb-4">
              Our certified technicians follow a systematic approach to diagnose and resolve the EE error efficiently. We carry diagnostic tools and common Blue Star spare parts in our service vehicles, enabling single-visit repairs in most cases.
            </p>
...
{/* CTA */}
      <section className="py-16 bg-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl font-bold mb-4">Can&apos;t Fix Blue Star Error EE?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href={`https://wa.me/919727257141?text=${encodeURIComponent("HELP: My Blue Star AC is showing error EE. I need support.")}`} className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-400 text-white px-8 py-4 rounded-full font-bold text-lg transition">
