...
export const metadata: Metadata = {
  title: "✅ 500+ AC Service Center Gujarat | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-center-gujarat" },
  openGraph: {
    title: "✅ 500+ AC Service Center Gujarat | Atlas Aircon",
    description: "Need AC service? Find 50+ reliable service centers across Gujarat for all brands. Quick repairs, honest pricing & free estimates. Connect with local experts tod",
    url: "https://atlasaircons.com/ac-service-center-gujarat",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Need AC service? Find 50+ reliable service centers across Gujarat for all brands. Quick repairs, honest pricing &amp; free estimates. Connect with local experts today!</p>
