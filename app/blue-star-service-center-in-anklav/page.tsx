...
export const metadata: Metadata = {
  title: "Blue Star Service Center In Anklav &raquo; Emergency Ac Repair #1 [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/blue-star-service-center-in-anklav" },
  openGraph: {
    title: "Blue Star Service Center In Anklav &raquo; Emergency Ac Repair #1 [2026 Updated] | Atlas Aircon",
    description: "Blue Star Service Center in Anklav: When it comes to Blue Star appliance repairs in Anklav, look no further than our service center. We specialize in diagnosing",
    url: "https://atlasaircons.com/blue-star-service-center-in-anklav",
    type: "website",
