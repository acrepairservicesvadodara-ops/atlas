...
export const metadata: Metadata = {
  title: "24/7 Emergency Expert Refrigerated Truck Repair Vadodara | Hitech Aircool Engineers Gujarat",
  description: "Urgent refrigerated truck repair Vadodara? Our certified technicians provide fast, reliable on-site service & genuine Carrier, Thermo King spares. Call for a sa",
  alternates: { canonical: "https://hitechairconditioning.in/refrigerated-truck-repair-vadodara" },
  openGraph: {
    title: "24/7 Emergency Expert Refrigerated Truck Repair Vadodara | Hitech Aircool Engineers",
    description: "Urgent refrigerated truck repair Vadodara? Our certified technicians provide fast, reliable on-site service & genuine Carrier, Thermo King spares. Call for a sa",
    url: "https://hitechairconditioning.in/refrigerated-truck-repair-vadodara",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "24/7 Emergency Expert Refrigerated Truck Repair Vadodara",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagerefrigeratedtruckrepairvadodara() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">24/7 Emergency Expert Refrigerated Truck Repair Vadodara</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Urgent refrigerated truck repair Vadodara? Our certified technicians provide fast, reliable on-site service &amp; genuine Carrier, Thermo King spares. Call for a same-day quote!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Urgent refrigerated truck repair Vadodara? Our certified technicians provide fast, reliable on-site service &amp; genuine Carrier, Thermo King spares. Call for a same-day quote!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/refrigerated-truck-repair-service.webp" alt="24/7 Emergency Expert Refrigerated Truck Repair Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="24/7 Emergency Expert Refrigerated Truck Repair Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Refrigerated Truck Repair Vadodara in Vadodara?", a: "Refrigerated Truck Repair Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Refrigerated Truck Repair Vadodara?", a: "Hitech Aircool Engineers offers same-day Refrigerated Truck Repair Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Refrigerated Truck Repair Vadodaras?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Refrigerated Truck Repair Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Refrigerated Truck Repair Vadodara available on holidays?", a: "Yes, Hitech Aircool Engineers provides Refrigerated Truck Repair Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Refrigerated Truck Repair Vadodara take?", a: "Most Refrigerated Truck Repair Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Refrigerated Truck Repair Vadodara in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Refrigerated Truck Repair Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Refrigerated Truck Repair Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Refrigerated Truck Repair Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Refrigerated Truck Repair Vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Refrigerated Truck Repair Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Refrigerated Truck Repair Vadodara available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Refrigerated Truck Repair Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Refrigerated Truck Repair Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Most Refrigerated Truck Repair Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
