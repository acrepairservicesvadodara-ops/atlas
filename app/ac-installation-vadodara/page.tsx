...
export const metadata: Metadata = {
  title: "AC Installation In Vadodara | Atlas Aircon Gujarat",
  description: "Stop waiting 48 hours for an untrained technician. Get expert AC Installation in Vadodara from Atlas Aircon. We use vacuum pumps, microns, and heavy gauge coppe",
  alternates: { canonical: "https://atlasaircons.com/ac-installation-vadodara" },
  openGraph: {
    title: "AC Installation In Vadodara | Atlas Aircon",
    description: "Stop waiting 48 hours for an untrained technician. Get expert AC Installation in Vadodara from Atlas Aircon. We use vacuum pumps, microns, and heavy gauge coppe",
    url: "https://atlasaircons.com/ac-installation-vadodara",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Stop waiting 48 hours for an untrained technician. Get expert AC Installation in Vadodara from Atlas Aircon. We use vacuum pumps, microns, and heavy gauge copper. 20+ Years Experience. Call Now.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Stop waiting 48 hours for an untrained technician. Get expert AC Installation in Vadodara from Atlas Aircon. We use vacuum pumps, microns, and heavy gauge copper. 20+ Years Experience. Call Now.</p>
          </div>
        </div>
      </section>
