...
export const metadata: Metadata = {
  title: "AC Installation In Vadodara | Hitech Aircool Engineers Gujarat",
  description: "Stop waiting 48 hours for an untrained technician. Get expert AC Installation in Vadodara from Hitech Aircool Engineers. We use vacuum pumps, microns, and heavy gauge coppe",
  alternates: { canonical: "https://hitechairconditioning.in/ac-installation-vadodara" },
  openGraph: {
    title: "AC Installation In Vadodara | Hitech Aircool Engineers",
    description: "Stop waiting 48 hours for an untrained technician. Get expert AC Installation in Vadodara from Hitech Aircool Engineers. We use vacuum pumps, microns, and heavy gauge coppe",
    url: "https://hitechairconditioning.in/ac-installation-vadodara",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "AC Installation In Vadodara",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageacinstallationvadodara() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">AC Installation In Vadodara</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Stop waiting 48 hours for an untrained technician. Get expert AC Installation in Vadodara from Hitech Aircool Engineers. We use vacuum pumps, microns, and heavy gauge copper. 20+ Years Experience. Call Now.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Stop waiting 48 hours for an untrained technician. Get expert AC Installation in Vadodara from Hitech Aircool Engineers. We use vacuum pumps, microns, and heavy gauge copper. 20+ Years Experience. Call Now.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/24X7-ac-repairing.webp" alt="AC Installation In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="AC Installation In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
