...
export const metadata: Metadata = {
  title: "5 Essential AC Air Filters | Hitech Aircool Engineers Gujarat",
  description: "Professional 5 essential ac air filters by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/ac-air-filters-sales-service" },
  openGraph: {
    title: "5 Essential AC Air Filters | Hitech Aircool Engineers",
    description: "Professional 5 essential ac air filters by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/ac-air-filters-sales-service",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "5 Essential AC Air Filters",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageacairfilterssalesservice() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">5 Essential AC Air Filters</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">&#123; &quot;@context&quot;: &quot;https://schema.org&quot;, &quot;@type&quot;: &quot;BlogPosting&quot;, &quot;mainEntityOfPage&quot;: &#123; &quot;@type&quot;: &quot;W...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">&#123; &quot;@context&quot;: &quot;https://schema.org&quot;, &quot;@type&quot;: &quot;BlogPosting&quot;, &quot;mainEntityOfPage&quot;: &#123; &quot;@type&quot;: &quot;W...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Air-Conditioner-Air-Filter.webp" alt="5 Essential AC Air Filters" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="5 Essential AC Air Filters" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="5 Essential AC Air Filters" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Air-Conditioner-Air-Filter.webp" alt="5 Essential AC Air Filters" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Air-Conditioner-Air-Filter.webp" alt="5 Essential AC Air Filters" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Air-Conditioner-Air-Filter.webp" alt="5 Essential AC Air Filters" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Ac Air Filters Sales Service include?", a: "Ac Air Filters Sales Service includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Ac Air Filters Sales Service cost?", a: "Ac Air Filters Sales Service starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Ac Air Filters Sales Service improve cooling?", a: "Yes, proper Ac Air Filters Sales Service can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Ac Air Filters Sales Service reduce electricity bills?", a: "Regular Ac Air Filters Sales Service can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Ac Air Filters Sales Service take?", a: "Basic Ac Air Filters Sales Service takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Ac Air Filters Sales Service remove bad smell?", a: "Yes, Ac Air Filters Sales Service includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Ac Air Filters Sales Service?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Ac Air Filters Sales Service include?", acceptedAnswer: { "@type": "Answer", text: "Ac Air Filters Sales Service includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Ac Air Filters Sales Service cost?", acceptedAnswer: { "@type": "Answer", text: "Ac Air Filters Sales Service starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Ac Air Filters Sales Service improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Ac Air Filters Sales Service can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Ac Air Filters Sales Service reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Ac Air Filters Sales Service can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Ac Air Filters Sales Service take?", acceptedAnswer: { "@type": "Answer", text: "Basic Ac Air Filters Sales Service takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Ac Air Filters Sales Service remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Ac Air Filters Sales Service includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Ac Air Filters Sales Service?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
