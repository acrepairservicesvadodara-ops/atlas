...
export const metadata: Metadata = {
  title: "AC Not Cooling? 5 Common Reasons &raquo; Call Atlas On 9727257141 [2026 Updated] | Atlas Aircon Gujarat",
  description: "The Vadodara Heatwave Despair: When Your AC Not Cooling and Stops Being Your Best Friend</h...",
  alternates: { canonical: "https://atlasaircons.com/ac-not-cooling" },
  openGraph: {
    title: "AC Not Cooling? 5 Common Reasons &raquo; Call Atlas On 9727257141 [2026 Updated] | Atlas Aircon",
    description: "The Vadodara Heatwave Despair: When Your AC Not Cooling and Stops Being Your Best Friend</h...",
    url: "https://atlasaircons.com/ac-not-cooling",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "AC Not Cooling? 5 Common Reasons &raquo; Call Atlas On 9727257141 [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">AC Not Cooling? 5 Common Reasons &amp;raquo; Call Atlas On 9727257141 [2026 Updated]</h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">The Vadodara Heatwave Despair: When Your AC Not Cooling and Stops Being Your Best Friend&lt;/h...</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/exhausted-man-and-woman-sitting-on-sofa-and-suffer-2024-11-19-09-36-50-utc.webp" alt="AC Not Cooling? 5 Common Reasons &raquo; Call Atlas On 9727257141 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/exhausted-man-and-woman-sitting-on-sofa-and-suffer-2024-11-19-09-36-50-utc-scaled.webp" alt="AC Not Cooling? 5 Common Reasons &raquo; Call Atlas On 9727257141 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="AC Not Cooling? 5 Common Reasons &raquo; Call Atlas On 9727257141 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="AC Not Cooling? 5 Common Reasons &raquo; Call Atlas On 9727257141 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Atlas-Aircon-Ac-Service-in-vadodara-2.webp" alt="AC Not Cooling? 5 Common Reasons &raquo; Call Atlas On 9727257141 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Atlas-Aircon-Ac-Service-in-vadodara-2.webp" alt="AC Not Cooling? 5 Common Reasons &raquo; Call Atlas On 9727257141 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What ac not coolings does Atlas Aircon provide?", a: "Atlas Aircon provides ac not cooling, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book ac not cooling?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency ac not cooling available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What ac not coolings does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides ac not cooling, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book ac not cooling?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency ac not cooling available. Call +91 97272 57141 for immediate assistance." } },
