...
export const metadata: Metadata = {
  title: "Sangama Vadodara AC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC service Sangama in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Sangama Vadodara AC Vadodara",
    "sangama vadodara ac",
    "Sangama Vadodara AC installation",
    "Sangama Vadodara AC service",
    "Sangama Vadodara AC repair",
    "best Sangama Vadodara AC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/sangama-vadodara-ac-vadodara",
  },
};

const keywordData = {
  title: "Sangama Vadodara AC",
  slug: "sangama-vadodara-ac",
  description: "AC service Sangama",
  category: "Area"
};
...
export default function SangamaVadodaraACPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What sangama vadodara ac vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides sangama vadodara ac vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book sangama vadodara ac vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency sangama vadodara ac vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What sangama vadodara ac vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides sangama vadodara ac vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book sangama vadodara ac vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency sangama vadodara ac vadodara available. Call +91 93289 53665 for immediate assistance." } },
