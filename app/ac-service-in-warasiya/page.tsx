...
export const metadata: Metadata = {
  title: "AC Service In Warasiya | Professional HVAC Service | Atlas Aircon",
  description: "AC Service In Warasiya — Professional service service by Atlas Aircon. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 97272 57141.",
  keywords: ["ac service in warasiya", "service service", "hvac service vadodara", "atlas aircon", "ac service gujarat"],
  alternates: { canonical: "https://atlasaircons.com/ac-service-in-warasiya" },
  openGraph: { title: "AC Service In Warasiya | Atlas Aircon", description: "Professional service service by Atlas Aircon Gujarat.", url: "https://atlasaircons.com/ac-service-in-warasiya", type: "website" },
};
  ...
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the best AC repair service in Warasiya?", a: "Atlas Aircon is rated 4.9★ for AC repair in Warasiya. Our certified technicians provide same-day service with 90-day warranty. Call +91 97272 57141." },
              ...
              { q: "Do you have technicians in Warasiya?", a: "Yes, Atlas Aircon has servicemen positioned across Vadodara. This ensures faster response times for AC repair and service calls." },
              { q: "Is emergency AC service available in Warasiya?", a: "Yes, 24/7 emergency AC repair is available. Call +91 97272 57141 for immediate assistance with AC breakdown or cooling failures." },
              ...
              { q: "Is service available on weekends in Warasiya?", a: "Yes, AC service available 7 days a week including Saturdays and Sundays. Book online or call +91 97272 57141." }
            ].map((faq, i) => (
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the best AC repair service in Warasiya?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon is rated 4.9★ for AC repair in Warasiya. Our certified technicians provide same-day service with 90-day warranty. Call +91 97272 57141." } },
          ...
          { "@type": "Question", name: "Do you have technicians in Warasiya?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon has servicemen positioned across Vadodara. This ensures faster response times for AC repair and service calls." } },
          { "@type": "Question", name: "Is emergency AC service available in Warasiya?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency AC repair is available. Call +91 97272 57141 for immediate assistance with AC breakdown or cooling failures." } },
          ...
          { "@type": "Question", name: "Is service available on weekends in Warasiya?", acceptedAnswer: { "@type": "Answer", text: "Yes, AC service available 7 days a week including Saturdays and Sundays. Book online or call +91 97272 57141." } }
        ]
      }) }} />
