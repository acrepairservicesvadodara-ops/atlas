...
export const metadata: Metadata = {
  title: "Voltas AC Service Center Rajkot | Professional HVAC Service | Atlas Aircon",
  description: "Voltas AC Service Center Rajkot — Professional service service by Atlas Aircon. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 97272 57141.",
  keywords: ["voltas ac service center rajkot", "service service", "hvac service vadodara", "atlas aircon", "ac service gujarat"],
  alternates: { canonical: "https://atlasaircons.com/voltas-ac-service-center-rajkot" },
  openGraph: { title: "Voltas AC Service Center Rajkot | Atlas Aircon", description: "Professional service service by Atlas Aircon Gujarat.", url: "https://atlasaircons.com/voltas-ac-service-center-rajkot", type: "website" },
};
