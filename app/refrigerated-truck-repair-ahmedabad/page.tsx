...
export const metadata: Metadata = {
  title: "24/7 Reliable Expert Refrigerated Truck Repair Ahmedabad | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/refrigerated-truck-repair-ahmedabad" },
  openGraph: {
    title: "24/7 Reliable Expert Refrigerated Truck Repair Ahmedabad | Atlas Aircon",
    description: "Need refrigerated truck repair ahmedabad near you? Our Ahmedabad service center offers fast, expert repairs, genuine spare parts, & 24/7 emergency support. Call",
    url: "https://atlasaircons.com/refrigerated-truck-repair-ahmedabad",
    type: "website",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Need refrigerated truck repair ahmedabad near you? Our Ahmedabad service center offers fast, expert repairs, genuine spare parts, &amp; 24/7 emergency support. Call now!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Refrigerated Truck Repair Ahmedabad in Vadodara?", a: "Refrigerated Truck Repair Ahmedabad cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Refrigerated Truck Repair Ahmedabad?", a: "Atlas Aircon offers same-day Refrigerated Truck Repair Ahmedabad across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Refrigerated Truck Repair Ahmedabads?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Refrigerated Truck Repair Ahmedabads depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Refrigerated Truck Repair Ahmedabad available on holidays?", a: "Yes, Atlas Aircon provides Refrigerated Truck Repair Ahmedabad 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Refrigerated Truck Repair Ahmedabad?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Refrigerated Truck Repair Ahmedabad across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Refrigerated Truck Repair Ahmedabads?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Refrigerated Truck Repair Ahmedabads depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Refrigerated Truck Repair Ahmedabad available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Refrigerated Truck Repair Ahmedabad 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
