...
export const metadata: Metadata = {
  title: "7 Step To Finding Cost-Effective AC Repair Services Near You [2026 Updated] | Atlas Aircon Gujarat",
  description: "Cost-Effective AC Repair Services for Your Home Atlas Aircon provides cost effective AC repair services for your home. Our te...",
  alternates: { canonical: "https://atlasaircons.com/ac-repair-services-for-your-home" },
  openGraph: {
    title: "7 Step To Finding Cost-Effective AC Repair Services Near You [2026 Updated] | Atlas Aircon",
    description: "Cost-Effective AC Repair Services for Your Home Atlas Aircon provides cost effective AC repair services for your home. Our te...",
    url: "https://atlasaircons.com/ac-repair-services-for-your-home",
    type: "website",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Cost-Effective AC Repair Services for Your Home Atlas Aircon provides cost effective AC repair services for your home. Our te...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Cost-Effective AC Repair Services for Your Home Atlas Aircon provides cost effective AC repair services for your home. Our te...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Ac Repair Services For Your Home in Vadodara?", a: "Ac Repair Services For Your Home cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Ac Repair Services For Your Home?", a: "Atlas Aircon offers same-day Ac Repair Services For Your Home across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Ac Repair Services For Your Homes?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Ac Repair Services For Your Homes depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Ac Repair Services For Your Home available on holidays?", a: "Yes, Atlas Aircon provides Ac Repair Services For Your Home 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Ac Repair Services For Your Home?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Ac Repair Services For Your Home across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Ac Repair Services For Your Homes?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Ac Repair Services For Your Homes depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Ac Repair Services For Your Home available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Ac Repair Services For Your Home 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
