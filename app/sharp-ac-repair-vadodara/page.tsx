...
export const metadata: Metadata = {
  title: "Sharp AC Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Sharp AC repair service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Sharp AC Repair Vadodara",
    "sharp ac repair",
    "Sharp AC Repair installation",
    "Sharp AC Repair service",
    "Sharp AC Repair repair",
    "best Sharp AC Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/sharp-ac-repair-vadodara",
  },
};

const keywordData = {
  title: "Sharp AC Repair",
  slug: "sharp-ac-repair",
  description: "Sharp AC repair service",
  category: "Brands"
};
...
export default function SharpACRepairPage() {
  return (
    <>
      {/* Hero Section */}
