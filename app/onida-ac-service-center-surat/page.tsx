...
export const metadata: Metadata = {
  title: "Onida AC Service Center Surat | Professional HVAC Service | Atlas Aircon",
  description: "Onida AC Service Center Surat — Professional service service by Atlas Aircon. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 97272 57141.",
  keywords: ["onida ac service center surat", "service service", "hvac service vadodara", "atlas aircon", "ac service gujarat"],
  alternates: { canonical: "https://atlasaircons.com/onida-ac-service-center-surat" },
  openGraph: { title: "Onida AC Service Center Surat | Atlas Aircon", description: "Professional service service by Atlas Aircon Gujarat.", url: "https://atlasaircons.com/onida-ac-service-center-surat", type: "website" },
};
