...
export const metadata: Metadata = {
  title: "BMS HVAC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Building management HVAC in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "BMS HVAC Vadodara",
    "bms hvac",
    "BMS HVAC installation",
    "BMS HVAC service",
    "BMS HVAC repair",
    "best BMS HVAC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/bms-hvac-vadodara",
  },
};
...
const keywordData = {
  title: "BMS HVAC",
  slug: "bms-hvac",
  description: "Building management HVAC",
...
export default function BMSHVACPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVbms hvac vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial bms hvac vadodara?", a: "Industrial bms hvac vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVbms hvac vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial bms hvac vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial bms hvac vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
