...
export const metadata: Metadata = {
  title: "Blue Star AC Service Center Anand | Out-of-Warranty Repair Expert | Hitech Aircool Engineers",
  description: "Independent Blue Star AC service center in Anand. Expert out-of-warranty split AC repair, gas charging, PCB repair, deep cleaning & compressor overhaul. Same-day service. Call +91 93289 53665.",
  keywords: [
    "blue star ac service center anand",
    "blue star ac repair anand",
    "blue star ac service anand",
    "blue star split ac repair anand",
    "blue star ac gas charging anand",
    "blue star ac pcb repair anand",
    "blue star ac installation anand",
    "blue star ac not cooling anand",
    "ac service center anand",
    "best ac repair anand",
  ],
  alternates: { canonical: "https://hitechairconditioning.in/blue-star-ac-service-center-anand" },
  openGraph: {
    title: "Blue Star AC Service Center Anand | Hitech Aircool Engineers",
    description: "Independent out-of-warranty Blue Star AC repair specialist in Anand. Same-day service, 90-day guarantee.",
    url: "https://hitechairconditioning.in/blue-star-ac-service-center-anand",
    type: "website",
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Blue Star AC Service Center Anand",
  ...
  description: "Independent, out-of-warranty Blue Star AC repair, maintenance and installation in Anand, Gujarat.",
};
...
const faqJsonLd = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "Is Hitech Aircool Engineers an authorized Blue Star service center in Anand?", acceptedAnswer: { "@type": "Answer", text: "No. Hitech Aircool Engineers is an independent service provider specializing in high-quality out-of-warranty repairs. If your Blue Star AC is under official warranty, contact Blue Star directly." } },
    { "@type": "Question", name: "How quickly can you repair my Blue Star AC in Anand?", acceptedAnswer: { "@type": "Answer", text: "We offer same-day service across Anand. Our technicians typically arrive within 45-60 minutes of your call for emergency repairs." } },
    { "@type": "Question", name: "What is the cost of Blue Star AC gas refilling in Anand?", acceptedAnswer: { "@type": "Answer", text: "Gas refilling for Blue Star ACs starts at \u20B92,500 including leak detection. Final cost depends on the refrigerant type (R32/R410A) and quantity needed." } },
...
export default function BlueStarServiceCenterAnandPage() {
  return (
    <>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                <span className="text-yellow-400">Blue Star AC Service Center</span> Anand
              </h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">
                Expert independent repair solutions for Blue Star air conditioners in Anand. Specializing in out-of-warranty service with same-day dispatch and a full satisfaction guarantee.
              </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">Blue Star AC Repair Price List — Anand</h2>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Blue Star AC Service FAQs — Anand</h2>
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              ...
              { q: "How quickly can you repair my Blue Star AC in Anand?", a: "Same-day service is standard. Emergency calls are attended within 45-60 minutes across Anand." },
      ...
      <section className="py-16 bg-teal-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Need Blue Star AC Repair in Anand?</h2>
