...
export const metadata: Metadata = {
  title: "Blue Star AC Service Center Anand | Out-of-Warranty Repair Expert | Atlas Aircon",
  description: "Independent Blue Star AC service center in Anand. Expert out-of-warranty split AC repair, gas charging, PCB repair, deep cleaning & compressor overhaul. Same-day service. Call +91 97272 57141.",
  keywords: [
  ...
  alternates: { canonical: "https://atlasaircons.com/blue-star-ac-service-center-anand" },
  openGraph: {
    title: "Blue Star AC Service Center Anand | Atlas Aircon",
    description: "Independent out-of-warranty Blue Star AC repair specialist in Anand. Same-day service, 90-day guarantee.",
    url: "https://atlasaircons.com/blue-star-ac-service-center-anand",
    type: "website",
  },
};
...
const faqJsonLd = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "Is Atlas Aircon an authorized Blue Star service center in Anand?", acceptedAnswer: { "@type": "Answer", text: "No. Atlas Aircon is an independent service provider specializing in high-quality out-of-warranty repairs. If your Blue Star AC is under official warranty, contact Blue Star directly." } },
