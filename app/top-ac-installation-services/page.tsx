...
export const metadata: Metadata = {
  title: "Stay Cool In Vadodara: Top AC Installation Services Near You [2026 Updated] | Atlas Aircon Gujarat",
  description: "Vadodara, also known as Baroda, is one of the hottest cities in Gujarat, especially during the summer months. ...",
  alternates: { canonical: "https://atlasaircons.com/top-ac-installation-services" },
  openGraph: {
    title: "Stay Cool In Vadodara: Top AC Installation Services Near You [2026 Updated] | Atlas Aircon",
    description: "Vadodara, also known as Baroda, is one of the hottest cities in Gujarat, especially during the summer months. ...",
    url: "https://atlasaircons.com/top-ac-installation-services",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Vadodara, also known as Baroda, is one of the hottest cities in Gujarat, especially during the summer months. ...</p>
