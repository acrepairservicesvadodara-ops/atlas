...
export const metadata: Metadata = {
  title: "Stay Cool In Vadodara: Top AC Installation Services Near You [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Vadodara, also known as Baroda, is one of the hottest cities in Gujarat, especially during the summer months. ...",
  alternates: { canonical: "https://hitechairconditioning.in/top-ac-installation-services" },
  openGraph: {
    title: "Stay Cool In Vadodara: Top AC Installation Services Near You [2026 Updated] | Hitech Aircool Engineers",
    description: "Vadodara, also known as Baroda, is one of the hottest cities in Gujarat, especially during the summer months. ...",
    url: "https://hitechairconditioning.in/top-ac-installation-services",
    type: "website",
    images: ["/images/products/ac-installation-service.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Stay Cool In Vadodara: Top AC Installation Services Near You [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagetopacinstallationservices() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Stay Cool In Vadodara: Top AC Installation Services Near You [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Vadodara, also known as Baroda, is one of the hottest cities in Gujarat, especially during the summer months. ...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Vadodara, also known as Baroda, is one of the hottest cities in Gujarat, especially during the summer months. ...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/ac-installation-service.webp" alt="Stay Cool In Vadodara: Top AC Installation Services Near You [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Stay Cool In Vadodara: Top AC Installation Services Near You [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Stay Cool In Vadodara: Top AC Installation Services Near You [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/ac-installation-service.webp" alt="Stay Cool In Vadodara: Top AC Installation Services Near You [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/ac-installation-service.webp" alt="Stay Cool In Vadodara: Top AC Installation Services Near You [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/ac-installation-service.webp" alt="Stay Cool In Vadodara: Top AC Installation Services Near You [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
