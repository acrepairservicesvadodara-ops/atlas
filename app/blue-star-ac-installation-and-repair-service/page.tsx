...
export const metadata: Metadata = {
  title: "Blue Star AC Installation And Repair Service By Atlas Aircon [2026 Updated] | Atlas Aircon Gujarat",
  description: "Expert Blue Star AC Installation & Repair Services | Maximize Efficiency with Blue Star AC Services | Reliable Blue Star AC Installation...",
  alternates: { canonical: "https://atlasaircons.com/blue-star-ac-installation-and-repair-service" },
  openGraph: {
    title: "Blue Star AC Installation And Repair Service By Atlas Aircon [2026 Updated] | Atlas Aircon",
    description: "Expert Blue Star AC Installation & Repair Services | Maximize Efficiency with Blue Star AC Services | Reliable Blue Star AC Installation...",
    url: "https://atlasaircons.com/blue-star-ac-installation-and-repair-service",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Blue Star AC Installation And Repair Service By Atlas Aircon [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
...
export default function Pagebluestaracinstallationandrepairservice() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Blue Star AC Installation And Repair Service By Atlas Aircon [2026 Updated]</h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert Blue Star AC Installation &amp; Repair Services | Maximize Efficiency with Blue Star AC Services | Reliable Blue Star AC Installation...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Expert Blue Star AC Installation &amp; Repair Services | Maximize Efficiency with Blue Star AC Services | Reliable Blue Star AC Installation...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Most-Secure-Cloud-Solution-for-Companies-to-Store-Computer-Files.webp" alt="Blue Star AC Installation And Repair Service By Atlas Aircon [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Blue Star AC Installation And Repair Service By Atlas Aircon [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Blue Star AC Installation And Repair Service By Atlas Aircon [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Most-Secure-Cloud-Solution-for-Companies-to-Store-Computer-Files.webp" alt="Blue Star AC Installation And Repair Service By Atlas Aircon [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Most-Secure-Cloud-Solution-for-Companies-to-Store-Computer-Files.webp" alt="Blue Star AC Installation And Repair Service By Atlas Aircon [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Most-Secure-Cloud-Solution-for-Companies-to-Store-Computer-Files.webp" alt="Blue Star AC Installation And Repair Service By Atlas Aircon [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
