...
export const metadata: Metadata = {
  title: "Kelvinator AC Service Center Valsad | Professional HVAC Service | Atlas Aircon",
  description: "Kelvinator AC Service Center Valsad — Professional service service by Atlas Aircon. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 97272 57141.",
  keywords: ["kelvinator ac service center valsad", "service service", "hvac service vadodara", "atlas aircon", "ac service gujarat"],
  alternates: { canonical: "https://atlasaircons.com/kelvinator-ac-service-center-valsad" },
  openGraph: { title: "Kelvinator AC Service Center Valsad | Atlas Aircon", description: "Professional service service by Atlas Aircon Gujarat.", url: "https://atlasaircons.com/kelvinator-ac-service-center-valsad", type: "website" },
};
