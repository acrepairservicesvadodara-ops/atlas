...
export const metadata: Metadata = {
  title: "Industrial AC Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Industrial AC repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Industrial AC Service Vadodara",
    "industrial ac service",
    "Industrial AC Service installation",
    "Industrial AC Service service",
    "Industrial AC Service repair",
    "best Industrial AC Service service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/industrial-ac-service-vadodara",
  },
};

const keywordData = {
  title: "Industrial AC Service",
  slug: "industrial-ac-service",
  description: "Industrial AC repair",
  category: "Commercial"
};
...
export default function IndustrialACServicePage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVindustrial ac service vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial industrial ac service vadodara?", a: "Industrial industrial ac service vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVindustrial ac service vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial industrial ac service vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial industrial ac service vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
