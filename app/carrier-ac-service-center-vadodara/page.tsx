...
export const metadata: Metadata = {
  title: "Carrier AC Service Center Vadodara | Out-of-Warranty Repair Expert | Hitech Aircool Engineers",
  description: "Independent Carrier AC service center in Vadodara. Expert out-of-warranty split AC repair, gas charging, PCB repair, deep cleaning & compressor overhaul. Same-day service. Call +91 93289 53665.",
  keywords: [
    "carrier ac service center vadodara",
    "carrier ac repair vadodara",
    "carrier ac service vadodara",
    "carrier split ac repair vadodara",
    "carrier ac gas charging vadodara",
    "carrier ac pcb repair vadodara",
    "carrier ac installation vadodara",
    "carrier ac not cooling vadodara",
    "ac service center vadodara",
    "best ac repair vadodara",
  ],
  alternates: { canonical: "https://hitechairconditioning.in/carrier-ac-service-center-vadodara" },
  openGraph: {
    title: "Carrier AC Service Center Vadodara | Hitech Aircool Engineers",
    description: "Independent out-of-warranty Carrier AC repair specialist in Vadodara. Same-day service, 90-day guarantee.",
    url: "https://hitechairconditioning.in/carrier-ac-service-center-vadodara",
    type: "website",
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Carrier AC Service Center Vadodara",
  ...
  description: "Independent, out-of-warranty Carrier AC repair, maintenance and installation in Vadodara, Gujarat.",
};
...
const faqJsonLd = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "Is Hitech Aircool Engineers an authorized Carrier service center in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "No. Hitech Aircool Engineers is an independent service provider specializing in high-quality out-of-warranty repairs. If your Carrier AC is under official warranty, contact Carrier directly." } },
    { "@type": "Question", name: "How quickly can you repair my Carrier AC in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "We offer same-day service across Vadodara. Our technicians typically arrive within 45-60 minutes of your call for emergency repairs." } },
    { "@type": "Question", name: "What is the cost of Carrier AC gas refilling in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Gas refilling for Carrier ACs starts at \u20B92,500 including leak detection. Final cost depends on the refrigerant type (R32/R410A) and quantity needed." } },
...
export default function CarrierServiceCenterVadodaraPage() {
  return (
    <>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                <span className="text-yellow-400">Carrier AC Service Center</span> Vadodara
              </h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">
                Expert independent repair solutions for Carrier air conditioners in Vadodara. Specializing in out-of-warranty service with same-day dispatch and a full satisfaction guarantee.
              </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">Carrier AC Repair Price List — Vadodara</h2>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Carrier AC Service FAQs — Vadodara</h2>
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              ...
              { q: "How quickly can you repair my Carrier AC in Vadodara?", a: "Same-day service is standard. Emergency calls are attended within 45-60 minutes across Vadodara." },
      ...
      <section className="py-16 bg-teal-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Need Carrier AC Repair in Vadodara?</h2>
