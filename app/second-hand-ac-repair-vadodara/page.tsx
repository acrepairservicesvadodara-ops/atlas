...
export const metadata: Metadata = {
  title: "Second Hand AC Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Used AC repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Second Hand AC Repair Vadodara",
    "second hand ac repair",
    "Second Hand AC Repair installation",
    "Second Hand AC Repair service",
    "Second Hand AC Repair repair",
    "best Second Hand AC Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/second-hand-ac-repair-vadodara",
  },
};

const keywordData = {
  title: "Second Hand AC Repair",
  slug: "second-hand-ac-repair",
  description: "Used AC repair",
...
export default function SecondHandACRepairPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Second Hand Ac Repair Vadodara in Vadodara?", a: "Second Hand Ac Repair Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Second Hand Ac Repair Vadodara?", a: "Hitech Aircool Engineers offers same-day Second Hand Ac Repair Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Second Hand Ac Repair Vadodaras?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Second Hand Ac Repair Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Second Hand Ac Repair Vadodara available on holidays?", a: "Yes, Hitech Aircool Engineers provides Second Hand Ac Repair Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Second Hand Ac Repair Vadodara take?", a: "Most Second Hand Ac Repair Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Second Hand Ac Repair Vadodara in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Second Hand Ac Repair Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Second Hand Ac Repair Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Second Hand Ac Repair Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Second Hand Ac Repair Vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Second Hand Ac Repair Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Second Hand Ac Repair Vadodara available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Second Hand Ac Repair Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Second Hand Ac Repair Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Most Second Hand Ac Repair Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
