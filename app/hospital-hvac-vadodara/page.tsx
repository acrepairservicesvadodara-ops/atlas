...
export const metadata: Metadata = {
  title: "Hospital HVAC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Hospital HVAC service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Hospital HVAC Vadodara",
    "hospital hvac",
    "Hospital HVAC installation",
    "Hospital HVAC service",
    "Hospital HVAC repair",
    "best Hospital HVAC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/hospital-hvac-vadodara",
  },
};
...
const keywordData = {
  title: "Hospital HVAC",
  slug: "hospital-hvac",
  description: "Hospital HVAC service",
  category: "Commercial"
};
...
export default function HospitalHVACPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVhospital hvac vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial hospital hvac vadodara?", a: "Industrial hospital hvac vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVhospital hvac vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial hospital hvac vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial hospital hvac vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
