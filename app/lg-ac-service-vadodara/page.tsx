...
export const metadata: Metadata = {
  title: "LG AC Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "LG AC repair and service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "LG AC Service Vadodara",
    "lg ac service",
    "LG AC Service installation",
    "LG AC Service service",
    "LG AC Service repair",
    "best LG AC Service service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/lg-ac-service-vadodara",
  },
};
...
const keywordData = {
  title: "LG AC Service",
  slug: "lg-ac-service",
  description: "LG AC repair and service",
  category: "Brands"
};
...
export default function LGACServicePage() {
  return (
    <>
      {/* Hero Section */}
