...
export const metadata: Metadata = {
  title: "Hitachi AC Service Center Rajkot | Out-of-Warranty Repair Expert | Atlas Aircon",
  description: "Independent Hitachi AC service center in Rajkot. Expert out-of-warranty split AC repair, gas charging, PCB repair, deep cleaning & compressor overhaul. Same-day service. Call +91 97272 57141.",
  keywords: [
    "hitachi ac service center rajkot",
    "hitachi ac repair rajkot",
    "hitachi ac service rajkot",
    "hitachi split ac repair rajkot",
    "hitachi ac gas charging rajkot",
    "hitachi ac pcb repair rajkot",
    "hitachi ac installation rajkot",
    "hitachi ac not cooling rajkot",
    "ac service center rajkot",
    "best ac repair rajkot",
  ],
  alternates: { canonical: "https://atlasaircons.com/hitachi-ac-service-center-rajkot" },
  openGraph: {
    title: "Hitachi AC Service Center Rajkot | Atlas Aircon",
    description: "Independent out-of-warranty Hitachi AC repair specialist in Rajkot. Same-day service, 90-day guarantee.",
    url: "https://atlasaircons.com/hitachi-ac-service-center-rajkot",
    type: "website",
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Hitachi AC Service Center Rajkot",
  ...
  description: "Independent, out-of-warranty Hitachi AC repair, maintenance and installation in Rajkot, Gujarat.",
};
...
const faqJsonLd = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "Is Atlas Aircon an authorized Hitachi service center in Rajkot?", acceptedAnswer: { "@type": "Answer", text: "No. Atlas Aircon is an independent service provider specializing in high-quality out-of-warranty repairs. If your Hitachi AC is under official warranty, contact Hitachi directly." } },
    { "@type": "Question", name: "How quickly can you repair my Hitachi AC in Rajkot?", acceptedAnswer: { "@type": "Answer", text: "We offer same-day service across Rajkot. Our technicians typically arrive within 45-60 minutes of your call for emergency repairs." } },
    { "@type": "Question", name: "What is the cost of Hitachi AC gas refilling in Rajkot?", acceptedAnswer: { "@type": "Answer", text: "Gas refilling for Hitachi ACs starts at \u20B92,500 including leak detection. Final cost depends on the refrigerant type (R32/R410A) and quantity needed." } },
...
export default function HitachiServiceCenterRajkotPage() {
  return (
    <>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                <span className="text-yellow-400">Hitachi AC Service Center</span> Rajkot
              </h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                Expert independent repair solutions for Hitachi air conditioners in Rajkot. Specializing in out-of-warranty service with same-day dispatch and a full satisfaction guarantee.
              </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">Hitachi AC Repair Price List — Rajkot</h2>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Hitachi AC Service FAQs — Rajkot</h2>
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              ...
              { q: "How quickly can you repair my Hitachi AC in Rajkot?", a: "Same-day service is standard. Emergency calls are attended within 45-60 minutes across Rajkot." },
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Need Hitachi AC Repair in Rajkot?</h2>
