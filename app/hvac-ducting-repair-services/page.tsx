...
export const metadata: Metadata = {
  title: "HVAC Ducting Repair Services #1&raquo; Ducting Contractor Vadodara [2026 Updated] | Atlas Aircon Gujarat",
  description: "Enhancing Comfort and Efficiency: A Comprehensive Guide to HVAC Ducting Repair Services Introduction: In...",
  alternates: { canonical: "https://atlasaircons.com/hvac-ducting-repair-services" },
  openGraph: {
    title: "HVAC Ducting Repair Services #1&raquo; Ducting Contractor Vadodara [2026 Updated] | Atlas Aircon",
    description: "Enhancing Comfort and Efficiency: A Comprehensive Guide to HVAC Ducting Repair Services Introduction: In...",
    url: "https://atlasaircons.com/hvac-ducting-repair-services",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Enhancing Comfort and Efficiency: A Comprehensive Guide to HVAC Ducting Repair Services Introduction: In...</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVhvac ducting repair servicess?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVhvac ducting repair servicess?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
