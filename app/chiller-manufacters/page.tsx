...
export const metadata: Metadata = {
  title: "Chiller Manufacters In Vadodara &raquo; Atlas Aircon [2026 Updated] | Atlas Aircon Gujarat",
  description: "Chiller Manufacters In Vadodara &raquo; Atlas Aircon [2026 Updated] - Atlas Aircon Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/chiller-manufacters" },
  openGraph: {
    title: "Chiller Manufacters In Vadodara &raquo; Atlas Aircon [2026 Updated] | Atlas Aircon",
    description: "Chiller Manufacters In Vadodara &raquo; Atlas Aircon [2026 Updated] - Atlas Aircon Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/chiller-manufacters",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Chiller Manufacters In Vadodara &raquo; Atlas Aircon [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Chiller Manufacters In Vadodara &amp;raquo; Atlas Aircon [2026 Updated]</h1>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/chiller-repair-service.webp" alt="Chiller Manufacters In Vadodara &raquo; Atlas Aircon [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Chiller Manufacters In Vadodara &raquo; Atlas Aircon [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Chiller Manufacters In Vadodara &raquo; Atlas Aircon [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVchiller manufacterss?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVchiller manufacterss?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
