...
export const metadata: Metadata = {
  title: "Refrigeration Compressor Repair in Vadodara | Installation, Service & Repair | Atlas Aircon",
  description: "Fridge compressor repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 97272 57141",
  keywords: [
    "Refrigeration Compressor Repair Vadodara",
    "refrigeration compressor repair",
    "Refrigeration Compressor Repair installation",
    "Refrigeration Compressor Repair service",
    "Refrigeration Compressor Repair repair",
    "best Refrigeration Compressor Repair service",
  ],
  alternates: {
    canonical: "https://atlasaircons.com/refrigeration-compressor-repair-vadodara",
  },
};

const keywordData = {
  title: "Refrigeration Compressor Repair",
  slug: "refrigeration-compressor-repair",
...
export default function RefrigerationCompressorRepairPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Refrigeration Compressor Repair Vadodara in Vadodara?", a: "Refrigeration Compressor Repair Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Refrigeration Compressor Repair Vadodara?", a: "Atlas Aircon offers same-day Refrigeration Compressor Repair Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Refrigeration Compressor Repair Vadodaras?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Refrigeration Compressor Repair Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Refrigeration Compressor Repair Vadodara available on holidays?", a: "Yes, Atlas Aircon provides Refrigeration Compressor Repair Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
              { q: "How long does Refrigeration Compressor Repair Vadodara take?", a: "Most Refrigeration Compressor Repair Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Refrigeration Compressor Repair Vadodara in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Refrigeration Compressor Repair Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Refrigeration Compressor Repair Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Refrigeration Compressor Repair Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Refrigeration Compressor Repair Vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Refrigeration Compressor Repair Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Refrigeration Compressor Repair Vadodara available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Refrigeration Compressor Repair Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
          { "@type": "Question", name: "How long does Refrigeration Compressor Repair Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Most Refrigeration Compressor Repair Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
