...
export const metadata: Metadata = {
  title: "Reliable Split AC Service Rajpipla | Hitech Aircool Engineers Gujarat",
  description: "Expert split AC repair & service in Rajpipla. Fast gas refill, installation & maintenance. Affordable rates, genuine spare parts & local technicians. Call for f",
  alternates: { canonical: "https://hitechairconditioning.in/split-ac-service-rajpipla" },
  openGraph: {
    title: "Reliable Split AC Service Rajpipla | Hitech Aircool Engineers",
    description: "Expert split AC repair & service in Rajpipla. Fast gas refill, installation & maintenance. Affordable rates, genuine spare parts & local technicians. Call for f",
    url: "https://hitechairconditioning.in/split-ac-service-rajpipla",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Reliable Split AC Service Rajpipla",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagesplitacservicerajpipla() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Reliable Split AC Service Rajpipla</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Expert split AC repair &amp; service in Rajpipla. Fast gas refill, installation &amp; maintenance. Affordable rates, genuine spare parts &amp; local technicians. Call for free estimate!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Expert split AC repair &amp; service in Rajpipla. Fast gas refill, installation &amp; maintenance. Affordable rates, genuine spare parts &amp; local technicians. Call for free estimate!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/Split-Air-Conditioner.webp" alt="Reliable Split AC Service Rajpipla" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Reliable Split AC Service Rajpipla" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
