...
export const metadata: Metadata = {
  title: "Reliable Split AC Service Rajpipla | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/split-ac-service-rajpipla" },
  openGraph: {
    title: "Reliable Split AC Service Rajpipla | Atlas Aircon",
    description: "Expert split AC repair & service in Rajpipla. Fast gas refill, installation & maintenance. Affordable rates, genuine spare parts & local technicians. Call for f",
    url: "https://atlasaircons.com/split-ac-service-rajpipla",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert split AC repair &amp; service in Rajpipla. Fast gas refill, installation &amp; maintenance. Affordable rates, genuine spare parts &amp; local technicians. Call for free estimate!</p>
