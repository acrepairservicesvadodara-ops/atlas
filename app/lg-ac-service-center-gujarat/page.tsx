...
export const metadata: Metadata = {
  title: "LG AC Service Center Gujarat | Professional HVAC Service | Hitech Aircool Engineers",
  description: "LG AC Service Center Gujarat — Professional service service by Hitech Aircool Engineers. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 93289 53665.",
  keywords: ["lg ac service center gujarat", "service service", "hvac service vadodara", "hitech aircool engineers", "ac service gujarat"],
  alternates: { canonical: "https://hitechairconditioning.in/lg-ac-service-center-gujarat" },
  openGraph: { title: "LG AC Service Center Gujarat | Hitech Aircool Engineers", description: "Professional service service by Hitech Aircool Engineers Gujarat.", url: "https://hitechairconditioning.in/lg-ac-service-center-gujarat", type: "website" },
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "LG AC Service Center Gujarat",
  provider: { "@type": "LocalBusiness", name: "Hitech Aircool Engineers", telephone: "+919328953665" },
  areaServed: { "@type": "State", name: "Gujarat" },
  serviceType: "LG AC Service Center Gujarat",
};

export default function LGACServiceCenterGujaratPage() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">LG AC Service Center Gujarat</h1>
