...
export const metadata: Metadata = {
  title: "AC Installation Services Gujarat | Hitech Aircool Engineers Gujarat",
  description: "Professional AC installation services across Gujarat. Expert split, window & commercial AC installation in all cities. Free consultation & competitive state-wid",
  alternates: { canonical: "https://hitechairconditioning.in/ac-installation-gujarat" },
  openGraph: {
    title: "AC Installation Services Gujarat | Hitech Aircool Engineers",
    description: "Professional AC installation services across Gujarat. Expert split, window & commercial AC installation in all cities. Free consultation & competitive state-wid",
    url: "https://hitechairconditioning.in/ac-installation-gujarat",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "AC Installation Services Gujarat",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageacinstallationgujarat() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">AC Installation Services Gujarat</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Professional AC installation services across Gujarat. Expert split, window &amp; commercial AC installation in all cities. Free consultation &amp; competitive state-wide pricing.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Professional AC installation services across Gujarat. Expert split, window &amp; commercial AC installation in all cities. Free consultation &amp; competitive state-wide pricing.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Split-Ac-Installation-and-Repair-Service-1.webp" alt="AC Installation Services Gujarat" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="AC Installation Services Gujarat" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
