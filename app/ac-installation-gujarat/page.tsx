...
export const metadata: Metadata = {
  title: "AC Installation Services Gujarat | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-installation-gujarat" },
  openGraph: {
    title: "AC Installation Services Gujarat | Atlas Aircon",
    description: "Professional AC installation services across Gujarat. Expert split, window & commercial AC installation in all cities. Free consultation & competitive state-wid",
    url: "https://atlasaircons.com/ac-installation-gujarat",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Professional AC installation services across Gujarat. Expert split, window &amp; commercial AC installation in all cities. Free consultation &amp; competitive state-wide pricing.</p>
