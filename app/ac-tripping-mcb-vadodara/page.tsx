...
export const metadata: Metadata = {
  title: "AC Tripping MCB in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC electrical trip fix in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC Tripping MCB Vadodara",
    "ac tripping mcb",
    "AC Tripping MCB installation",
    "AC Tripping MCB service",
    "AC Tripping MCB repair",
    "best AC Tripping MCB service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-tripping-mcb-vadodara",
  },
};

const keywordData = {
  title: "AC Tripping MCB",
  slug: "ac-tripping-mcb",
  description: "AC electrical trip fix",
  category: "Problems"
};
...
export default function ACTrippingMCBPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What ac tripping mcb vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides ac tripping mcb vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book ac tripping mcb vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency ac tripping mcb vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What ac tripping mcb vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides ac tripping mcb vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book ac tripping mcb vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency ac tripping mcb vadodara available. Call +91 93289 53665 for immediate assistance." } },
