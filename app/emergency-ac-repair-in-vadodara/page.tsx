...
export const metadata: Metadata = {
  title: "2-Hour Emergency AC Repair In Vadodara | Hitech Aircool Engineers Gujarat",
  description: "The sound of summer in Vadodara isn't the chirping of birds or the distant traffic. It's the steadfast, reassu...",
  alternates: { canonical: "https://hitechairconditioning.in/emergency-ac-repair-in-vadodara" },
  openGraph: {
    title: "2-Hour Emergency AC Repair In Vadodara | Hitech Aircool Engineers",
    description: "The sound of summer in Vadodara isn't the chirping of birds or the distant traffic. It's the steadfast, reassu...",
    url: "https://hitechairconditioning.in/emergency-ac-repair-in-vadodara",
    type: "website",
    images: ["/images/products/Emergency-AC-Breakdown.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "2-Hour Emergency AC Repair In Vadodara",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageemergencyacrepairinvadodara() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">2-Hour Emergency AC Repair In Vadodara</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">The sound of summer in Vadodara isn&apos;t the chirping of birds or the distant traffic. It&apos;s the steadfast, reassu...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">The sound of summer in Vadodara isn&apos;t the chirping of birds or the distant traffic. It&apos;s the steadfast, reassu...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Emergency-AC-Breakdown.webp" alt="2-Hour Emergency AC Repair In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="2-Hour Emergency AC Repair In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="2-Hour Emergency AC Repair In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/ac-repair-service.webp" alt="2-Hour Emergency AC Repair In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/ac-repair-service.webp" alt="2-Hour Emergency AC Repair In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/ac-repair-service.webp" alt="2-Hour Emergency AC Repair In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Emergency Ac Repair In Vadodara in Vadodara?", a: "Emergency Ac Repair In Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Emergency Ac Repair In Vadodara?", a: "Hitech Aircool Engineers offers same-day Emergency Ac Repair In Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Emergency Ac Repair In Vadodaras?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Emergency Ac Repair In Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Emergency Ac Repair In Vadodara available on holidays?", a: "Yes, Hitech Aircool Engineers provides Emergency Ac Repair In Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Emergency Ac Repair In Vadodara take?", a: "Most Emergency Ac Repair In Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Emergency Ac Repair In Vadodara in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Emergency Ac Repair In Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Emergency Ac Repair In Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Emergency Ac Repair In Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Emergency Ac Repair In Vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Emergency Ac Repair In Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Emergency Ac Repair In Vadodara available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Emergency Ac Repair In Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Emergency Ac Repair In Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Most Emergency Ac Repair In Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
