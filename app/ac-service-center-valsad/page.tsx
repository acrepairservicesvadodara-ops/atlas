...
export const metadata: Metadata = {
  title: "✅ AC Service Center Valsad #1 | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-center-valsad" },
  openGraph: {
    title: "✅ AC Service Center Valsad #1 | Atlas Aircon",
    description: "Top-rated AC service center Valsad. Expert repairs, maintenance & gas charging for all brands. Same-day service available. Get honest pricing & guaranteed workm",
    url: "https://atlasaircons.com/ac-service-center-valsad",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Top-rated AC service center Valsad. Expert repairs, maintenance &amp; gas charging for all brands. Same-day service available. Get honest pricing &amp; guaranteed workmanship today!</p>
