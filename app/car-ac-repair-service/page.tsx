...
export const metadata: Metadata = {
  title: "Revive Your Ride: Expert Car AC Repair Services In Your Area [2026 Updated] | Hitech Aircool Engineers Gujarat",
  ...
  alternates: { canonical: "https://hitechairconditioning.in/car-ac-repair-service" },
  openGraph: {
    title: "Revive Your Ride: Expert Car AC Repair Services In Your Area [2026 Updated] | Hitech Aircool Engineers",
    description: "Expert and Affordable Car Ac Sales, Repair and Services in Vadodara | 20 Years Experienced in Car Ac Sales, Repair and Services <span data-pre...",
    url: "https://hitechairconditioning.in/car-ac-repair-service",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Expert and Affordable Car Ac Sales, Repair and Services in Vadodara | 20 Years Experienced in Car Ac Sales, Repair and Services &lt;span data-pre...</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Car Ac Repair Service in Vadodara?", a: "Car Ac Repair Service cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Car Ac Repair Service?", a: "Hitech Aircool Engineers offers same-day Car Ac Repair Service across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Car Ac Repair Services?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Car Ac Repair Services depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Car Ac Repair Service available on holidays?", a: "Yes, Hitech Aircool Engineers provides Car Ac Repair Service 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Car Ac Repair Service in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Car Ac Repair Service cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Car Ac Repair Service?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Car Ac Repair Service across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Car Ac Repair Services?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Car Ac Repair Services depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Car Ac Repair Service available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Car Ac Repair Service 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
