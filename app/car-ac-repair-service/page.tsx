...
export const metadata: Metadata = {
  title: "Revive Your Ride: Expert Car AC Repair Services In Your Area [2026 Updated] | Atlas Aircon Gujarat",
  description: "Expert and Affordable Car Ac Sales, Repair and Services in Vadodara | 20 Years Experienced in Car Ac Sales, Repair and Services <span data-pre...",
  alternates: { canonical: "https://atlasaircons.com/car-ac-repair-service" },
  openGraph: {
    title: "Revive Your Ride: Expert Car AC Repair Services In Your Area [2026 Updated] | Atlas Aircon",
    description: "Expert and Affordable Car Ac Sales, Repair and Services in Vadodara | 20 Years Experienced in Car Ac Sales, Repair and Services <span data-pre...",
    url: "https://atlasaircons.com/car-ac-repair-service",
    type: "website",
    images: ["/images/products/Car-Ac-Repair.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Revive Your Ride: Expert Car AC Repair Services In Your Area [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
...
export default function Pagecaracrepairservice() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Revive Your Ride: Expert Car AC Repair Services In Your Area [2026 Updated]</h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert and Affordable Car Ac Sales, Repair and Services in Vadodara | 20 Years Experienced in Car Ac Sales, Repair and Services &lt;span data-pre...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Expert and Affordable Car Ac Sales, Repair and Services in Vadodara | 20 Years Experienced in Car Ac Sales, Repair and Services &lt;span data-pre...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Car-Ac-Repair.webp" alt="Revive Your Ride: Expert Car AC Repair Services In Your Area [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Revive Your Ride: Expert Car AC Repair Services In Your Area [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Revive Your Ride: Expert Car AC Repair Services In Your Area [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Car-Ac-Service.webp" alt="Revive Your Ride: Expert Car AC Repair Services In Your Area [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Car-Ac-Service.webp" alt="Revive Your Ride: Expert Car AC Repair Services In Your Area [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Car-Ac-Service.webp" alt="Revive Your Ride: Expert Car AC Repair Services In Your Area [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Car Ac Repair Service in Vadodara?", a: "Car Ac Repair Service cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Car Ac Repair Service?", a: "Atlas Aircon offers same-day Car Ac Repair Service across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Car Ac Repair Services?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Car Ac Repair Services depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Car Ac Repair Service available on holidays?", a: "Yes, Atlas Aircon provides Car Ac Repair Service 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
              { q: "How long does Car Ac Repair Service take?", a: "Most Car Ac Repair Services are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Car Ac Repair Service in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Car Ac Repair Service cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Car Ac Repair Service?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Car Ac Repair Service across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Car Ac Repair Services?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Car Ac Repair Services depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Car Ac Repair Service available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Car Ac Repair Service 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
          { "@type": "Question", name: "How long does Car Ac Repair Service take?", acceptedAnswer: { "@type": "Answer", text: "Most Car Ac Repair Services are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
