...
export const metadata: Metadata = {
  title: "Shop &raquo; Atlas Aircon | Atlas Aircon Gujarat",
  description: "Products Archive &raquo; Atlas Aircon - AC Repair in Vadodara",
  alternates: { canonical: "https://atlasaircons.com/shop" },
  openGraph: {
    title: "Shop &raquo; Atlas Aircon | Atlas Aircon",
    description: "Products Archive &raquo; Atlas Aircon - AC Repair in Vadodara",
    url: "https://atlasaircons.com/shop",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Shop &amp;raquo; Atlas Aircon</h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Products Archive &amp;raquo; Atlas Aircon - AC Repair in Vadodara</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Products Archive &amp;raquo; Atlas Aircon - AC Repair in Vadodara</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Capilary-1-scaled-1.webp" alt="Shop &raquo; Atlas Aircon" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Capilary-scaled-1.webp" alt="Shop &raquo; Atlas Aircon" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Spare-1-scaled-1.webp" alt="Shop &raquo; Atlas Aircon" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Spare-2-scaled-1.webp" alt="Shop &raquo; Atlas Aircon" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Spare-3-scaled-1.webp" alt="Shop &raquo; Atlas Aircon" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Spare-scaled-1.webp" alt="Shop &raquo; Atlas Aircon" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
