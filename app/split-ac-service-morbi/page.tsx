...
export const metadata: Metadata = {
  title: "Fast Split AC Repair & Service In Morbi | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/split-ac-service-morbi" },
  openGraph: {
    title: "Fast Split AC Repair & Service In Morbi | Atlas Aircon",
    description: "Need reliable split AC service Morbi? Expert repair, installation & gas refill for ceramic & industrial units. Genuine spare parts & affordable AMC plans. Call ",
    url: "https://atlasaircons.com/split-ac-service-morbi",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Need reliable split AC service Morbi? Expert repair, installation &amp; gas refill for ceramic &amp; industrial units. Genuine spare parts &amp; affordable AMC plans. Call now!</p>
