...
export const metadata: Metadata = {
  title: "Fast Split AC Repair & Service In Morbi | Hitech Aircool Engineers Gujarat",
  description: "Need reliable split AC service Morbi? Expert repair, installation & gas refill for ceramic & industrial units. Genuine spare parts & affordable AMC plans. Call ",
  alternates: { canonical: "https://hitechairconditioning.in/split-ac-service-morbi" },
  openGraph: {
    title: "Fast Split AC Repair & Service In Morbi | Hitech Aircool Engineers",
    description: "Need reliable split AC service Morbi? Expert repair, installation & gas refill for ceramic & industrial units. Genuine spare parts & affordable AMC plans. Call ",
    url: "https://hitechairconditioning.in/split-ac-service-morbi",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Fast Split AC Repair & Service In Morbi",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagesplitacservicemorbi() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Fast Split AC Repair &amp; Service In Morbi</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Need reliable split AC service Morbi? Expert repair, installation &amp; gas refill for ceramic &amp; industrial units. Genuine spare parts &amp; affordable AMC plans. Call now!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Need reliable split AC service Morbi? Expert repair, installation &amp; gas refill for ceramic &amp; industrial units. Genuine spare parts &amp; affordable AMC plans. Call now!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/Split-Air-Conditioner.webp" alt="Fast Split AC Repair & Service In Morbi" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Fast Split AC Repair & Service In Morbi" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
