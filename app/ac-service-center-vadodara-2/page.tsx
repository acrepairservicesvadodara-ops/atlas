...
export const metadata: Metadata = {
  title: "AC Service Center Vadodara | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-center-vadodara-2" },
  openGraph: {
    title: "AC Service Center Vadodara | Atlas Aircon",
    description: "Your trusted AC service center in Vadodara. Our expert technicians offer reliable repair, maintenance & AMC plans for all brands. Honest pricing & fast service.",
    url: "https://atlasaircons.com/ac-service-center-vadodara-2",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Your trusted AC service center in Vadodara. Our expert technicians offer reliable repair, maintenance &amp; AMC plans for all brands. Honest pricing &amp; fast service.</p>
