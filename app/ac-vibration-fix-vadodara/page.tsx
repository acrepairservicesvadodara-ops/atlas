...
export const metadata: Metadata = {
  title: "AC Vibration Fix in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC vibration repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC Vibration Fix Vadodara",
    "ac vibration fix",
    "AC Vibration Fix installation",
    "AC Vibration Fix service",
    "AC Vibration Fix repair",
    "best AC Vibration Fix service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-vibration-fix-vadodara",
  },
};

const keywordData = {
  title: "AC Vibration Fix",
  slug: "ac-vibration-fix",
  description: "AC vibration repair",
  category: "Problems"
};
...
export default function ACVibrationFixPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Ac Vibration Fix Vadodara in Vadodara?", a: "Ac Vibration Fix Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Ac Vibration Fix Vadodara?", a: "Hitech Aircool Engineers offers same-day Ac Vibration Fix Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Ac Vibration Fix Vadodaras?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Ac Vibration Fix Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Ac Vibration Fix Vadodara available on holidays?", a: "Yes, Hitech Aircool Engineers provides Ac Vibration Fix Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Ac Vibration Fix Vadodara take?", a: "Most Ac Vibration Fix Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Ac Vibration Fix Vadodara in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Ac Vibration Fix Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Ac Vibration Fix Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Ac Vibration Fix Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Ac Vibration Fix Vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Ac Vibration Fix Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Ac Vibration Fix Vadodara available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Ac Vibration Fix Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Ac Vibration Fix Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Most Ac Vibration Fix Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
