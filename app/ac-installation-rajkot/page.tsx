...
export const metadata: Metadata = {
  title: "AC Installation Rajkot | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-installation-rajkot" },
  openGraph: {
    title: "AC Installation Rajkot | Atlas Aircon",
    description: "Professional AC installation services in Rajkot. Expert split & window AC fitting, bracket fixing & gas charging. Free site survey & same-day service available.",
    url: "https://atlasaircons.com/ac-installation-rajkot",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Professional AC installation services in Rajkot. Expert split &amp; window AC fitting, bracket fixing &amp; gas charging. Free site survey &amp; same-day service available.</p>
