...
export const metadata: Metadata = {
  title: "AC Installation Rajkot | Hitech Aircool Engineers Gujarat",
  description: "Professional AC installation services in Rajkot. Expert split & window AC fitting, bracket fixing & gas charging. Free site survey & same-day service available.",
  alternates: { canonical: "https://hitechairconditioning.in/ac-installation-rajkot" },
  openGraph: {
    title: "AC Installation Rajkot | Hitech Aircool Engineers",
    description: "Professional AC installation services in Rajkot. Expert split & window AC fitting, bracket fixing & gas charging. Free site survey & same-day service available.",
    url: "https://hitechairconditioning.in/ac-installation-rajkot",
    type: "website",
...
export default function Pageacinstallationrajkot() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">AC Installation Rajkot</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Professional AC installation services in Rajkot. Expert split &amp; window AC fitting, bracket fixing &amp; gas charging. Free site survey &amp; same-day service available.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Professional AC installation services in Rajkot. Expert split &amp; window AC fitting, bracket fixing &amp; gas charging. Free site survey &amp; same-day service available.</p>
          </div>
        </div>
      </section>
