...
export const metadata: Metadata = {
  title: "Panel AC Service Valsad | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/panel-ac-service-valsad" },
  openGraph: {
    title: "Panel AC Service Valsad | Atlas Aircon",
    description: "Expert Rittal & Schneider panel AC service Valsad's GIDC, hotels & ports. Corrosion-resistant repair for coastal environments, 24/7 emergency support & industri",
    url: "https://atlasaircons.com/panel-ac-service-valsad",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert Rittal &amp; Schneider panel AC service Valsad&apos;s GIDC, hotels &amp; ports. Corrosion-resistant repair for coastal environments, 24/7 emergency support &amp; industrial AMCs.</p>
