...
export const metadata: Metadata = {
  title: "Mitsubishi AC Service Center Ahmedabad | Professional HVAC Service | Atlas Aircon",
  description: "Mitsubishi AC Service Center Ahmedabad — Professional service service by Atlas Aircon. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 97272 57141.",
  keywords: ["mitsubishi ac service center ahmedabad", "service service", "hvac service vadodara", "atlas aircon", "ac service gujarat"],
  alternates: { canonical: "https://atlasaircons.com/mitsubishi-ac-service-center-ahmedabad" },
  openGraph: { title: "Mitsubishi AC Service Center Ahmedabad | Atlas Aircon", description: "Professional service service by Atlas Aircon Gujarat.", url: "https://atlasaircons.com/mitsubishi-ac-service-center-ahmedabad", type: "website" },
};
