...
export const metadata: Metadata = {
  title: "#1 Lg AC Repair Service Center Vadodara | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/lg-ac-repair-service-center-vadodara" },
  openGraph: {
    title: "#1 Lg AC Repair Service Center Vadodara | Atlas Aircon",
    description: "Expert lg AC repair, installation, and service in Vadodara. Get transparent charges, 3-month guarantee, and 24/7 emergency support from certified technicians. C",
    url: "https://atlasaircons.com/lg-ac-repair-service-center-vadodara",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert lg AC repair, installation, and service in Vadodara. Get transparent charges, 3-month guarantee, and 24/7 emergency support from certified technicians. Call Atlas Aircon now!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Expert lg AC repair, installation, and service in Vadodara. Get transparent charges, 3-month guarantee, and 24/7 emergency support from certified technicians. Call Atlas Aircon now!</p>
          </div>
        </div>
      </section>
