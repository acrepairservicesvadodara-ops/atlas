...
export const metadata: Metadata = {
  title: "Best HVAC To Buy For Your Office In This Summer 2018 [2026 Updated] | Atlas Aircon Blog",
  ...
  alternates: { canonical: "https://atlasaircons.com/best-hvac-to-buy-for-your-office-in-this-summer-2019" },
  openGraph: {
    title: "Best HVAC To Buy For Your Office In This Summer 2018 [2026 Updated] | Atlas Aircon",
    description: "Today, air conditioning is used in almost all of the commercial properties that range from small shops & cafes to the large office buildings and mos...",
    url: "https://atlasaircons.com/best-hvac-to-buy-for-your-office-in-this-summer-2019",
    type: "article",
...
const jsonLd = {
  ...
  mainEntityOfPage: "https://atlasaircons.com/best-hvac-to-buy-for-your-office-in-this-summer-2019",
  ...
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVbest hvac to buy for your office in this summer 2019s?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVbest hvac to buy for your office in this summer 2019s?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
