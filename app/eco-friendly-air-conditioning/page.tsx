...
export const metadata: Metadata = {
  title: "The Future Of Eco-Friendly Air Conditioning &raquo; Hitech Aircool Engineers [2026 Updated] | Hitech Aircool Engineers Blog",
  description: "The Future Of Eco-Friendly Air Conditioning &raquo; Hitech Aircool Engineers [2026 Updated] - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/eco-friendly-air-conditioning" },
  openGraph: {
    title: "The Future Of Eco-Friendly Air Conditioning &raquo; Hitech Aircool Engineers [2026 Updated] | Hitech Aircool Engineers",
    description: "The Future Of Eco-Friendly Air Conditioning &raquo; Hitech Aircool Engineers [2026 Updated] - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/eco-friendly-air-conditioning",
    type: "article",
    images: ["/images/products/A-photo-or-map-showing-areas-with-high-solar-energy-potential-where-solar-ACs-are-being-used-effectively.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Article",
  headline: "The Future Of Eco-Friendly Air Conditioning &raquo; Hitech Aircool Engineers [2026 Updated]",
  ...
  mainEntityOfPage: "https://hitechairconditioning.in/eco-friendly-air-conditioning",
  image: "/images/products/A-photo-or-map-showing-areas-with-high-solar-energy-potential-where-solar-ACs-are-being-used-effectively.webp",
};

export default function Pageecofriendlyairconditioning() {
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-gray-900 via-gray-800 to-teal-900 text-white py-12 md:py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">The Future Of Eco-Friendly Air Conditioning &amp;raquo; Hitech Aircool Engineers [2026 Updated]</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <img src="/images/products/A-photo-or-map-showing-areas-with-high-solar-energy-potential-where-solar-ACs-are-being-used-effectively.webp" alt="The Future Of Eco-Friendly Air Conditioning &raquo; Hitech Aircool Engineers [2026 Updated]" className="w-full h-auto rounded-xl mb-8" />
            <p className="text-gray-600 mb-4">&lt;img src=&quot;https://hitechairconditioning.in/wp-...</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What eco friendly air conditionings does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides eco friendly air conditioning, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book eco friendly air conditioning?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency eco friendly air conditioning available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What eco friendly air conditionings does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides eco friendly air conditioning, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book eco friendly air conditioning?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency eco friendly air conditioning available. Call +91 93289 53665 for immediate assistance." } },
