...
export const metadata: Metadata = {
  title: "Reliable Ducting Repair Services Daman : Fix 8+ Airflow [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Top-rated ducting & HVAC repair services in Daman, Diu & Silvassa. Expert solutions for hotels, restaurants & homes. ✅ Free consultation & same-day service avai",
  alternates: { canonical: "https://hitechairconditioning.in/ducting-repair-services-daman" },
  openGraph: {
    title: "Reliable Ducting Repair Services Daman : Fix 8+ Airflow [2026 Updated] | Hitech Aircool Engineers",
    description: "Top-rated ducting & HVAC repair services in Daman, Diu & Silvassa. Expert solutions for hotels, restaurants & homes. ✅ Free consultation & same-day service avai",
    url: "https://hitechairconditioning.in/ducting-repair-services-daman",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Reliable Ducting Repair Services Daman : Fix 8+ Airflow [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageductingrepairservicesdaman() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Reliable Ducting Repair Services Daman : Fix 8+ Airflow [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Top-rated ducting &amp; HVAC repair services in Daman, Diu &amp; Silvassa. Expert solutions for hotels, restaurants &amp; homes. ✅ Free consultation &amp; same-day service available. Ducting Repair services Daman</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Top-rated ducting &amp; HVAC repair services in Daman, Diu &amp; Silvassa. Expert solutions for hotels, restaurants &amp; homes. ✅ Free consultation &amp; same-day service available. Ducting Repair services Daman</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/hitech-logo.webp" alt="Reliable Ducting Repair Services Daman : Fix 8+ Airflow [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Reliable Ducting Repair Services Daman : Fix 8+ Airflow [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Ducting Repair Services Daman in Vadodara?", a: "Ducting Repair Services Daman cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Ducting Repair Services Daman?", a: "Hitech Aircool Engineers offers same-day Ducting Repair Services Daman across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Ducting Repair Services Damans?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Ducting Repair Services Damans depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Ducting Repair Services Daman available on holidays?", a: "Yes, Hitech Aircool Engineers provides Ducting Repair Services Daman 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Ducting Repair Services Daman take?", a: "Most Ducting Repair Services Damans are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Ducting Repair Services Daman in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Ducting Repair Services Daman cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Ducting Repair Services Daman?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Ducting Repair Services Daman across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Ducting Repair Services Damans?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Ducting Repair Services Damans depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Ducting Repair Services Daman available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Ducting Repair Services Daman 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Ducting Repair Services Daman take?", acceptedAnswer: { "@type": "Answer", text: "Most Ducting Repair Services Damans are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
