...
export const metadata: Metadata = {
  title: "Split AC Installation in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  ...
  keywords: [
    ...
    "Split AC Installation installation",
    "Split AC Installation service",
    "Split AC Installation repair",
    "best Split AC Installation service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/split-ac-installation-vadodara",
  },
};
...
export default function SplitACInstallationPage() {
  return (
    <>
      {/* Hero Section */}
