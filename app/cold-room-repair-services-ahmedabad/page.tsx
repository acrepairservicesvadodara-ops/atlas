...
export const metadata: Metadata = {
  title: "Guaranteed! Fastest Cold Room Repair Services Ahmedabad: [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/cold-room-repair-services-ahmedabad" },
  openGraph: {
    title: "Guaranteed! Fastest Cold Room Repair Services Ahmedabad: [2026 Updated] | Atlas Aircon",
    description: "Broken cold room? Get expert cold room repair services Ahmedabad with 24/7 emergency response, on-site fixes, and AMC plans. 100% guaranteed work by certified t",
    url: "https://atlasaircons.com/cold-room-repair-services-ahmedabad",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Broken cold room? Get expert cold room repair services Ahmedabad with 24/7 emergency response, on-site fixes, and AMC plans. 100% guaranteed work by certified technicians. Free inspection!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVcold room repair services ahmedabads?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVcold room repair services ahmedabads?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
