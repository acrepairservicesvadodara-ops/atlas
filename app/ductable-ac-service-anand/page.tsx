...
export const metadata: Metadata = {
  title: "Reliable Ductable AC Service Anand | Hitech Aircool Engineers Gujarat",
  description: "Need Ductable AC Service Anand? 🛠️ Expert repair, installation & maintenance for homes & shops. Fast, affordable service by local technicians. Call for a free ",
  alternates: { canonical: "https://hitechairconditioning.in/ductable-ac-service-anand" },
  openGraph: {
    title: "Reliable Ductable AC Service Anand | Hitech Aircool Engineers",
    description: "Need Ductable AC Service Anand? 🛠️ Expert repair, installation & maintenance for homes & shops. Fast, affordable service by local technicians. Call for a free ",
    url: "https://hitechairconditioning.in/ductable-ac-service-anand",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Reliable Ductable AC Service Anand",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageductableacserviceanand() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Reliable Ductable AC Service Anand</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Need Ductable AC Service Anand? 🛠️ Expert repair, installation &amp; maintenance for homes &amp; shops. Fast, affordable service by local technicians. Call for a free estimate now!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Need Ductable AC Service Anand? 🛠️ Expert repair, installation &amp; maintenance for homes &amp; shops. Fast, affordable service by local technicians. Call for a free estimate now!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/hitech-logo.webp" alt="Reliable Ductable AC Service Anand" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Reliable Ductable AC Service Anand" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
