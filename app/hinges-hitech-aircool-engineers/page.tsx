...
export const metadata: Metadata = {
  title: "Hinges | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "A sagging or broken door hinge affects seal integrity and energy efficiency. We supply top-mount, bottom-mount, and side-mount hinges for all types of r...",
  keywords: ["hinges | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "hinges"],
  alternates: { canonical: "https://atlasaircons.com/hinges-hitech-aircool-engineers" },
  openGraph: {
    title: "Hinges | Hitech Aircool Engineers",
    description: "A sagging or broken door hinge affects seal integrity and energy efficiency. We supply top-mount, bottom-mount, and side-mount hinges for all types of r...",
    url: "https://atlasaircons.com/hinges-hitech-aircool-engineers",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Hinges | Hitech Aircool Engineers",
  description: "A sagging or broken door hinge affects seal integrity and energy efficiency. We supply top-mount, bottom-mount, and side-mount hinges for all types of refrigeration cabinets, ovens, and commercial equipment. Our hinges are made from durable stainless steel or plated steel to withstand frequent use a",
...
export default function Pagehingeshitechaircoolengineers() {
  return (
    <>
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  ...
                  alt="Hinges | Hitech Aircool Engineers"
                ...
                <img
                  src="/images/products/Spare-1-scaled-1.webp"
                  alt="Hinges | Hitech Aircool Engineers - Image 2"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Hinges | Hitech Aircool Engineers - Image 3"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Hinges | Hitech Aircool Engineers - Image 4"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="bg-blue-500/20 text-blue-300 px-3 py-1 rounded-full text-xs font-semibold">Hinges</span>
              </div>
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Hinges | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">A sagging or broken door hinge affects seal integrity and energy efficiency. We supply top-mount, bottom-mount, and side-mount hinges for all types of</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%20Hinges%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">All Enclosures</span>
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Hinges</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Other</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Panels</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>A sagging or broken door hinge affects seal integrity and energy efficiency. We supply top-mount, bottom-mount, and side-mount hinges for all types of refrigeration cabinets, ovens, and commercial equipment. Our hinges are made from durable stainless steel or plated steel to withstand frequent use and heavy loads.</p>
            </div>
            ...
            <div className="mt-8 bg-gray-50 rounded-xl p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                ...
                <div className="flex justify-between py-2 border-b border-gray-200"><span className="text-gray-500">Category</span><span className="font-medium">Hinges</span></div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[{"url":"https://www.atlasaircons.com/24x7-washing-machine-emergency-service-hitech-aircool-engineers/","title":"24X7 Washing Machine Emergency Service | Hitech Aircool Engineers","price":""},{"url":"https://www.atlasaircons.com/24x7-air-conditioner-emergency-service-hitech-aircool-engineers/","title":"24X7 Air Conditioner Emergency Service | Hitech Aircool Engineers","price":""}].map((p: { url: string; title: string; price: string }) => (
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What hinges hitech aircool engineerss does Atlas Aircon provide?", a: "Atlas Aircon provides hinges hitech aircool engineers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book hinges hitech aircool engineers?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency hinges hitech aircool engineers available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What hinges hitech aircool engineerss does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides hinges hitech aircool engineers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book hinges hitech aircool engineers?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency hinges hitech aircool engineers available. Call +91 97272 57141 for immediate assistance." } },
