...
export const metadata: Metadata = {
  title: "❄️❄️ Expert Carrier AC Repair Services By Hitech Aircool Engineers ❄️❄️ [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Mastering Carrier AC Repair: Your Trusted Guide to Expert Solutions by Hitech Aircool Engineers Experience top-tier Carrier AC repair services at our cente...",
  alternates: { canonical: "https://hitechairconditioning.in/carrier-ac-repair-services" },
  openGraph: {
    title: "❄️❄️ Expert Carrier AC Repair Services By Hitech Aircool Engineers ❄️❄️ [2026 Updated] | Hitech Aircool Engineers",
    description: "Mastering Carrier AC Repair: Your Trusted Guide to Expert Solutions by Hitech Aircool Engineers Experience top-tier Carrier AC repair services at our cente...",
    url: "https://hitechairconditioning.in/carrier-ac-repair-services",
    type: "website",
    images: ["/images/products/Carrier-Ac-Repair-Service.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "❄️❄️ Expert Carrier AC Repair Services By Hitech Aircool Engineers ❄️❄️ [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagecarrieracrepairservices() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">❄️❄️ Expert Carrier AC Repair Services By Hitech Aircool Engineers ❄️❄️ [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Mastering Carrier AC Repair: Your Trusted Guide to Expert Solutions by Hitech Aircool Engineers Experience top-tier Carrier AC repair services at our cente...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Mastering Carrier AC Repair: Your Trusted Guide to Expert Solutions by Hitech Aircool Engineers Experience top-tier Carrier AC repair services at our cente...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Carrier-Ac-Repair-Service.webp" alt="❄️❄️ Expert Carrier AC Repair Services By Hitech Aircool Engineers ❄️❄️ [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="❄️❄️ Expert Carrier AC Repair Services By Hitech Aircool Engineers ❄️❄️ [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="❄️❄️ Expert Carrier AC Repair Services By Hitech Aircool Engineers ❄️❄️ [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Carrier-Ac-Repair-Service.webp" alt="❄️❄️ Expert Carrier AC Repair Services By Hitech Aircool Engineers ❄️❄️ [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Carrier-Ac-Repair-Service.webp" alt="❄️❄️ Expert Carrier AC Repair Services By Hitech Aircool Engineers ❄️❄️ [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Carrier-Ac-Repair-Service.webp" alt="❄️❄️ Expert Carrier AC Repair Services By Hitech Aircool Engineers ❄️❄️ [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
