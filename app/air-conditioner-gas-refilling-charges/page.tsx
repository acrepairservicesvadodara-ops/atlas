...
export const metadata: Metadata = {
  title: "Air Conditioner (ac) Gas Refilling Charges » Hitech Aircool Engineers [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Air Conditioner (ac) Gas Refilling Charges » Hitech Aircool Engineers [2026 Updated] - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/air-conditioner-gas-refilling-charges" },
  openGraph: {
    title: "Air Conditioner (ac) Gas Refilling Charges » Hitech Aircool Engineers [2026 Updated] | Hitech Aircool Engineers",
    description: "Air Conditioner (ac) Gas Refilling Charges » Hitech Aircool Engineers [2026 Updated] - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/air-conditioner-gas-refilling-charges",
    type: "website",
    images: ["/images/products/Atlas-Aircon-Ac-Gas-Refilling-charges-2.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Air Conditioner (ac) Gas Refilling Charges » Hitech Aircool Engineers [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageairconditionergasrefillingcharges() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Air Conditioner (ac) Gas Refilling Charges » Hitech Aircool Engineers [2026 Updated]</h1>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Atlas-Aircon-Ac-Gas-Refilling-charges-2.webp" alt="Air Conditioner (ac) Gas Refilling Charges » Hitech Aircool Engineers [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Air Conditioner (ac) Gas Refilling Charges » Hitech Aircool Engineers [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Air Conditioner (ac) Gas Refilling Charges » Hitech Aircool Engineers [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of AC Gas Refilling in Vadodara?", a: "AC Gas Refilling cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for AC Gas Refilling?", a: "Hitech Aircool Engineers offers same-day AC Gas Refilling across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on AC Gas Refillings?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on AC Gas Refillings depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency AC Gas Refilling available on holidays?", a: "Yes, Hitech Aircool Engineers provides AC Gas Refilling 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of AC Gas Refilling in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "AC Gas Refilling cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for AC Gas Refilling?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day AC Gas Refilling across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on AC Gas Refillings?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on AC Gas Refillings depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency AC Gas Refilling available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides AC Gas Refilling 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
