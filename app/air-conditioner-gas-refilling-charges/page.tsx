...
export const metadata: Metadata = {
  title: "Air Conditioner (ac) Gas Refilling Charges » Atlas Aircon [2026 Updated] | Atlas Aircon Gujarat",
  description: "Air Conditioner (ac) Gas Refilling Charges » Atlas Aircon [2026 Updated] - Atlas Aircon Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/air-conditioner-gas-refilling-charges" },
  openGraph: {
    title: "Air Conditioner (ac) Gas Refilling Charges » Atlas Aircon [2026 Updated] | Atlas Aircon",
    description: "Air Conditioner (ac) Gas Refilling Charges » Atlas Aircon [2026 Updated] - Atlas Aircon Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/air-conditioner-gas-refilling-charges",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Air Conditioner (ac) Gas Refilling Charges » Atlas Aircon [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Air Conditioner (ac) Gas Refilling Charges » Atlas Aircon [2026 Updated]</h1>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Atlas-Aircon-Ac-Gas-Refilling-charges-2.webp" alt="Air Conditioner (ac) Gas Refilling Charges » Atlas Aircon [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Air Conditioner (ac) Gas Refilling Charges » Atlas Aircon [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Air Conditioner (ac) Gas Refilling Charges » Atlas Aircon [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
