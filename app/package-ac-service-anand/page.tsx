...
export const metadata: Metadata = {
  title: "Fast Package AC Service Anand | Hitech Aircool Engineers Gujarat",
  description: "Reliable package AC repair, gas filling & annual maintenance in Anand. Our certified technicians offer same-day service with genuine spare parts. Get your free ",
  alternates: { canonical: "https://hitechairconditioning.in/package-ac-service-anand" },
  openGraph: {
    title: "Fast Package AC Service Anand | Hitech Aircool Engineers",
    description: "Reliable package AC repair, gas filling & annual maintenance in Anand. Our certified technicians offer same-day service with genuine spare parts. Get your free ",
    url: "https://hitechairconditioning.in/package-ac-service-anand",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Fast Package AC Service Anand",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagepackageacserviceanand() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Fast Package AC Service Anand</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Reliable package AC repair, gas filling &amp; annual maintenance in Anand. Our certified technicians offer same-day service with genuine spare parts. Get your free AC health check today!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Reliable package AC repair, gas filling &amp; annual maintenance in Anand. Our certified technicians offer same-day service with genuine spare parts. Get your free AC health check today!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/package-ac-service-vadodara-near-me.webp" alt="Fast Package AC Service Anand" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Fast Package AC Service Anand" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
