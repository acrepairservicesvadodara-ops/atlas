...
export const metadata: Metadata = {
  title: "Local AC Technician in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Local AC repair experts in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Local AC Technician Vadodara",
    "local ac technician",
    "Local AC Technician installation",
    "Local AC Technician service",
    "Local AC Technician repair",
    "best Local AC Technician service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/local-ac-technician-vadodara",
  },
};

const keywordData = {
  title: "Local AC Technician",
  slug: "local-ac-technician",
  description: "Local AC repair experts",
  category: "Core"
};
...
export default function LocalACTechnicianPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What local ac technician vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides local ac technician vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book local ac technician vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency local ac technician vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What local ac technician vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides local ac technician vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book local ac technician vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency local ac technician vadodara available. Call +91 93289 53665 for immediate assistance." } },
