...
export const metadata: Metadata = {
  title: "🌾 AC Service Kheda | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-kheda" },
  openGraph: {
    title: "🌾 AC Service Kheda | Atlas Aircon",
    description: "Trusted AC service across Kheda district! Expert maintenance, repair & AMC plans from local technicians who understand rural needs. Free check-up & fair pricing",
    url: "https://atlasaircons.com/ac-service-kheda",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Trusted AC service across Kheda district! Expert maintenance, repair &amp; AMC plans from local technicians who understand rural needs. Free check-up &amp; fair pricing. Call!</p>
