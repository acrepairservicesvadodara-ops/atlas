...
export const metadata: Metadata = {
  title: "#1 HVAC Repair Services Surat | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/hvac-repair-services-surat" },
  openGraph: {
    title: "#1 HVAC Repair Services Surat | Atlas Aircon",
    description: "Expert HVAC repair services Surat with certified technicians. Get affordable AC, heating & ventilation solutions across Surat. 24/7 emergency support available!",
    url: "https://atlasaircons.com/hvac-repair-services-surat",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert HVAC repair services Surat with certified technicians. Get affordable AC, heating &amp; ventilation solutions across Surat. 24/7 emergency support available!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVhvac repair services surats?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVhvac repair services surats?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
