...
export const metadata: Metadata = {
  title: "Air Cooler Dismantling & Re-Installation Services | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "For large industrial desert coolers on rooftops or walls, we safely disconnect electrical and water supplies, dismantle the unit, and lower it. Re-insta...",
  keywords: ["air cooler dismantling & re-installation services | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "installation"],
  alternates: { canonical: "https://atlasaircons.com/air-cooler-dismantling-re-installation-services-hitech-aircool-engineers" },
  openGraph: {
    title: "Air Cooler Dismantling & Re-Installation Services | Hitech Aircool Engineers",
    description: "For large industrial desert coolers on rooftops or walls, we safely disconnect electrical and water supplies, dismantle the unit, and lower it. Re-insta...",
    url: "https://atlasaircons.com/air-cooler-dismantling-re-installation-services-hitech-aircool-engineers",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Air Cooler Dismantling & Re-Installation Services | Hitech Aircool Engineers",
  description: "For large industrial desert coolers on rooftops or walls, we safely disconnect electrical and water supplies, dismantle the unit, and lower it. Re-installation includes securing the unit, connecting new water lines with float valves, and wiring, followed by a test run to check pump and fan operation",
...
export default function Pageaircoolerdismantlingreinstallationservic() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  ...
                  alt="Air Cooler Dismantling & Re-Installation Services | Hitech Aircool Engineers"
                ...
                <img
                  ...
                  alt="Air Cooler Dismantling & Re-Installation Services | Hitech Aircool Engineers - Image 2"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Air Cooler Dismantling & Re-Installation Services | Hitech Aircool Engineers - Image 3"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Air Cooler Dismantling & Re-Installation Services | Hitech Aircool Engineers - Image 4"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Air Cooler Dismantling &amp; Re-Installation Services | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">For large industrial desert coolers on rooftops or walls, we safely disconnect electrical and water supplies, dismantle the unit, and lower it. Re-ins</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%20Air%20Cooler%20Dismantling%20%26%20Re-Installation%20Services%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Air Cooler Dismantling &amp; Re-Installation Services</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>For large industrial desert coolers on rooftops or walls, we safely disconnect electrical and water supplies, dismantle the unit, and lower it. Re-installation includes securing the unit, connecting new water lines with float valves, and wiring, followed by a test run to check pump and fan operation.</p>
            </div>
