...
export const metadata: Metadata = {
  title: "Things To Consider Before Buying Air Conditioner | Hitech Aircool Engineers Blog",
  description: "Best AC Buying Guide - Points you must know before buying Air Conditioner for Home or ...",
  alternates: { canonical: "https://hitechairconditioning.in/things-to-consider-before-buying-air-conditioner-ac-buying-guide" },
  openGraph: {
    title: "Things To Consider Before Buying Air Conditioner | Hitech Aircool Engineers",
    description: "Best AC Buying Guide - Points you must know before buying Air Conditioner for Home or ...",
    url: "https://hitechairconditioning.in/things-to-consider-before-buying-air-conditioner-ac-buying-guide",
    type: "article",
    images: ["/images/products/Air-Conditioner-Buying-Guide.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Article",
  headline: "Things To Consider Before Buying Air Conditioner",
  ...
  mainEntityOfPage: "https://hitechairconditioning.in/things-to-consider-before-buying-air-conditioner-ac-buying-guide",
  image: "/images/products/Air-Conditioner-Buying-Guide.webp",
};

export default function Pagethingstoconsiderbeforebuyingaircondition() {
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-gray-900 via-gray-800 to-teal-900 text-white py-12 md:py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">Things To Consider Before Buying Air Conditioner</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <img src="/images/products/Air-Conditioner-Buying-Guide.webp" alt="Things To Consider Before Buying Air Conditioner" className="w-full h-auto rounded-xl mb-8" />
            <p className="text-gray-600 mb-4">Best AC Buying Guide - Points you must know before buying Air Conditioner for Home or ...</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What things to consider before buying air conditioner ac buying guides does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides things to consider before buying air conditioner ac buying guide, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book things to consider before buying air conditioner ac buying guide?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency things to consider before buying air conditioner ac buying guide available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What things to consider before buying air conditioner ac buying guides does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides things to consider before buying air conditioner ac buying guide, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book things to consider before buying air conditioner ac buying guide?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency things to consider before buying air conditioner ac buying guide available. Call +91 93289 53665 for immediate assistance." } },
