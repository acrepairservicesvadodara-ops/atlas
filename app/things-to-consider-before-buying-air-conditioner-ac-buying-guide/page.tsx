...
export const metadata: Metadata = {
  title: "Things To Consider Before Buying Air Conditioner | Atlas Aircon Blog",
  description: "Best AC Buying Guide - Points you must know before buying Air Conditioner for Home or ...",
  alternates: { canonical: "https://atlasaircons.com/things-to-consider-before-buying-air-conditioner-ac-buying-guide" },
  openGraph: {
    title: "Things To Consider Before Buying Air Conditioner | Atlas Aircon",
    description: "Best AC Buying Guide - Points you must know before buying Air Conditioner for Home or ...",
    url: "https://atlasaircons.com/things-to-consider-before-buying-air-conditioner-ac-buying-guide",
    type: "article",
...
const jsonLd = {
  ...
  mainEntityOfPage: "https://atlasaircons.com/things-to-consider-before-buying-air-conditioner-ac-buying-guide",
  ...
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What things to consider before buying air conditioner ac buying guides does Atlas Aircon provide?", a: "Atlas Aircon provides things to consider before buying air conditioner ac buying guide, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book things to consider before buying air conditioner ac buying guide?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency things to consider before buying air conditioner ac buying guide available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What things to consider before buying air conditioner ac buying guides does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides things to consider before buying air conditioner ac buying guide, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book things to consider before buying air conditioner ac buying guide?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency things to consider before buying air conditioner ac buying guide available. Call +91 97272 57141 for immediate assistance." } },
