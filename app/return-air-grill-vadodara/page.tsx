...
export const metadata: Metadata = {
  title: "Return Air Grill in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Return air grill fitting in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Return Air Grill Vadodara",
    "return air grill",
    "Return Air Grill installation",
    "Return Air Grill service",
    "Return Air Grill repair",
    "best Return Air Grill service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/return-air-grill-vadodara",
  },
};

const keywordData = {
  title: "Return Air Grill",
  slug: "return-air-grill",
  description: "Return air grill fitting",
  category: "HVAC"
};
...
export default function ReturnAirGrillPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What return air grill vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides return air grill vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book return air grill vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency return air grill vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What return air grill vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides return air grill vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book return air grill vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency return air grill vadodara available. Call +91 93289 53665 for immediate assistance." } },
