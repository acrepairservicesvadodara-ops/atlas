...
export const metadata: Metadata = {
  title: "Panel AC Service Godhra | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/panel-ac-service-godhra" },
  openGraph: {
    title: "Panel AC Service Godhra | Atlas Aircon",
    description: "Expert panel AC service Godhra for transport hubs, GIDC units, and cold storage facilities. We provide 24/7 emergency repair, genuine parts, and reliable AMCs f",
    url: "https://atlasaircons.com/panel-ac-service-godhra",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert panel AC service Godhra for transport hubs, GIDC units, and cold storage facilities. We provide 24/7 emergency repair, genuine parts, and reliable AMCs for uninterrupted operations.</p>
