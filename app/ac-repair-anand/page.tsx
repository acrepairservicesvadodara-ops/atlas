...
export const metadata: Metadata = {
  title: "AC Repair Anand | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-repair-anand" },
  openGraph: {
    title: "AC Repair Anand | Atlas Aircon",
    description: "Struggling with a broken AC in Anand? Get quick, trusted AC repair service. Expert technicians fix all brands. Same-day service & 90-day warranty. Call now!",
    url: "https://atlasaircons.com/ac-repair-anand",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Struggling with a broken AC in Anand? Get quick, trusted AC repair service. Expert technicians fix all brands. Same-day service &amp; 90-day warranty. Call now!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Ac Repair Anand in Vadodara?", a: "Ac Repair Anand cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Ac Repair Anand?", a: "Atlas Aircon offers same-day Ac Repair Anand across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Ac Repair Anands?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Ac Repair Anands depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Ac Repair Anand available on holidays?", a: "Yes, Atlas Aircon provides Ac Repair Anand 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Ac Repair Anand in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Ac Repair Anand cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Ac Repair Anand?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Ac Repair Anand across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Ac Repair Anands?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Ac Repair Anands depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Ac Repair Anand available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Ac Repair Anand 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
