...
export const metadata: Metadata = {
  title: "AC Repair Padra in Vadodara | Installation, Service & Repair | Atlas Aircon",
  description: "AC repair in Padra in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 97272 57141",
  keywords: [
    "AC Repair Padra Vadodara",
    "ac repair padra",
    "AC Repair Padra installation",
    "AC Repair Padra service",
    "AC Repair Padra repair",
    "best AC Repair Padra service",
  ],
  alternates: {
    canonical: "https://atlasaircons.com/ac-repair-padra-vadodara",
  },
};

const keywordData = {
  title: "AC Repair Padra",
  slug: "ac-repair-padra",
  description: "AC repair in Padra",
  category: "OutCity"
};
...
export default function ACRepairPadraPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Ac Repair Padra Vadodara in Vadodara?", a: "Ac Repair Padra Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Ac Repair Padra Vadodara?", a: "Atlas Aircon offers same-day Ac Repair Padra Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Ac Repair Padra Vadodaras?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Ac Repair Padra Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Ac Repair Padra Vadodara available on holidays?", a: "Yes, Atlas Aircon provides Ac Repair Padra Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
              { q: "How long does Ac Repair Padra Vadodara take?", a: "Most Ac Repair Padra Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Ac Repair Padra Vadodara in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Ac Repair Padra Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Ac Repair Padra Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Ac Repair Padra Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Ac Repair Padra Vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Ac Repair Padra Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Ac Repair Padra Vadodara available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Ac Repair Padra Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
          { "@type": "Question", name: "How long does Ac Repair Padra Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Most Ac Repair Padra Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
