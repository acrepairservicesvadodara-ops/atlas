...
export const metadata: Metadata = {
  title: "Daikin AC Gas Refill in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Daikin AC gas refilling in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Daikin AC Gas Refill Vadodara",
    "daikin ac gas refill",
    "Daikin AC Gas Refill installation",
    "Daikin AC Gas Refill service",
    "Daikin AC Gas Refill repair",
    "best Daikin AC Gas Refill service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/daikin-ac-gas-refill-vadodara",
  },
};

const keywordData = {
  title: "Daikin AC Gas Refill",
  slug: "daikin-ac-gas-refill",
  description: "Daikin AC gas refilling",
  category: "Brands"
};
...
export default function DaikinACGasRefillPage() {
  return (
    <>
      {/* Hero Section */}
