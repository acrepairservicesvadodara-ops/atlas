...
export const metadata: Metadata = {
  title: "AC Service Fatehgunj in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC service Fatehgunj in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC Service Fatehgunj Vadodara",
    "ac service fatehgunj",
    "AC Service Fatehgunj installation",
    "AC Service Fatehgunj service",
    "AC Service Fatehgunj repair",
    "best AC Service Fatehgunj service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-service-fatehgunj-vadodara",
  },
};

const keywordData = {
  title: "AC Service Fatehgunj",
  slug: "ac-service-fatehgunj",
  description: "AC service Fatehgunj",
  category: "Area"
};
...
export default function ACServiceFatehgunjPage() {
  return (
    <>
      {/* Hero Section */}
