...
export const metadata: Metadata = {
  title: "AC AMC Manjalpur in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC AMC in Manjalpur in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC AMC Manjalpur Vadodara",
    "ac amc manjalpur",
    "AC AMC Manjalpur installation",
    "AC AMC Manjalpur service",
    "AC AMC Manjalpur repair",
    "best AC AMC Manjalpur service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-amc-manjalpur-vadodara",
  },
};

const keywordData = {
  title: "AC AMC Manjalpur",
  slug: "ac-amc-manjalpur",
  description: "AC AMC in Manjalpur",
  category: "Area"
};
...
export default function ACAMCManjalpurPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Ac Amc Manjalpur Vadodara include?", a: "Ac Amc Manjalpur Vadodara includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Ac Amc Manjalpur Vadodara cost?", a: "Ac Amc Manjalpur Vadodara starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Ac Amc Manjalpur Vadodara improve cooling?", a: "Yes, proper Ac Amc Manjalpur Vadodara can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Ac Amc Manjalpur Vadodara reduce electricity bills?", a: "Regular Ac Amc Manjalpur Vadodara can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Ac Amc Manjalpur Vadodara take?", a: "Basic Ac Amc Manjalpur Vadodara takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Ac Amc Manjalpur Vadodara remove bad smell?", a: "Yes, Ac Amc Manjalpur Vadodara includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Ac Amc Manjalpur Vadodara?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Ac Amc Manjalpur Vadodara include?", acceptedAnswer: { "@type": "Answer", text: "Ac Amc Manjalpur Vadodara includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Ac Amc Manjalpur Vadodara cost?", acceptedAnswer: { "@type": "Answer", text: "Ac Amc Manjalpur Vadodara starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Ac Amc Manjalpur Vadodara improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Ac Amc Manjalpur Vadodara can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Ac Amc Manjalpur Vadodara reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Ac Amc Manjalpur Vadodara can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Ac Amc Manjalpur Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Basic Ac Amc Manjalpur Vadodara takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Ac Amc Manjalpur Vadodara remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Ac Amc Manjalpur Vadodara includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Ac Amc Manjalpur Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
