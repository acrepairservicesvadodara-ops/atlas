...
export const metadata: Metadata = {
  title: "Daikin AC Service Center Morbi | Out-of-Warranty Repair Expert | Atlas Aircon",
  description: "Independent Daikin AC service center in Morbi. Expert out-of-warranty split AC repair, gas charging, PCB repair, deep cleaning & compressor overhaul. Same-day service. Call +91 97272 57141.",
  keywords: [
    "daikin ac service center morbi",
    "daikin ac repair morbi",
    "daikin ac service morbi",
    "daikin split ac repair morbi",
    "daikin ac gas charging morbi",
    "daikin ac pcb repair morbi",
    "daikin ac installation morbi",
    "daikin ac not cooling morbi",
    "ac service center morbi",
    "best ac repair morbi",
  ],
  alternates: { canonical: "https://atlasaircons.com/daikin-ac-service-center-morbi" },
  openGraph: {
    title: "Daikin AC Service Center Morbi | Atlas Aircon",
    description: "Independent out-of-warranty Daikin AC repair specialist in Morbi. Same-day service, 90-day guarantee.",
    url: "https://atlasaircons.com/daikin-ac-service-center-morbi",
    type: "website",
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Daikin AC Service Center Morbi",
  ...
  description: "Independent, out-of-warranty Daikin AC repair, maintenance and installation in Morbi, Gujarat.",
};
...
const faqJsonLd = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "Is Atlas Aircon an authorized Daikin service center in Morbi?", acceptedAnswer: { "@type": "Answer", text: "No. Atlas Aircon is an independent service provider specializing in high-quality out-of-warranty repairs. If your Daikin AC is under official warranty, contact Daikin directly." } },
    { "@type": "Question", name: "How quickly can you repair my Daikin AC in Morbi?", acceptedAnswer: { "@type": "Answer", text: "We offer same-day service across Morbi. Our technicians typically arrive within 45-60 minutes of your call for emergency repairs." } },
    { "@type": "Question", name: "What is the cost of Daikin AC gas refilling in Morbi?", acceptedAnswer: { "@type": "Answer", text: "Gas refilling for Daikin ACs starts at \u20B92,500 including leak detection. Final cost depends on the refrigerant type (R32/R410A) and quantity needed." } },
...
export default function DaikinServiceCenterMorbiPage() {
  return (
    <>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                <span className="text-yellow-400">Daikin AC Service Center</span> Morbi
              </h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                Expert independent repair solutions for Daikin air conditioners in Morbi. Specializing in out-of-warranty service with same-day dispatch and a full satisfaction guarantee.
              </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">Daikin AC Repair Price List — Morbi</h2>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Daikin AC Service FAQs — Morbi</h2>
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              ...
              { q: "How quickly can you repair my Daikin AC in Morbi?", a: "Same-day service is standard. Emergency calls are attended within 45-60 minutes across Morbi." },
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Need Daikin AC Repair in Morbi?</h2>
