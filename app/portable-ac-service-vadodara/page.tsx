...
export const metadata: Metadata = {
  title: "Portable AC Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Portable AC repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Portable AC Service Vadodara",
    "portable ac service",
    "Portable AC Service installation",
    "Portable AC Service service",
    "Portable AC Service repair",
    "best Portable AC Service service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/portable-ac-service-vadodara",
  },
};

const keywordData = {
  title: "Portable AC Service",
  slug: "portable-ac-service",
  description: "Portable AC repair",
  category: "ACTypes"
};
...
export default function PortableACServicePage() {
  return (
    <>
      {/* Hero Section */}
