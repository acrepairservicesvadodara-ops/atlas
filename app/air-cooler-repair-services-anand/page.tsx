...
export const metadata: Metadata = {
  title: "🔧 7 Common Air Cooler Repair Services Anand | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/air-cooler-repair-services-anand" },
  openGraph: {
    title: "🔧 7 Common Air Cooler Repair Services Anand | Atlas Aircon",
    description: "Is your air cooler failing in Anand's heat? Fast, reliable repair services for all cooler issues. Same-day service & honest pricing. Get a free repair estimate ",
    url: "https://atlasaircons.com/air-cooler-repair-services-anand",
    type: "website",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Is your air cooler failing in Anand&apos;s heat? Fast, reliable repair services for all cooler issues. Same-day service &amp; honest pricing. Get a free repair estimate now! air cooler repair services anand</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Air Cooler Repair Services Anand in Vadodara?", a: "Air Cooler Repair Services Anand cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Air Cooler Repair Services Anand?", a: "Atlas Aircon offers same-day Air Cooler Repair Services Anand across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Air Cooler Repair Services Anands?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Air Cooler Repair Services Anands depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Air Cooler Repair Services Anand available on holidays?", a: "Yes, Atlas Aircon provides Air Cooler Repair Services Anand 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Air Cooler Repair Services Anand?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Air Cooler Repair Services Anand across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Air Cooler Repair Services Anands?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Air Cooler Repair Services Anands depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Air Cooler Repair Services Anand available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Air Cooler Repair Services Anand 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
