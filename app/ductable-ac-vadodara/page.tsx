...
export const metadata: Metadata = {
  title: "Ductable AC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  ...
  keywords: [
    "Ductable AC Vadodara",
    "ductable ac",
    "Ductable AC installation",
    "Ductable AC service",
    "Ductable AC repair",
    "best Ductable AC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ductable-ac-vadodara",
  },
};
