...
export const metadata: Metadata = {
  title: "Urgent Refrigerator Repair Services Vadodara | Hitech Aircool Engineers Gujarat",
  description: "Need fast fridge repair in Vadodara? Our expert technicians offer same-day service, genuine spare parts, and a 3-month warranty. Call now for a free estimate!",
  alternates: { canonical: "https://hitechairconditioning.in/refrigerator-repair-services-vadodara" },
  openGraph: {
    title: "Urgent Refrigerator Repair Services Vadodara | Hitech Aircool Engineers",
    description: "Need fast fridge repair in Vadodara? Our expert technicians offer same-day service, genuine spare parts, and a 3-month warranty. Call now for a free estimate!",
    url: "https://hitechairconditioning.in/refrigerator-repair-services-vadodara",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Urgent Refrigerator Repair Services Vadodara",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagerefrigeratorrepairservicesvadodara() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Urgent Refrigerator Repair Services Vadodara</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Need fast fridge repair in Vadodara? Our expert technicians offer same-day service, genuine spare parts, and a 3-month warranty. Call now for a free estimate!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Need fast fridge repair in Vadodara? Our expert technicians offer same-day service, genuine spare parts, and a 3-month warranty. Call now for a free estimate!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Atlas-Aircon-1.webp" alt="Urgent Refrigerator Repair Services Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Urgent Refrigerator Repair Services Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Refrigerator Repair Services Vadodara in Vadodara?", a: "Refrigerator Repair Services Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Refrigerator Repair Services Vadodara?", a: "Hitech Aircool Engineers offers same-day Refrigerator Repair Services Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Refrigerator Repair Services Vadodaras?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Refrigerator Repair Services Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Refrigerator Repair Services Vadodara available on holidays?", a: "Yes, Hitech Aircool Engineers provides Refrigerator Repair Services Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Refrigerator Repair Services Vadodara take?", a: "Most Refrigerator Repair Services Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Refrigerator Repair Services Vadodara in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Refrigerator Repair Services Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Refrigerator Repair Services Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Refrigerator Repair Services Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Refrigerator Repair Services Vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Refrigerator Repair Services Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Refrigerator Repair Services Vadodara available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Refrigerator Repair Services Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Refrigerator Repair Services Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Most Refrigerator Repair Services Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
