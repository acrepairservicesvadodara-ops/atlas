...
export const metadata: Metadata = {
  title: "Hitachi AC Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Hitachi AC repair and service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    ...
    "Hitachi AC service",
    "Hitachi AC repair",
    "best Hitachi AC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/hitachi-ac-service-vadodara",
  },
};

const keywordData = {
  title: "Hitachi AC Service",
  slug: "hitachi-ac-service",
  description: "Hitachi AC repair and service",
  category: "Brands"
};
...
export default function HitachiACServicePage() {
  return (
    <>
      {/* Hero Section */}
