...
export const metadata: Metadata = {
  title: "Contact Hitech Aircool Engineers | AC Repair Service Vadodara | +91 93289 53665",
  description: "Contact Hitech Aircool Engineers for AC repair & service in Vadodara. Call +91 93289 53665 or email hitechairconditioning@gmail.com. Same-day service available.",
  alternates: {
    canonical: "https://hitechairconditioning.in/contact",
  },
};
  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-teal-600 via-teal-700 to-teal-900 text-white py-16 md:py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Contact <span className="text-yellow-400">Hitech Aircool Engineers</span>
          </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            <a
              ...
              className="bg-teal-50 hover:bg-teal-100 p-6 rounded-xl text-center transition group"
            >
              <div className="w-14 h-14 bg-teal-600 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition">
                <Phone className="w-7 h-7 text-white" />
              </div>
              <h3 className="font-semibold text-gray-900 mb-1">Call Us</h3>
              <p className="text-teal-600 font-medium">+91 93289 53665</p>
            </a>
            ...
            <a
              href="mailto:hitechairconditioning@gmail.com"
            ...
            >
              ...
              <p className="text-orange-600 font-medium text-sm">hitechairconditioning@gmail.com</p>
            </a>
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div>
              ...
              <form className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full bg-teal-600 hover:bg-teal-700 text-white py-4 rounded-lg font-bold text-lg transition"
                >
                  Submit Request
                </button>
              </form>
            ...
            <div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm mb-6">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Hitech Aircool Engineers</h3>
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <p className="text-gray-600">+91 93289 53665</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-gray-600">hitechairconditioning@gmail.com</p>
                    <p className="text-gray-600">service@hitechairconditioning.in</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-200 rounded-xl overflow-hidden h-80">
                <iframe
                  ...
                  title="Hitech Aircool Engineers Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What contacts does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides contact, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book contact?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency contact available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What contacts does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides contact, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book contact?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency contact available. Call +91 93289 53665 for immediate assistance." } },
...
<section className="py-12 bg-teal-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-teal-100 mb-6">Call now for same-day service in Vadodara!</p>
          <a
            href="tel:+919328953665"
