...
export const metadata: Metadata = {
  title: "Top-Mount Air Curtains (Horizontal) | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "Our top-mount horizontal air curtains are the standard installation above doorways. They provide a wide, uniform air stream coverage suitable for most s...",
  keywords: ["top-mount air curtains (horizontal) | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "air curtains"],
  alternates: { canonical: "https://atlasaircons.com/top-mount-air-curtains-horizontal-hitech-aircool-engineers" },
  openGraph: {
    title: "Top-Mount Air Curtains (Horizontal) | Hitech Aircool Engineers",
    description: "Our top-mount horizontal air curtains are the standard installation above doorways. They provide a wide, uniform air stream coverage suitable for most s...",
    url: "https://atlasaircons.com/top-mount-air-curtains-horizontal-hitech-aircool-engineers",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Top-Mount Air Curtains (Horizontal) | Hitech Aircool Engineers",
  description: "Our top-mount horizontal air curtains are the standard installation above doorways. They provide a wide, uniform air stream coverage suitable for most single or double door applications. Easy to install and maintain, they are a popular choice for a wide range of commercial and industrial settings re",
...
export default function Pagetopmountaircurtainshorizontalhitechairco() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  ...
                  alt="Top-Mount Air Curtains (Horizontal) | Hitech Aircool Engineers"
                ...
                <img
                  src="/images/products/air-curtains-scaled-1.webp"
                  alt="Top-Mount Air Curtains (Horizontal) | Hitech Aircool Engineers - Image 2"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Top-Mount Air Curtains (Horizontal) | Hitech Aircool Engineers - Image 3"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Top-Mount Air Curtains (Horizontal) | Hitech Aircool Engineers - Image 4"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Top-Mount Air Curtains (Horizontal) | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">Our top-mount horizontal air curtains are the standard installation above doorways. They provide a wide, uniform air stream coverage suitable for most</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%20Top-Mount%20Air%20Curtains%20(Horizontal)%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Commercial Entrances</span>
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Maintain indoor climate</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Office Buildings</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Other</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Receiving Areas</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>Our top-mount horizontal air curtains are the standard installation above doorways. They provide a wide, uniform air stream coverage suitable for most single or double door applications. Easy to install and maintain, they are a popular choice for a wide range of commercial and industrial settings requiring an effective air barrier.</p>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[{"url":"https://www.atlasaircons.com/pedestrian-entrance-air-curtains-hitech-aircool-engineers/","title":"Pedestrian Entrance Air Curtains | Hitech Aircool Engineers","price":""},{"url":"https://www.atlasaircons.com/24x7-washing-machine-emergency-service-hitech-aircool-engineers/","title":"24X7 Washing Machine Emergency Service | Hitech Aircool Engineers","price":""}].map((p: { url: string; title: string; price: string }) => (
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What top mount air curtains horizontal hitech aircool engineerss does Atlas Aircon provide?", a: "Atlas Aircon provides top mount air curtains horizontal hitech aircool engineers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book top mount air curtains horizontal hitech aircool engineers?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency top mount air curtains horizontal hitech aircool engineers available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What top mount air curtains horizontal hitech aircool engineerss does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides top mount air curtains horizontal hitech aircool engineers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book top mount air curtains horizontal hitech aircool engineers?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency top mount air curtains horizontal hitech aircool engineers available. Call +91 97272 57141 for immediate assistance." } },
