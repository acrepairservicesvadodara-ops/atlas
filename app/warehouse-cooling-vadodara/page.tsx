...
export const metadata: Metadata = {
  title: "Warehouse Cooling in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Warehouse AC service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Warehouse Cooling Vadodara",
    "warehouse cooling",
    "Warehouse Cooling installation",
    "Warehouse Cooling service",
    "Warehouse Cooling repair",
    "best Warehouse Cooling service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/warehouse-cooling-vadodara",
  },
};

const keywordData = {
  title: "Warehouse Cooling",
  slug: "warehouse-cooling",
  description: "Warehouse AC service",
  category: "Commercial"
};
...
export default function WarehouseCoolingPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What warehouse cooling vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides warehouse cooling vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book warehouse cooling vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency warehouse cooling vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What warehouse cooling vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides warehouse cooling vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book warehouse cooling vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency warehouse cooling vadodara available. Call +91 93289 53665 for immediate assistance." } },
