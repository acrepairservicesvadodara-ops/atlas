...
export const metadata: Metadata = {
  title: "✅ Fast AC Repair Gujarat | Hitech Aircool Engineers Gujarat",
  ...
  alternates: { canonical: "https://hitechairconditioning.in/ac-repair-gujarat" },
  openGraph: {
    title: "✅ Fast AC Repair Gujarat | Hitech Aircool Engineers",
    description: "Struggling with AC breakdown? Get reliable AC repair service across Gujarat. Expert technicians, same-day solutions & 100% satisfaction guarantee. Call now for ",
    url: "https://hitechairconditioning.in/ac-repair-gujarat",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Struggling with AC breakdown? Get reliable AC repair service across Gujarat. Expert technicians, same-day solutions &amp; 100% satisfaction guarantee. Call now for quick fix!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Ac Repair Gujarat in Vadodara?", a: "Ac Repair Gujarat cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Ac Repair Gujarat?", a: "Hitech Aircool Engineers offers same-day Ac Repair Gujarat across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Ac Repair Gujarats?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Ac Repair Gujarats depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Ac Repair Gujarat available on holidays?", a: "Yes, Hitech Aircool Engineers provides Ac Repair Gujarat 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Ac Repair Gujarat in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Ac Repair Gujarat cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Ac Repair Gujarat?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Ac Repair Gujarat across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Ac Repair Gujarats?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Ac Repair Gujarats depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Ac Repair Gujarat available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Ac Repair Gujarat 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
