...
export const metadata: Metadata = {
  title: "✅ Fast AC Repair Gujarat | Atlas Aircon Gujarat",
  description: "Struggling with AC breakdown? Get reliable AC repair service across Gujarat. Expert technicians, same-day solutions & 100% satisfaction guarantee. Call now for ",
  alternates: { canonical: "https://atlasaircons.com/ac-repair-gujarat" },
  openGraph: {
    title: "✅ Fast AC Repair Gujarat | Atlas Aircon",
    description: "Struggling with AC breakdown? Get reliable AC repair service across Gujarat. Expert technicians, same-day solutions & 100% satisfaction guarantee. Call now for ",
    url: "https://atlasaircons.com/ac-repair-gujarat",
    type: "website",
...
export default function Pageacrepairgujarat() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">✅ Fast AC Repair Gujarat</h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Struggling with AC breakdown? Get reliable AC repair service across Gujarat. Expert technicians, same-day solutions &amp; 100% satisfaction guarantee. Call now for quick fix!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Struggling with AC breakdown? Get reliable AC repair service across Gujarat. Expert technicians, same-day solutions &amp; 100% satisfaction guarantee. Call now for quick fix!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/24X7-ac-repairing.webp" alt="✅ Fast AC Repair Gujarat" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="✅ Fast AC Repair Gujarat" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Ac Repair Gujarat in Vadodara?", a: "Ac Repair Gujarat cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Ac Repair Gujarat?", a: "Atlas Aircon offers same-day Ac Repair Gujarat across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Ac Repair Gujarats?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Ac Repair Gujarats depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Ac Repair Gujarat available on holidays?", a: "Yes, Atlas Aircon provides Ac Repair Gujarat 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
              { q: "How long does Ac Repair Gujarat take?", a: "Most Ac Repair Gujarats are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Ac Repair Gujarat in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Ac Repair Gujarat cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Ac Repair Gujarat?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Ac Repair Gujarat across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Ac Repair Gujarats?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Ac Repair Gujarats depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Ac Repair Gujarat available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Ac Repair Gujarat 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
          { "@type": "Question", name: "How long does Ac Repair Gujarat take?", acceptedAnswer: { "@type": "Answer", text: "Most Ac Repair Gujarats are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
