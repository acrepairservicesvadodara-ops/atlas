...
export const metadata: Metadata = {
  title: "Non-Inverter AC Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Non-inverter AC repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Non-Inverter AC Repair Vadodara",
    "non inverter ac repair",
    "Non-Inverter AC Repair installation",
    "Non-Inverter AC Repair service",
    "Non-Inverter AC Repair repair",
    "best Non-Inverter AC Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/non-inverter-ac-repair-vadodara",
  },
};

const keywordData = {
  title: "Non-Inverter AC Repair",
  slug: "non-inverter-ac-repair",
  description: "Non-inverter AC repair",
  category: "ACTypes"
};
...
export default function NonInverterACRepairPage() {
  return (
    <>
      {/* Hero Section */}
