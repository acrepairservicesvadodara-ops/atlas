...
export const metadata: Metadata = {
  title: "VRF System Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "VRF AC system repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "VRF System Repair Vadodara",
    "vrf system repair",
    "VRF System Repair installation",
    "VRF System Repair service",
    "VRF System Repair repair",
    "best VRF System Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/vrf-system-repair-vadodara",
  },
};

const keywordData = {
  title: "VRF System Repair",
  slug: "vrf-system-repair",
  description: "VRF AC system repair",
  category: "HVAC"
};
...
export default function VRFSystemRepairPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVvrf system repair vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial vrf system repair vadodara?", a: "Industrial vrf system repair vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVvrf system repair vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial vrf system repair vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial vrf system repair vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
