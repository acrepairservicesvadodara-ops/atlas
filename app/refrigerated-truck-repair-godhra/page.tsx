...
export const metadata: Metadata = {
  title: "Expert Refrigerated Truck Repair In Godhra | Hitech Aircool Engineers Gujarat",
  description: "Urgent reefer truck repair in Godhra? Our local workshop offers 24/7 emergency service, genuine parts & expert repair for dairy & produce transport. Call now!",
  alternates: { canonical: "https://hitechairconditioning.in/refrigerated-truck-repair-godhra" },
  openGraph: {
    title: "Expert Refrigerated Truck Repair In Godhra | Hitech Aircool Engineers",
    description: "Urgent reefer truck repair in Godhra? Our local workshop offers 24/7 emergency service, genuine parts & expert repair for dairy & produce transport. Call now!",
    url: "https://hitechairconditioning.in/refrigerated-truck-repair-godhra",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Expert Refrigerated Truck Repair In Godhra",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagerefrigeratedtruckrepairgodhra() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Expert Refrigerated Truck Repair In Godhra</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Urgent reefer truck repair in Godhra? Our local workshop offers 24/7 emergency service, genuine parts &amp; expert repair for dairy &amp; produce transport. Call now!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Urgent reefer truck repair in Godhra? Our local workshop offers 24/7 emergency service, genuine parts &amp; expert repair for dairy &amp; produce transport. Call now!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/refrigerated-truck-repair-service.webp" alt="Expert Refrigerated Truck Repair In Godhra" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Expert Refrigerated Truck Repair In Godhra" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Refrigerated Truck Repair Godhra in Vadodara?", a: "Refrigerated Truck Repair Godhra cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Refrigerated Truck Repair Godhra?", a: "Hitech Aircool Engineers offers same-day Refrigerated Truck Repair Godhra across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Refrigerated Truck Repair Godhras?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Refrigerated Truck Repair Godhras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Refrigerated Truck Repair Godhra available on holidays?", a: "Yes, Hitech Aircool Engineers provides Refrigerated Truck Repair Godhra 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Refrigerated Truck Repair Godhra take?", a: "Most Refrigerated Truck Repair Godhras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Refrigerated Truck Repair Godhra in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Refrigerated Truck Repair Godhra cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Refrigerated Truck Repair Godhra?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Refrigerated Truck Repair Godhra across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Refrigerated Truck Repair Godhras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Refrigerated Truck Repair Godhras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Refrigerated Truck Repair Godhra available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Refrigerated Truck Repair Godhra 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Refrigerated Truck Repair Godhra take?", acceptedAnswer: { "@type": "Answer", text: "Most Refrigerated Truck Repair Godhras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
