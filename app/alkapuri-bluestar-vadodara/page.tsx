...
export const metadata: Metadata = {
  title: "Alkapuri Bluestar in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Blue Star service Alkapuri in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Alkapuri Bluestar Vadodara",
    "alkapuri bluestar",
    "Alkapuri Bluestar installation",
    "Alkapuri Bluestar service",
    "Alkapuri Bluestar repair",
    "best Alkapuri Bluestar service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/alkapuri-bluestar-vadodara",
  },
};

const keywordData = {
  title: "Alkapuri Bluestar",
  slug: "alkapuri-bluestar",
  description: "Blue Star service Alkapuri",
  category: "Area"
};
...
export default function AlkapuriBluestarPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What alkapuri bluestar vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides alkapuri bluestar vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book alkapuri bluestar vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency alkapuri bluestar vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What alkapuri bluestar vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides alkapuri bluestar vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book alkapuri bluestar vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency alkapuri bluestar vadodara available. Call +91 93289 53665 for immediate assistance." } },
