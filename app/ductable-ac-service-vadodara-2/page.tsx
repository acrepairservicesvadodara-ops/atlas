...
export const metadata: Metadata = {
  title: "Professional Ductable AC Service Vadodara | Hitech Aircool Engineers Gujarat",
  description: "🚨 24/7 Emergency Ductable AC Service Vadodara! Expert repair, installation & maintenance by certified technicians. Fast, affordable & guaranteed. Get a free qu",
  alternates: { canonical: "https://hitechairconditioning.in/ductable-ac-service-vadodara-2" },
  openGraph: {
    title: "Professional Ductable AC Service Vadodara | Hitech Aircool Engineers",
    description: "🚨 24/7 Emergency Ductable AC Service Vadodara! Expert repair, installation & maintenance by certified technicians. Fast, affordable & guaranteed. Get a free qu",
    url: "https://hitechairconditioning.in/ductable-ac-service-vadodara-2",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Professional Ductable AC Service Vadodara",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageductableacservicevadodara2() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Professional Ductable AC Service Vadodara</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">🚨 24/7 Emergency Ductable AC Service Vadodara! Expert repair, installation &amp; maintenance by certified technicians. Fast, affordable &amp; guaranteed. Get a free quote today.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">🚨 24/7 Emergency Ductable AC Service Vadodara! Expert repair, installation &amp; maintenance by certified technicians. Fast, affordable &amp; guaranteed. Get a free quote today.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/hitech-logo.webp" alt="Professional Ductable AC Service Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Professional Ductable AC Service Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
