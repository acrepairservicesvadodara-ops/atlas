...
export const metadata: Metadata = {
  title: "Professional Ductable AC Service Vadodara | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ductable-ac-service-vadodara-2" },
  openGraph: {
    title: "Professional Ductable AC Service Vadodara | Atlas Aircon",
    description: "🚨 24/7 Emergency Ductable AC Service Vadodara! Expert repair, installation & maintenance by certified technicians. Fast, affordable & guaranteed. Get a free qu",
    url: "https://atlasaircons.com/ductable-ac-service-vadodara-2",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">🚨 24/7 Emergency Ductable AC Service Vadodara! Expert repair, installation &amp; maintenance by certified technicians. Fast, affordable &amp; guaranteed. Get a free quote today.</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/cropped-AtlasAircon-Logo.webp" alt="Professional Ductable AC Service Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
