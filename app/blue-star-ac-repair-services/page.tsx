...
export const metadata: Metadata = {
  title: "❄️Expert Blue Star AC Repair Services: Trust Atlas Aircon❄️ [2026 Updated] | Atlas Aircon Gujarat",
  description: "Mastering Blue Star AC Repair: Your Trusted Guide to Expert Solutions by Atlas Aircon Experience top-tier <a href=\"https://atlasaircons.com/ac-...",
  alternates: { canonical: "https://atlasaircons.com/blue-star-ac-repair-services" },
  openGraph: {
    title: "❄️Expert Blue Star AC Repair Services: Trust Atlas Aircon❄️ [2026 Updated] | Atlas Aircon",
    description: "Mastering Blue Star AC Repair: Your Trusted Guide to Expert Solutions by Atlas Aircon Experience top-tier <a href=\"https://atlasaircons.com/ac-...",
    url: "https://atlasaircons.com/blue-star-ac-repair-services",
    type: "website",
    images: ["/images/products/Blue-Star-Ac-Repair-Service.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "❄️Expert Blue Star AC Repair Services: Trust Atlas Aircon❄️ [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
...
export default function Pagebluestaracrepairservices() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">❄️Expert Blue Star AC Repair Services: Trust Atlas Aircon❄️ [2026 Updated]</h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Mastering Blue Star AC Repair: Your Trusted Guide to Expert Solutions by Atlas Aircon Experience top-tier &lt;a href=&quot;https://atlasaircons.com/ac-...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Mastering Blue Star AC Repair: Your Trusted Guide to Expert Solutions by Atlas Aircon Experience top-tier &lt;a href=&quot;https://atlasaircons.com/ac-...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Blue-Star-Ac-Repair-Service.webp" alt="❄️Expert Blue Star AC Repair Services: Trust Atlas Aircon❄️ [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="❄️Expert Blue Star AC Repair Services: Trust Atlas Aircon❄️ [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="❄️Expert Blue Star AC Repair Services: Trust Atlas Aircon❄️ [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Blue-Star-Ac-Repair-Service.webp" alt="❄️Expert Blue Star AC Repair Services: Trust Atlas Aircon❄️ [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Blue-Star-Ac-Repair-Service.webp" alt="❄️Expert Blue Star AC Repair Services: Trust Atlas Aircon❄️ [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Blue-Star-Ac-Repair-Service.webp" alt="❄️Expert Blue Star AC Repair Services: Trust Atlas Aircon❄️ [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
