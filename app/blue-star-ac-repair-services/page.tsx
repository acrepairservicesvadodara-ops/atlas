...
export const metadata: Metadata = {
  title: "❄️Expert Blue Star AC Repair Services: Trust Hitech Aircool Engineers❄️ [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Mastering Blue Star AC Repair: Your Trusted Guide to Expert Solutions by Hitech Aircool Engineers Experience top-tier <a href=\"https://hitechairconditioning.in/ac-...",
  alternates: { canonical: "https://hitechairconditioning.in/blue-star-ac-repair-services" },
  openGraph: {
    title: "❄️Expert Blue Star AC Repair Services: Trust Hitech Aircool Engineers❄️ [2026 Updated] | Hitech Aircool Engineers",
    description: "Mastering Blue Star AC Repair: Your Trusted Guide to Expert Solutions by Hitech Aircool Engineers Experience top-tier <a href=\"https://hitechairconditioning.in/ac-...",
    url: "https://hitechairconditioning.in/blue-star-ac-repair-services",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "❄️Expert Blue Star AC Repair Services: Trust Hitech Aircool Engineers❄️ [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">❄️Expert Blue Star AC Repair Services: Trust Hitech Aircool Engineers❄️ [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Mastering Blue Star AC Repair: Your Trusted Guide to Expert Solutions by Hitech Aircool Engineers Experience top-tier &lt;a href=&quot;https://hitechairconditioning.in/ac-...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Mastering Blue Star AC Repair: Your Trusted Guide to Expert Solutions by Hitech Aircool Engineers Experience top-tier &lt;a href=&quot;https://hitechairconditioning.in/ac-...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Blue-Star-Ac-Repair-Service.webp" alt="❄️Expert Blue Star AC Repair Services: Trust Hitech Aircool Engineers❄️ [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="❄️Expert Blue Star AC Repair Services: Trust Hitech Aircool Engineers❄️ [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="❄️Expert Blue Star AC Repair Services: Trust Hitech Aircool Engineers❄️ [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Blue-Star-Ac-Repair-Service.webp" alt="❄️Expert Blue Star AC Repair Services: Trust Hitech Aircool Engineers❄️ [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Blue-Star-Ac-Repair-Service.webp" alt="❄️Expert Blue Star AC Repair Services: Trust Hitech Aircool Engineers❄️ [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Blue-Star-Ac-Repair-Service.webp" alt="❄️Expert Blue Star AC Repair Services: Trust Hitech Aircool Engineers❄️ [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
