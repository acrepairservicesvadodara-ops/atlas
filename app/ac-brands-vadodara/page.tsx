...
export const metadata: Metadata = {
  title: "AC Brands in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "All AC brands service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC Brands Vadodara",
    "ac brands",
    "AC Brands installation",
    "AC Brands service",
    "AC Brands repair",
    "best AC Brands service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-brands-vadodara",
  },
};
...
const keywordData = {
  title: "AC Brands",
  slug: "ac-brands",
  description: "All AC brands service",
  ...
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What ac brands vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides ac brands vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book ac brands vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency ac brands vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What ac brands vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides ac brands vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book ac brands vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency ac brands vadodara available. Call +91 93289 53665 for immediate assistance." } },
