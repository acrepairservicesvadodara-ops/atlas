...
export const metadata: Metadata = {
  title: "Godrej AC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Godrej AC service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Godrej AC Vadodara",
    "godrej ac",
  ...
  alternates: {
    canonical: "https://hitechairconditioning.in/godrej-ac-vadodara",
  },
};
...
export default function GodrejACPage() {
  return (
    <>
      {/* Hero Section */}
