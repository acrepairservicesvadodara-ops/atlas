...
export const metadata: Metadata = {
  title: "Thermostat Repair AC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC thermostat repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Thermostat Repair AC Vadodara",
    "thermostat repair ac",
    "Thermostat Repair AC installation",
    "Thermostat Repair AC service",
    "Thermostat Repair AC repair",
    "best Thermostat Repair AC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/thermostat-repair-ac-vadodara",
  },
};

const keywordData = {
  title: "Thermostat Repair AC",
  slug: "thermostat-repair-ac",
  description: "AC thermostat repair",
  category: "Problems"
};
...
export default function ThermostatRepairACPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Thermostat Repair Ac Vadodara in Vadodara?", a: "Thermostat Repair Ac Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Thermostat Repair Ac Vadodara?", a: "Hitech Aircool Engineers offers same-day Thermostat Repair Ac Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Thermostat Repair Ac Vadodaras?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Thermostat Repair Ac Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Thermostat Repair Ac Vadodara available on holidays?", a: "Yes, Hitech Aircool Engineers provides Thermostat Repair Ac Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Thermostat Repair Ac Vadodara take?", a: "Most Thermostat Repair Ac Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Thermostat Repair Ac Vadodara in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Thermostat Repair Ac Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Thermostat Repair Ac Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Thermostat Repair Ac Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Thermostat Repair Ac Vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Thermostat Repair Ac Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Thermostat Repair Ac Vadodara available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Thermostat Repair Ac Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Thermostat Repair Ac Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Most Thermostat Repair Ac Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
