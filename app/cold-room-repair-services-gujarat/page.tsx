...
export const metadata: Metadata = {
  title: "Gujarat's #1 Cold Room Repair Service: 24/7 Across Cities! [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/cold-room-repair-services-gujarat" },
  openGraph: {
    title: "Gujarat's #1 Cold Room Repair Service: 24/7 Across Cities! [2026 Updated] | Atlas Aircon",
    description: "Leading cold room repair services Gujarat with a network of certified technicians in Ahmedabad, Vadodara, Surat & more. 24/7 emergency industrial, dairy & comme",
    url: "https://atlasaircons.com/cold-room-repair-services-gujarat",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Leading cold room repair services Gujarat with a network of certified technicians in Ahmedabad, Vadodara, Surat &amp; more. 24/7 emergency industrial, dairy &amp; commercial cold storage repair. All Gujarat covered.</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVcold room repair services gujarats?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVcold room repair services gujarats?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
