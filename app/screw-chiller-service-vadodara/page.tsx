...
export const metadata: Metadata = {
  title: "Screw Chiller Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Screw chiller repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Screw Chiller Service Vadodara",
    "screw chiller service",
    "Screw Chiller Service installation",
    "Screw Chiller Service service",
    "Screw Chiller Service repair",
    "best Screw Chiller Service service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/screw-chiller-service-vadodara",
  },
};

const keywordData = {
  title: "Screw Chiller Service",
  slug: "screw-chiller-service",
  description: "Screw chiller repair",
  category: "Commercial"
};
...
export default function ScrewChillerServicePage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVscrew chiller service vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial screw chiller service vadodara?", a: "Industrial screw chiller service vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVscrew chiller service vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial screw chiller service vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial screw chiller service vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
