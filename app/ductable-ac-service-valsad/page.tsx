...
export const metadata: Metadata = {
  title: "Expert Ductable AC Service Valsad | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ductable-ac-service-valsad" },
  openGraph: {
    title: "Expert Ductable AC Service Valsad | Atlas Aircon",
    description: "Professional HVAC contractor for Valsad's industries, offices & homes. Specialized ductable AC installation, urgent repair & comprehensive AMC for GIDC units. F",
    url: "https://atlasaircons.com/ductable-ac-service-valsad",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Professional HVAC contractor for Valsad&apos;s industries, offices &amp; homes. Specialized ductable AC installation, urgent repair &amp; comprehensive AMC for GIDC units. Fast, reliable local service. Ductable AC Service Valsad</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/cropped-AtlasAircon-Logo.webp" alt="Expert Ductable AC Service Valsad" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
