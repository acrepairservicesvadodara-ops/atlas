...
export const metadata: Metadata = {
  title: "Walkin Dismantling & Re-Installation Services | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "A complex task requiring expertise. We dismantle walk-in cooler/freezer panels, doors, evaporators, and electrical controls piece by piece, labeling eve...",
  keywords: ["walkin dismantling & re-installation services | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "installation"],
  alternates: { canonical: "https://atlasaircons.com/walkin-dismantling-re-installation-services-hitech-aircool-engineers" },
  openGraph: {
    title: "Walkin Dismantling & Re-Installation Services | Hitech Aircool Engineers",
    description: "A complex task requiring expertise. We dismantle walk-in cooler/freezer panels, doors, evaporators, and electrical controls piece by piece, labeling eve...",
    url: "https://atlasaircons.com/walkin-dismantling-re-installation-services-hitech-aircool-engineers",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Walkin Dismantling & Re-Installation Services | Hitech Aircool Engineers",
  description: "A complex task requiring expertise. We dismantle walk-in cooler/freezer panels, doors, evaporators, and electrical controls piece by piece, labeling everything. At the new site, we reassemble on a prepared floor, ensuring perfect alignment of panels for thermal integrity, re-pipe the refrigeration s",
...
export default function Pagewalkindismantlingreinstallationservicesh() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  ...
                  alt="Walkin Dismantling & Re-Installation Services | Hitech Aircool Engineers"
                ...
                <img
                  ...
                  alt="Walkin Dismantling & Re-Installation Services | Hitech Aircool Engineers - Image 2"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Walkin Dismantling & Re-Installation Services | Hitech Aircool Engineers - Image 3"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Walkin Dismantling & Re-Installation Services | Hitech Aircool Engineers - Image 4"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Walkin Dismantling &amp; Re-Installation Services | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">A complex task requiring expertise. We dismantle walk-in cooler/freezer panels, doors, evaporators, and electrical controls piece by piece, labeling e</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%20Walkin%20Dismantling%20%26%20Re-Installation%20Services%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>A complex task requiring expertise. We dismantle walk-in cooler/freezer panels, doors, evaporators, and electrical controls piece by piece, labeling everything. At the new site, we reassemble on a prepared floor, ensuring perfect alignment of panels for thermal integrity, re-pipe the refrigeration system, and recommission the unit.</p>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[{"url":"https://www.atlasaircons.com/side-mount-air-curtains-vertical-hitech-aircool-engineers/","title":"Side-Mount Air Curtains (Vertical) | Hitech Aircool Engineers","price":""},{"url":"https://www.atlasaircons.com/24x7-washing-machine-emergency-service-hitech-aircool-engineers/","title":"24X7 Washing Machine Emergency Service | Hitech Aircool Engineers","price":""}].map((p: { url: string; title: string; price: string }) => (
