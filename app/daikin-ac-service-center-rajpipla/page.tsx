...
export const metadata: Metadata = {
  title: "Daikin AC Service Center Rajpipla | Out-of-Warranty Repair Expert | Atlas Aircon",
  description: "Independent Daikin AC service center in Rajpipla. Expert out-of-warranty split AC repair, gas charging, PCB repair, deep cleaning & compressor overhaul. Same-day service. Call +91 97272 57141.",
  keywords: [
    "daikin ac service center rajpipla",
    "daikin ac repair rajpipla",
    "daikin ac service rajpipla",
    "daikin split ac repair rajpipla",
    "daikin ac gas charging rajpipla",
    "daikin ac pcb repair rajpipla",
    "daikin ac installation rajpipla",
    "daikin ac not cooling rajpipla",
    "ac service center rajpipla",
    "best ac repair rajpipla",
  ],
  alternates: { canonical: "https://atlasaircons.com/daikin-ac-service-center-rajpipla" },
  openGraph: {
    title: "Daikin AC Service Center Rajpipla | Atlas Aircon",
    description: "Independent out-of-warranty Daikin AC repair specialist in Rajpipla. Same-day service, 90-day guarantee.",
    url: "https://atlasaircons.com/daikin-ac-service-center-rajpipla",
    type: "website",
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Daikin AC Service Center Rajpipla",
  ...
  description: "Independent, out-of-warranty Daikin AC repair, maintenance and installation in Rajpipla, Gujarat.",
};
...
const faqJsonLd = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "Is Atlas Aircon an authorized Daikin service center in Rajpipla?", acceptedAnswer: { "@type": "Answer", text: "No. Atlas Aircon is an independent service provider specializing in high-quality out-of-warranty repairs. If your Daikin AC is under official warranty, contact Daikin directly." } },
    { "@type": "Question", name: "How quickly can you repair my Daikin AC in Rajpipla?", acceptedAnswer: { "@type": "Answer", text: "We offer same-day service across Rajpipla. Our technicians typically arrive within 45-60 minutes of your call for emergency repairs." } },
    { "@type": "Question", name: "What is the cost of Daikin AC gas refilling in Rajpipla?", acceptedAnswer: { "@type": "Answer", text: "Gas refilling for Daikin ACs starts at \u20B92,500 including leak detection. Final cost depends on the refrigerant type (R32/R410A) and quantity needed." } },
...
export default function DaikinServiceCenterRajpiplaPage() {
  return (
    <>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                <span className="text-yellow-400">Daikin AC Service Center</span> Rajpipla
              </h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                Expert independent repair solutions for Daikin air conditioners in Rajpipla. Specializing in out-of-warranty service with same-day dispatch and a full satisfaction guarantee.
              </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">Daikin AC Repair Price List — Rajpipla</h2>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Daikin AC Service FAQs — Rajpipla</h2>
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              ...
              { q: "How quickly can you repair my Daikin AC in Rajpipla?", a: "Same-day service is standard. Emergency calls are attended within 45-60 minutes across Rajpipla." },
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Need Daikin AC Repair in Rajpipla?</h2>
