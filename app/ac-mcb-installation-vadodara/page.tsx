...
export const metadata: Metadata = {
  title: "AC MCB Installation in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC MCB fitting in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC MCB Installation Vadodara",
    "ac mcb installation",
    "AC MCB Installation installation",
    "AC MCB Installation service",
    "AC MCB Installation repair",
    "best AC MCB Installation service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-mcb-installation-vadodara",
  },
};

const keywordData = {
  title: "AC MCB Installation",
  slug: "ac-mcb-installation",
  description: "AC MCB fitting",
  category: "Parts"
};
...
export default function ACMCBInstallationPage() {
  return (
    <>
      {/* Hero Section */}
