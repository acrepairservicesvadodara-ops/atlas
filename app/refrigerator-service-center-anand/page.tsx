...
export const metadata: Metadata = {
  title: "Quick Refrigerator Repair In Anand [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Your fridge broke down in Anand? Our expert technicians provide same-day, doorstep refrigerator repair with genuine parts & a 100-day warranty. Call for service",
  alternates: { canonical: "https://hitechairconditioning.in/refrigerator-service-center-anand" },
  openGraph: {
    title: "Quick Refrigerator Repair In Anand [2026 Updated] | Hitech Aircool Engineers",
    description: "Your fridge broke down in Anand? Our expert technicians provide same-day, doorstep refrigerator repair with genuine parts & a 100-day warranty. Call for service",
    url: "https://hitechairconditioning.in/refrigerator-service-center-anand",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Quick Refrigerator Repair In Anand [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagerefrigeratorservicecenteranand() {
  return (
    <>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur px-4 py-2 rounded-full text-sm mb-6">
                <MapPin className="w-4 h-4" /><span>Anand, Gujarat</span>
              </div>
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Quick Refrigerator Repair In Anand [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Your fridge broke down in Anand? Our expert technicians provide same-day, doorstep refrigerator repair with genuine parts &amp; a 100-day warranty. Call for service!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Your fridge broke down in Anand? Our expert technicians provide same-day, doorstep refrigerator repair with genuine parts &amp; a 100-day warranty. Call for service!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Refrigerator-Buying-Guide.webp" alt="Quick Refrigerator Repair In Anand [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Quick Refrigerator Repair In Anand [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Refrigerator Service Center Anand include?", a: "Refrigerator Service Center Anand includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Refrigerator Service Center Anand cost?", a: "Refrigerator Service Center Anand starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Refrigerator Service Center Anand improve cooling?", a: "Yes, proper Refrigerator Service Center Anand can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Refrigerator Service Center Anand reduce electricity bills?", a: "Regular Refrigerator Service Center Anand can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Refrigerator Service Center Anand take?", a: "Basic Refrigerator Service Center Anand takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Refrigerator Service Center Anand remove bad smell?", a: "Yes, Refrigerator Service Center Anand includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Refrigerator Service Center Anand?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Refrigerator Service Center Anand include?", acceptedAnswer: { "@type": "Answer", text: "Refrigerator Service Center Anand includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Refrigerator Service Center Anand cost?", acceptedAnswer: { "@type": "Answer", text: "Refrigerator Service Center Anand starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Refrigerator Service Center Anand improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Refrigerator Service Center Anand can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Refrigerator Service Center Anand reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Refrigerator Service Center Anand can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Refrigerator Service Center Anand take?", acceptedAnswer: { "@type": "Answer", text: "Basic Refrigerator Service Center Anand takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Refrigerator Service Center Anand remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Refrigerator Service Center Anand includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Refrigerator Service Center Anand?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
