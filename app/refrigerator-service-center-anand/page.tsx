...
export const metadata: Metadata = {
  title: "Quick Refrigerator Repair In Anand [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/refrigerator-service-center-anand" },
  openGraph: {
    title: "Quick Refrigerator Repair In Anand [2026 Updated] | Atlas Aircon",
    description: "Your fridge broke down in Anand? Our expert technicians provide same-day, doorstep refrigerator repair with genuine parts & a 100-day warranty. Call for service",
    url: "https://atlasaircons.com/refrigerator-service-center-anand",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Your fridge broke down in Anand? Our expert technicians provide same-day, doorstep refrigerator repair with genuine parts &amp; a 100-day warranty. Call for service!</p>
