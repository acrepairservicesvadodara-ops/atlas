...
export const metadata: Metadata = {
  title: "Air Conditioning Repair, Installation, And Refilling Gas [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Air conditioning repair service as the summer season begins, we must plan our air conditioners to battle the summer weather. We...",
  alternates: { canonical: "https://hitechairconditioning.in/air-conditioning-repair-installation-and-refilling-services" },
  openGraph: {
    title: "Air Conditioning Repair, Installation, And Refilling Gas [2026 Updated] | Hitech Aircool Engineers",
    description: "Air conditioning repair service as the summer season begins, we must plan our air conditioners to battle the summer weather. We...",
    url: "https://hitechairconditioning.in/air-conditioning-repair-installation-and-refilling-services",
    type: "website",
    images: ["/images/products/technician-man-repairing-cleaning-maintenance-air-conditioner_101276-185.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Air Conditioning Repair, Installation, And Refilling Gas [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageairconditioningrepairinstallationandrefi() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Air Conditioning Repair, Installation, And Refilling Gas [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Air conditioning repair service as the summer season begins, we must plan our air conditioners to battle the summer weather. We...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Air conditioning repair service as the summer season begins, we must plan our air conditioners to battle the summer weather. We...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/technician-man-repairing-cleaning-maintenance-air-conditioner_101276-185.webp" alt="Air Conditioning Repair, Installation, And Refilling Gas [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Air Conditioning Repair, Installation, And Refilling Gas [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Air Conditioning Repair, Installation, And Refilling Gas [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
