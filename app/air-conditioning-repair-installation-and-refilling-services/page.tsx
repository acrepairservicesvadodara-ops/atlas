...
export const metadata: Metadata = {
  title: "Air Conditioning Repair, Installation, And Refilling Gas [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/air-conditioning-repair-installation-and-refilling-services" },
  openGraph: {
    title: "Air Conditioning Repair, Installation, And Refilling Gas [2026 Updated] | Atlas Aircon",
    description: "Air conditioning repair service as the summer season begins, we must plan our air conditioners to battle the summer weather. We...",
    url: "https://atlasaircons.com/air-conditioning-repair-installation-and-refilling-services",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Air conditioning repair service as the summer season begins, we must plan our air conditioners to battle the summer weather. We...</p>
