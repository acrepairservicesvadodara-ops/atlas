...
export const metadata: Metadata = {
  title: "Expert Package AC Service Godhra | Hitech Aircool Engineers Gujarat",
  description: "Professional package AC repair, gas filling & installation services in Godhra. We offer 24/7 emergency support, genuine spare parts & affordable maintenance pla",
  alternates: { canonical: "https://hitechairconditioning.in/package-ac-service-godhra" },
  openGraph: {
    title: "Expert Package AC Service Godhra | Hitech Aircool Engineers",
    description: "Professional package AC repair, gas filling & installation services in Godhra. We offer 24/7 emergency support, genuine spare parts & affordable maintenance pla",
    url: "https://hitechairconditioning.in/package-ac-service-godhra",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Expert Package AC Service Godhra",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagepackageacservicegodhra() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Expert Package AC Service Godhra</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Professional package AC repair, gas filling &amp; installation services in Godhra. We offer 24/7 emergency support, genuine spare parts &amp; affordable maintenance plans. Call for free AC checkup today!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Professional package AC repair, gas filling &amp; installation services in Godhra. We offer 24/7 emergency support, genuine spare parts &amp; affordable maintenance plans. Call for free AC checkup today!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/hitech-logo.webp" alt="Expert Package AC Service Godhra" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Expert Package AC Service Godhra" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
