...
export const metadata: Metadata = {
  title: "Expert Package AC Service Godhra | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/package-ac-service-godhra" },
  openGraph: {
    title: "Expert Package AC Service Godhra | Atlas Aircon",
    description: "Professional package AC repair, gas filling & installation services in Godhra. We offer 24/7 emergency support, genuine spare parts & affordable maintenance pla",
    url: "https://atlasaircons.com/package-ac-service-godhra",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Professional package AC repair, gas filling &amp; installation services in Godhra. We offer 24/7 emergency support, genuine spare parts &amp; affordable maintenance plans. Call for free AC checkup today!</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/cropped-AtlasAircon-Logo.webp" alt="Expert Package AC Service Godhra" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
