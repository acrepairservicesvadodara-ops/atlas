...
export const metadata: Metadata = {
  title: "Hitachi Authorized Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Hitachi authorized service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Hitachi Authorized Service Vadodara",
    "hitachi authorized service",
    "Hitachi Authorized Service installation",
    "Hitachi Authorized Service service",
    "Hitachi Authorized Service repair",
    "best Hitachi Authorized Service service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/hitachi-authorized-service-vadodara",
  },
};

const keywordData = {
  title: "Hitachi Authorized Service",
  slug: "hitachi-authorized-service",
  description: "Hitachi authorized service",
  category: "Brands"
};
...
export default function HitachiAuthorizedServicePage() {
  return (
    <>
      {/* Hero Section */}
