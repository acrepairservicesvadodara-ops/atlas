...
export const metadata: Metadata = {
  title: "Stay Cool: Ac Fan Motor Sales And Repair Service In Vadodara [2026 Updated] | Atlas Aircon Gujarat",
  description: "Professional stay cool: ac fan motor sales and repair service in vadodara [2026 updated] by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/ac-fan-motor-sales-and-repair-service" },
  openGraph: {
    title: "Stay Cool: Ac Fan Motor Sales And Repair Service In Vadodara [2026 Updated] | Atlas Aircon",
    description: "Professional stay cool: ac fan motor sales and repair service in vadodara [2026 updated] by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/ac-fan-motor-sales-and-repair-service",
    type: "website",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">&lt;meta name=&quot;viewport&quot; content=&quot;width=device-width, initial-s...</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Ac Fan Motor Sales And Repair Service in Vadodara?", a: "Ac Fan Motor Sales And Repair Service cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Ac Fan Motor Sales And Repair Service?", a: "Atlas Aircon offers same-day Ac Fan Motor Sales And Repair Service across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Ac Fan Motor Sales And Repair Services?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Ac Fan Motor Sales And Repair Services depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Ac Fan Motor Sales And Repair Service available on holidays?", a: "Yes, Atlas Aircon provides Ac Fan Motor Sales And Repair Service 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Ac Fan Motor Sales And Repair Service?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Ac Fan Motor Sales And Repair Service across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Ac Fan Motor Sales And Repair Services?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Ac Fan Motor Sales And Repair Services depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Ac Fan Motor Sales And Repair Service available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Ac Fan Motor Sales And Repair Service 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
