...
export const metadata: Metadata = {
  title: "Blue Star Service Center In AlkaPuri &raquo; Bluestar Ac Repair [2026 Updated] | Hitech Aircool Engineers Gujarat",
  ...
  alternates: { canonical: "https://hitechairconditioning.in/blue-star-service-center-in-alkapuri" },
  openGraph: {
    title: "Blue Star Service Center In AlkaPuri &raquo; Bluestar Ac Repair [2026 Updated] | Hitech Aircool Engineers",
    description: "Blue Star Service Center in AlkaPuri, Blue Star Service Center AlkaPuri, , Blue Star Appliance Repairs, , AlkaPuri Cooling Solutions, , Professional HVAC Servic",
    url: "https://hitechairconditioning.in/blue-star-service-center-in-alkapuri",
    type: "website",
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="https://www.hitechairconditioning.in/images/page-home/service01_list.jpg" alt="Blue Star Service Center In AlkaPuri &raquo; Bluestar Ac Repair [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
