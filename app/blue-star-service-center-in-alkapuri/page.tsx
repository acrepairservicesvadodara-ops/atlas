...
export const metadata: Metadata = {
  title: "Blue Star Service Center In AlkaPuri &raquo; Bluestar Ac Repair [2026 Updated] | Atlas Aircon Gujarat",
  description: "Blue Star Service Center in AlkaPuri, Blue Star Service Center AlkaPuri, , Blue Star Appliance Repairs, , AlkaPuri Cooling Solutions, , Professional HVAC Servic",
  alternates: { canonical: "https://atlasaircons.com/blue-star-service-center-in-alkapuri" },
  openGraph: {
    title: "Blue Star Service Center In AlkaPuri &raquo; Bluestar Ac Repair [2026 Updated] | Atlas Aircon",
    description: "Blue Star Service Center in AlkaPuri, Blue Star Service Center AlkaPuri, , Blue Star Appliance Repairs, , AlkaPuri Cooling Solutions, , Professional HVAC Servic",
    url: "https://atlasaircons.com/blue-star-service-center-in-alkapuri",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Blue Star Service Center In AlkaPuri &raquo; Bluestar Ac Repair [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
...
export default function Pagebluestarservicecenterinalkapuri() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Blue Star Service Center In AlkaPuri &amp;raquo; Bluestar Ac Repair [2026 Updated]</h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Blue Star Service Center in AlkaPuri, Blue Star Service Center AlkaPuri, , Blue Star Appliance Repairs, , AlkaPuri Cooling Solutions, , Professional HVAC Services, , Blue Star Maintenance Services, , Emergency Ac Repair AlkaPuri, , Certified Ac Technicians, , Air Conditioner Annual Maintenance Contr</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Blue Star Service Center in AlkaPuri, Blue Star Service Center AlkaPuri, , Blue Star Appliance Repairs, , AlkaPuri Cooling Solutions, , Professional HVAC Services, , Blue Star Maintenance Services, , Emergency Ac Repair AlkaPuri, , Certified Ac Technicians, , Air Conditioner Annual Maintenance Contract (AMC), , Genuine Blue Star Parts, , Cooling Appliance Diagnostics,</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="https://www.atlasaircons.com/images/page-home/service01_list.jpg" alt="Blue Star Service Center In AlkaPuri &raquo; Bluestar Ac Repair [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Blue Star Service Center In AlkaPuri &raquo; Bluestar Ac Repair [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
