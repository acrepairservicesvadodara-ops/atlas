...
export const metadata: Metadata = {
  title: "Expert Tips For Fully Automatic Washing Machine Repair! Cool [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Elevate Your Laundry Experience with Hitech Aircool Engineers's Advanced Fully Automatic Washing Machine Repair Service in Vadodara Are you facing issue...",
  alternates: { canonical: "https://hitechairconditioning.in/fully-automatic-washing-machine-repair" },
  openGraph: {
    title: "Expert Tips For Fully Automatic Washing Machine Repair! Cool [2026 Updated] | Hitech Aircool Engineers",
    description: "Elevate Your Laundry Experience with Hitech Aircool Engineers's Advanced Fully Automatic Washing Machine Repair Service in Vadodara Are you facing issue...",
    url: "https://hitechairconditioning.in/fully-automatic-washing-machine-repair",
    type: "website",
    images: ["/images/products/Fully-Automatic-washing-machine-repair-service.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Expert Tips For Fully Automatic Washing Machine Repair! Cool [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagefullyautomaticwashingmachinerepair() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Expert Tips For Fully Automatic Washing Machine Repair! Cool [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Elevate Your Laundry Experience with Hitech Aircool Engineers&apos;s Advanced Fully Automatic Washing Machine Repair Service in Vadodara Are you facing issue...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Elevate Your Laundry Experience with Hitech Aircool Engineers&apos;s Advanced Fully Automatic Washing Machine Repair Service in Vadodara Are you facing issue...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Fully-Automatic-washing-machine-repair-service.webp" alt="Expert Tips For Fully Automatic Washing Machine Repair! Cool [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Expert Tips For Fully Automatic Washing Machine Repair! Cool [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Expert Tips For Fully Automatic Washing Machine Repair! Cool [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Fully-Automatic-washing-machine-repair.webp" alt="Expert Tips For Fully Automatic Washing Machine Repair! Cool [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Fully-Automatic-washing-machine-repair.webp" alt="Expert Tips For Fully Automatic Washing Machine Repair! Cool [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Fully-Automatic-washing-machine-repair.webp" alt="Expert Tips For Fully Automatic Washing Machine Repair! Cool [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Fully Automatic Washing Machine Repair in Vadodara?", a: "Fully Automatic Washing Machine Repair cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Fully Automatic Washing Machine Repair?", a: "Hitech Aircool Engineers offers same-day Fully Automatic Washing Machine Repair across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Fully Automatic Washing Machine Repairs?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Fully Automatic Washing Machine Repairs depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Fully Automatic Washing Machine Repair available on holidays?", a: "Yes, Hitech Aircool Engineers provides Fully Automatic Washing Machine Repair 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Fully Automatic Washing Machine Repair take?", a: "Most Fully Automatic Washing Machine Repairs are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Fully Automatic Washing Machine Repair in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Fully Automatic Washing Machine Repair cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Fully Automatic Washing Machine Repair?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Fully Automatic Washing Machine Repair across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Fully Automatic Washing Machine Repairs?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Fully Automatic Washing Machine Repairs depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Fully Automatic Washing Machine Repair available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Fully Automatic Washing Machine Repair 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Fully Automatic Washing Machine Repair take?", acceptedAnswer: { "@type": "Answer", text: "Most Fully Automatic Washing Machine Repairs are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
