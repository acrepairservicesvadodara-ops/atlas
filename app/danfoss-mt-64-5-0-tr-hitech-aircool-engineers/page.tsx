...
export const metadata: Metadata = {
  title: "Danfoss – Mt 64 – 5.0 Tr | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "A 5 TR capacity compressor frequently used in larger commercial air conditioning systems and industrial process cooling. The MT 64 can handle both air c...",
  keywords: ["danfoss – mt 64 – 5.0 tr | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "danfoss"],
  alternates: { canonical: "https://atlasaircons.com/danfoss-mt-64-5-0-tr-hitech-aircool-engineers" },
  openGraph: {
    title: "Danfoss – Mt 64 – 5.0 Tr | Hitech Aircool Engineers",
    description: "A 5 TR capacity compressor frequently used in larger commercial air conditioning systems and industrial process cooling. The MT 64 can handle both air c...",
    url: "https://atlasaircons.com/danfoss-mt-64-5-0-tr-hitech-aircool-engineers",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Danfoss – Mt 64 – 5.0 Tr | Hitech Aircool Engineers",
  description: "A 5 TR capacity compressor frequently used in larger commercial air conditioning systems and industrial process cooling. The MT 64 can handle both air conditioning and refrigeration duties, making it a versatile component for system builders.",
...
export default function Pagedanfossmt6450trhitechaircoolengineers() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  ...
                  alt="Danfoss – Mt 64 – 5.0 Tr | Hitech Aircool Engineers"
                ...
                <img
                  ...
                  alt="Danfoss – Mt 64 – 5.0 Tr | Hitech Aircool Engineers - Image 2"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Danfoss – Mt 64 – 5.0 Tr | Hitech Aircool Engineers - Image 3"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Danfoss – Mt 64 – 5.0 Tr | Hitech Aircool Engineers - Image 4"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Danfoss – Mt 64 – 5.0 Tr | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">A 5 TR capacity compressor frequently used in larger commercial air conditioning systems and industrial process cooling. The MT 64 can handle both air</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%20Danfoss%20%E2%80%93%20Mt%2064%20%E2%80%93%205.0%20Tr%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Danfoss - Mt 64 - 5.0 Tr</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>A 5 TR capacity compressor frequently used in larger commercial air conditioning systems and industrial process cooling. The MT 64 can handle both air conditioning and refrigeration duties, making it a versatile component for system builders.</p>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What danfoss mt 64 5 0 tr hitech aircool engineerss does Atlas Aircon provide?", a: "Atlas Aircon provides danfoss mt 64 5 0 tr hitech aircool engineers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book danfoss mt 64 5 0 tr hitech aircool engineers?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency danfoss mt 64 5 0 tr hitech aircool engineers available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What danfoss mt 64 5 0 tr hitech aircool engineerss does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides danfoss mt 64 5 0 tr hitech aircool engineers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book danfoss mt 64 5 0 tr hitech aircool engineers?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency danfoss mt 64 5 0 tr hitech aircool engineers available. Call +91 97272 57141 for immediate assistance." } },
