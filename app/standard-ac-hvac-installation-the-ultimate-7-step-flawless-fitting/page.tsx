...
export const metadata: Metadata = {
  title: "Standard AC & HVAC Installation: The Ultimate 7-Step Flawles | Hitech Aircool Engineers Blog",
  description: "Professional standard ac & hvac installation: the ultimate 7-step flawles by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/standard-ac-hvac-installation-the-ultimate-7-step-flawless-fitting" },
  openGraph: {
    title: "Standard AC & HVAC Installation: The Ultimate 7-Step Flawles | Hitech Aircool Engineers",
    description: "Professional standard ac & hvac installation: the ultimate 7-step flawles by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/standard-ac-hvac-installation-the-ultimate-7-step-flawless-fitting",
    type: "article",
...
const jsonLd = {
  ...
  mainEntityOfPage: "https://hitechairconditioning.in/standard-ac-hvac-installation-the-ultimate-7-step-flawless-fitting",
  ...
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVstandard ac hvac installation the ultimate 7 step flawless fittings?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVstandard ac hvac installation the ultimate 7 step flawless fittings?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
