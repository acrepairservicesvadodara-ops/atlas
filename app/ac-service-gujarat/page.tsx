...
export const metadata: Metadata = {
  title: "🏅 AC Service Gujarat | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-gujarat" },
  openGraph: {
    title: "🏅 AC Service Gujarat | Atlas Aircon",
    description: "Gujarat's gold-standard AC service network! Professional maintenance, repair & AMC plans available in all 33 districts. Certified technicians with 24/7 support.",
    url: "https://atlasaircons.com/ac-service-gujarat",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Gujarat&apos;s gold-standard AC service network! Professional maintenance, repair &amp; AMC plans available in all 33 districts. Certified technicians with 24/7 support. Book now!</p>
