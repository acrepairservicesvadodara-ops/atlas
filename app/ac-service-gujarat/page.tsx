...
export const metadata: Metadata = {
  title: "🏅 AC Service Gujarat | Hitech Aircool Engineers Gujarat",
  description: "Gujarat's gold-standard AC service network! Professional maintenance, repair & AMC plans available in all 33 districts. Certified technicians with 24/7 support.",
  alternates: { canonical: "https://hitechairconditioning.in/ac-service-gujarat" },
  openGraph: {
    title: "🏅 AC Service Gujarat | Hitech Aircool Engineers",
    description: "Gujarat's gold-standard AC service network! Professional maintenance, repair & AMC plans available in all 33 districts. Certified technicians with 24/7 support.",
    url: "https://hitechairconditioning.in/ac-service-gujarat",
    type: "website",
...
export default function Pageacservicegujarat() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">🏅 AC Service Gujarat</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Gujarat&apos;s gold-standard AC service network! Professional maintenance, repair &amp; AMC plans available in all 33 districts. Certified technicians with 24/7 support. Book now!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Gujarat&apos;s gold-standard AC service network! Professional maintenance, repair &amp; AMC plans available in all 33 districts. Certified technicians with 24/7 support. Book now!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/emergency-ac-repairing.webp" alt="🏅 AC Service Gujarat" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="🏅 AC Service Gujarat" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Ac Service Gujarat include?", a: "Ac Service Gujarat includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Ac Service Gujarat cost?", a: "Ac Service Gujarat starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Ac Service Gujarat improve cooling?", a: "Yes, proper Ac Service Gujarat can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Ac Service Gujarat reduce electricity bills?", a: "Regular Ac Service Gujarat can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Ac Service Gujarat take?", a: "Basic Ac Service Gujarat takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Ac Service Gujarat remove bad smell?", a: "Yes, Ac Service Gujarat includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Ac Service Gujarat?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Ac Service Gujarat include?", acceptedAnswer: { "@type": "Answer", text: "Ac Service Gujarat includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Ac Service Gujarat cost?", acceptedAnswer: { "@type": "Answer", text: "Ac Service Gujarat starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Ac Service Gujarat improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Ac Service Gujarat can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Ac Service Gujarat reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Ac Service Gujarat can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Ac Service Gujarat take?", acceptedAnswer: { "@type": "Answer", text: "Basic Ac Service Gujarat takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Ac Service Gujarat remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Ac Service Gujarat includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Ac Service Gujarat?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
