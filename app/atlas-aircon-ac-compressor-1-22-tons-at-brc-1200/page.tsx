...
export const metadata: Metadata = {
  title: "Top-Quality Ac Compressors | Hitech Aircool Engineers Gujarat",
  description: "Hitech Aircool Engineers AC Compressor (AT-BRC-1200) For Sale | Buy Danfoss, Copeland, & Kirloskar Compressors Online (1-22 Ton) | Scr...",
  alternates: { canonical: "https://hitechairconditioning.in/atlas-aircon-ac-compressor-1-22-tons-at-brc-1200" },
  openGraph: {
    title: "Top-Quality Ac Compressors | Hitech Aircool Engineers",
    description: "Hitech Aircool Engineers AC Compressor (AT-BRC-1200) For Sale | Buy Danfoss, Copeland, & Kirloskar Compressors Online (1-22 Ton) | Scr...",
    url: "https://hitechairconditioning.in/atlas-aircon-ac-compressor-1-22-tons-at-brc-1200",
    type: "website",
    images: ["/images/products/ac-compressor.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Top-Quality Ac Compressors",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageatlasairconaccompressor122tonsatbrc1200() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Top-Quality Ac Compressors</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Hitech Aircool Engineers AC Compressor (AT-BRC-1200) For Sale | Buy Danfoss, Copeland, &amp; Kirloskar Compressors Online (1-22 Ton) | Scr...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Hitech Aircool Engineers AC Compressor (AT-BRC-1200) For Sale | Buy Danfoss, Copeland, &amp; Kirloskar Compressors Online (1-22 Ton) | Scr...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/ac-compressor.webp" alt="Top-Quality Ac Compressors" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Ac-Compressor-2.webp" alt="Top-Quality Ac Compressors" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Air-Conditioning-Compressors-1.webp" alt="Top-Quality Ac Compressors" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/air-conditioner-compressor.webp" alt="Top-Quality Ac Compressors" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What hitech aircool engineers ac compressor 1 22 tons at brc 1200s does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides hitech aircool engineers ac compressor 1 22 tons at brc 1200, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book hitech aircool engineers ac compressor 1 22 tons at brc 1200?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency hitech aircool engineers ac compressor 1 22 tons at brc 1200 available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What hitech aircool engineers ac compressor 1 22 tons at brc 1200s does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides hitech aircool engineers ac compressor 1 22 tons at brc 1200, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book hitech aircool engineers ac compressor 1 22 tons at brc 1200?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency hitech aircool engineers ac compressor 1 22 tons at brc 1200 available. Call +91 93289 53665 for immediate assistance." } },
