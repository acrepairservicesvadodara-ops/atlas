...
export const metadata: Metadata = {
  title: "Package AC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Package AC repair service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Package AC Vadodara",
    "package ac",
    ...
    "Package AC service",
    "Package AC repair",
    "best Package AC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/package-ac-vadodara",
  },
};
...
const keywordData = {
  title: "Package AC",
  slug: "package-ac",
  description: "Package AC repair service",
  category: "ACTypes"
};
...
export default function PackageACPage() {
  return (
    <>
      {/* Hero Section */}
