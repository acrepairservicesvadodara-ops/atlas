...
export const metadata: Metadata = {
  title: "Second Hand Ac Buyers & Dealers » Call Now On +91-9328953665 [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Second Hand Ac Buyers & Dealers » Call Now On +91-9328953665 [2026 Updated] - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/second-hand-ac-buyers-dealers" },
  openGraph: {
    title: "Second Hand Ac Buyers & Dealers » Call Now On +91-9328953665 [2026 Updated] | Hitech Aircool Engineers",
    description: "Second Hand Ac Buyers & Dealers » Call Now On +91-9328953665 [2026 Updated] - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/second-hand-ac-buyers-dealers",
    type: "website",
    images: ["/images/products/Buy-and-Sell-Air-Conditioner.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Second Hand Ac Buyers & Dealers » Call Now On +91-9328953665 [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagesecondhandacbuyersdealers() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Second Hand Ac Buyers &amp; Dealers » Call Now On +91-9328953665 [2026 Updated]</h1>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Buy-and-Sell-Air-Conditioner.webp" alt="Second Hand Ac Buyers & Dealers » Call Now On +91-9328953665 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Second Hand Ac Buyers & Dealers » Call Now On +91-9328953665 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Second Hand Ac Buyers & Dealers » Call Now On +91-9328953665 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What second hand ac buyers dealerss does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides second hand ac buyers dealers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book second hand ac buyers dealers?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency second hand ac buyers dealers available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What second hand ac buyers dealerss does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides second hand ac buyers dealers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book second hand ac buyers dealers?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency second hand ac buyers dealers available. Call +91 93289 53665 for immediate assistance." } },
