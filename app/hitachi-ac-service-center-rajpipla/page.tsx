...
export const metadata: Metadata = {
  title: "Hitachi AC Service Center Rajpipla | Out-of-Warranty Repair Expert | Atlas Aircon",
  description: "Independent Hitachi AC service center in Rajpipla. Expert out-of-warranty split AC repair, gas charging, PCB repair, deep cleaning & compressor overhaul. Same-day service. Call +91 97272 57141.",
  keywords: [
    "hitachi ac service center rajpipla",
    "hitachi ac repair rajpipla",
    "hitachi ac service rajpipla",
    "hitachi split ac repair rajpipla",
    "hitachi ac gas charging rajpipla",
    "hitachi ac pcb repair rajpipla",
    "hitachi ac installation rajpipla",
    "hitachi ac not cooling rajpipla",
    "ac service center rajpipla",
    "best ac repair rajpipla",
  ],
  alternates: { canonical: "https://atlasaircons.com/hitachi-ac-service-center-rajpipla" },
  openGraph: {
    title: "Hitachi AC Service Center Rajpipla | Atlas Aircon",
    description: "Independent out-of-warranty Hitachi AC repair specialist in Rajpipla. Same-day service, 90-day guarantee.",
    url: "https://atlasaircons.com/hitachi-ac-service-center-rajpipla",
    type: "website",
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Hitachi AC Service Center Rajpipla",
  ...
  description: "Independent, out-of-warranty Hitachi AC repair, maintenance and installation in Rajpipla, Gujarat.",
};
...
const faqJsonLd = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "Is Atlas Aircon an authorized Hitachi service center in Rajpipla?", acceptedAnswer: { "@type": "Answer", text: "No. Atlas Aircon is an independent service provider specializing in high-quality out-of-warranty repairs. If your Hitachi AC is under official warranty, contact Hitachi directly." } },
    { "@type": "Question", name: "How quickly can you repair my Hitachi AC in Rajpipla?", acceptedAnswer: { "@type": "Answer", text: "We offer same-day service across Rajpipla. Our technicians typically arrive within 45-60 minutes of your call for emergency repairs." } },
    { "@type": "Question", name: "What is the cost of Hitachi AC gas refilling in Rajpipla?", acceptedAnswer: { "@type": "Answer", text: "Gas refilling for Hitachi ACs starts at \u20B92,500 including leak detection. Final cost depends on the refrigerant type (R32/R410A) and quantity needed." } },
...
export default function HitachiServiceCenterRajpiplaPage() {
  return (
    <>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                <span className="text-yellow-400">Hitachi AC Service Center</span> Rajpipla
              </h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                Expert independent repair solutions for Hitachi air conditioners in Rajpipla. Specializing in out-of-warranty service with same-day dispatch and a full satisfaction guarantee.
              </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">Hitachi AC Repair Price List — Rajpipla</h2>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Hitachi AC Service FAQs — Rajpipla</h2>
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              ...
              { q: "How quickly can you repair my Hitachi AC in Rajpipla?", a: "Same-day service is standard. Emergency calls are attended within 45-60 minutes across Rajpipla." },
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Need Hitachi AC Repair in Rajpipla?</h2>
