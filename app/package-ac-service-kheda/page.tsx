...
export const metadata: Metadata = {
  title: "Reliable Package AC Service Kheda | Hitech Aircool Engineers Gujarat",
  description: "Professional package AC installation, gas filling & repair across Kheda district. We serve Nadiad, Matar, Mehmedabad & more with same-day service, genuine parts",
  alternates: { canonical: "https://hitechairconditioning.in/package-ac-service-kheda" },
  openGraph: {
    title: "Reliable Package AC Service Kheda | Hitech Aircool Engineers",
    description: "Professional package AC installation, gas filling & repair across Kheda district. We serve Nadiad, Matar, Mehmedabad & more with same-day service, genuine parts",
    url: "https://hitechairconditioning.in/package-ac-service-kheda",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Reliable Package AC Service Kheda",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagepackageacservicekheda() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Reliable Package AC Service Kheda</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Professional package AC installation, gas filling &amp; repair across Kheda district. We serve Nadiad, Matar, Mehmedabad &amp; more with same-day service, genuine parts &amp; affordable plans. Call now!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Professional package AC installation, gas filling &amp; repair across Kheda district. We serve Nadiad, Matar, Mehmedabad &amp; more with same-day service, genuine parts &amp; affordable plans. Call now!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/hitech-logo.webp" alt="Reliable Package AC Service Kheda" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Reliable Package AC Service Kheda" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
