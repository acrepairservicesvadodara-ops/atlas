...
export const metadata: Metadata = {
  title: "AC Contractor in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Professional AC contractor in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC Contractor Vadodara",
    "ac contractor",
    "AC Contractor installation",
    "AC Contractor service",
    "AC Contractor repair",
    "best AC Contractor service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-contractor-vadodara",
  },
};
...
const keywordData = {
  title: "AC Contractor",
  slug: "ac-contractor",
  description: "Professional AC contractor",
  category: "Core"
};
...
export default function ACContractorPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What ac contractor vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides ac contractor vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book ac contractor vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency ac contractor vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What ac contractor vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides ac contractor vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book ac contractor vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency ac contractor vadodara available. Call +91 93289 53665 for immediate assistance." } },
