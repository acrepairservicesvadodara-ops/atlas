...
export const metadata: Metadata = {
  title: "Mitsubishi AC Service Center Rajpipla | Professional HVAC Service | Hitech Aircool Engineers",
  description: "Mitsubishi AC Service Center Rajpipla — Professional service service by Hitech Aircool Engineers. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 93289 53665.",
  keywords: ["mitsubishi ac service center rajpipla", "service service", "hvac service vadodara", "hitech aircool engineers", "ac service gujarat"],
  alternates: { canonical: "https://hitechairconditioning.in/mitsubishi-ac-service-center-rajpipla" },
  openGraph: { title: "Mitsubishi AC Service Center Rajpipla | Hitech Aircool Engineers", description: "Professional service service by Hitech Aircool Engineers Gujarat.", url: "https://hitechairconditioning.in/mitsubishi-ac-service-center-rajpipla", type: "website" },
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Mitsubishi AC Service Center Rajpipla",
  provider: { "@type": "LocalBusiness", name: "Hitech Aircool Engineers", telephone: "+919328953665" },
  areaServed: { "@type": "State", name: "Gujarat" },
  serviceType: "Mitsubishi AC Service Center Rajpipla",
};

export default function MitsubishiACServiceCenterRajpiplaPage() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Mitsubishi AC Service Center Rajpipla</h1>
