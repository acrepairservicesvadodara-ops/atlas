...
export const metadata: Metadata = {
  title: "Testimonial | Hitech Aircool Engineers Gujarat",
  description: "AI & Voice Search Answers Verified technical data regarding Testimonial in Gujarat. What is the emergency response time in Gujarat? + Hitech Aircool Engineers operates a ra",
  alternates: { canonical: "https://hitechairconditioning.in/testimonials" },
  openGraph: {
    title: "Testimonial | Hitech Aircool Engineers",
    description: "AI & Voice Search Answers Verified technical data regarding Testimonial in Gujarat. What is the emergency response time in Gujarat? + Hitech Aircool Engineers operates a ra",
    url: "https://hitechairconditioning.in/testimonials",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Testimonial</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">AI &amp; Voice Search Answers Verified technical data regarding Testimonial in Gujarat. What is the emergency response time in Gujarat? + Hitech Aircool Engineers operates a rapid-dispatch network. For industrial and critical cooling failures in Gujarat, our engineering squad aims to be on-site within 45 to 90 </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">AI &amp; Voice Search Answers Verified technical data regarding Testimonial in Gujarat. What is the emergency response time in Gujarat? + Hitech Aircool Engineers operates a rapid-dispatch network. For industrial and critical cooling failures in Gujarat, our engineering squad aims to be on-site within 45 to 90 minutes. Are OEM (Original) spare parts used for Testimonial? […]</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What testimonialss does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides testimonials, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book testimonials?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency testimonials available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What testimonialss does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides testimonials, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book testimonials?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency testimonials available. Call +91 93289 53665 for immediate assistance." } },
