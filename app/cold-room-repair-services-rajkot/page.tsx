...
export const metadata: Metadata = {
  title: "Top Cold Room Repair Services Rajkot: 24/7 Fix All Industry! [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/cold-room-repair-services-rajkot" },
  openGraph: {
    title: "Top Cold Room Repair Services Rajkot: 24/7 Fix All Industry! [2026 Updated] | Atlas Aircon",
    description: "Leading cold room repair services Rajkot for auto parts, foundries, dairy, and food processing industries. 24/7 emergency response, industrial AMC plans, and ce",
    url: "https://atlasaircons.com/cold-room-repair-services-rajkot",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Leading cold room repair services Rajkot for auto parts, foundries, dairy, and food processing industries. 24/7 emergency response, industrial AMC plans, and certified technicians across all Rajkot areas.</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVcold room repair services rajkots?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVcold room repair services rajkots?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
