...
export const metadata: Metadata = {
  title: "Mitsubishi AC Service Center Bharuch | Professional HVAC Service | Atlas Aircon",
  description: "Mitsubishi AC Service Center Bharuch — Professional service service by Atlas Aircon. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 97272 57141.",
  keywords: ["mitsubishi ac service center bharuch", "service service", "hvac service vadodara", "atlas aircon", "ac service gujarat"],
  alternates: { canonical: "https://atlasaircons.com/mitsubishi-ac-service-center-bharuch" },
  openGraph: { title: "Mitsubishi AC Service Center Bharuch | Atlas Aircon", description: "Professional service service by Atlas Aircon Gujarat.", url: "https://atlasaircons.com/mitsubishi-ac-service-center-bharuch", type: "website" },
};
