...
export const metadata: Metadata = {
  title: "Expert Rittal & Panel AC Service Ahmedabad | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/panel-ac-service-ahmedabad" },
  openGraph: {
    title: "Expert Rittal & Panel AC Service Ahmedabad | Atlas Aircon",
    description: "24/7 expert repair for Rittal, Schneider, and all Panel AC service Ahmedabad's across industrial zones. Fast service with genuine parts and warranty for factori",
    url: "https://atlasaircons.com/panel-ac-service-ahmedabad",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">24/7 expert repair for Rittal, Schneider, and all Panel AC service Ahmedabad&apos;s across industrial zones. Fast service with genuine parts and warranty for factories in Naroda, Odhav, Vatva.</p>
