...
export const metadata: Metadata = {
  title: "Expert Rittal & Panel AC Service Ahmedabad | Hitech Aircool Engineers Gujarat",
  description: "24/7 expert repair for Rittal, Schneider, and all Panel AC service Ahmedabad's across industrial zones. Fast service with genuine parts and warranty for factori",
  alternates: { canonical: "https://hitechairconditioning.in/panel-ac-service-ahmedabad" },
  openGraph: {
    title: "Expert Rittal & Panel AC Service Ahmedabad | Hitech Aircool Engineers",
    description: "24/7 expert repair for Rittal, Schneider, and all Panel AC service Ahmedabad's across industrial zones. Fast service with genuine parts and warranty for factori",
    url: "https://hitechairconditioning.in/panel-ac-service-ahmedabad",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Expert Rittal & Panel AC Service Ahmedabad",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagepanelacserviceahmedabad() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Expert Rittal &amp; Panel AC Service Ahmedabad</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">24/7 expert repair for Rittal, Schneider, and all Panel AC service Ahmedabad&apos;s across industrial zones. Fast service with genuine parts and warranty for factories in Naroda, Odhav, Vatva.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">24/7 expert repair for Rittal, Schneider, and all Panel AC service Ahmedabad&apos;s across industrial zones. Fast service with genuine parts and warranty for factories in Naroda, Odhav, Vatva.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/panel-ac-repair-service.webp" alt="Expert Rittal & Panel AC Service Ahmedabad" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Expert Rittal & Panel AC Service Ahmedabad" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
