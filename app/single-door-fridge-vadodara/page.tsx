...
export const metadata: Metadata = {
  title: "Single Door Fridge in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Single door fridge repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Single Door Fridge Vadodara",
    "single door fridge",
    "Single Door Fridge installation",
    "Single Door Fridge service",
    "Single Door Fridge repair",
    "best Single Door Fridge service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/single-door-fridge-vadodara",
  },
};

const keywordData = {
  title: "Single Door Fridge",
  slug: "single-door-fridge",
  description: "Single door fridge repair",
...
export default function SingleDoorFridgePage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What single door fridge vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides single door fridge vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book single door fridge vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency single door fridge vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What single door fridge vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides single door fridge vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book single door fridge vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency single door fridge vadodara available. Call +91 93289 53665 for immediate assistance." } },
