...
export const metadata: Metadata = {
  title: "Portable Air Conditioner (Ac) Repairing Service » 9727257141 [2026 Updated] | Atlas Aircon Gujarat",
  description: "Professional portable air conditioner (ac) repairing service » 9727257141 [2026 updated] by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/portable-air-conditioner-ac-repairing-service" },
  openGraph: {
    title: "Portable Air Conditioner (Ac) Repairing Service » 9727257141 [2026 Updated] | Atlas Aircon",
    description: "Professional portable air conditioner (ac) repairing service » 9727257141 [2026 updated] by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/portable-air-conditioner-ac-repairing-service",
    type: "website",
    images: ["/images/products/Portable-Ac-Service.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Portable Air Conditioner (Ac) Repairing Service » 9727257141 [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
...
export default function Pageportableairconditioneracrepairingservice() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Portable Air Conditioner (Ac) Repairing Service » 9727257141 [2026 Updated]</h1>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Portable-Ac-Service.webp" alt="Portable Air Conditioner (Ac) Repairing Service » 9727257141 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Portable Air Conditioner (Ac) Repairing Service » 9727257141 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Portable Air Conditioner (Ac) Repairing Service » 9727257141 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Portable Air Conditioner Ac Repairing Service in Vadodara?", a: "Portable Air Conditioner Ac Repairing Service cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Portable Air Conditioner Ac Repairing Service?", a: "Atlas Aircon offers same-day Portable Air Conditioner Ac Repairing Service across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Portable Air Conditioner Ac Repairing Services?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Portable Air Conditioner Ac Repairing Services depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Portable Air Conditioner Ac Repairing Service available on holidays?", a: "Yes, Atlas Aircon provides Portable Air Conditioner Ac Repairing Service 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
              { q: "How long does Portable Air Conditioner Ac Repairing Service take?", a: "Most Portable Air Conditioner Ac Repairing Services are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Portable Air Conditioner Ac Repairing Service in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Portable Air Conditioner Ac Repairing Service cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Portable Air Conditioner Ac Repairing Service?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Portable Air Conditioner Ac Repairing Service across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Portable Air Conditioner Ac Repairing Services?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Portable Air Conditioner Ac Repairing Services depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Portable Air Conditioner Ac Repairing Service available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Portable Air Conditioner Ac Repairing Service 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
          { "@type": "Question", name: "How long does Portable Air Conditioner Ac Repairing Service take?", acceptedAnswer: { "@type": "Answer", text: "Most Portable Air Conditioner Ac Repairing Services are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
