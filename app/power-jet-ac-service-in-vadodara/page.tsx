...
export const metadata: Metadata = {
  title: "⭐ Power Jet AC Service In Vadodara | Hitech Aircool Engineers Gujarat",
  description: "Professional ⭐ power jet ac service in vadodara by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/power-jet-ac-service-in-vadodara" },
  openGraph: {
    title: "⭐ Power Jet AC Service In Vadodara | Hitech Aircool Engineers",
    description: "Professional ⭐ power jet ac service in vadodara by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/power-jet-ac-service-in-vadodara",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "⭐ Power Jet AC Service In Vadodara",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagepowerjetacserviceinvadodara() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">⭐ Power Jet AC Service In Vadodara</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">&lt;meta name=&quot;viewport&quot; content=&quot;width=devic...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">&lt;meta name=&quot;viewport&quot; content=&quot;width=devic...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/Atlas-Aircon-Ac-Service-in-vadodara-2.webp" alt="⭐ Power Jet AC Service In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="⭐ Power Jet AC Service In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="⭐ Power Jet AC Service In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/comman-problems-of-AC-scaled.webp" alt="⭐ Power Jet AC Service In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/ac-chemical-service.webp" alt="⭐ Power Jet AC Service In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Power Jet Ac Service In Vadodara include?", a: "Power Jet Ac Service In Vadodara includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Power Jet Ac Service In Vadodara cost?", a: "Power Jet Ac Service In Vadodara starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Power Jet Ac Service In Vadodara improve cooling?", a: "Yes, proper Power Jet Ac Service In Vadodara can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Power Jet Ac Service In Vadodara reduce electricity bills?", a: "Regular Power Jet Ac Service In Vadodara can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Power Jet Ac Service In Vadodara take?", a: "Basic Power Jet Ac Service In Vadodara takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Power Jet Ac Service In Vadodara remove bad smell?", a: "Yes, Power Jet Ac Service In Vadodara includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Power Jet Ac Service In Vadodara?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Power Jet Ac Service In Vadodara include?", acceptedAnswer: { "@type": "Answer", text: "Power Jet Ac Service In Vadodara includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Power Jet Ac Service In Vadodara cost?", acceptedAnswer: { "@type": "Answer", text: "Power Jet Ac Service In Vadodara starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Power Jet Ac Service In Vadodara improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Power Jet Ac Service In Vadodara can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Power Jet Ac Service In Vadodara reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Power Jet Ac Service In Vadodara can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Power Jet Ac Service In Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Basic Power Jet Ac Service In Vadodara takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Power Jet Ac Service In Vadodara remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Power Jet Ac Service In Vadodara includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Power Jet Ac Service In Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
