...
export const metadata: Metadata = {
  title: "⭐ Power Jet AC Service In Vadodara | Atlas Aircon Gujarat",
  description: "Professional ⭐ power jet ac service in vadodara by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/power-jet-ac-service-in-vadodara" },
  openGraph: {
    title: "⭐ Power Jet AC Service In Vadodara | Atlas Aircon",
    description: "Professional ⭐ power jet ac service in vadodara by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/power-jet-ac-service-in-vadodara",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">&lt;meta name=&quot;viewport&quot; content=&quot;width=devic...</p>
