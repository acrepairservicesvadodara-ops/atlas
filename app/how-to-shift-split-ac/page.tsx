...
export const metadata: Metadata = {
  title: "How To A Split AC System Move Without Professional Help! [2026 Updated] | Atlas Aircon Blog",
  description: "A Split AC System air conditioner is an extremely popular method to cool down your home in those scorching India summers. Alwa...",
  alternates: { canonical: "https://atlasaircons.com/how-to-shift-split-ac" },
  openGraph: {
    title: "How To A Split AC System Move Without Professional Help! [2026 Updated] | Atlas Aircon",
    description: "A Split AC System air conditioner is an extremely popular method to cool down your home in those scorching India summers. Alwa...",
    url: "https://atlasaircons.com/how-to-shift-split-ac",
    type: "article",
    images: ["/images/products/How-to-shift-split-ac.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Article",
  headline: "How To A Split AC System Move Without Professional Help! [2026 Updated]",
  ...
  mainEntityOfPage: "https://atlasaircons.com/how-to-shift-split-ac",
  image: "/images/products/How-to-shift-split-ac.webp",
};

export default function Pagehowtoshiftsplitac() {
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-gray-900 via-gray-800 to-blue-900 text-white py-12 md:py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">How To A Split AC System Move Without Professional Help! [2026 Updated]</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <img src="/images/products/How-to-shift-split-ac.webp" alt="How To A Split AC System Move Without Professional Help! [2026 Updated]" className="w-full h-auto rounded-xl mb-8" />
            <p className="text-gray-600 mb-4">A Split AC System air conditioner is an extremely popular method to cool down your home in those scorching India summers. Alwa...</p>
