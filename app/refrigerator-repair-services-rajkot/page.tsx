...
export const metadata: Metadata = {
  title: "Expert 24/7 Refrigerator Repair Services In Rajkot | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/refrigerator-repair-services-rajkot" },
  openGraph: {
    title: "Expert 24/7 Refrigerator Repair Services In Rajkot | Atlas Aircon",
    description: "Urgent fridge repair in Rajkot? Get reliable, same-day service by expert technicians for LG, Samsung & all brands at home. Free check-up, genuine parts & warran",
    url: "https://atlasaircons.com/refrigerator-repair-services-rajkot",
    type: "website",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Urgent fridge repair in Rajkot? Get reliable, same-day service by expert technicians for LG, Samsung &amp; all brands at home. Free check-up, genuine parts &amp; warranty. Call now!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Refrigerator Repair Services Rajkot in Vadodara?", a: "Refrigerator Repair Services Rajkot cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Refrigerator Repair Services Rajkot?", a: "Atlas Aircon offers same-day Refrigerator Repair Services Rajkot across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Refrigerator Repair Services Rajkots?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Refrigerator Repair Services Rajkots depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Refrigerator Repair Services Rajkot available on holidays?", a: "Yes, Atlas Aircon provides Refrigerator Repair Services Rajkot 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Refrigerator Repair Services Rajkot?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Refrigerator Repair Services Rajkot across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Refrigerator Repair Services Rajkots?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Refrigerator Repair Services Rajkots depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Refrigerator Repair Services Rajkot available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Refrigerator Repair Services Rajkot 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
