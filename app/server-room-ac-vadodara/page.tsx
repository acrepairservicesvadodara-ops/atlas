...
export const metadata: Metadata = {
  title: "Server Room AC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Precision AC for servers in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Server Room AC Vadodara",
    "server room ac",
    "Server Room AC installation",
    "Server Room AC service",
    "Server Room AC repair",
    "best Server Room AC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/server-room-ac-vadodara",
  },
};
...
const keywordData = {
  ...
  slug: "server-room-ac",
  description: "Precision AC for servers",
  category: "Commercial"
};
...
export default function ServerRoomACPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What server room ac vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides server room ac vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book server room ac vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency server room ac vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What server room ac vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides server room ac vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book server room ac vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency server room ac vadodara available. Call +91 93289 53665 for immediate assistance." } },
