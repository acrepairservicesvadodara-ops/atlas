...
export const metadata: Metadata = {
  title: "HVAC Ducting Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "HVAC duct repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "HVAC Ducting Repair Vadodara",
    "hvac ducting repair",
    "HVAC Ducting Repair installation",
    "HVAC Ducting Repair service",
    "HVAC Ducting Repair repair",
    "best HVAC Ducting Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/hvac-ducting-repair-vadodara",
  },
};

const keywordData = {
  title: "HVAC Ducting Repair",
  slug: "hvac-ducting-repair",
  description: "HVAC duct repair",
  category: "HVAC"
};
...
export default function HVACDuctingRepairPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVhvac ducting repair vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial hvac ducting repair vadodara?", a: "Industrial hvac ducting repair vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVhvac ducting repair vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial hvac ducting repair vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial hvac ducting repair vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
