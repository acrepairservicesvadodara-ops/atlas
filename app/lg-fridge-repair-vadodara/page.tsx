...
export const metadata: Metadata = {
  title: "LG Fridge Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "LG refrigerator service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "LG Fridge Repair Vadodara",
    "lg fridge repair",
    "LG Fridge Repair installation",
    "LG Fridge Repair service",
    "LG Fridge Repair repair",
    "best LG Fridge Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/lg-fridge-repair-vadodara",
  },
};

const keywordData = {
  title: "LG Fridge Repair",
  slug: "lg-fridge-repair",
  description: "LG refrigerator service",
...
export default function LGFridgeRepairPage() {
  return (
    <>
      {/* Hero Section */}
