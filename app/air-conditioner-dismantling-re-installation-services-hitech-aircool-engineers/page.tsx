...
export const metadata: Metadata = {
  title: "Air Conditioner Dismantling & Re-Installation Services | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "We specialize in moving split and window ACs. For splits, we recover gas, disconnect indoor and outdoor units, carefully remove mounting brackets and li...",
  keywords: ["air conditioner dismantling & re-installation services | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "installation"],
  alternates: { canonical: "https://atlasaircons.com/air-conditioner-dismantling-re-installation-services-hitech-aircool-engineers" },
  openGraph: {
    title: "Air Conditioner Dismantling & Re-Installation Services | Hitech Aircool Engineers",
    description: "We specialize in moving split and window ACs. For splits, we recover gas, disconnect indoor and outdoor units, carefully remove mounting brackets and li...",
    url: "https://atlasaircons.com/air-conditioner-dismantling-re-installation-services-hitech-aircool-engineers",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Air Conditioner Dismantling & Re-Installation Services | Hitech Aircool Engineers",
  description: "We specialize in moving split and window ACs. For splits, we recover gas, disconnect indoor and outdoor units, carefully remove mounting brackets and line sets, and reinstall at the new site, often pressure testing and vacuuming the lines before a fresh gas charge. For window units, we ensure safe r",
...
export default function Pageairconditionerdismantlingreinstallations() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  ...
                  alt="Air Conditioner Dismantling & Re-Installation Services | Hitech Aircool Engineers"
                ...
                <img
                  ...
                  alt="Air Conditioner Dismantling & Re-Installation Services | Hitech Aircool Engineers - Image 2"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Air Conditioner Dismantling & Re-Installation Services | Hitech Aircool Engineers - Image 3"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Air Conditioner Dismantling & Re-Installation Services | Hitech Aircool Engineers - Image 4"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Air Conditioner Dismantling &amp; Re-Installation Services | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">We specialize in moving split and window ACs. For splits, we recover gas, disconnect indoor and outdoor units, carefully remove mounting brackets and</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%20Air%20Conditioner%20Dismantling%20%26%20Re-Installation%20Services%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Air Conditioner Dismantling &amp; Re-Installation Services</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>We specialize in moving split and window ACs. For splits, we recover gas, disconnect indoor and outdoor units, carefully remove mounting brackets and line sets, and reinstall at the new site, often pressure testing and vacuuming the lines before a fresh gas charge. For window units, we ensure safe removal and secure new installation.</p>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[{"url":"https://www.atlasaircons.com/24x7-panel-acs-emergency-service-hitech-aircool-engineers/","title":"24X7 Panel Acs Emergency Service | Hitech Aircool Engineers","price":""},{"url":"https://www.atlasaircons.com/24x7-air-cooler-emergency-service-hitech-aircool-engineers/","title":"24X7 Air Cooler Emergency Service | Hitech Aircool Engineers","price":""}].map((p: { url: string; title: string; price: string }) => (
