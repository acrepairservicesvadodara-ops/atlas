...
export const metadata: Metadata = {
  title: "Expert Rittal Panel AC Repair Service Center | Hitech Aircool Engineers Gujarat",
  description: "Professional expert rittal panel ac repair service center by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/rittal-panel-ac-service-center" },
  openGraph: {
    title: "Expert Rittal Panel AC Repair Service Center | Hitech Aircool Engineers",
    description: "Professional expert rittal panel ac repair service center by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/rittal-panel-ac-service-center",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Expert Rittal Panel AC Repair Service Center",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagerittalpanelacservicecenter() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Expert Rittal Panel AC Repair Service Center</h1>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/panel-ac-centrifugal-fan.webp" alt="Expert Rittal Panel AC Repair Service Center" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Expert Rittal Panel AC Repair Service Center" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Expert Rittal Panel AC Repair Service Center" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
