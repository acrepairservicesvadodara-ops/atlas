...
export const metadata: Metadata = {
  title: "AC Outdoor Unit Cleaning in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Outdoor unit cleaning in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC Outdoor Unit Cleaning Vadodara",
    "ac outdoor unit cleaning",
    "AC Outdoor Unit Cleaning installation",
    "AC Outdoor Unit Cleaning service",
    "AC Outdoor Unit Cleaning repair",
    "best AC Outdoor Unit Cleaning service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-outdoor-unit-cleaning-vadodara",
  },
};

const keywordData = {
  title: "AC Outdoor Unit Cleaning",
  slug: "ac-outdoor-unit-cleaning",
  description: "Outdoor unit cleaning",
  category: "Problems"
};
...
export default function ACOutdoorUnitCleaningPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Ac Outdoor Unit Cleaning Vadodara include?", a: "Ac Outdoor Unit Cleaning Vadodara includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Ac Outdoor Unit Cleaning Vadodara cost?", a: "Ac Outdoor Unit Cleaning Vadodara starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Ac Outdoor Unit Cleaning Vadodara improve cooling?", a: "Yes, proper Ac Outdoor Unit Cleaning Vadodara can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Ac Outdoor Unit Cleaning Vadodara reduce electricity bills?", a: "Regular Ac Outdoor Unit Cleaning Vadodara can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Ac Outdoor Unit Cleaning Vadodara take?", a: "Basic Ac Outdoor Unit Cleaning Vadodara takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Ac Outdoor Unit Cleaning Vadodara remove bad smell?", a: "Yes, Ac Outdoor Unit Cleaning Vadodara includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Ac Outdoor Unit Cleaning Vadodara?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Ac Outdoor Unit Cleaning Vadodara include?", acceptedAnswer: { "@type": "Answer", text: "Ac Outdoor Unit Cleaning Vadodara includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Ac Outdoor Unit Cleaning Vadodara cost?", acceptedAnswer: { "@type": "Answer", text: "Ac Outdoor Unit Cleaning Vadodara starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Ac Outdoor Unit Cleaning Vadodara improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Ac Outdoor Unit Cleaning Vadodara can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Ac Outdoor Unit Cleaning Vadodara reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Ac Outdoor Unit Cleaning Vadodara can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Ac Outdoor Unit Cleaning Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Basic Ac Outdoor Unit Cleaning Vadodara takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Ac Outdoor Unit Cleaning Vadodara remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Ac Outdoor Unit Cleaning Vadodara includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Ac Outdoor Unit Cleaning Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
