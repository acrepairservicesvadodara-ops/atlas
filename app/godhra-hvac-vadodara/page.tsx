...
export const metadata: Metadata = {
  title: "Godhra HVAC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "HVAC service in Godhra in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Godhra HVAC Vadodara",
    "godhra hvac",
    "Godhra HVAC installation",
    "Godhra HVAC service",
    "Godhra HVAC repair",
    "best Godhra HVAC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/godhra-hvac-vadodara",
  },
};
...
const keywordData = {
  title: "Godhra HVAC",
  slug: "godhra-hvac",
  description: "HVAC service in Godhra",
  category: "OutCity"
};
...
export default function GodhraHVACPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVgodhra hvac vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial godhra hvac vadodara?", a: "Industrial godhra hvac vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVgodhra hvac vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial godhra hvac vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial godhra hvac vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
