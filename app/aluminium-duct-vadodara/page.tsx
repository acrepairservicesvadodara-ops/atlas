...
export const metadata: Metadata = {
  title: "Aluminium Duct in Vadodara | Installation, Service & Repair | Atlas Aircon",
  description: "Aluminium duct work in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 97272 57141",
  keywords: [
  ...
  alternates: {
    canonical: "https://atlasaircons.com/aluminium-duct-vadodara",
  },
};
  ...
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What aluminium duct vadodaras does Atlas Aircon provide?", a: "Atlas Aircon provides aluminium duct vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book aluminium duct vadodara?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency aluminium duct vadodara available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What aluminium duct vadodaras does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides aluminium duct vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book aluminium duct vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency aluminium duct vadodara available. Call +91 97272 57141 for immediate assistance." } },
