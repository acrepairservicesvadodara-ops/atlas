...
export const metadata: Metadata = {
  title: "Expert Refrigerator Repair Services Across Gujarat | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/refrigerator-repair-services-gujarat" },
  openGraph: {
    title: "Expert Refrigerator Repair Services Across Gujarat | Atlas Aircon",
    description: "Need reliable fridge repair anywhere in Gujarat? We offer expert service in Ahmedabad, Vadodara, Surat, Rajkot & more. Fast, affordable repair with genuine part",
    url: "https://atlasaircons.com/refrigerator-repair-services-gujarat",
    type: "website",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Need reliable fridge repair anywhere in Gujarat? We offer expert service in Ahmedabad, Vadodara, Surat, Rajkot &amp; more. Fast, affordable repair with genuine parts &amp; warranty. Call for service!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Refrigerator Repair Services Gujarat in Vadodara?", a: "Refrigerator Repair Services Gujarat cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Refrigerator Repair Services Gujarat?", a: "Atlas Aircon offers same-day Refrigerator Repair Services Gujarat across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Refrigerator Repair Services Gujarats?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Refrigerator Repair Services Gujarats depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Refrigerator Repair Services Gujarat available on holidays?", a: "Yes, Atlas Aircon provides Refrigerator Repair Services Gujarat 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Refrigerator Repair Services Gujarat?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Refrigerator Repair Services Gujarat across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Refrigerator Repair Services Gujarats?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Refrigerator Repair Services Gujarats depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Refrigerator Repair Services Gujarat available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Refrigerator Repair Services Gujarat 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
