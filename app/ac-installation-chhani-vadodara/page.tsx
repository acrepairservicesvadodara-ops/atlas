...
export const metadata: Metadata = {
  title: "AC Installation Chhani in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC installation Chhani in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC Installation Chhani Vadodara",
    "ac installation chhani",
    "AC Installation Chhani installation",
    "AC Installation Chhani service",
    "AC Installation Chhani repair",
    "best AC Installation Chhani service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-installation-chhani-vadodara",
  },
};

const keywordData = {
  title: "AC Installation Chhani",
  slug: "ac-installation-chhani",
  description: "AC installation Chhani",
  category: "Area"
};
...
export default function ACInstallationChhaniPage() {
  return (
    <>
      {/* Hero Section */}
