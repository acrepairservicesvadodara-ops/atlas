...
export const metadata: Metadata = {
  title: "AC Installation Rajpipla | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-installation-rajpipla" },
  openGraph: {
    title: "AC Installation Rajpipla | Atlas Aircon",
    description: "Professional AC installation services in Rajpipla, Narmada. Expert split & window AC fitting, gas charging & bracket fixing. Free site survey. Call for pricing!",
    url: "https://atlasaircons.com/ac-installation-rajpipla",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Professional AC installation services in Rajpipla, Narmada. Expert split &amp; window AC fitting, gas charging &amp; bracket fixing. Free site survey. Call for pricing!</p>
