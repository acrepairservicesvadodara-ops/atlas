...
export const metadata: Metadata = {
  title: "Expert Solar Panel Repair In Vadodara [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/solar-panel-repair-vadodara" },
  openGraph: {
    title: "Expert Solar Panel Repair In Vadodara [2026 Updated] | Atlas Aircon",
    description: "Need urgent solar panel repair in Vadodara? Our certified technicians provide fast, reliable service & spare parts for homes & businesses. Get a free quote now!",
    url: "https://atlasaircons.com/solar-panel-repair-vadodara",
    type: "website",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Need urgent solar panel repair in Vadodara? Our certified technicians provide fast, reliable service &amp; spare parts for homes &amp; businesses. Get a free quote now!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Solar Panel Repair Vadodara in Vadodara?", a: "Solar Panel Repair Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Solar Panel Repair Vadodara?", a: "Atlas Aircon offers same-day Solar Panel Repair Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Solar Panel Repair Vadodaras?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Solar Panel Repair Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Solar Panel Repair Vadodara available on holidays?", a: "Yes, Atlas Aircon provides Solar Panel Repair Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Solar Panel Repair Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Solar Panel Repair Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Solar Panel Repair Vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Solar Panel Repair Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Solar Panel Repair Vadodara available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Solar Panel Repair Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
