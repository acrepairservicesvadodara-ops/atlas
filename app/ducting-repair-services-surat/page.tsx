...
export const metadata: Metadata = {
  title: "Expert Ducting Repair Services Surat: Fix 10+ Issues [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Leading ducting repair services Surat for AC, HVAC & industrial exhaust systems. Serving residential, commercial (malls, offices) & textile/diamond factories. ✅",
  alternates: { canonical: "https://hitechairconditioning.in/ducting-repair-services-surat" },
  openGraph: {
    title: "Expert Ducting Repair Services Surat: Fix 10+ Issues [2026 Updated] | Hitech Aircool Engineers",
    description: "Leading ducting repair services Surat for AC, HVAC & industrial exhaust systems. Serving residential, commercial (malls, offices) & textile/diamond factories. ✅",
    url: "https://hitechairconditioning.in/ducting-repair-services-surat",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Expert Ducting Repair Services Surat: Fix 10+ Issues [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageductingrepairservicessurat() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Expert Ducting Repair Services Surat: Fix 10+ Issues [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Leading ducting repair services Surat for AC, HVAC &amp; industrial exhaust systems. Serving residential, commercial (malls, offices) &amp; textile/diamond factories. ✅ 24/7 Support.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Leading ducting repair services Surat for AC, HVAC &amp; industrial exhaust systems. Serving residential, commercial (malls, offices) &amp; textile/diamond factories. ✅ 24/7 Support.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/hitech-logo.webp" alt="Expert Ducting Repair Services Surat: Fix 10+ Issues [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Expert Ducting Repair Services Surat: Fix 10+ Issues [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Ducting Repair Services Surat in Vadodara?", a: "Ducting Repair Services Surat cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Ducting Repair Services Surat?", a: "Hitech Aircool Engineers offers same-day Ducting Repair Services Surat across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Ducting Repair Services Surats?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Ducting Repair Services Surats depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Ducting Repair Services Surat available on holidays?", a: "Yes, Hitech Aircool Engineers provides Ducting Repair Services Surat 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Ducting Repair Services Surat take?", a: "Most Ducting Repair Services Surats are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Ducting Repair Services Surat in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Ducting Repair Services Surat cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Ducting Repair Services Surat?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Ducting Repair Services Surat across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Ducting Repair Services Surats?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Ducting Repair Services Surats depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Ducting Repair Services Surat available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Ducting Repair Services Surat 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Ducting Repair Services Surat take?", acceptedAnswer: { "@type": "Answer", text: "Most Ducting Repair Services Surats are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
