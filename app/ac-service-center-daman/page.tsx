...
export const metadata: Metadata = {
  title: "AC Service Center Daman | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-center-daman" },
  openGraph: {
    title: "AC Service Center Daman | Atlas Aircon",
    description: "Affordable AC service center in Daman offering expert repairs, maintenance & gas charging. Quick response, honest pricing, and guaranteed workmanship for all AC",
    url: "https://atlasaircons.com/ac-service-center-daman",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Affordable AC service center in Daman offering expert repairs, maintenance &amp; gas charging. Quick response, honest pricing, and guaranteed workmanship for all AC brands.</p>
