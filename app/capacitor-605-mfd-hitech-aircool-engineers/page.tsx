...
export const metadata: Metadata = {
  title: "Capacitor 60+5 Mfd | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "For larger residential and commercial packaged units. This dual capacitor supports a big compressor and its accompanying fan motor. We supply rugged 60/...",
  keywords: ["capacitor 60+5 mfd | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "dual"],
  alternates: { canonical: "https://atlasaircons.com/capacitor-605-mfd-hitech-aircool-engineers" },
  openGraph: {
    title: "Capacitor 60+5 Mfd | Hitech Aircool Engineers",
    description: "For larger residential and commercial packaged units. This dual capacitor supports a big compressor and its accompanying fan motor. We supply rugged 60/...",
    url: "https://atlasaircons.com/capacitor-605-mfd-hitech-aircool-engineers",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Capacitor 60+5 Mfd | Hitech Aircool Engineers",
  description: "For larger residential and commercial packaged units. This dual capacitor supports a big compressor and its accompanying fan motor. We supply rugged 60/5 Mfd capacitors built to handle the electrical demands and outdoor exposure of rooftop installations.",
...
export default function Pagecapacitor605mfdhitechaircoolengineers() {
  return (
    <>
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  ...
                  alt="Capacitor 60+5 Mfd | Hitech Aircool Engineers"
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="bg-blue-500/20 text-blue-300 px-3 py-1 rounded-full text-xs font-semibold">Dual</span>
              </div>
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Capacitor 60+5 Mfd | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">For larger residential and commercial packaged units. This dual capacitor supports a big compressor and its accompanying fan motor. We supply rugged 6</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%20Capacitor%2060%2B5%20Mfd%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Capacitor 60+5 Mfd</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>For larger residential and commercial packaged units. This dual capacitor supports a big compressor and its accompanying fan motor. We supply rugged 60/5 Mfd capacitors built to handle the electrical demands and outdoor exposure of rooftop installations.</p>
            </div>
            ...
            <div className="mt-8 bg-gray-50 rounded-xl p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                ...
                <div className="flex justify-between py-2 border-b border-gray-200"><span className="text-gray-500">Category</span><span className="font-medium">Dual</span></div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What capacitor 605 mfd hitech aircool engineerss does Atlas Aircon provide?", a: "Atlas Aircon provides capacitor 605 mfd hitech aircool engineers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book capacitor 605 mfd hitech aircool engineers?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency capacitor 605 mfd hitech aircool engineers available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What capacitor 605 mfd hitech aircool engineerss does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides capacitor 605 mfd hitech aircool engineers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book capacitor 605 mfd hitech aircool engineers?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency capacitor 605 mfd hitech aircool engineers available. Call +91 97272 57141 for immediate assistance." } },
