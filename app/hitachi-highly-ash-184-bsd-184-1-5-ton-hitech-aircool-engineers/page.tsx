...
export const metadata: Metadata = {
  title: "Hitachi (Highly) – Ash 184 / Bsd 184 – 1.5 Ton | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "A Hitachi rotary compressor model, likely for split AC systems. Rotary compressors are compact, quiet, and efficient, making them popular in Japanese an...",
  keywords: ["hitachi (highly) – ash 184 / bsd 184 – 1.5 ton | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "hitachi"],
  alternates: { canonical: "https://atlasaircons.com/hitachi-highly-ash-184-bsd-184-1-5-ton-hitech-aircool-engineers" },
  openGraph: {
    title: "Hitachi (Highly) – Ash 184 / Bsd 184 – 1.5 Ton | Hitech Aircool Engineers",
    description: "A Hitachi rotary compressor model, likely for split AC systems. Rotary compressors are compact, quiet, and efficient, making them popular in Japanese an...",
    url: "https://atlasaircons.com/hitachi-highly-ash-184-bsd-184-1-5-ton-hitech-aircool-engineers",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Hitachi (Highly) – Ash 184 / Bsd 184 – 1.5 Ton | Hitech Aircool Engineers",
  description: "A Hitachi rotary compressor model, likely for split AC systems. Rotary compressors are compact, quiet, and efficient, making them popular in Japanese and Korean air conditioner brands. This 1.5-ton model is a common replacement part for Hitachi and compatible systems.",
...
export default function Pagehitachihighlyash184bsd18415tonhitechairc() {
  return (
    <>
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  ...
                  alt="Hitachi (Highly) – Ash 184 / Bsd 184 – 1.5 Ton | Hitech Aircool Engineers"
                ...
                <img
                  ...
                  alt="Hitachi (Highly) – Ash 184 / Bsd 184 – 1.5 Ton | Hitech Aircool Engineers - Image 2"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Hitachi (Highly) – Ash 184 / Bsd 184 – 1.5 Ton | Hitech Aircool Engineers - Image 3"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Hitachi (Highly) – Ash 184 / Bsd 184 – 1.5 Ton | Hitech Aircool Engineers - Image 4"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="bg-blue-500/20 text-blue-300 px-3 py-1 rounded-full text-xs font-semibold">Hitachi</span>
              </div>
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Hitachi (Highly) – Ash 184 / Bsd 184 – 1.5 Ton | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">A Hitachi rotary compressor model, likely for split AC systems. Rotary compressors are compact, quiet, and efficient, making them popular in Japanese</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%20Hitachi%20(Highly)%20%E2%80%93%20Ash%20184%20%2F%20Bsd%20184%20%E2%80%93%201.5%20Ton%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Apartments</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Gujarat</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Hitachi (Highly) - Ash 184 / Bsd 184 - 1.5 Ton</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>A Hitachi rotary compressor model, likely for split AC systems. Rotary compressors are compact, quiet, and efficient, making them popular in Japanese and Korean air conditioner brands. This 1.5-ton model is a common replacement part for Hitachi and compatible systems.</p>
            </div>
            ...
            <div className="mt-8 bg-gray-50 rounded-xl p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                ...
                <div className="flex justify-between py-2 border-b border-gray-200"><span className="text-gray-500">Category</span><span className="font-medium">Hitachi</span></div>
