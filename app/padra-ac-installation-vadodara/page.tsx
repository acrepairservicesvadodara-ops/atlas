...
export const metadata: Metadata = {
  title: "Padra AC Installation in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC installation Padra in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Padra AC Installation Vadodara",
    "padra ac installation",
    "Padra AC Installation installation",
    "Padra AC Installation service",
    "Padra AC Installation repair",
    "best Padra AC Installation service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/padra-ac-installation-vadodara",
  },
};

const keywordData = {
  title: "Padra AC Installation",
  slug: "padra-ac-installation",
  description: "AC installation Padra",
  category: "OutCity"
};
...
export default function PadraACInstallationPage() {
  return (
    <>
      {/* Hero Section */}
