...
export const metadata: Metadata = {
  title: "Samsung AC Service Center Morbi | Professional HVAC Service | Hitech Aircool Engineers",
  description: "Samsung AC Service Center Morbi — Professional service service by Hitech Aircool Engineers. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 93289 53665.",
  keywords: ["samsung ac service center morbi", "service service", "hvac service vadodara", "hitech aircool engineers", "ac service gujarat"],
  alternates: { canonical: "https://hitechairconditioning.in/samsung-ac-service-center-morbi" },
  openGraph: { title: "Samsung AC Service Center Morbi | Hitech Aircool Engineers", description: "Professional service service by Hitech Aircool Engineers Gujarat.", url: "https://hitechairconditioning.in/samsung-ac-service-center-morbi", type: "website" },
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Samsung AC Service Center Morbi",
  provider: { "@type": "LocalBusiness", name: "Hitech Aircool Engineers", telephone: "+919328953665" },
  areaServed: { "@type": "State", name: "Gujarat" },
  serviceType: "Samsung AC Service Center Morbi",
};

export default function SamsungACServiceCenterMorbiPage() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Samsung AC Service Center Morbi</h1>
