...
export const metadata: Metadata = {
  title: "AC Timer Problem in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC timer issue fix in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC Timer Problem Vadodara",
    "ac timer problem",
    "AC Timer Problem installation",
    "AC Timer Problem service",
    "AC Timer Problem repair",
    "best AC Timer Problem service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-timer-problem-vadodara",
  },
};

const keywordData = {
  title: "AC Timer Problem",
  slug: "ac-timer-problem",
  description: "AC timer issue fix",
  category: "Problems"
};
...
export default function ACTimerProblemPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What ac timer problem vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides ac timer problem vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book ac timer problem vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency ac timer problem vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What ac timer problem vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides ac timer problem vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book ac timer problem vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency ac timer problem vadodara available. Call +91 93289 53665 for immediate assistance." } },
