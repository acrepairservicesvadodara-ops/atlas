...
export const metadata: Metadata = {
  title: "Comprehensive & Non-Comprehensive Amc | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "Secure hassle-free operation of your equipment with our tailored Annual Maintenance Contracts (AMC). Choose a Comprehensive AMC covering all parts, labo...",
  keywords: ["comprehensive & non-comprehensive amc | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "amc"],
  alternates: { canonical: "https://atlasaircons.com/comprehensive-non-comprehensive-amc-hitech-aircool-engineers" },
  openGraph: {
    title: "Comprehensive & Non-Comprehensive Amc | Hitech Aircool Engineers",
    description: "Secure hassle-free operation of your equipment with our tailored Annual Maintenance Contracts (AMC). Choose a Comprehensive AMC covering all parts, labo...",
    url: "https://atlasaircons.com/comprehensive-non-comprehensive-amc-hitech-aircool-engineers",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Comprehensive & Non-Comprehensive Amc | Hitech Aircool Engineers",
  description: "Secure hassle-free operation of your equipment with our tailored Annual Maintenance Contracts (AMC). Choose a Comprehensive AMC covering all parts, labor, and preventive services, or a Non-Comprehensive (Labor-only) AMC for scheduled maintenance and discounted repairs. Our AMCs provide peace of mind",
...
export default function Pagecomprehensivenoncomprehensiveamchitechai() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  ...
                  alt="Comprehensive & Non-Comprehensive Amc | Hitech Aircool Engineers"
                ...
                <img
                  ...
                  alt="Comprehensive & Non-Comprehensive Amc | Hitech Aircool Engineers - Image 2"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Comprehensive & Non-Comprehensive Amc | Hitech Aircool Engineers - Image 3"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Comprehensive & Non-Comprehensive Amc | Hitech Aircool Engineers - Image 4"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Comprehensive &amp; Non-Comprehensive Amc | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">Secure hassle-free operation of your equipment with our tailored Annual Maintenance Contracts (AMC). Choose a Comprehensive AMC covering all parts, la</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%20Comprehensive%20%26%20Non-Comprehensive%20Amc%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Comprehensive &amp; Non-Comprehensive Amc</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>Secure hassle-free operation of your equipment with our tailored Annual Maintenance Contracts (AMC). Choose a Comprehensive AMC covering all parts, labor, and preventive services, or a Non-Comprehensive (Labor-only) AMC for scheduled maintenance and discounted repairs. Our AMCs provide peace of mind, predictable budgeting, and priority service to maximize uptime.</p>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[{"url":"https://www.atlasaircons.com/top-mount-air-curtains-horizontal-hitech-aircool-engineers/","title":"Top-Mount Air Curtains (Horizontal) | Hitech Aircool Engineers","price":""},{"url":"https://www.atlasaircons.com/refrigerated-cold-storage-air-curtains-hitech-aircool-engineers/","title":"Refrigerated/Cold Storage Air Curtains | Hitech Aircool Engineers","price":""}].map((p: { url: string; title: string; price: string }) => (
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Comprehensive Non Comprehensive Amc Hitech Aircool Engineers include?", a: "Comprehensive Non Comprehensive Amc Hitech Aircool Engineers includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Comprehensive Non Comprehensive Amc Hitech Aircool Engineers cost?", a: "Comprehensive Non Comprehensive Amc Hitech Aircool Engineers starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Comprehensive Non Comprehensive Amc Hitech Aircool Engineers improve cooling?", a: "Yes, proper Comprehensive Non Comprehensive Amc Hitech Aircool Engineers can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Comprehensive Non Comprehensive Amc Hitech Aircool Engineers reduce electricity bills?", a: "Regular Comprehensive Non Comprehensive Amc Hitech Aircool Engineers can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Comprehensive Non Comprehensive Amc Hitech Aircool Engineers take?", a: "Basic Comprehensive Non Comprehensive Amc Hitech Aircool Engineers takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Comprehensive Non Comprehensive Amc Hitech Aircool Engineers remove bad smell?", a: "Yes, Comprehensive Non Comprehensive Amc Hitech Aircool Engineers includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Comprehensive Non Comprehensive Amc Hitech Aircool Engineers?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Comprehensive Non Comprehensive Amc Hitech Aircool Engineers include?", acceptedAnswer: { "@type": "Answer", text: "Comprehensive Non Comprehensive Amc Hitech Aircool Engineers includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Comprehensive Non Comprehensive Amc Hitech Aircool Engineers cost?", acceptedAnswer: { "@type": "Answer", text: "Comprehensive Non Comprehensive Amc Hitech Aircool Engineers starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Comprehensive Non Comprehensive Amc Hitech Aircool Engineers improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Comprehensive Non Comprehensive Amc Hitech Aircool Engineers can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Comprehensive Non Comprehensive Amc Hitech Aircool Engineers reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Comprehensive Non Comprehensive Amc Hitech Aircool Engineers can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Comprehensive Non Comprehensive Amc Hitech Aircool Engineers take?", acceptedAnswer: { "@type": "Answer", text: "Basic Comprehensive Non Comprehensive Amc Hitech Aircool Engineers takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Comprehensive Non Comprehensive Amc Hitech Aircool Engineers remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Comprehensive Non Comprehensive Amc Hitech Aircool Engineers includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Comprehensive Non Comprehensive Amc Hitech Aircool Engineers?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
