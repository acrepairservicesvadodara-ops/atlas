...
export const metadata: Metadata = {
  title: "1-Hour Emergency Split AC Service Anand | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/split-ac-service-anand" },
  openGraph: {
    title: "1-Hour Emergency Split AC Service Anand | Atlas Aircon",
    description: "Expert split AC service in Anand. Fast repair, installation & gas refilling for brands like Voltas & LG. Same-day service available. Call now for 20% off first ",
    url: "https://atlasaircons.com/split-ac-service-anand",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert split AC service in Anand. Fast repair, installation &amp; gas refilling for brands like Voltas &amp; LG. Same-day service available. Call now for 20% off first service!</p>
