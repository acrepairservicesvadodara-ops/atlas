...
export const metadata: Metadata = {
  title: "1-Hour Emergency Split AC Service Anand | Hitech Aircool Engineers Gujarat",
  description: "Expert split AC service in Anand. Fast repair, installation & gas refilling for brands like Voltas & LG. Same-day service available. Call now for 20% off first ",
  alternates: { canonical: "https://hitechairconditioning.in/split-ac-service-anand" },
  openGraph: {
    title: "1-Hour Emergency Split AC Service Anand | Hitech Aircool Engineers",
    description: "Expert split AC service in Anand. Fast repair, installation & gas refilling for brands like Voltas & LG. Same-day service available. Call now for 20% off first ",
    url: "https://hitechairconditioning.in/split-ac-service-anand",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "1-Hour Emergency Split AC Service Anand",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagesplitacserviceanand() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">1-Hour Emergency Split AC Service Anand</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Expert split AC service in Anand. Fast repair, installation &amp; gas refilling for brands like Voltas &amp; LG. Same-day service available. Call now for 20% off first service!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Expert split AC service in Anand. Fast repair, installation &amp; gas refilling for brands like Voltas &amp; LG. Same-day service available. Call now for 20% off first service!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/Split-Air-Conditioner.webp" alt="1-Hour Emergency Split AC Service Anand" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="1-Hour Emergency Split AC Service Anand" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
