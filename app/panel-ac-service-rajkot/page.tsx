...
export const metadata: Metadata = {
  title: "Panel AC Service Rajkot | Hitech Aircool Engineers Gujarat",
  description: "Expert Rittal & Schneider panel AC service Rajkot's GIDCs, auto parts plants & CNC units. 24/7 emergency service, genuine parts & industrial AMCs to prevent cos",
  alternates: { canonical: "https://hitechairconditioning.in/panel-ac-service-rajkot" },
  openGraph: {
    title: "Panel AC Service Rajkot | Hitech Aircool Engineers",
    description: "Expert Rittal & Schneider panel AC service Rajkot's GIDCs, auto parts plants & CNC units. 24/7 emergency service, genuine parts & industrial AMCs to prevent cos",
    url: "https://hitechairconditioning.in/panel-ac-service-rajkot",
    type: "website",
...
export default function Pagepanelacservicerajkot() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Panel AC Service Rajkot</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Expert Rittal &amp; Schneider panel AC service Rajkot&apos;s GIDCs, auto parts plants &amp; CNC units. 24/7 emergency service, genuine parts &amp; industrial AMCs to prevent costly downtime.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Expert Rittal &amp; Schneider panel AC service Rajkot&apos;s GIDCs, auto parts plants &amp; CNC units. 24/7 emergency service, genuine parts &amp; industrial AMCs to prevent costly downtime.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/panel-ac-repair-service.webp" alt="Panel AC Service Rajkot" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Panel AC Service Rajkot" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
