...
export const metadata: Metadata = {
  title: "Panel AC Service Rajkot | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/panel-ac-service-rajkot" },
  openGraph: {
    title: "Panel AC Service Rajkot | Atlas Aircon",
    description: "Expert Rittal & Schneider panel AC service Rajkot's GIDCs, auto parts plants & CNC units. 24/7 emergency service, genuine parts & industrial AMCs to prevent cos",
    url: "https://atlasaircons.com/panel-ac-service-rajkot",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert Rittal &amp; Schneider panel AC service Rajkot&apos;s GIDCs, auto parts plants &amp; CNC units. 24/7 emergency service, genuine parts &amp; industrial AMCs to prevent costly downtime.</p>
