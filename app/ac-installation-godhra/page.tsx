...
export const metadata: Metadata = {
  title: "AC Installation Godhra | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-installation-godhra" },
  openGraph: {
    title: "AC Installation Godhra | Atlas Aircon",
    description: "Professional AC installation service in Godhra. Expert split & window AC fitting, gas charging & electrical work. Free site survey & affordable pricing. Call no",
    url: "https://atlasaircons.com/ac-installation-godhra",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Professional AC installation service in Godhra. Expert split &amp; window AC fitting, gas charging &amp; electrical work. Free site survey &amp; affordable pricing. Call now!</p>
