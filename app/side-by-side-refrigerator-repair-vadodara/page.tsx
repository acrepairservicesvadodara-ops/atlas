...
export const metadata: Metadata = {
  title: "Side by Side Refrigerator Repair in Vadodara | Installation, Service & Repair | Atlas Aircon",
  description: "Side by side fridge service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 97272 57141",
  keywords: [
    "Side by Side Refrigerator Repair Vadodara",
    "side by side refrigerator repair",
    "Side by Side Refrigerator Repair installation",
    "Side by Side Refrigerator Repair service",
    "Side by Side Refrigerator Repair repair",
    "best Side by Side Refrigerator Repair service",
  ],
  alternates: {
    canonical: "https://atlasaircons.com/side-by-side-refrigerator-repair-vadodara",
  },
};

const keywordData = {
  title: "Side by Side Refrigerator Repair",
  slug: "side-by-side-refrigerator-repair",
  description: "Side by side fridge service",
...
export default function SidebySideRefrigeratorRepairPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Side By Side Refrigerator Repair Vadodara in Vadodara?", a: "Side By Side Refrigerator Repair Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Side By Side Refrigerator Repair Vadodara?", a: "Atlas Aircon offers same-day Side By Side Refrigerator Repair Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Side By Side Refrigerator Repair Vadodaras?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Side By Side Refrigerator Repair Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Side By Side Refrigerator Repair Vadodara available on holidays?", a: "Yes, Atlas Aircon provides Side By Side Refrigerator Repair Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
              { q: "How long does Side By Side Refrigerator Repair Vadodara take?", a: "Most Side By Side Refrigerator Repair Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Side By Side Refrigerator Repair Vadodara in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Side By Side Refrigerator Repair Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Side By Side Refrigerator Repair Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Side By Side Refrigerator Repair Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Side By Side Refrigerator Repair Vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Side By Side Refrigerator Repair Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Side By Side Refrigerator Repair Vadodara available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Side By Side Refrigerator Repair Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
          { "@type": "Question", name: "How long does Side By Side Refrigerator Repair Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Most Side By Side Refrigerator Repair Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
