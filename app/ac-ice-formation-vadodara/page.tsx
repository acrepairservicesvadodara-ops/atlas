...
export const metadata: Metadata = {
  title: "AC Ice Formation in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Fix AC freezing issue in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC Ice Formation Vadodara",
    "ac ice formation",
    "AC Ice Formation installation",
    "AC Ice Formation service",
    "AC Ice Formation repair",
    "best AC Ice Formation service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-ice-formation-vadodara",
  },
};

const keywordData = {
  title: "AC Ice Formation",
  slug: "ac-ice-formation",
  description: "Fix AC freezing issue",
  category: "Problems"
};
...
export default function ACIceFormationPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What ac ice formation vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides ac ice formation vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book ac ice formation vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency ac ice formation vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What ac ice formation vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides ac ice formation vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book ac ice formation vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency ac ice formation vadodara available. Call +91 93289 53665 for immediate assistance." } },
