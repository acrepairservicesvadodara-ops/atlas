...
export const metadata: Metadata = {
  title: "Ice Cream Parlor AC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Ice cream parlor cooling in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Ice Cream Parlor AC Vadodara",
    "ice cream parlor ac",
    "Ice Cream Parlor AC installation",
    "Ice Cream Parlor AC service",
    "Ice Cream Parlor AC repair",
    "best Ice Cream Parlor AC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ice-cream-parlor-ac-vadodara",
  },
};

const keywordData = {
  title: "Ice Cream Parlor AC",
  slug: "ice-cream-parlor-ac",
  description: "Ice cream parlor cooling",
  category: "Commercial"
};
...
export default function IceCreamParlorACPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What ice cream parlor ac vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides ice cream parlor ac vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book ice cream parlor ac vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency ice cream parlor ac vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What ice cream parlor ac vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides ice cream parlor ac vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book ice cream parlor ac vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency ice cream parlor ac vadodara available. Call +91 93289 53665 for immediate assistance." } },
