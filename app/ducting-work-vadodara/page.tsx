...
export const metadata: Metadata = {
  title: "Ducting Work in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC duct installation in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Ducting Work Vadodara",
    "ducting work",
    "Ducting Work installation",
    "Ducting Work service",
    "Ducting Work repair",
    "best Ducting Work service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ducting-work-vadodara",
  },
};
...
const keywordData = {
  title: "Ducting Work",
  slug: "ducting-work",
  description: "AC duct installation",
  category: "HVAC"
};
...
export default function DuctingWorkPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What ducting work vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides ducting work vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book ducting work vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency ducting work vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What ducting work vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides ducting work vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book ducting work vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency ducting work vadodara available. Call +91 93289 53665 for immediate assistance." } },
