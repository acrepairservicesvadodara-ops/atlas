...
export const metadata: Metadata = {
  title: "Chilled Water Alum Or Gi Casing Coil | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "Chilled water coil housed in an aluminum or galvanized iron (GI) casing. The casing directs airflow through the coil and provides structural support. Al...",
  keywords: ["chilled water alum or gi casing coil | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "coils"],
  alternates: { canonical: "https://atlasaircons.com/chilled-water-alum-or-gi-casing-coil-hitech-aircool-engineers" },
  openGraph: {
    title: "Chilled Water Alum Or Gi Casing Coil | Hitech Aircool Engineers",
    description: "Chilled water coil housed in an aluminum or galvanized iron (GI) casing. The casing directs airflow through the coil and provides structural support. Al...",
    url: "https://atlasaircons.com/chilled-water-alum-or-gi-casing-coil-hitech-aircool-engineers",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Chilled Water Alum Or Gi Casing Coil | Hitech Aircool Engineers",
  description: "Chilled water coil housed in an aluminum or galvanized iron (GI) casing. The casing directs airflow through the coil and provides structural support. Aluminum is lighter and rust-proof; GI is more robust and cost-effective for standard indoor applications.",
...
export default function Pagechilledwateralumorgicasingcoilhitechairc() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  ...
                  alt="Chilled Water Alum Or Gi Casing Coil | Hitech Aircool Engineers"
                ...
                <img
                  ...
                  alt="Chilled Water Alum Or Gi Casing Coil | Hitech Aircool Engineers - Image 2"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Chilled Water Alum Or Gi Casing Coil | Hitech Aircool Engineers - Image 3"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Chilled Water Alum Or Gi Casing Coil | Hitech Aircool Engineers - Image 4"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Chilled Water Alum Or Gi Casing Coil | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">Chilled water coil housed in an aluminum or galvanized iron (GI) casing. The casing directs airflow through the coil and provides structural support.</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%20Chilled%20Water%20Alum%20Or%20Gi%20Casing%20Coil%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Chilled Water Alum Or Gi Casing Coil</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Commercial Buildings</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">General HVAC applications</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>Chilled water coil housed in an aluminum or galvanized iron (GI) casing. The casing directs airflow through the coil and provides structural support. Aluminum is lighter and rust-proof; GI is more robust and cost-effective for standard indoor applications.</p>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What chilled water alum or gi casing coil hitech aircool engineerss does Atlas Aircon provide?", a: "Atlas Aircon provides chilled water alum or gi casing coil hitech aircool engineers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book chilled water alum or gi casing coil hitech aircool engineers?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency chilled water alum or gi casing coil hitech aircool engineers available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What chilled water alum or gi casing coil hitech aircool engineerss does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides chilled water alum or gi casing coil hitech aircool engineers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book chilled water alum or gi casing coil hitech aircool engineers?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency chilled water alum or gi casing coil hitech aircool engineers available. Call +91 97272 57141 for immediate assistance." } },
