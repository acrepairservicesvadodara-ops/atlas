...
export const metadata: Metadata = {
  title: "Tower AC Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Tower AC repair and service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    ...
    "Tower AC service",
    "Tower AC repair",
    "best Tower AC repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/tower-ac-repair-vadodara",
  },
};
...
const keywordData = {
  ...
  description: "Tower AC repair and service",
  category: "ACTypes"
};
...
export default function TowerACRepairPage() {
  return (
    <>
      {/* Hero Section */}
