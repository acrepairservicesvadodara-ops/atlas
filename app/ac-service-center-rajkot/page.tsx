...
export const metadata: Metadata = {
  title: "🚑 AC Service Center Rajkot | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-center-rajkot" },
  openGraph: {
    title: "🚑 AC Service Center Rajkot | Atlas Aircon",
    description: "Trusted AC Service Center Rajkot. We provide fast repair, maintenance & troubleshooting for all AC brands at your doorstep. Free check-up & honest pricing. Call",
    url: "https://atlasaircons.com/ac-service-center-rajkot",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Trusted AC Service Center Rajkot. We provide fast repair, maintenance &amp; troubleshooting for all AC brands at your doorstep. Free check-up &amp; honest pricing. Call now!</p>
