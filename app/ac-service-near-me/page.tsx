...
export const metadata: Metadata = {
  title: "AC Service Near Me: Trusted, Professional, And Ready To Help [2026 Updated] | Atlas Aircon Gujarat",
  description: "When the scorching heat hits, the last thing you want is a broken air conditioner. But don’t worry – <stro...",
  alternates: { canonical: "https://atlasaircons.com/ac-service-near-me" },
  openGraph: {
    title: "AC Service Near Me: Trusted, Professional, And Ready To Help [2026 Updated] | Atlas Aircon",
    description: "When the scorching heat hits, the last thing you want is a broken air conditioner. But don’t worry – <stro...",
    url: "https://atlasaircons.com/ac-service-near-me",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">When the scorching heat hits, the last thing you want is a broken air conditioner. But don’t worry – &lt;stro...</p>
