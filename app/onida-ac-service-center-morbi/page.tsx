...
export const metadata: Metadata = {
  title: "Onida AC Service Center Morbi | Professional HVAC Service | Atlas Aircon",
  description: "Onida AC Service Center Morbi — Professional service service by Atlas Aircon. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 97272 57141.",
  keywords: ["onida ac service center morbi", "service service", "hvac service vadodara", "atlas aircon", "ac service gujarat"],
  alternates: { canonical: "https://atlasaircons.com/onida-ac-service-center-morbi" },
  openGraph: { title: "Onida AC Service Center Morbi | Atlas Aircon", description: "Professional service service by Atlas Aircon Gujarat.", url: "https://atlasaircons.com/onida-ac-service-center-morbi", type: "website" },
};
