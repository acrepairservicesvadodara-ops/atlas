...
export const metadata: Metadata = {
  title: "Affordable Ducting Repair Services Godhra: Solve 5+ Leak [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ducting-repair-services-godhra" },
  openGraph: {
    title: "Affordable Ducting Repair Services Godhra: Solve 5+ Leak [2026 Updated] | Atlas Aircon",
    description: "Local ducting repair services Godhra. We provide fast & reliable fixes for home & shop AC ducts, improving cooling & air quality. ✅ Free estimate & honest prici",
    url: "https://atlasaircons.com/ducting-repair-services-godhra",
    type: "website",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Local ducting repair services Godhra. We provide fast &amp; reliable fixes for home &amp; shop AC ducts, improving cooling &amp; air quality. ✅ Free estimate &amp; honest pricing.</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/cropped-AtlasAircon-Logo.webp" alt="Affordable Ducting Repair Services Godhra: Solve 5+ Leak [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Ducting Repair Services Godhra in Vadodara?", a: "Ducting Repair Services Godhra cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Ducting Repair Services Godhra?", a: "Atlas Aircon offers same-day Ducting Repair Services Godhra across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Ducting Repair Services Godhras?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Ducting Repair Services Godhras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Ducting Repair Services Godhra available on holidays?", a: "Yes, Atlas Aircon provides Ducting Repair Services Godhra 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Ducting Repair Services Godhra?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Ducting Repair Services Godhra across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Ducting Repair Services Godhras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Ducting Repair Services Godhras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Ducting Repair Services Godhra available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Ducting Repair Services Godhra 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
