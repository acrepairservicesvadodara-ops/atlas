...
export const metadata: Metadata = {
  title: "Panel AC Service Surat | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/panel-ac-service-surat" },
  openGraph: {
    title: "Panel AC Service Surat | Atlas Aircon",
    description: "Expert Rittal & Schneider panel AC service Surat's diamond polishing, textile mills & Hazira GIDC. 24/7 emergency repair, genuine parts & AMCs to protect precis",
    url: "https://atlasaircons.com/panel-ac-service-surat",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert Rittal &amp; Schneider panel AC service Surat&apos;s diamond polishing, textile mills &amp; Hazira GIDC. 24/7 emergency repair, genuine parts &amp; AMCs to protect precision equipment.</p>
