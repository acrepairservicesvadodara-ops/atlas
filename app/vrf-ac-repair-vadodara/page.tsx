...
export const metadata: Metadata = {
  title: "VRF AC Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "VRF system service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "VRF AC Repair Vadodara",
    "vrf ac repair",
    "VRF AC Repair installation",
    "VRF AC Repair service",
    "VRF AC Repair repair",
    "best VRF AC Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/vrf-ac-repair-vadodara",
  },
};
...
const keywordData = {
  title: "VRF AC Repair",
  slug: "vrf-ac-repair",
  description: "VRF system service",
  category: "HVAC"
};
...
export default function VRFACRepairPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVvrf ac repair vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial vrf ac repair vadodara?", a: "Industrial vrf ac repair vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVvrf ac repair vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial vrf ac repair vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial vrf ac repair vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
