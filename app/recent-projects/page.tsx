...
export const metadata: Metadata = {
  title: "Project Log Archive &raquo; Atlas Aircon | Atlas Aircon Gujarat",
  description: "Project Log Archive &raquo; Atlas Aircon - AC Repair in Vadodara",
  alternates: { canonical: "https://atlasaircons.com/recent-projects" },
  openGraph: {
    title: "Project Log Archive &raquo; Atlas Aircon | Atlas Aircon",
    description: "Project Log Archive &raquo; Atlas Aircon - AC Repair in Vadodara",
    url: "https://atlasaircons.com/recent-projects",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Project Log Archive &raquo; Atlas Aircon",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Project Log Archive &amp;raquo; Atlas Aircon</h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Project Log Archive &amp;raquo; Atlas Aircon - AC Repair in Vadodara</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Project Log Archive &amp;raquo; Atlas Aircon - AC Repair in Vadodara</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Project Log Archive &raquo; Atlas Aircon" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/mitsibushi-cassette-ac-precision-repair-service-in-subhanpura-1772028381-1.webp" alt="Project Log Archive &raquo; Atlas Aircon" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/mitsibushi-cassette-ac-precision-repair-service-in-subhanpura-1772028381-1.webp" alt="Project Log Archive &raquo; Atlas Aircon" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/mitsibushi-cassette-ac-precision-repair-service-in-subhanpura-1772028381-1.webp" alt="Project Log Archive &raquo; Atlas Aircon" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/mitsibushi-cassette-ac-precision-repair-service-in-subhanpura-1772028381-1.webp" alt="Project Log Archive &raquo; Atlas Aircon" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/mitsibushi-cassette-ac-precision-repair-service-in-subhanpura-1772028381-1.webp" alt="Project Log Archive &raquo; Atlas Aircon" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What recent projectss does Atlas Aircon provide?", a: "Atlas Aircon provides recent projects, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book recent projects?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency recent projects available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What recent projectss does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides recent projects, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book recent projects?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency recent projects available. Call +91 97272 57141 for immediate assistance." } },
