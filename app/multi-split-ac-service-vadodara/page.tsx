...
export const metadata: Metadata = {
  title: "Multi Split AC Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Multi split AC repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Multi Split AC Service Vadodara",
    "multi split ac service",
    "Multi Split AC Service installation",
    "Multi Split AC Service service",
    "Multi Split AC Service repair",
    "best Multi Split AC Service service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/multi-split-ac-service-vadodara",
  },
};

const keywordData = {
  title: "Multi Split AC Service",
  slug: "multi-split-ac-service",
  description: "Multi split AC repair",
  category: "ACTypes"
};
...
export default function MultiSplitACServicePage() {
  return (
    <>
      {/* Hero Section */}
