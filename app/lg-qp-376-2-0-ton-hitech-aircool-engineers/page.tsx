...
export const metadata: Metadata = {
  title: "Lg – Qp 376 – 2.0 Ton | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "A 2-ton LG rotary compressor. This capacity is used in larger rooms or small offices. Rotary compressors in this size offer a good power-to-size ratio, ...",
  keywords: ["lg – qp 376 – 2.0 ton | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "lg"],
  alternates: { canonical: "https://atlasaircons.com/lg-qp-376-2-0-ton-hitech-aircool-engineers" },
  openGraph: {
    title: "Lg – Qp 376 – 2.0 Ton | Hitech Aircool Engineers",
    description: "A 2-ton LG rotary compressor. This capacity is used in larger rooms or small offices. Rotary compressors in this size offer a good power-to-size ratio, ...",
    url: "https://atlasaircons.com/lg-qp-376-2-0-ton-hitech-aircool-engineers",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Lg – Qp 376 – 2.0 Ton | Hitech Aircool Engineers",
  description: "A 2-ton LG rotary compressor. This capacity is used in larger rooms or small offices. Rotary compressors in this size offer a good power-to-size ratio, allowing for more compact outdoor unit designs.",
...
export default function Pagelgqp37620tonhitechaircoolengineers() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  ...
                  alt="Lg – Qp 376 – 2.0 Ton | Hitech Aircool Engineers"
                ...
                <img
                  ...
                  alt="Lg – Qp 376 – 2.0 Ton | Hitech Aircool Engineers - Image 2"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Lg – Qp 376 – 2.0 Ton | Hitech Aircool Engineers - Image 3"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Lg – Qp 376 – 2.0 Ton | Hitech Aircool Engineers - Image 4"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Lg – Qp 376 – 2.0 Ton | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">A 2-ton LG rotary compressor. This capacity is used in larger rooms or small offices. Rotary compressors in this size offer a good power-to-size ratio</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%20Lg%20%E2%80%93%20Qp%20376%20%E2%80%93%202.0%20Ton%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Commercial/Residential</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Gujarat</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Larger Rooms</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Lg - Qp 376 - 2.0 Ton</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Medium capacity cooling</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>A 2-ton LG rotary compressor. This capacity is used in larger rooms or small offices. Rotary compressors in this size offer a good power-to-size ratio, allowing for more compact outdoor unit designs.</p>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[{"url":"https://www.atlasaircons.com/recirculating-air-curtains-hitech-aircool-engineers/","title":"Recirculating Air Curtains | Hitech Aircool Engineers","price":""},{"url":"https://www.atlasaircons.com/24x7-air-conditioner-emergency-service-hitech-aircool-engineers/","title":"24X7 Air Conditioner Emergency Service | Hitech Aircool Engineers","price":""}].map((p: { url: string; title: string; price: string }) => (
