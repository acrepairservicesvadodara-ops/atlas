...
export const metadata: Metadata = {
  title: "LG AC Service Center Godhra | Professional HVAC Service | Atlas Aircon",
  description: "LG AC Service Center Godhra — Professional service service by Atlas Aircon. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 97272 57141.",
  keywords: ["lg ac service center godhra", "service service", "hvac service vadodara", "atlas aircon", "ac service gujarat"],
  alternates: { canonical: "https://atlasaircons.com/lg-ac-service-center-godhra" },
  openGraph: { title: "LG AC Service Center Godhra | Atlas Aircon", description: "Professional service service by Atlas Aircon Gujarat.", url: "https://atlasaircons.com/lg-ac-service-center-godhra", type: "website" },
};
