...
export const metadata: Metadata = {
  title: "VRF Installation in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "VRF system installation in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "VRF Installation Vadodara",
    "vrf installation",
    "VRF Installation installation",
    "VRF Installation service",
    "VRF Installation repair",
    "best VRF Installation service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/vrf-installation-vadodara",
  },
};

const keywordData = {
  title: "VRF Installation",
  slug: "vrf-installation",
  description: "VRF system installation",
  category: "HVAC"
};
  ...
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVvrf installation vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial vrf installation vadodara?", a: "Industrial vrf installation vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVvrf installation vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial vrf installation vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial vrf installation vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
