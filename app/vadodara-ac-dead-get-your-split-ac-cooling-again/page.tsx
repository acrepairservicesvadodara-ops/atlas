...
export const metadata: Metadata = {
  title: "Vadodara #1, AC Dead? Get Your Split AC Cooling Again [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Vadodara #1, AC Dead? Get Your Split AC Cooling Again [2026 Updated] - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/vadodara-ac-dead-get-your-split-ac-cooling-again" },
  openGraph: {
    title: "Vadodara #1, AC Dead? Get Your Split AC Cooling Again [2026 Updated] | Hitech Aircool Engineers",
    description: "Vadodara #1, AC Dead? Get Your Split AC Cooling Again [2026 Updated] - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/vadodara-ac-dead-get-your-split-ac-cooling-again",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Vadodara #1, AC Dead? Get Your Split AC Cooling Again [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagevadodaraacdeadgetyoursplitaccoolingagain() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Vadodara #1, AC Dead? Get Your Split AC Cooling Again [2026 Updated]</h1>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Split-Ac-Installation-and-Repair-Service-1.webp" alt="Vadodara #1, AC Dead? Get Your Split AC Cooling Again [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Vadodara #1, AC Dead? Get Your Split AC Cooling Again [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Vadodara #1, AC Dead? Get Your Split AC Cooling Again [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
