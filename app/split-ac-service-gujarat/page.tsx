...
export const metadata: Metadata = {
  title: "Top Split AC Repair & Service Across Gujarat | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/split-ac-service-gujarat" },
  openGraph: {
    title: "Top Split AC Repair & Service Across Gujarat | Atlas Aircon",
    description: "Gujarat's trusted AC experts. We provide professional split AC service, repair & installation in Ahmedabad, Vadodara, Surat & 20+ cities. Same-day service & gen",
    url: "https://atlasaircons.com/split-ac-service-gujarat",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Gujarat&apos;s trusted AC experts. We provide professional split AC service, repair &amp; installation in Ahmedabad, Vadodara, Surat &amp; 20+ cities. Same-day service &amp; genuine spare parts.</p>
