...
export const metadata: Metadata = {
  title: "Top Split AC Repair & Service Across Gujarat | Hitech Aircool Engineers Gujarat",
  description: "Gujarat's trusted AC experts. We provide professional split AC service, repair & installation in Ahmedabad, Vadodara, Surat & 20+ cities. Same-day service & gen",
  alternates: { canonical: "https://hitechairconditioning.in/split-ac-service-gujarat" },
  openGraph: {
    title: "Top Split AC Repair & Service Across Gujarat | Hitech Aircool Engineers",
    description: "Gujarat's trusted AC experts. We provide professional split AC service, repair & installation in Ahmedabad, Vadodara, Surat & 20+ cities. Same-day service & gen",
    url: "https://hitechairconditioning.in/split-ac-service-gujarat",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Top Split AC Repair & Service Across Gujarat",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagesplitacservicegujarat() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Top Split AC Repair &amp; Service Across Gujarat</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Gujarat&apos;s trusted AC experts. We provide professional split AC service, repair &amp; installation in Ahmedabad, Vadodara, Surat &amp; 20+ cities. Same-day service &amp; genuine spare parts.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Gujarat&apos;s trusted AC experts. We provide professional split AC service, repair &amp; installation in Ahmedabad, Vadodara, Surat &amp; 20+ cities. Same-day service &amp; genuine spare parts.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/Split-Air-Conditioner.webp" alt="Top Split AC Repair & Service Across Gujarat" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Top Split AC Repair & Service Across Gujarat" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
