...
export const metadata: Metadata = {
  title: "Onida AC Service Center Bharuch | Professional HVAC Service | Hitech Aircool Engineers",
  description: "Onida AC Service Center Bharuch — Professional service service by Hitech Aircool Engineers. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 93289 53665.",
  keywords: ["onida ac service center bharuch", "service service", "hvac service vadodara", "hitech aircool engineers", "ac service gujarat"],
  alternates: { canonical: "https://hitechairconditioning.in/onida-ac-service-center-bharuch" },
  openGraph: { title: "Onida AC Service Center Bharuch | Hitech Aircool Engineers", description: "Professional service service by Hitech Aircool Engineers Gujarat.", url: "https://hitechairconditioning.in/onida-ac-service-center-bharuch", type: "website" },
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Onida AC Service Center Bharuch",
  provider: { "@type": "LocalBusiness", name: "Hitech Aircool Engineers", telephone: "+919328953665" },
  areaServed: { "@type": "State", name: "Gujarat" },
  serviceType: "Onida AC Service Center Bharuch",
};

export default function OnidaACServiceCenterBharuchPage() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Onida AC Service Center Bharuch</h1>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Onida Ac Service Center Bharuch include?", a: "Onida Ac Service Center Bharuch includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Onida Ac Service Center Bharuch cost?", a: "Onida Ac Service Center Bharuch starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Onida Ac Service Center Bharuch improve cooling?", a: "Yes, proper Onida Ac Service Center Bharuch can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Onida Ac Service Center Bharuch reduce electricity bills?", a: "Regular Onida Ac Service Center Bharuch can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Onida Ac Service Center Bharuch take?", a: "Basic Onida Ac Service Center Bharuch takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Onida Ac Service Center Bharuch remove bad smell?", a: "Yes, Onida Ac Service Center Bharuch includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Onida Ac Service Center Bharuch?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Onida Ac Service Center Bharuch include?", acceptedAnswer: { "@type": "Answer", text: "Onida Ac Service Center Bharuch includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Onida Ac Service Center Bharuch cost?", acceptedAnswer: { "@type": "Answer", text: "Onida Ac Service Center Bharuch starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Onida Ac Service Center Bharuch improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Onida Ac Service Center Bharuch can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Onida Ac Service Center Bharuch reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Onida Ac Service Center Bharuch can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Onida Ac Service Center Bharuch take?", acceptedAnswer: { "@type": "Answer", text: "Basic Onida Ac Service Center Bharuch takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Onida Ac Service Center Bharuch remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Onida Ac Service Center Bharuch includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Onida Ac Service Center Bharuch?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
