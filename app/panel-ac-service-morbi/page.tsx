...
export const metadata: Metadata = {
  title: "Panel AC Service Morbi | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/panel-ac-service-morbi" },
  openGraph: {
    title: "Panel AC Service Morbi | Atlas Aircon",
    description: "Expert Rittal & Schneider panel AC service Morbi's ceramic plants, tile factories & GIDC units. 24/7 emergency service, genuine parts & AMCs to prevent producti",
    url: "https://atlasaircons.com/panel-ac-service-morbi",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert Rittal &amp; Schneider panel AC service Morbi&apos;s ceramic plants, tile factories &amp; GIDC units. 24/7 emergency service, genuine parts &amp; AMCs to prevent production downtime.</p>
