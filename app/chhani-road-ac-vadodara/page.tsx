...
export const metadata: Metadata = {
  title: "Chhani Road AC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC service Chhani Road in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Chhani Road AC Vadodara",
    "chhani road ac",
    "Chhani Road AC installation",
    "Chhani Road AC service",
    "Chhani Road AC repair",
    "best Chhani Road AC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/chhani-road-ac-vadodara",
  },
};

const keywordData = {
  title: "Chhani Road AC",
  slug: "chhani-road-ac",
  description: "AC service Chhani Road",
  category: "Area"
};
...
export default function ChhaniRoadACPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What chhani road ac vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides chhani road ac vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book chhani road ac vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency chhani road ac vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What chhani road ac vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides chhani road ac vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book chhani road ac vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency chhani road ac vadodara available. Call +91 93289 53665 for immediate assistance." } },
