...
export const metadata: Metadata = {
  title: "🔧 #1 AC Service Center Surat | Hitech Aircool Engineers Gujarat",
  description: "Need AC service in Surat? Our expert technicians offer fast repairs & maintenance at your doorstep. Same-day service, honest pricing & customer satisfaction gua",
  alternates: { canonical: "https://hitechairconditioning.in/ac-service-center-surat" },
  openGraph: {
    title: "🔧 #1 AC Service Center Surat | Hitech Aircool Engineers",
    description: "Need AC service in Surat? Our expert technicians offer fast repairs & maintenance at your doorstep. Same-day service, honest pricing & customer satisfaction gua",
    url: "https://hitechairconditioning.in/ac-service-center-surat",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "🔧 #1 AC Service Center Surat",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageacservicecentersurat() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">🔧 #1 AC Service Center Surat</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Need AC service in Surat? Our expert technicians offer fast repairs &amp; maintenance at your doorstep. Same-day service, honest pricing &amp; customer satisfaction guaranteed.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Need AC service in Surat? Our expert technicians offer fast repairs &amp; maintenance at your doorstep. Same-day service, honest pricing &amp; customer satisfaction guaranteed.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Atlas-Aircon-Vehicle.webp" alt="🔧 #1 AC Service Center Surat" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="🔧 #1 AC Service Center Surat" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Ac Service Center Surat include?", a: "Ac Service Center Surat includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Ac Service Center Surat cost?", a: "Ac Service Center Surat starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Ac Service Center Surat improve cooling?", a: "Yes, proper Ac Service Center Surat can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Ac Service Center Surat reduce electricity bills?", a: "Regular Ac Service Center Surat can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Ac Service Center Surat take?", a: "Basic Ac Service Center Surat takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Ac Service Center Surat remove bad smell?", a: "Yes, Ac Service Center Surat includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Ac Service Center Surat?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Ac Service Center Surat include?", acceptedAnswer: { "@type": "Answer", text: "Ac Service Center Surat includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Ac Service Center Surat cost?", acceptedAnswer: { "@type": "Answer", text: "Ac Service Center Surat starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Ac Service Center Surat improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Ac Service Center Surat can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Ac Service Center Surat reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Ac Service Center Surat can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Ac Service Center Surat take?", acceptedAnswer: { "@type": "Answer", text: "Basic Ac Service Center Surat takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Ac Service Center Surat remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Ac Service Center Surat includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Ac Service Center Surat?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
