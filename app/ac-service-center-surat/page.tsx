...
export const metadata: Metadata = {
  title: "🔧 #1 AC Service Center Surat | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-center-surat" },
  openGraph: {
    title: "🔧 #1 AC Service Center Surat | Atlas Aircon",
    description: "Need AC service in Surat? Our expert technicians offer fast repairs & maintenance at your doorstep. Same-day service, honest pricing & customer satisfaction gua",
    url: "https://atlasaircons.com/ac-service-center-surat",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Need AC service in Surat? Our expert technicians offer fast repairs &amp; maintenance at your doorstep. Same-day service, honest pricing &amp; customer satisfaction guaranteed.</p>
