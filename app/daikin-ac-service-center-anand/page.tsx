...
export const metadata: Metadata = {
  title: "Daikin AC Service Center Anand | Out-of-Warranty Repair Expert | Hitech Aircool Engineers",
  description: "Independent Daikin AC service center in Anand. Expert out-of-warranty split AC repair, gas charging, PCB repair, deep cleaning & compressor overhaul. Same-day service. Call +91 93289 53665.",
  keywords: [
  ...
  alternates: { canonical: "https://hitechairconditioning.in/daikin-ac-service-center-anand" },
  openGraph: {
    title: "Daikin AC Service Center Anand | Hitech Aircool Engineers",
    description: "Independent out-of-warranty Daikin AC repair specialist in Anand. Same-day service, 90-day guarantee.",
    url: "https://hitechairconditioning.in/daikin-ac-service-center-anand",
    type: "website",
  },
};
...
const faqJsonLd = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "Is Hitech Aircool Engineers an authorized Daikin service center in Anand?", acceptedAnswer: { "@type": "Answer", text: "No. Hitech Aircool Engineers is an independent service provider specializing in high-quality out-of-warranty repairs. If your Daikin AC is under official warranty, contact Daikin directly." } },
