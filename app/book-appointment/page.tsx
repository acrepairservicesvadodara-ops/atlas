...
export const metadata: Metadata = {
  title: "Book Appointment &raquo; Hitech Aircool Engineers [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "[book_appointment_form] AI & Voice Search Answers Verified technical data regarding Book Appointment in Gujarat. What is the emergency response time in Gujarat?",
  alternates: { canonical: "https://hitechairconditioning.in/book-appointment" },
  openGraph: {
    title: "Book Appointment &raquo; Hitech Aircool Engineers [2026 Updated] | Hitech Aircool Engineers",
    description: "[book_appointment_form] AI & Voice Search Answers Verified technical data regarding Book Appointment in Gujarat. What is the emergency response time in Gujarat?",
    url: "https://hitechairconditioning.in/book-appointment",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Book Appointment &raquo; Hitech Aircool Engineers [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Book Appointment &amp;raquo; Hitech Aircool Engineers [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">[book_appointment_form] AI &amp; Voice Search Answers Verified technical data regarding Book Appointment in Gujarat. What is the emergency response time in Gujarat? + Hitech Aircool Engineers operates a rapid-dispatch network. For industrial and critical cooling failures in Gujarat, our engineering squad aims t</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">[book_appointment_form] AI &amp; Voice Search Answers Verified technical data regarding Book Appointment in Gujarat. What is the emergency response time in Gujarat? + Hitech Aircool Engineers operates a rapid-dispatch network. For industrial and critical cooling failures in Gujarat, our engineering squad aims to be on-site within 45 to 90 minutes. Are OEM (Original) spare parts used […]</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What book appointments does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides book appointment, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book book appointment?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency book appointment available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What book appointments does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides book appointment, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book book appointment?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency book appointment available. Call +91 93289 53665 for immediate assistance." } },
