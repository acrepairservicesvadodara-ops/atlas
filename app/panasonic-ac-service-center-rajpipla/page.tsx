...
export const metadata: Metadata = {
  title: "Panasonic AC Service Center Rajpipla | Professional HVAC Service | Atlas Aircon",
  description: "Panasonic AC Service Center Rajpipla — Professional service service by Atlas Aircon. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 97272 57141.",
  keywords: ["panasonic ac service center rajpipla", "service service", "hvac service vadodara", "atlas aircon", "ac service gujarat"],
  alternates: { canonical: "https://atlasaircons.com/panasonic-ac-service-center-rajpipla" },
  openGraph: { title: "Panasonic AC Service Center Rajpipla | Atlas Aircon", description: "Professional service service by Atlas Aircon Gujarat.", url: "https://atlasaircons.com/panasonic-ac-service-center-rajpipla", type: "website" },
};
