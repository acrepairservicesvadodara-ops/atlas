...
export const metadata: Metadata = {
  title: "LG AC Service Center Vadodara | Professional HVAC Service | Atlas Aircon",
  description: "LG AC Service Center Vadodara — Professional service service by Atlas Aircon. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 97272 57141.",
  keywords: ["lg ac service center vadodara", "service service", "hvac service vadodara", "atlas aircon", "ac service gujarat"],
  alternates: { canonical: "https://atlasaircons.com/lg-ac-service-center-vadodara" },
  openGraph: { title: "LG AC Service Center Vadodara | Atlas Aircon", description: "Professional service service by Atlas Aircon Gujarat.", url: "https://atlasaircons.com/lg-ac-service-center-vadodara", type: "website" },
};
