...
export const metadata: Metadata = {
  title: "Ductable AC Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Ductable AC repair and service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    ...
    "Ductable AC service",
    "Ductable AC repair",
    "best Ductable AC repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ductable-ac-repair-vadodara",
  },
};
...
const keywordData = {
  ...
  description: "Ductable AC repair and service",
  category: "ACTypes"
};
...
export default function DuctableACRepairPage() {
  return (
    <>
      {/* Hero Section */}
