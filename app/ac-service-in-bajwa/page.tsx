...
export const metadata: Metadata = {
  title: "AC Service & Repair in Bajwa, Vadodara | Expert Technicians | Hitech Aircool Engineers",
  description: "Best AC service in Bajwa, Vadodara. Professional AC repair, installation, gas refilling & deep cleaning. 24/7 emergency support. 1-year warranty. Starting \u20B9499. Call +91 93289 53665.",
  keywords: [
    "ac service bajwa",
    "ac repair bajwa vadodara",
    "ac installation bajwa",
    "ac gas refilling bajwa",
    "split ac repair bajwa",
    "window ac service bajwa",
    "ac deep cleaning bajwa",
    "best ac service near me bajwa",
    "ac mechanic bajwa vadodara",
    "refrigerator repair bajwa",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-service-in-bajwa",
  },
  openGraph: {
    title: "AC Service & Repair in Bajwa | Hitech Aircool Engineers Vadodara",
    description: "Professional AC repair, installation & maintenance in Bajwa. 24/7 emergency service, 1-year warranty.",
    url: "https://hitechairconditioning.in/ac-service-in-bajwa",
    type: "website",
  },
};
...
const jsonLd = {
  ...
  areaServed: { "@type": "Place", name: "Bajwa, Vadodara" },
...
const faqJsonLd = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "How much does AC service cost in Bajwa?", acceptedAnswer: { "@type": "Answer", text: "Standard AC service in Bajwa costs \u20B9499-\u20B9799 for window/split ACs. Deep jet cleaning starts at \u20B9499. Visit charges of \u20B9299 are adjusted against the final repair bill." } },
    { "@type": "Question", name: "Do you provide 24/7 emergency AC repair in Bajwa?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides round-the-clock emergency AC repair across Bajwa and all of Vadodara. Our technicians can reach you within 45-60 minutes." } },
    { "@type": "Question", name: "Which AC brands do you service in Bajwa?", acceptedAnswer: { "@type": "Answer", text: "We service all major brands including Voltas, LG, Samsung, Daikin, Hitachi, Blue Star, Carrier, O General, Lloyd, Panasonic and more." } },
    { "@type": "Question", name: "Do you offer an AC AMC plan for Bajwa residents?", acceptedAnswer: { "@type": "Answer", text: "Yes, we offer comprehensive Annual Maintenance Contracts (AMC) covering quarterly servicing, priority emergency calls, and discounted spare parts for homes and offices in Bajwa." } },
...
export default function ACServiceInBajwaPage() {
  return (
    <>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur px-4 py-2 rounded-full text-sm mb-6">
                ...
                <span>Bajwa, Vadodara</span>
              </div>
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                <span className="text-yellow-400">AC Service &amp; Repair</span> in Bajwa
              </h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">
                Looking for reliable AC service in Bajwa? Hitech Aircool Engineers delivers fast, professional AC repair, installation and maintenance for all brands.
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">Honest pricing with no hidden fees. All rates are for the Bajwa area.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Why Bajwa Residents Trust Hitech Aircool Engineers</h2>
          <div className="grid md:grid-cols-4 gap-8 max-w-5xl mx-auto">
            {[
              { icon: Award, t: "20+ Years Experience", d: "Gujarat\u2019s most experienced HVAC team since 2004" },
              { icon: Clock, t: "45-Min Response Time", d: "Fastest dispatch in Bajwa & all Vadodara" },
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-6">Common AC Problems We Solve in Bajwa</h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Frequently Asked Questions — AC Service in Bajwa</h2>
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "How much does AC service cost in Bajwa?", a: "Standard AC service costs \u20B9499-\u20B9799. Deep cleaning starts at \u20B9499. Visit charge of \u20B9299 is deducted from the repair bill." },
              { q: "Do you provide 24/7 emergency AC repair in Bajwa?", a: "Yes! Our technicians are available round the clock. We can reach Bajwa within 45-60 minutes for emergency calls." },
              ...
              { q: "Do you offer AMC plans for Bajwa residents?", a: "Yes, we offer Comprehensive and Non-Comprehensive AMCs with quarterly servicing, priority support, and discounted parts." },
              ...
              { q: "Can you install a new split AC in Bajwa?", a: "Absolutely. We handle end-to-end installation including site survey, copper piping, wiring, wall mounting, gas charging, and testing." },
      ...
      <section className="py-16 bg-teal-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Need AC Service in Bajwa?</h2>
