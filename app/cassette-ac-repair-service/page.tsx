...
export const metadata: Metadata = {
  title: "Cassette AC Repair Service In Vadodara | Hitech Aircool Engineers Gujarat",
  description: "Professional cassette ac repair service in vadodara by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/cassette-ac-repair-service" },
  openGraph: {
    title: "Cassette AC Repair Service In Vadodara | Hitech Aircool Engineers",
    description: "Professional cassette ac repair service in vadodara by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/cassette-ac-repair-service",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Cassette AC Repair Service In Vadodara",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagecassetteacrepairservice() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Cassette AC Repair Service In Vadodara</h1>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Cassette-Ac-Sales-Repair-Service.webp" alt="Cassette AC Repair Service In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Cassette AC Repair Service In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Cassette AC Repair Service In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
