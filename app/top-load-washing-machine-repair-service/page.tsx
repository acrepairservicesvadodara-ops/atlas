...
export const metadata: Metadata = {
  title: "The Best Top Load Washing Machine Repair Service Vadodara [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Professional the best top load washing machine repair service vadodara [2026 updated] by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/top-load-washing-machine-repair-service" },
  openGraph: {
    title: "The Best Top Load Washing Machine Repair Service Vadodara [2026 Updated] | Hitech Aircool Engineers",
    description: "Professional the best top load washing machine repair service vadodara [2026 updated] by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/top-load-washing-machine-repair-service",
    type: "website",
    images: ["https://hitechairconditioning.in/images/og-washing-machine-repair.jpg"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "The Best Top Load Washing Machine Repair Service Vadodara [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagetoploadwashingmachinerepairservice() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">The Best Top Load Washing Machine Repair Service Vadodara [2026 Updated]</h1>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="https://hitechairconditioning.in/images/og-washing-machine-repair.jpg" alt="The Best Top Load Washing Machine Repair Service Vadodara [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="The Best Top Load Washing Machine Repair Service Vadodara [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="The Best Top Load Washing Machine Repair Service Vadodara [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Top Load Washing Machine Repair Service in Vadodara?", a: "Top Load Washing Machine Repair Service cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Top Load Washing Machine Repair Service?", a: "Hitech Aircool Engineers offers same-day Top Load Washing Machine Repair Service across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Top Load Washing Machine Repair Services?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Top Load Washing Machine Repair Services depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Top Load Washing Machine Repair Service available on holidays?", a: "Yes, Hitech Aircool Engineers provides Top Load Washing Machine Repair Service 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Top Load Washing Machine Repair Service take?", a: "Most Top Load Washing Machine Repair Services are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Top Load Washing Machine Repair Service in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Top Load Washing Machine Repair Service cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Top Load Washing Machine Repair Service?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Top Load Washing Machine Repair Service across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Top Load Washing Machine Repair Services?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Top Load Washing Machine Repair Services depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Top Load Washing Machine Repair Service available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Top Load Washing Machine Repair Service 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Top Load Washing Machine Repair Service take?", acceptedAnswer: { "@type": "Answer", text: "Most Top Load Washing Machine Repair Services are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
