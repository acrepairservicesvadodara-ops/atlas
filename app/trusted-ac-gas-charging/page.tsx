...
export const metadata: Metadata = {
  title: "Trusted & Premium Refrigerant Gas For AC, HVAC & Chillers [2026 Updated] | Atlas Aircon Gujarat",
  description: "Professional trusted & premium refrigerant gas for ac, hvac & chillers [2026 updated] by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/trusted-ac-gas-charging" },
  openGraph: {
    title: "Trusted & Premium Refrigerant Gas For AC, HVAC & Chillers [2026 Updated] | Atlas Aircon",
    description: "Professional trusted & premium refrigerant gas for ac, hvac & chillers [2026 updated] by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/trusted-ac-gas-charging",
    type: "website",
    images: ["/images/products/Air-Conditioner-Gas.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Trusted & Premium Refrigerant Gas For AC, HVAC & Chillers [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
...
export default function Pagetrustedacgascharging() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Trusted &amp; Premium Refrigerant Gas For AC, HVAC &amp; Chillers [2026 Updated]</h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">&#123; &quot;@context&quot;: &quot;https://schema.org&quot;, &quot;@type&quot;: &quot;Product&quot;, &quot;name&quot;: &quot;Refrigerant Gas for Air Conditioner, H...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">&#123; &quot;@context&quot;: &quot;https://schema.org&quot;, &quot;@type&quot;: &quot;Product&quot;, &quot;name&quot;: &quot;Refrigerant Gas for Air Conditioner, H...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Air-Conditioner-Gas.webp" alt="Trusted & Premium Refrigerant Gas For AC, HVAC & Chillers [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Trusted & Premium Refrigerant Gas For AC, HVAC & Chillers [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Trusted & Premium Refrigerant Gas For AC, HVAC & Chillers [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Air-Conditioner-Gas.webp" alt="Trusted & Premium Refrigerant Gas For AC, HVAC & Chillers [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Air-Conditioner-Gas.webp" alt="Trusted & Premium Refrigerant Gas For AC, HVAC & Chillers [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Air-Conditioner-Gas.webp" alt="Trusted & Premium Refrigerant Gas For AC, HVAC & Chillers [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
