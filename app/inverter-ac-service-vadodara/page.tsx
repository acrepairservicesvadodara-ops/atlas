...
export const metadata: Metadata = {
  title: "Inverter AC Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Inverter AC repair and service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Inverter AC Service Vadodara",
    "inverter ac service",
    "Inverter AC Service installation",
    "Inverter AC Service service",
    "Inverter AC Service repair",
    "best Inverter AC Service service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/inverter-ac-service-vadodara",
  },
};

const keywordData = {
  title: "Inverter AC Service",
  slug: "inverter-ac-service",
  description: "Inverter AC repair and service",
  category: "ACTypes"
};
