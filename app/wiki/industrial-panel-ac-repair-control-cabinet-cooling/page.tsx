...
export const metadata: Metadata = {
  title: "Industrial Panel AC Repair (Control Cabinet Cooling) [2026 Updated] | Atlas Aircon Blog",
  description: "Professional industrial panel ac repair (control cabinet cooling) [2026 updated] by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/wiki/industrial-panel-ac-repair-control-cabinet-cooling" },
  openGraph: {
    title: "Industrial Panel AC Repair (Control Cabinet Cooling) [2026 Updated] | Atlas Aircon",
    description: "Professional industrial panel ac repair (control cabinet cooling) [2026 updated] by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/wiki/industrial-panel-ac-repair-control-cabinet-cooling",
    type: "article",
...
const jsonLd = {
  ...
  "@type": "Article",
  headline: "Industrial Panel AC Repair (Control Cabinet Cooling) [2026 Updated]",
  ...
  mainEntityOfPage: "https://atlasaircons.com/wiki/industrial-panel-ac-repair-control-cabinet-cooling",
  image: "/images/products/panel-ac-repair-service.webp",
};

export default function Pagewikiindustrialpanelacrepaircontrolcabine() {
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-gray-900 via-gray-800 to-blue-900 text-white py-12 md:py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">Industrial Panel AC Repair (Control Cabinet Cooling) [2026 Updated]</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <img src="/images/products/panel-ac-repair-service.webp" alt="Industrial Panel AC Repair (Control Cabinet Cooling) [2026 Updated]" className="w-full h-auto rounded-xl mb-8" />
