...
export const metadata: Metadata = {
  title: "Industrial Chiller Repair Services In Vadodara | Atlas Aircon Blog",
  description: "Professional industrial chiller repair services in vadodara by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/wiki/industrial-chiller-repair-services-in-vadodara" },
  openGraph: {
    title: "Industrial Chiller Repair Services In Vadodara | Atlas Aircon",
    description: "Professional industrial chiller repair services in vadodara by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/wiki/industrial-chiller-repair-services-in-vadodara",
    type: "article",
...
const jsonLd = {
  ...
  "@type": "Article",
  headline: "Industrial Chiller Repair Services In Vadodara",
  ...
  mainEntityOfPage: "https://atlasaircons.com/wiki/industrial-chiller-repair-services-in-vadodara",
  image: "/images/products/chiller-repair-service.webp",
};

export default function Pagewikiindustrialchillerrepairservicesinvad() {
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-gray-900 via-gray-800 to-blue-900 text-white py-12 md:py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">Industrial Chiller Repair Services In Vadodara</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <img src="/images/products/chiller-repair-service.webp" alt="Industrial Chiller Repair Services In Vadodara" className="w-full h-auto rounded-xl mb-8" />
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVindustrial chiller repair services in vadodaras?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial industrial chiller repair services in vadodara?", a: "Industrial industrial chiller repair services in vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVindustrial chiller repair services in vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial industrial chiller repair services in vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial industrial chiller repair services in vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
