...
export const metadata: Metadata = {
  title: "Wiki Archive &raquo; Atlas Aircon | Atlas Aircon Gujarat",
  description: "Wiki Archive &raquo; Atlas Aircon - AC Repair in Vadodara",
  alternates: { canonical: "https://atlasaircons.com/wiki" },
  openGraph: {
    title: "Wiki Archive &raquo; Atlas Aircon | Atlas Aircon",
    description: "Wiki Archive &raquo; Atlas Aircon - AC Repair in Vadodara",
    url: "https://atlasaircons.com/wiki",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Wiki Archive &raquo; Atlas Aircon",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Wiki Archive &amp;raquo; Atlas Aircon</h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Wiki Archive &amp;raquo; Atlas Aircon - AC Repair in Vadodara</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Wiki Archive &amp;raquo; Atlas Aircon - AC Repair in Vadodara</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What wikis does Atlas Aircon provide?", a: "Atlas Aircon provides wiki, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book wiki?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency wiki available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What wikis does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides wiki, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book wiki?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency wiki available. Call +91 97272 57141 for immediate assistance." } },
