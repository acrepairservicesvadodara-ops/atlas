...
export const metadata: Metadata = {
  title: "Professional Ductable AC Service Godhra | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ductable-ac-service-godhra" },
  openGraph: {
    title: "Professional Ductable AC Service Godhra | Atlas Aircon",
    description: "Need reliable Ductable AC Service Godhra? 🛠️ Expert installation, urgent repair & affordable AMC plans for homes & shops. Local technicians, guaranteed service",
    url: "https://atlasaircons.com/ductable-ac-service-godhra",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Need reliable Ductable AC Service Godhra? 🛠️ Expert installation, urgent repair &amp; affordable AMC plans for homes &amp; shops. Local technicians, guaranteed service. Get a free estimate today!</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/cropped-AtlasAircon-Logo.webp" alt="Professional Ductable AC Service Godhra" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
