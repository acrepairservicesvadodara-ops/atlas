...
export const metadata: Metadata = {
  title: "Professional Ductable AC Service Godhra | Hitech Aircool Engineers Gujarat",
  description: "Need reliable Ductable AC Service Godhra? 🛠️ Expert installation, urgent repair & affordable AMC plans for homes & shops. Local technicians, guaranteed service",
  alternates: { canonical: "https://hitechairconditioning.in/ductable-ac-service-godhra" },
  openGraph: {
    title: "Professional Ductable AC Service Godhra | Hitech Aircool Engineers",
    description: "Need reliable Ductable AC Service Godhra? 🛠️ Expert installation, urgent repair & affordable AMC plans for homes & shops. Local technicians, guaranteed service",
    url: "https://hitechairconditioning.in/ductable-ac-service-godhra",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Professional Ductable AC Service Godhra",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageductableacservicegodhra() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Professional Ductable AC Service Godhra</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Need reliable Ductable AC Service Godhra? 🛠️ Expert installation, urgent repair &amp; affordable AMC plans for homes &amp; shops. Local technicians, guaranteed service. Get a free estimate today!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Need reliable Ductable AC Service Godhra? 🛠️ Expert installation, urgent repair &amp; affordable AMC plans for homes &amp; shops. Local technicians, guaranteed service. Get a free estimate today!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/hitech-logo.webp" alt="Professional Ductable AC Service Godhra" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Professional Ductable AC Service Godhra" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
