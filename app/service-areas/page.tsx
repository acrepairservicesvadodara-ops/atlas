...
export const metadata: Metadata = {
  title: "Service Areas &raquo; Atlas Aircon [2026 Updated] | Atlas Aircon Gujarat",
  description: "*45-Min Emergency Response Available",
  alternates: { canonical: "https://atlasaircons.com/service-areas" },
  openGraph: {
    title: "Service Areas &raquo; Atlas Aircon [2026 Updated] | Atlas Aircon",
    description: "*45-Min Emergency Response Available",
    url: "https://atlasaircons.com/service-areas",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Service Areas &raquo; Atlas Aircon [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Service Areas &amp;raquo; Atlas Aircon [2026 Updated]</h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">*45-Min Emergency Response Available</p>
