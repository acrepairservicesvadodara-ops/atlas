...
export const metadata: Metadata = {
  title: "✅ Emergency Refrigerator Service Center Gujarat | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/refrigerator-service-center-gujarat" },
  openGraph: {
    title: "✅ Emergency Refrigerator Service Center Gujarat | Atlas Aircon",
    description: "Your trusted fridge repair experts in Gujarat! Get same-day, doorstep service from certified technicians using genuine parts. Serving Ahmedabad, Vadodara, Surat",
    url: "https://atlasaircons.com/refrigerator-service-center-gujarat",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Your trusted fridge repair experts in Gujarat! Get same-day, doorstep service from certified technicians using genuine parts. Serving Ahmedabad, Vadodara, Surat &amp; more. Call for a free quote.</p>
