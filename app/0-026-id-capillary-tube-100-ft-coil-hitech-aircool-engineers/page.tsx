...
export const metadata: Metadata = {
  title: "0.026″ Id Capillary Tube – 100 Ft Coil | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "With an internal diameter of 0.026 inches, this is one of the smallest standard capillary tubes. It's used in very low-capacity systems like small refri...",
  keywords: ["0.026″ id capillary tube – 100 ft coil | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "plumbing pipe & conduit"],
  alternates: { canonical: "https://atlasaircons.com/0-026-id-capillary-tube-100-ft-coil-hitech-aircool-engineers" },
  openGraph: {
    title: "0.026″ Id Capillary Tube – 100 Ft Coil | Hitech Aircool Engineers",
    description: "With an internal diameter of 0.026 inches, this is one of the smallest standard capillary tubes. It's used in very low-capacity systems like small refri...",
    url: "https://atlasaircons.com/0-026-id-capillary-tube-100-ft-coil-hitech-aircool-engineers",
    type: "website",
    images: ["/images/products/Capilary-1-scaled-1.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "0.026″ Id Capillary Tube – 100 Ft Coil | Hitech Aircool Engineers",
  description: "With an internal diameter of 0.026 inches, this is one of the smallest standard capillary tubes. It’s used in very low-capacity systems like small refrigerators, water coolers, or dehumidifiers. The 100-foot coil allows technicians to cut the exact length required for the specific application.",
  image: "/images/products/Capilary-1-scaled-1.webp",
  ...
  category: "Plumbing Pipe & Conduit",
  
};

export default function Page0026idcapillarytube100ftcoilhitechaircoo() {
  return (
    <>
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  src="/images/products/Capilary-1-scaled-1.webp"
                  alt="0.026″ Id Capillary Tube – 100 Ft Coil | Hitech Aircool Engineers"
                ...
                <img
                  src="/images/products/Capilary-1-scaled-1.webp"
                  alt="0.026″ Id Capillary Tube – 100 Ft Coil | Hitech Aircool Engineers - Image 2"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />

                <img
                  src="/images/products/Capilary-scaled-1.webp"
                  alt="0.026″ Id Capillary Tube – 100 Ft Coil | Hitech Aircool Engineers - Image 3"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="bg-blue-500/20 text-blue-300 px-3 py-1 rounded-full text-xs font-semibold">Plumbing Pipe &amp; Conduit</span>
              </div>
              <h1 className="text-3xl md:text-4xl font-bold mb-4">0.026″ Id Capillary Tube – 100 Ft Coil | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">With an internal diameter of 0.026 inches, this is one of the smallest standard capillary tubes. It’s used in very low-capacity systems like small ref</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%200.026%E2%80%B3%20Id%20Capillary%20Tube%20%E2%80%93%20100%20Ft%20Coil%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">0.026&quot; Id Capillary Tube - 100 Ft Coil</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">AC Units</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">AMC</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Expansion Devices in Small Systems</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Freezers</span>
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Refrigerant metering and pressure drop</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>With an internal diameter of 0.026 inches, this is one of the smallest standard capillary tubes. It’s used in very low-capacity systems like small refrigerators, water coolers, or dehumidifiers. The 100-foot coil allows technicians to cut the exact length required for the specific application.</p>
            </div>
            ...
            <div className="mt-8 bg-gray-50 rounded-xl p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                ...
                <div className="flex justify-between py-2 border-b border-gray-200"><span className="text-gray-500">Category</span><span className="font-medium">Plumbing Pipe &amp; Conduit</span></div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[{"url":"https://www.atlasaircons.com/side-mount-air-curtains-vertical-hitech-aircool-engineers/","title":"Side-Mount Air Curtains (Vertical) | Hitech Aircool Engineers","price":""},{"url":"https://www.atlasaircons.com/24x7-panel-acs-emergency-service-hitech-aircool-engineers/","title":"24X7 Panel Acs Emergency Service | Hitech Aircool Engineers","price":""}].map((p: { url: string; title: string; price: string }) => (
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What 0 026 id capillary tube 100 ft coil hitech aircool engineerss does Atlas Aircon provide?", a: "Atlas Aircon provides 0 026 id capillary tube 100 ft coil hitech aircool engineers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book 0 026 id capillary tube 100 ft coil hitech aircool engineers?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency 0 026 id capillary tube 100 ft coil hitech aircool engineers available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What 0 026 id capillary tube 100 ft coil hitech aircool engineerss does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides 0 026 id capillary tube 100 ft coil hitech aircool engineers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book 0 026 id capillary tube 100 ft coil hitech aircool engineers?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency 0 026 id capillary tube 100 ft coil hitech aircool engineers available. Call +91 97272 57141 for immediate assistance." } },
