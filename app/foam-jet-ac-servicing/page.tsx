...
export const metadata: Metadata = {
  title: "Unleash The Power Of Foam Jet AC Cleaning Service Near You [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/foam-jet-ac-servicing" },
  openGraph: {
    title: "Unleash The Power Of Foam Jet AC Cleaning Service Near You [2026 Updated] | Atlas Aircon",
    description: "Foam Jet AC Cleaning Service, Foam Jet AC Servicing Vadodara, , AC Cleaning Services, , Air Conditioner Maintenance, , Vadodara AC Servicing, , Advanced AC Clea",
    url: "https://atlasaircons.com/foam-jet-ac-servicing",
    type: "website",
  ...
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What foam jet ac servicings does Atlas Aircon provide?", a: "Atlas Aircon provides foam jet ac servicing, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book foam jet ac servicing?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency foam jet ac servicing available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What foam jet ac servicings does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides foam jet ac servicing, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book foam jet ac servicing?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency foam jet ac servicing available. Call +91 97272 57141 for immediate assistance." } },
