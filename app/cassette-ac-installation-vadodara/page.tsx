...
export const metadata: Metadata = {
  title: "Cassette AC Installation in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Cassette AC fitting in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Cassette AC Installation Vadodara",
    "cassette ac installation",
    "Cassette AC Installation installation",
    "Cassette AC Installation service",
    "Cassette AC Installation repair",
    "best Cassette AC Installation service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/cassette-ac-installation-vadodara",
  },
};
...
const keywordData = {
  ...
  description: "Cassette AC fitting",
...
export default function CassetteACInstallationPage() {
  return (
    <>
      {/* Hero Section */}
