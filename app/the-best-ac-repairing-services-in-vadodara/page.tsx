...
export const metadata: Metadata = {
  title: "AC Repair Services In Vadodara | Hitech Aircool Engineers Blog",
  ...
  alternates: { canonical: "https://hitechairconditioning.in/the-best-ac-repairing-services-in-vadodara" },
  openGraph: {
    title: "AC Repair Services In Vadodara | Hitech Aircool Engineers",
    description: "In the sweltering heat of Vadodara, a well-functioning air conditioner is more than just a luxury; it's a necessity. Whether you're battling the scorchi...",
    url: "https://hitechairconditioning.in/the-best-ac-repairing-services-in-vadodara",
    type: "article",
...
const jsonLd = {
  ...
  mainEntityOfPage: "https://hitechairconditioning.in/the-best-ac-repairing-services-in-vadodara",
    ...
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of The Best Ac Repairing Services In Vadodara in Vadodara?", a: "The Best Ac Repairing Services In Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for The Best Ac Repairing Services In Vadodara?", a: "Hitech Aircool Engineers offers same-day The Best Ac Repairing Services In Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on The Best Ac Repairing Services In Vadodaras?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on The Best Ac Repairing Services In Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency The Best Ac Repairing Services In Vadodara available on holidays?", a: "Yes, Hitech Aircool Engineers provides The Best Ac Repairing Services In Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for The Best Ac Repairing Services In Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day The Best Ac Repairing Services In Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on The Best Ac Repairing Services In Vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on The Best Ac Repairing Services In Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency The Best Ac Repairing Services In Vadodara available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides The Best Ac Repairing Services In Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
