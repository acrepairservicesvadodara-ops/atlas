...
export const metadata: Metadata = {
  title: "24/7 Emergency Diamond Unit Chiller Repair Services Surat [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/chiller-repair-services-surat" },
  openGraph: {
    title: "24/7 Emergency Diamond Unit Chiller Repair Services Surat [2026 Updated] | Atlas Aircon",
    description: "Chiller Repair Services Surat for diamond polishing, textile mills & cleanrooms. Our precision specialists handle emergency compressor, tube & condenser repair ",
    url: "https://atlasaircons.com/chiller-repair-services-surat",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Chiller Repair Services Surat for diamond polishing, textile mills &amp; cleanrooms. Our precision specialists handle emergency compressor, tube &amp; condenser repair to prevent production loss. Call now!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVchiller repair services surats?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVchiller repair services surats?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
