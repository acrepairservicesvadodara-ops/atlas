...
export const metadata: Metadata = {
  title: "Top Split AC Repair & Service In Surat | Hitech Aircool Engineers Gujarat",
  description: "Surat's trusted AC experts. Professional split AC service, gas refill & installation. Serving Adajan, Vesu, Varachha & all areas. Genuine parts, certified techn",
  alternates: { canonical: "https://hitechairconditioning.in/split-ac-service-surat" },
  openGraph: {
    title: "Top Split AC Repair & Service In Surat | Hitech Aircool Engineers",
    description: "Surat's trusted AC experts. Professional split AC service, gas refill & installation. Serving Adajan, Vesu, Varachha & all areas. Genuine parts, certified techn",
    url: "https://hitechairconditioning.in/split-ac-service-surat",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Top Split AC Repair & Service In Surat",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagesplitacservicesurat() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Top Split AC Repair &amp; Service In Surat</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Surat&apos;s trusted AC experts. Professional split AC service, gas refill &amp; installation. Serving Adajan, Vesu, Varachha &amp; all areas. Genuine parts, certified technicians. Book now!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Surat&apos;s trusted AC experts. Professional split AC service, gas refill &amp; installation. Serving Adajan, Vesu, Varachha &amp; all areas. Genuine parts, certified technicians. Book now!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/Split-Air-Conditioner.webp" alt="Top Split AC Repair & Service In Surat" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Top Split AC Repair & Service In Surat" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
