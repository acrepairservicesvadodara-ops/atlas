...
export const metadata: Metadata = {
  title: "Top Split AC Repair & Service In Surat | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/split-ac-service-surat" },
  openGraph: {
    title: "Top Split AC Repair & Service In Surat | Atlas Aircon",
    description: "Surat's trusted AC experts. Professional split AC service, gas refill & installation. Serving Adajan, Vesu, Varachha & all areas. Genuine parts, certified techn",
    url: "https://atlasaircons.com/split-ac-service-surat",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Surat&apos;s trusted AC experts. Professional split AC service, gas refill &amp; installation. Serving Adajan, Vesu, Varachha &amp; all areas. Genuine parts, certified technicians. Book now!</p>
