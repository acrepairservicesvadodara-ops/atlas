...
export const metadata: Metadata = {
  title: "AC Installation Daman | Hitech Aircool Engineers Gujarat",
  description: "Professional AC installation services in Daman. Expert split & window AC fitting, gas charging & electrical work. Free site visit. Call for best price today!",
  alternates: { canonical: "https://hitechairconditioning.in/ac-installation-daman" },
  openGraph: {
    title: "AC Installation Daman | Hitech Aircool Engineers",
    description: "Professional AC installation services in Daman. Expert split & window AC fitting, gas charging & electrical work. Free site visit. Call for best price today!",
    url: "https://hitechairconditioning.in/ac-installation-daman",
    type: "website",
...
export default function Pageacinstallationdaman() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">AC Installation Daman</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Professional AC installation services in Daman. Expert split &amp; window AC fitting, gas charging &amp; electrical work. Free site visit. Call for best price today!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Professional AC installation services in Daman. Expert split &amp; window AC fitting, gas charging &amp; electrical work. Free site visit. Call for best price today!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Split-Ac-Installation-and-Repair-Service-1.webp" alt="AC Installation Daman" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="AC Installation Daman" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
