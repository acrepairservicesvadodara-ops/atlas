...
export const metadata: Metadata = {
  title: "AC Installation Daman | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-installation-daman" },
  openGraph: {
    title: "AC Installation Daman | Atlas Aircon",
    description: "Professional AC installation services in Daman. Expert split & window AC fitting, gas charging & electrical work. Free site visit. Call for best price today!",
    url: "https://atlasaircons.com/ac-installation-daman",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Professional AC installation services in Daman. Expert split &amp; window AC fitting, gas charging &amp; electrical work. Free site visit. Call for best price today!</p>
