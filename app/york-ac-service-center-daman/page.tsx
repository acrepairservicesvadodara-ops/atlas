...
export const metadata: Metadata = {
  title: "York AC Service Center Daman | Professional HVAC Service | Hitech Aircool Engineers",
  description: "York AC Service Center Daman — Professional service service by Hitech Aircool Engineers. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 93289 53665.",
  keywords: ["york ac service center daman", "service service", "hvac service vadodara", "hitech aircool engineers", "ac service gujarat"],
  alternates: { canonical: "https://hitechairconditioning.in/york-ac-service-center-daman" },
  openGraph: { title: "York AC Service Center Daman | Hitech Aircool Engineers", description: "Professional service service by Hitech Aircool Engineers Gujarat.", url: "https://hitechairconditioning.in/york-ac-service-center-daman", type: "website" },
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "York AC Service Center Daman",
  provider: { "@type": "LocalBusiness", name: "Hitech Aircool Engineers", telephone: "+919328953665" },
  areaServed: { "@type": "State", name: "Gujarat" },
  serviceType: "York AC Service Center Daman",
};

export default function YorkACServiceCenterDamanPage() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">York AC Service Center Daman</h1>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does York Ac Service Center Daman include?", a: "York Ac Service Center Daman includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does York Ac Service Center Daman cost?", a: "York Ac Service Center Daman starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will York Ac Service Center Daman improve cooling?", a: "Yes, proper York Ac Service Center Daman can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does York Ac Service Center Daman reduce electricity bills?", a: "Regular York Ac Service Center Daman can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does York Ac Service Center Daman take?", a: "Basic York Ac Service Center Daman takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can York Ac Service Center Daman remove bad smell?", a: "Yes, York Ac Service Center Daman includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in York Ac Service Center Daman?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does York Ac Service Center Daman include?", acceptedAnswer: { "@type": "Answer", text: "York Ac Service Center Daman includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does York Ac Service Center Daman cost?", acceptedAnswer: { "@type": "Answer", text: "York Ac Service Center Daman starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will York Ac Service Center Daman improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper York Ac Service Center Daman can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does York Ac Service Center Daman reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular York Ac Service Center Daman can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does York Ac Service Center Daman take?", acceptedAnswer: { "@type": "Answer", text: "Basic York Ac Service Center Daman takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can York Ac Service Center Daman remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, York Ac Service Center Daman includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in York Ac Service Center Daman?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
