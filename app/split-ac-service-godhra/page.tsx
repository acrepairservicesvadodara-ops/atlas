...
export const metadata: Metadata = {
  title: "1-Hour* Quick Split AC Service & Repair In Godhra | Hitech Aircool Engineers Gujarat",
  description: "Reliable split AC repair & service in Godhra. Expert technicians for gas refill, installation & cleaning. Same-day, affordable service with genuine spare parts.",
  alternates: { canonical: "https://hitechairconditioning.in/split-ac-service-godhra" },
  openGraph: {
    title: "1-Hour* Quick Split AC Service & Repair In Godhra | Hitech Aircool Engineers",
    description: "Reliable split AC repair & service in Godhra. Expert technicians for gas refill, installation & cleaning. Same-day, affordable service with genuine spare parts.",
    url: "https://hitechairconditioning.in/split-ac-service-godhra",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "1-Hour* Quick Split AC Service & Repair In Godhra",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagesplitacservicegodhra() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">1-Hour* Quick Split AC Service &amp; Repair In Godhra</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Reliable split AC repair &amp; service in Godhra. Expert technicians for gas refill, installation &amp; cleaning. Same-day, affordable service with genuine spare parts. Get a free estimate today!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Reliable split AC repair &amp; service in Godhra. Expert technicians for gas refill, installation &amp; cleaning. Same-day, affordable service with genuine spare parts. Get a free estimate today!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/Split-Air-Conditioner.webp" alt="1-Hour* Quick Split AC Service & Repair In Godhra" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="1-Hour* Quick Split AC Service & Repair In Godhra" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
