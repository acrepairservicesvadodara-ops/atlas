...
export const metadata: Metadata = {
  title: "1-Hour* Quick Split AC Service & Repair In Godhra | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/split-ac-service-godhra" },
  openGraph: {
    title: "1-Hour* Quick Split AC Service & Repair In Godhra | Atlas Aircon",
    description: "Reliable split AC repair & service in Godhra. Expert technicians for gas refill, installation & cleaning. Same-day, affordable service with genuine spare parts.",
    url: "https://atlasaircons.com/split-ac-service-godhra",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Reliable split AC repair &amp; service in Godhra. Expert technicians for gas refill, installation &amp; cleaning. Same-day, affordable service with genuine spare parts. Get a free estimate today!</p>
