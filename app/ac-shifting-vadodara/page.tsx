...
export const metadata: Metadata = {
  title: "AC Shifting in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC relocation service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    ...
    "AC Shifting service",
    "AC Shifting repair",
    "best AC Shifting service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-shifting-vadodara",
  },
};
...
const keywordData = {
  title: "AC Shifting",
  slug: "ac-shifting",
  description: "AC relocation service",
...
export default function ACShiftingPage() {
  return (
    <>
      {/* Hero Section */}
