...
export const metadata: Metadata = {
  title: "Return Policy &raquo; Atlas Aircon [2026 Updated] | Atlas Aircon Gujarat",
  description: "At Atlas Aircon, customer satisfaction is our top priority. Our return and refund policy is designed to offer peace of mind for both product purchases and",
  alternates: { canonical: "https://atlasaircons.com/return-policy" },
  openGraph: {
    title: "Return Policy &raquo; Atlas Aircon [2026 Updated] | Atlas Aircon",
    description: "At Atlas Aircon, customer satisfaction is our top priority. Our return and refund policy is designed to offer peace of mind for both product purchases and",
    url: "https://atlasaircons.com/return-policy",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Return Policy &raquo; Atlas Aircon [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Return Policy &amp;raquo; Atlas Aircon [2026 Updated]</h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">At Atlas Aircon, customer satisfaction is our top priority. Our return and refund policy is designed to offer peace of mind for both product purchases and</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">At Atlas Aircon, customer satisfaction is our top priority. Our return and refund policy is designed to offer peace of mind for both product purchases and</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/Atlas-Aircon-Ac-Service-in-vadodara-2.webp" alt="Return Policy &raquo; Atlas Aircon [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Return Policy &raquo; Atlas Aircon [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Atlas-Aircon-Ac-Service-in-vadodara-2.webp" alt="Return Policy &raquo; Atlas Aircon [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Atlas-Aircon-Ac-Service-in-vadodara-2.webp" alt="Return Policy &raquo; Atlas Aircon [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Atlas-Aircon-Ac-Service-in-vadodara-2.webp" alt="Return Policy &raquo; Atlas Aircon [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Atlas-Aircon-Ac-Service-in-vadodara-2.webp" alt="Return Policy &raquo; Atlas Aircon [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What return policys does Atlas Aircon provide?", a: "Atlas Aircon provides return policy, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book return policy?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency return policy available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What return policys does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides return policy, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book return policy?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency return policy available. Call +91 97272 57141 for immediate assistance." } },
