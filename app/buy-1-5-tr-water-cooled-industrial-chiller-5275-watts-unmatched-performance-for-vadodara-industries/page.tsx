...
export const metadata: Metadata = {
  title: "Buy 1.5 TR Water Cooled Industrial Chiller (5275 Watts) | Atlas Aircon Gujarat",
  description: "body { font-family: 'Inter', sans-serif;...",
  alternates: { canonical: "https://atlasaircons.com/buy-1-5-tr-water-cooled-industrial-chiller-5275-watts-unmatched-performance-for-vadodara-industries" },
  openGraph: {
    title: "Buy 1.5 TR Water Cooled Industrial Chiller (5275 Watts) | Atlas Aircon",
    description: "body { font-family: 'Inter', sans-serif;...",
    url: "https://atlasaircons.com/buy-1-5-tr-water-cooled-industrial-chiller-5275-watts-unmatched-performance-for-vadodara-industries",
    type: "website",
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVbuy 1 5 tr water cooled industrial chiller 5275 watts unmatched performance for vadodara industriess?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
