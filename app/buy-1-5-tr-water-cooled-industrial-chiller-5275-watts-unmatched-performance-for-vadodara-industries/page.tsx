...
export const metadata: Metadata = {
  title: "Buy 1.5 TR Water Cooled Industrial Chiller (5275 Watts) | Hitech Aircool Engineers Gujarat",
  description: "body { font-family: 'Inter', sans-serif;...",
  alternates: { canonical: "https://hitechairconditioning.in/buy-1-5-tr-water-cooled-industrial-chiller-5275-watts-unmatched-performance-for-vadodara-industries" },
  openGraph: {
    title: "Buy 1.5 TR Water Cooled Industrial Chiller (5275 Watts) | Hitech Aircool Engineers",
    description: "body { font-family: 'Inter', sans-serif;...",
    url: "https://hitechairconditioning.in/buy-1-5-tr-water-cooled-industrial-chiller-5275-watts-unmatched-performance-for-vadodara-industries",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Buy 1.5 TR Water Cooled Industrial Chiller (5275 Watts)",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagebuy15trwatercooledindustrialchiller5275w() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Buy 1.5 TR Water Cooled Industrial Chiller (5275 Watts)</h1>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVbuy 1 5 tr water cooled industrial chiller 5275 watts unmatched performance for vadodara industriess?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial buy 1 5 tr water cooled industrial chiller 5275 watts unmatched performance for vadodara industries?", a: "Industrial buy 1 5 tr water cooled industrial chiller 5275 watts unmatched performance for vadodara industries costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVbuy 1 5 tr water cooled industrial chiller 5275 watts unmatched performance for vadodara industriess?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial buy 1 5 tr water cooled industrial chiller 5275 watts unmatched performance for vadodara industries?", acceptedAnswer: { "@type": "Answer", text: "Industrial buy 1 5 tr water cooled industrial chiller 5275 watts unmatched performance for vadodara industries costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
