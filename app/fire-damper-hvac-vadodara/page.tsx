...
export const metadata: Metadata = {
  title: "Fire Damper HVAC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Fire damper installation in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Fire Damper HVAC Vadodara",
    "fire damper hvac",
    "Fire Damper HVAC installation",
    "Fire Damper HVAC service",
    "Fire Damper HVAC repair",
    "best Fire Damper HVAC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/fire-damper-hvac-vadodara",
  },
};

const keywordData = {
  title: "Fire Damper HVAC",
  slug: "fire-damper-hvac",
...
export default function FireDamperHVACPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVfire damper hvac vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial fire damper hvac vadodara?", a: "Industrial fire damper hvac vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVfire damper hvac vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial fire damper hvac vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial fire damper hvac vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
