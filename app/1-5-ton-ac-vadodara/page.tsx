...
export const metadata: Metadata = {
  title: "1.5 Ton AC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "1.5 ton AC repair service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "1.5 Ton AC Vadodara",
    "1 5 ton ac",
    "1.5 Ton AC installation",
    "1.5 Ton AC service",
    "1.5 Ton AC repair",
    "best 1.5 Ton AC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/1-5-ton-ac-vadodara",
  },
};
...
export default function AC15TonACPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What 1 5 ton ac vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides 1 5 ton ac vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book 1 5 ton ac vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency 1 5 ton ac vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What 1 5 ton ac vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides 1 5 ton ac vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book 1 5 ton ac vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency 1 5 ton ac vadodara available. Call +91 93289 53665 for immediate assistance." } },
