...
export const metadata: Metadata = {
  title: "Voltas AC Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Voltas AC repair service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Voltas AC Repair Vadodara",
    "voltas ac repair",
    "Voltas AC Repair installation",
    "Voltas AC Repair service",
    "Voltas AC Repair repair",
    "best Voltas AC Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/voltas-ac-repair-vadodara",
  },
};

const keywordData = {
  title: "Voltas AC Repair",
  slug: "voltas-ac-repair",
  description: "Voltas AC repair service",
  category: "Brands"
};
