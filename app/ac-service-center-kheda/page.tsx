...
export const metadata: Metadata = {
  title: "📍 AC Service Center Kheda [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-center-kheda" },
  openGraph: {
    title: "📍 AC Service Center Kheda [2026 Updated] | Atlas Aircon",
    description: "Your trusted AC service center in Kheda. Fast, reliable repairs & maintenance at honest prices. Local technicians with 15+ years experience. Free diagnosis & sa",
    url: "https://atlasaircons.com/ac-service-center-kheda",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Your trusted AC service center in Kheda. Fast, reliable repairs &amp; maintenance at honest prices. Local technicians with 15+ years experience. Free diagnosis &amp; satisfaction guarantee!</p>
