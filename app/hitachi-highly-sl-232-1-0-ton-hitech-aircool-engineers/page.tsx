...
export const metadata: Metadata = {
  title: "Hitachi (Highly) – Sl 232 – 1.0 Ton | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "A 1-ton Hitachi rotary compressor. Used in smaller capacity window or split AC units. Rotary technology offers smooth operation with fewer vibration iss...",
  keywords: ["hitachi (highly) – sl 232 – 1.0 ton | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "hitachi"],
  alternates: { canonical: "https://atlasaircons.com/hitachi-highly-sl-232-1-0-ton-hitech-aircool-engineers" },
  openGraph: {
    title: "Hitachi (Highly) – Sl 232 – 1.0 Ton | Hitech Aircool Engineers",
    description: "A 1-ton Hitachi rotary compressor. Used in smaller capacity window or split AC units. Rotary technology offers smooth operation with fewer vibration iss...",
    url: "https://atlasaircons.com/hitachi-highly-sl-232-1-0-ton-hitech-aircool-engineers",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Hitachi (Highly) – Sl 232 – 1.0 Ton | Hitech Aircool Engineers",
  description: "A 1-ton Hitachi rotary compressor. Used in smaller capacity window or split AC units. Rotary technology offers smooth operation with fewer vibration issues, contributing to a quieter overall air conditioner.",
...
export default function Pagehitachihighlysl23210tonhitechaircoolengi() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  ...
                  alt="Hitachi (Highly) – Sl 232 – 1.0 Ton | Hitech Aircool Engineers"
                ...
                <img
                  ...
                  alt="Hitachi (Highly) – Sl 232 – 1.0 Ton | Hitech Aircool Engineers - Image 2"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Hitachi (Highly) – Sl 232 – 1.0 Ton | Hitech Aircool Engineers - Image 3"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Hitachi (Highly) – Sl 232 – 1.0 Ton | Hitech Aircool Engineers - Image 4"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Hitachi (Highly) – Sl 232 – 1.0 Ton | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">A 1-ton Hitachi rotary compressor. Used in smaller capacity window or split AC units. Rotary technology offers smooth operation with fewer vibration i</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%20Hitachi%20(Highly)%20%E2%80%93%20Sl%20232%20%E2%80%93%201.0%20Ton%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Compact cooling</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Gujarat</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Hitachi (Highly) - Sl 232 - 1.0 Ton</span>
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Server Rooms</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>A 1-ton Hitachi rotary compressor. Used in smaller capacity window or split AC units. Rotary technology offers smooth operation with fewer vibration issues, contributing to a quieter overall air conditioner.</p>
            </div>
