...
export const metadata: Metadata = {
  title: "Lowest Price AC Copper Condenser Coil Sale & Service | Hitech Aircool Engineers Gujarat",
  description: "Buy Lowest Price AC Copper Condenser Coil Sale & Service at best price from Hitech Aircool Engineers. Genuine HVAC spare parts with warranty and fast delivery across Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/ac-copper-condenser-evaporator-radiator-coil" },
  openGraph: {
    title: "Lowest Price AC Copper Condenser Coil Sale & Service | Hitech Aircool Engineers",
    description: "Buy Lowest Price AC Copper Condenser Coil Sale & Service at best price from Hitech Aircool Engineers. Genuine HVAC spare parts with warranty and fast delivery across Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/ac-copper-condenser-evaporator-radiator-coil",
    type: "website",
    images: ["/images/products/ac-copper-condenser-coil.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Lowest Price AC Copper Condenser Coil Sale & Service",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageaccoppercondenserevaporatorradiatorcoil() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Lowest Price AC Copper Condenser Coil Sale &amp; Service</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">[ &#123; &quot;@context&quot;: &quot;https://schema.org&quot;, &quot;@type&quot;: &quot;Product&quot;, &quot;name&quot;: &quot;AC Copper Condenser – Evapor...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">[ &#123; &quot;@context&quot;: &quot;https://schema.org&quot;, &quot;@type&quot;: &quot;Product&quot;, &quot;name&quot;: &quot;AC Copper Condenser – Evapor...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/ac-copper-condenser-coil.webp" alt="Lowest Price AC Copper Condenser Coil Sale & Service" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/ac-copper-evaporator-coil-1.webp" alt="Lowest Price AC Copper Condenser Coil Sale & Service" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/ac-copper-condensor-coil.webp" alt="Lowest Price AC Copper Condenser Coil Sale & Service" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/ac-copper-condensor.webp" alt="Lowest Price AC Copper Condenser Coil Sale & Service" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What ac copper condenser evaporator radiator coils does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides ac copper condenser evaporator radiator coil, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book ac copper condenser evaporator radiator coil?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency ac copper condenser evaporator radiator coil available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What ac copper condenser evaporator radiator coils does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides ac copper condenser evaporator radiator coil, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book ac copper condenser evaporator radiator coil?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency ac copper condenser evaporator radiator coil available. Call +91 93289 53665 for immediate assistance." } },
