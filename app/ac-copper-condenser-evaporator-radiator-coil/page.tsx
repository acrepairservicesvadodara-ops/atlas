...
export const metadata: Metadata = {
  title: "Lowest Price AC Copper Condenser Coil Sale & Service | Atlas Aircon Gujarat",
  description: "Buy Lowest Price AC Copper Condenser Coil Sale & Service at best price from Atlas Aircon. Genuine HVAC spare parts with warranty and fast delivery across Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/ac-copper-condenser-evaporator-radiator-coil" },
  openGraph: {
    title: "Lowest Price AC Copper Condenser Coil Sale & Service | Atlas Aircon",
    description: "Buy Lowest Price AC Copper Condenser Coil Sale & Service at best price from Atlas Aircon. Genuine HVAC spare parts with warranty and fast delivery across Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/ac-copper-condenser-evaporator-radiator-coil",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">[ &#123; &quot;@context&quot;: &quot;https://schema.org&quot;, &quot;@type&quot;: &quot;Product&quot;, &quot;name&quot;: &quot;AC Copper Condenser – Evapor...</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What ac copper condenser evaporator radiator coils does Atlas Aircon provide?", a: "Atlas Aircon provides ac copper condenser evaporator radiator coil, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book ac copper condenser evaporator radiator coil?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency ac copper condenser evaporator radiator coil available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What ac copper condenser evaporator radiator coils does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides ac copper condenser evaporator radiator coil, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book ac copper condenser evaporator radiator coil?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency ac copper condenser evaporator radiator coil available. Call +91 97272 57141 for immediate assistance." } },
