...
export const metadata: Metadata = {
  title: "Reliable Package AC Service Rajpipla | Hitech Aircool Engineers Gujarat",
  description: "Expert package AC installation, gas filling & repair services in Rajpipla. We provide 24/7 emergency support, genuine spare parts & affordable maintenance plans",
  alternates: { canonical: "https://hitechairconditioning.in/package-ac-service-rajpipla" },
  openGraph: {
    title: "Reliable Package AC Service Rajpipla | Hitech Aircool Engineers",
    description: "Expert package AC installation, gas filling & repair services in Rajpipla. We provide 24/7 emergency support, genuine spare parts & affordable maintenance plans",
    url: "https://hitechairconditioning.in/package-ac-service-rajpipla",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Reliable Package AC Service Rajpipla",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagepackageacservicerajpipla() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Reliable Package AC Service Rajpipla</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Expert package AC installation, gas filling &amp; repair services in Rajpipla. We provide 24/7 emergency support, genuine spare parts &amp; affordable maintenance plans for homes &amp; businesses. Call now!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Expert package AC installation, gas filling &amp; repair services in Rajpipla. We provide 24/7 emergency support, genuine spare parts &amp; affordable maintenance plans for homes &amp; businesses. Call now!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/package-ac-service-vadodara-near-me.webp" alt="Reliable Package AC Service Rajpipla" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Reliable Package AC Service Rajpipla" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
