...
export const metadata: Metadata = {
  title: "Reliable Package AC Service Rajpipla | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/package-ac-service-rajpipla" },
  openGraph: {
    title: "Reliable Package AC Service Rajpipla | Atlas Aircon",
    description: "Expert package AC installation, gas filling & repair services in Rajpipla. We provide 24/7 emergency support, genuine spare parts & affordable maintenance plans",
    url: "https://atlasaircons.com/package-ac-service-rajpipla",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert package AC installation, gas filling &amp; repair services in Rajpipla. We provide 24/7 emergency support, genuine spare parts &amp; affordable maintenance plans for homes &amp; businesses. Call now!</p>
