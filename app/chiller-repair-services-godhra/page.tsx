...
export const metadata: Metadata = {
  title: "24/7 Emergency Cold Storage Chiller Repair Services Godhra | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/chiller-repair-services-godhra" },
  openGraph: {
    title: "24/7 Emergency Cold Storage Chiller Repair Services Godhra | Atlas Aircon",
    description: "Chiller Repair Services Godhra for cold storage, warehouses & agro-processing. Prevent grain & produce spoilage with fast compressor, tube & gas leak repair. Pr",
    url: "https://atlasaircons.com/chiller-repair-services-godhra",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Chiller Repair Services Godhra for cold storage, warehouses &amp; agro-processing. Prevent grain &amp; produce spoilage with fast compressor, tube &amp; gas leak repair. Protect your inventory. Call now!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVchiller repair services godhras?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVchiller repair services godhras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
