...
export const metadata: Metadata = {
  title: "🔧 AC Repair Rajpipla | Hitech Aircool Engineers Gujarat",
  ...
  alternates: { canonical: "https://hitechairconditioning.in/ac-repair-rajpipla" },
  openGraph: {
    title: "🔧 AC Repair Rajpipla | Hitech Aircool Engineers",
    description: "Your trusted local partner for AC repair in Rajpipla. Our expert technicians provide reliable cooling solutions with a personal touch. Same-day service & satisf",
    url: "https://hitechairconditioning.in/ac-repair-rajpipla",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Your trusted local partner for AC repair in Rajpipla. Our expert technicians provide reliable cooling solutions with a personal touch. Same-day service &amp; satisfaction guarantee. Call!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Ac Repair Rajpipla in Vadodara?", a: "Ac Repair Rajpipla cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Ac Repair Rajpipla?", a: "Hitech Aircool Engineers offers same-day Ac Repair Rajpipla across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Ac Repair Rajpiplas?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Ac Repair Rajpiplas depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Ac Repair Rajpipla available on holidays?", a: "Yes, Hitech Aircool Engineers provides Ac Repair Rajpipla 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Ac Repair Rajpipla in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Ac Repair Rajpipla cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Ac Repair Rajpipla?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Ac Repair Rajpipla across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Ac Repair Rajpiplas?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Ac Repair Rajpiplas depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Ac Repair Rajpipla available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Ac Repair Rajpipla 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
