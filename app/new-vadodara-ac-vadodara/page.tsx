...
export const metadata: Metadata = {
  title: "New Vadodara AC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "New Vadodara AC service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "New Vadodara AC Vadodara",
    "new vadodara ac",
    "New Vadodara AC installation",
    "New Vadodara AC service",
    "New Vadodara AC repair",
    "best New Vadodara AC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/new-vadodara-ac-vadodara",
  },
};

const keywordData = {
  title: "New Vadodara AC",
  slug: "new-vadodara-ac",
  description: "New Vadodara AC service",
  category: "Area"
};
...
export default function NewVadodaraACPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What new vadodara ac vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides new vadodara ac vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book new vadodara ac vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency new vadodara ac vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What new vadodara ac vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides new vadodara ac vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book new vadodara ac vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency new vadodara ac vadodara available. Call +91 93289 53665 for immediate assistance." } },
