...
export const metadata: Metadata = {
  title: "🌊 AC Service Valsad | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-valsad" },
  openGraph: {
    title: "🌊 AC Service Valsad | Atlas Aircon",
    description: "Protect your AC from Valsad's coastal humidity! Expert AC service, monsoon-proof maintenance & industrial-grade repairs for homes & GIDC units. Free corrosion c",
    url: "https://atlasaircons.com/ac-service-valsad",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Protect your AC from Valsad&apos;s coastal humidity! Expert AC service, monsoon-proof maintenance &amp; industrial-grade repairs for homes &amp; GIDC units. Free corrosion check!</p>
