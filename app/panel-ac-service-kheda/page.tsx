...
export const metadata: Metadata = {
  title: "Rittal & Panel AC Service Kheda | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/panel-ac-service-kheda" },
  openGraph: {
    title: "Rittal & Panel AC Service Kheda | Atlas Aircon",
    description: "Expert repair for Rittal, Schneider & all Panel AC service Kheda district - Nadiad, Matar, Kapadvanj, Mahemdabad. 24/7 emergency service & AMCs for factories, c",
    url: "https://atlasaircons.com/panel-ac-service-kheda",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert repair for Rittal, Schneider &amp; all Panel AC service Kheda district - Nadiad, Matar, Kapadvanj, Mahemdabad. 24/7 emergency service &amp; AMCs for factories, cold storage &amp; dairies.</p>
