...
export const metadata: Metadata = {
  title: "Rittal & Panel AC Service Kheda | Hitech Aircool Engineers Gujarat",
  description: "Expert repair for Rittal, Schneider & all Panel AC service Kheda district - Nadiad, Matar, Kapadvanj, Mahemdabad. 24/7 emergency service & AMCs for factories, c",
  alternates: { canonical: "https://hitechairconditioning.in/panel-ac-service-kheda" },
  openGraph: {
    title: "Rittal & Panel AC Service Kheda | Hitech Aircool Engineers",
    description: "Expert repair for Rittal, Schneider & all Panel AC service Kheda district - Nadiad, Matar, Kapadvanj, Mahemdabad. 24/7 emergency service & AMCs for factories, c",
    url: "https://hitechairconditioning.in/panel-ac-service-kheda",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Rittal & Panel AC Service Kheda",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagepanelacservicekheda() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Rittal &amp; Panel AC Service Kheda</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Expert repair for Rittal, Schneider &amp; all Panel AC service Kheda district - Nadiad, Matar, Kapadvanj, Mahemdabad. 24/7 emergency service &amp; AMCs for factories, cold storage &amp; dairies.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Expert repair for Rittal, Schneider &amp; all Panel AC service Kheda district - Nadiad, Matar, Kapadvanj, Mahemdabad. 24/7 emergency service &amp; AMCs for factories, cold storage &amp; dairies.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/panel-ac-repair-service.webp" alt="Rittal & Panel AC Service Kheda" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Rittal & Panel AC Service Kheda" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
