...
export const metadata: Metadata = {
  title: "Expert Godrej AC Repair Services: Fast & Reliable Solutions [2026 Updated] | Atlas Aircon Gujarat",
  description: "Comprehensive Godrej AC Repair and Maintenance Services in Vadodara: Your Ultimate Cooling Solution</stron...",
  alternates: { canonical: "https://atlasaircons.com/godrej-ac-repair" },
  openGraph: {
    title: "Expert Godrej AC Repair Services: Fast & Reliable Solutions [2026 Updated] | Atlas Aircon",
    description: "Comprehensive Godrej AC Repair and Maintenance Services in Vadodara: Your Ultimate Cooling Solution</stron...",
    url: "https://atlasaircons.com/godrej-ac-repair",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Comprehensive Godrej AC Repair and Maintenance Services in Vadodara: Your Ultimate Cooling Solution&lt;/stron...</p>
