...
export const metadata: Metadata = {
  title: "Expert Godrej AC Repair Services: Fast & Reliable Solutions [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Comprehensive Godrej AC Repair and Maintenance Services in Vadodara: Your Ultimate Cooling Solution</stron...",
  alternates: { canonical: "https://hitechairconditioning.in/godrej-ac-repair" },
  openGraph: {
    title: "Expert Godrej AC Repair Services: Fast & Reliable Solutions [2026 Updated] | Hitech Aircool Engineers",
    description: "Comprehensive Godrej AC Repair and Maintenance Services in Vadodara: Your Ultimate Cooling Solution</stron...",
    url: "https://hitechairconditioning.in/godrej-ac-repair",
    type: "website",
    images: ["/images/products/Godrej-Ac-Repair-Service-1.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Expert Godrej AC Repair Services: Fast & Reliable Solutions [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagegodrejacrepair() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Expert Godrej AC Repair Services: Fast &amp; Reliable Solutions [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Comprehensive Godrej AC Repair and Maintenance Services in Vadodara: Your Ultimate Cooling Solution&lt;/stron...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Comprehensive Godrej AC Repair and Maintenance Services in Vadodara: Your Ultimate Cooling Solution&lt;/stron...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Godrej-Ac-Repair-Service-1.webp" alt="Expert Godrej AC Repair Services: Fast & Reliable Solutions [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Expert Godrej AC Repair Services: Fast & Reliable Solutions [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Expert Godrej AC Repair Services: Fast & Reliable Solutions [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Godrej-Ac-Repair-Service-1.webp" alt="Expert Godrej AC Repair Services: Fast & Reliable Solutions [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Godrej-Ac-Repair-Service-1.webp" alt="Expert Godrej AC Repair Services: Fast & Reliable Solutions [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Godrej-Ac-Repair-Service-1.webp" alt="Expert Godrej AC Repair Services: Fast & Reliable Solutions [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
