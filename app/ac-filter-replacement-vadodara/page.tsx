...
export const metadata: Metadata = {
  title: "AC Filter Replacement in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC filter change service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC Filter Replacement Vadodara",
    "ac filter replacement",
    "AC Filter Replacement installation",
    "AC Filter Replacement service",
    "AC Filter Replacement repair",
    "best AC Filter Replacement service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-filter-replacement-vadodara",
  },
};

const keywordData = {
  title: "AC Filter Replacement",
  slug: "ac-filter-replacement",
  description: "AC filter change service",
  category: "Problems"
};
...
export default function ACFilterReplacementPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What ac filter replacement vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides ac filter replacement vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book ac filter replacement vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency ac filter replacement vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What ac filter replacement vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides ac filter replacement vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book ac filter replacement vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency ac filter replacement vadodara available. Call +91 93289 53665 for immediate assistance." } },
