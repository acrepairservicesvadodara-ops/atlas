...
export const metadata: Metadata = {
  title: "Top 7 Superior Refrigerant Gas For AC, HVAC & Chillers | Atlas Aircon Blog",
  description: "Top 7 Superior Refrigerant Gas For AC, HVAC & Chillers - Expert guide by Atlas Aircon Vadodara. Professional HVAC tips and service insights. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/top-7-superior-refrigerant-gas-deals-for-ac-hvac-chillers-in-gujarat-save-today" },
  openGraph: {
    title: "Top 7 Superior Refrigerant Gas For AC, HVAC & Chillers | Atlas Aircon",
    description: "Top 7 Superior Refrigerant Gas For AC, HVAC & Chillers - Expert guide by Atlas Aircon Vadodara. Professional HVAC tips and service insights. Call +91 97272 57141.",
    url: "https://atlasaircons.com/top-7-superior-refrigerant-gas-deals-for-ac-hvac-chillers-in-gujarat-save-today",
    type: "article",
...
const jsonLd = {
  ...
  mainEntityOfPage: "https://atlasaircons.com/top-7-superior-refrigerant-gas-deals-for-ac-hvac-chillers-in-gujarat-save-today",
  ...
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVtop 7 superior refrigerant gas deals for ac hvac chillers in gujarat save todays?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVtop 7 superior refrigerant gas deals for ac hvac chillers in gujarat save todays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
