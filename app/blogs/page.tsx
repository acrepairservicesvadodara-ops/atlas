...
export const metadata: Metadata = {
  title: "Blogs &raquo; Hitech Aircool Engineers | Hitech Aircool Engineers Gujarat",
  description: "Blogs &raquo; Hitech Aircool Engineers - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/blogs" },
  openGraph: {
    title: "Blogs &raquo; Hitech Aircool Engineers | Hitech Aircool Engineers",
    description: "Blogs &raquo; Hitech Aircool Engineers - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/blogs",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Blogs &raquo; Hitech Aircool Engineers",
  provider: {
    "@type": "LocalBusiness",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Blogs &amp;raquo; Hitech Aircool Engineers</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Blogs</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Blogs</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Blogs &raquo; Hitech Aircool Engineers" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/chiller-repair.webp" alt="Blogs &raquo; Hitech Aircool Engineers" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/chiller-repair.webp" alt="Blogs &raquo; Hitech Aircool Engineers" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/chiller-repair.webp" alt="Blogs &raquo; Hitech Aircool Engineers" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/chiller-repair.webp" alt="Blogs &raquo; Hitech Aircool Engineers" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/chiller-repair.webp" alt="Blogs &raquo; Hitech Aircool Engineers" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
