...
export const metadata: Metadata = {
  title: "Blogs &raquo; Atlas Aircon | Atlas Aircon Gujarat",
  description: "Blogs &raquo; Atlas Aircon - Atlas Aircon Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/blogs" },
  openGraph: {
    title: "Blogs &raquo; Atlas Aircon | Atlas Aircon",
    description: "Blogs &raquo; Atlas Aircon - Atlas Aircon Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/blogs",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Blogs &amp;raquo; Atlas Aircon</h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Blogs</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Blogs &raquo; Atlas Aircon" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/chiller-repair.webp" alt="Blogs &raquo; Atlas Aircon" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/chiller-repair.webp" alt="Blogs &raquo; Atlas Aircon" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/chiller-repair.webp" alt="Blogs &raquo; Atlas Aircon" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/chiller-repair.webp" alt="Blogs &raquo; Atlas Aircon" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/chiller-repair.webp" alt="Blogs &raquo; Atlas Aircon" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
