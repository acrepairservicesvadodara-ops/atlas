...
export const metadata: Metadata = {
  title: "O General AC Service in Vadodara | Installation, Service & Repair | Atlas Aircon",
  description: "O General AC repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 97272 57141",
  keywords: [
  ...
  alternates: {
    canonical: "https://atlasaircons.com/ogeneral-ac-service-vadodara",
  },
};
  ...
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Are you an authorized service center for OGENERAL?", a: "Atlas Aircon provides multi-brand AC service. While not an authorized center, our technicians are trained on OGENERAL and use genuine parts." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Are you an authorized service center for OGENERAL?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides multi-brand AC service. While not an authorized center, our technicians are trained on OGENERAL and use genuine parts." } },
