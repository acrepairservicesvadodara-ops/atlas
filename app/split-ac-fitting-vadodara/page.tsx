...
export const metadata: Metadata = {
  title: "Split AC Fitting in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Split AC installation in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Split AC Fitting Vadodara",
    "split ac fitting",
    "Split AC Fitting installation",
    "Split AC Fitting service",
    "Split AC Fitting repair",
    "best Split AC Fitting service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/split-ac-fitting-vadodara",
  },
};

const keywordData = {
  title: "Split AC Fitting",
  slug: "split-ac-fitting",
...
export default function SplitACFittingPage() {
  return (
    <>
      {/* Hero Section */}
