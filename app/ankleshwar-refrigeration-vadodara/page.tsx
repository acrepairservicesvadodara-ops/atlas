...
export const metadata: Metadata = {
  title: "Ankleshwar Refrigeration in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Refrigeration Ankleshwar in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Ankleshwar Refrigeration Vadodara",
    "ankleshwar refrigeration",
    "Ankleshwar Refrigeration installation",
    "Ankleshwar Refrigeration service",
    "Ankleshwar Refrigeration repair",
    "best Ankleshwar Refrigeration service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ankleshwar-refrigeration-vadodara",
  },
};

const keywordData = {
  title: "Ankleshwar Refrigeration",
  slug: "ankleshwar-refrigeration",
  description: "Refrigeration Ankleshwar",
  category: "OutCity"
};
...
export default function AnkleshwarRefrigerationPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What ankleshwar refrigeration vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides ankleshwar refrigeration vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book ankleshwar refrigeration vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency ankleshwar refrigeration vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What ankleshwar refrigeration vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides ankleshwar refrigeration vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book ankleshwar refrigeration vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency ankleshwar refrigeration vadodara available. Call +91 93289 53665 for immediate assistance." } },
