...
export const metadata: Metadata = {
  title: "Expert Cold Room Repair Rajpipla: Same-Day, Guaranteed Fix! [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/cold-room-repair-services-rajpipla" },
  openGraph: {
    title: "Expert Cold Room Repair Rajpipla: Same-Day, Guaranteed Fix! [2026 Updated] | Atlas Aircon",
    description: "Top-rated cold room repair services Rajpipla for agricultural storage, resorts, hotels & local businesses. 24/7 emergency repair, maintenance & AMC plans. Servi",
    url: "https://atlasaircons.com/cold-room-repair-services-rajpipla",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Top-rated cold room repair services Rajpipla for agricultural storage, resorts, hotels &amp; local businesses. 24/7 emergency repair, maintenance &amp; AMC plans. Serving Narmada district &amp; surrounding tribal areas.</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVcold room repair services rajpiplas?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVcold room repair services rajpiplas?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
