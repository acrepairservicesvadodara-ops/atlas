...
export const metadata: Metadata = {
  title: "York AC Service Center Anand | Professional HVAC Service | Atlas Aircon",
  description: "York AC Service Center Anand — Professional service service by Atlas Aircon. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 97272 57141.",
  keywords: ["york ac service center anand", "service service", "hvac service vadodara", "atlas aircon", "ac service gujarat"],
  alternates: { canonical: "https://atlasaircons.com/york-ac-service-center-anand" },
  openGraph: { title: "York AC Service Center Anand | Atlas Aircon", description: "Professional service service by Atlas Aircon Gujarat.", url: "https://atlasaircons.com/york-ac-service-center-anand", type: "website" },
};
