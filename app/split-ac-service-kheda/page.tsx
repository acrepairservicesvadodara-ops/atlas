...
export const metadata: Metadata = {
  title: "Fast 24/7 Split AC Repair & Service Kheda | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/split-ac-service-kheda" },
  openGraph: {
    title: "Fast 24/7 Split AC Repair & Service Kheda | Atlas Aircon",
    description: "Expert split AC service Kheda. Same-day repair, installation & gas refilling for all brands. Affordable rates, genuine spare parts & local technicians. Call for",
    url: "https://atlasaircons.com/split-ac-service-kheda",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert split AC service Kheda. Same-day repair, installation &amp; gas refilling for all brands. Affordable rates, genuine spare parts &amp; local technicians. Call for free estimate!</p>
