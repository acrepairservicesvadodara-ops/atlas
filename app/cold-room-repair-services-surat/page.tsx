...
export const metadata: Metadata = {
  title: "24/7 Emergency Surat's #1 Cold Room Repair Services: [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/cold-room-repair-services-surat" },
  openGraph: {
    title: "24/7 Emergency Surat's #1 Cold Room Repair Services: [2026 Updated] | Atlas Aircon",
    description: "Premier cold room repair services in Surat for diamond polishing, textile mills, food processing & commercial units. 24/7 emergency industrial AMC, certified te",
    url: "https://atlasaircons.com/cold-room-repair-services-surat",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Premier cold room repair services in Surat for diamond polishing, textile mills, food processing &amp; commercial units. 24/7 emergency industrial AMC, certified technicians. Serving all zones including Varachha, Adajan &amp; Pandesara.</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVcold room repair services surats?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVcold room repair services surats?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
