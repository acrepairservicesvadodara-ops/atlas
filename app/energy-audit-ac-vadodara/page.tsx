...
export const metadata: Metadata = {
  title: "Energy Audit AC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC energy audit in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Energy Audit AC Vadodara",
    "energy audit ac",
    "Energy Audit AC installation",
    "Energy Audit AC service",
    "Energy Audit AC repair",
    "best Energy Audit AC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/energy-audit-ac-vadodara",
  },
};

const keywordData = {
  title: "Energy Audit AC",
  slug: "energy-audit-ac",
  description: "AC energy audit",
...
export default function EnergyAuditACPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What energy audit ac vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides energy audit ac vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book energy audit ac vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency energy audit ac vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What energy audit ac vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides energy audit ac vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book energy audit ac vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency energy audit ac vadodara available. Call +91 93289 53665 for immediate assistance." } },
