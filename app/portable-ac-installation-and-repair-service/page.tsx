...
export const metadata: Metadata = {
  title: "Portable AC Installation And Repair Service By Atlas Aircon [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/portable-ac-installation-and-repair-service" },
  openGraph: {
    title: "Portable AC Installation And Repair Service By Atlas Aircon [2026 Updated] | Atlas Aircon",
    description: "Stay Cool and Comfortable with Our Portable AC Installation Repair Service | Don't Sweat It: Expert Portable AC Installation and Repair Serv...",
    url: "https://atlasaircons.com/portable-ac-installation-and-repair-service",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Portable AC Installation And Repair Service By Atlas Aircon [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Portable AC Installation And Repair Service By Atlas Aircon [2026 Updated]</h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Stay Cool and Comfortable with Our Portable AC Installation Repair Service | Don&apos;t Sweat It: Expert Portable AC Installation and Repair Serv...</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Portable-Ac-Service.webp" alt="Portable AC Installation And Repair Service By Atlas Aircon [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Portable AC Installation And Repair Service By Atlas Aircon [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Portable AC Installation And Repair Service By Atlas Aircon [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Portable-Ac-Service.webp" alt="Portable AC Installation And Repair Service By Atlas Aircon [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Portable-Ac-Service.webp" alt="Portable AC Installation And Repair Service By Atlas Aircon [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Portable-Ac-Service.webp" alt="Portable AC Installation And Repair Service By Atlas Aircon [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
