...
export const metadata: Metadata = {
  title: "⚠️ 24/7 Dairy & Cold Storage Chiller Repair Services Kheda [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/chiller-repair-services-kheda" },
  openGraph: {
    title: "⚠️ 24/7 Dairy & Cold Storage Chiller Repair Services Kheda [2026 Updated] | Atlas Aircon",
    description: "Chiller Repair Services Kheda for dairy plants, cold storage & food processing. Our specialists prevent spoilage with fast compressor, tube & gas leak repair. P",
    url: "https://atlasaircons.com/chiller-repair-services-kheda",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Chiller Repair Services Kheda for dairy plants, cold storage &amp; food processing. Our specialists prevent spoilage with fast compressor, tube &amp; gas leak repair. Protect milk &amp; produce inventory. Call now!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVchiller repair services khedas?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVchiller repair services khedas?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
