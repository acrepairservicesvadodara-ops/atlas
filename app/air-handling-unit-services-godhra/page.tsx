...
export const metadata: Metadata = {
  title: "Air Handling Unit Services Godhra | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/air-handling-unit-services-godhra" },
  openGraph: {
    title: "Air Handling Unit Services Godhra | Atlas Aircon",
    description: "Reliable Air Handling Unit Services in Godhra. Fast repair & maintenance for warehouses, factories & cold storage. Ensure product safety & operational continuit",
    url: "https://atlasaircons.com/air-handling-unit-services-godhra",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Reliable Air Handling Unit Services in Godhra. Fast repair &amp; maintenance for warehouses, factories &amp; cold storage. Ensure product safety &amp; operational continuity. 24/7 Response. Call for Priority Service!</p>
