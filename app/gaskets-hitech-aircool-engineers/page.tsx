...
export const metadata: Metadata = {
  title: "Gaskets | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "Ensure airtight and watertight seals in refrigeration and HVAC systems with our comprehensive range of gaskets. We supply door gaskets for refrigerators...",
  keywords: ["gaskets | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "gaskets"],
  alternates: { canonical: "https://atlasaircons.com/gaskets-hitech-aircool-engineers" },
  openGraph: {
    title: "Gaskets | Hitech Aircool Engineers",
    description: "Ensure airtight and watertight seals in refrigeration and HVAC systems with our comprehensive range of gaskets. We supply door gaskets for refrigerators...",
    url: "https://atlasaircons.com/gaskets-hitech-aircool-engineers",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Gaskets | Hitech Aircool Engineers",
  description: "Ensure airtight and watertight seals in refrigeration and HVAC systems with our comprehensive range of gaskets. We supply door gaskets for refrigerators and freezers, flange gaskets for compressor service valves, manifold gaskets, and custom-cut gaskets from materials like neoprene, silicone, cork, ",
...
export default function Pagegasketshitechaircoolengineers() {
  return (
    <>
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  ...
                  alt="Gaskets | Hitech Aircool Engineers"
                ...
                <img
                  src="/images/products/Spare-1-scaled-1.webp"
                  alt="Gaskets | Hitech Aircool Engineers - Image 2"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Gaskets | Hitech Aircool Engineers - Image 3"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Gaskets | Hitech Aircool Engineers - Image 4"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="bg-blue-500/20 text-blue-300 px-3 py-1 rounded-full text-xs font-semibold">Gaskets</span>
              </div>
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Gaskets | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">Ensure airtight and watertight seals in refrigeration and HVAC systems with our comprehensive range of gaskets. We supply door gaskets for refrigerato</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%20Gaskets%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Gaskets</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Gujarat</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Leak prevention</span>
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">sealing</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>Ensure airtight and watertight seals in refrigeration and HVAC systems with our comprehensive range of gaskets. We supply door gaskets for refrigerators and freezers, flange gaskets for compressor service valves, manifold gaskets, and custom-cut gaskets from materials like neoprene, silicone, cork, and fiber. A proper gasket prevents energy loss, moisture ingress, and refrigerant leaks.</p>
            </div>
            ...
            <div className="mt-8 bg-gray-50 rounded-xl p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                ...
                <div className="flex justify-between py-2 border-b border-gray-200"><span className="text-gray-500">Category</span><span className="font-medium">Gaskets</span></div>
