...
export const metadata: Metadata = {
  title: "AC Reinstallation in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC reinstall service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC Reinstallation Vadodara",
    "ac reinstallation",
    "AC Reinstallation installation",
    "AC Reinstallation service",
    "AC Reinstallation repair",
    "best AC Reinstallation service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-reinstallation-vadodara",
  },
};

const keywordData = {
  title: "AC Reinstallation",
  slug: "ac-reinstallation",
  description: "AC reinstall service",
...
export default function ACReinstallationPage() {
  return (
    <>
      {/* Hero Section */}
