...
export const metadata: Metadata = {
  title: "👑 AC Service Anand | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-anand" },
  openGraph: {
    title: "👑 AC Service Anand | Atlas Aircon",
    description: "Experience royal AC service in Anand! Expert maintenance, repair & AMC plans from Anand's most trusted technicians. Free health check-up & genuine parts guarant",
    url: "https://atlasaircons.com/ac-service-anand",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Experience royal AC service in Anand! Expert maintenance, repair &amp; AMC plans from Anand&apos;s most trusted technicians. Free health check-up &amp; genuine parts guarantee. Call!</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/cropped-AtlasAircon-Logo.webp" alt="👑 AC Service Anand" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
