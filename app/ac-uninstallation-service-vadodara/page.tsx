...
export const metadata: Metadata = {
  title: "AC Uninstallation Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC removal in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC Uninstallation Service Vadodara",
    "ac uninstallation service",
    "AC Uninstallation Service installation",
    "AC Uninstallation Service service",
    "AC Uninstallation Service repair",
    "best AC Uninstallation Service service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-uninstallation-service-vadodara",
  },
};
...
export default function ACUninstallationServicePage() {
  return (
    <>
      {/* Hero Section */}
