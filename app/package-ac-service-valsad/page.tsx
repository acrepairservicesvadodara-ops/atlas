...
export const metadata: Metadata = {
  title: "Expert Package AC Service Valsad | Hitech Aircool Engineers Gujarat",
  description: "Professional packaged AC installation, emergency repair & gas filling in Valsad. We offer genuine spare parts, same-day service, and 30-day warranty. Book your ",
  alternates: { canonical: "https://hitechairconditioning.in/package-ac-service-valsad" },
  openGraph: {
    title: "Expert Package AC Service Valsad | Hitech Aircool Engineers",
    description: "Professional packaged AC installation, emergency repair & gas filling in Valsad. We offer genuine spare parts, same-day service, and 30-day warranty. Book your ",
    url: "https://hitechairconditioning.in/package-ac-service-valsad",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Expert Package AC Service Valsad",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagepackageacservicevalsad() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Expert Package AC Service Valsad</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Professional packaged AC installation, emergency repair &amp; gas filling in Valsad. We offer genuine spare parts, same-day service, and 30-day warranty. Book your service now!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Professional packaged AC installation, emergency repair &amp; gas filling in Valsad. We offer genuine spare parts, same-day service, and 30-day warranty. Book your service now!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/hitech-logo.webp" alt="Expert Package AC Service Valsad" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Expert Package AC Service Valsad" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
