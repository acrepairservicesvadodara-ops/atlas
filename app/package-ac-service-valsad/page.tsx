...
export const metadata: Metadata = {
  title: "Expert Package AC Service Valsad | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/package-ac-service-valsad" },
  openGraph: {
    title: "Expert Package AC Service Valsad | Atlas Aircon",
    description: "Professional packaged AC installation, emergency repair & gas filling in Valsad. We offer genuine spare parts, same-day service, and 30-day warranty. Book your ",
    url: "https://atlasaircons.com/package-ac-service-valsad",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Professional packaged AC installation, emergency repair &amp; gas filling in Valsad. We offer genuine spare parts, same-day service, and 30-day warranty. Book your service now!</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/cropped-AtlasAircon-Logo.webp" alt="Expert Package AC Service Valsad" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
