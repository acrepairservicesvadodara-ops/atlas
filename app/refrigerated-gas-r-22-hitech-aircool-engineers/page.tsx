...
export const metadata: Metadata = {
  title: "Refrigerated Gas R-22 | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "A joint design where one panel edge has a protruding tongue\" and the other has a matching \"groove.\" This creates a tight, interlocking fit that improve...",
  keywords: ["refrigerated gas r-22 | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "refrigerants"],
  alternates: { canonical: "https://atlasaircons.com/refrigerated-gas-r-22-hitech-aircool-engineers" },
  openGraph: {
    title: "Refrigerated Gas R-22 | Hitech Aircool Engineers",
    description: "A joint design where one panel edge has a protruding tongue\" and the other has a matching \"groove.\" This creates a tight, interlocking fit that improve...",
    url: "https://atlasaircons.com/refrigerated-gas-r-22-hitech-aircool-engineers",
    type: "website",
    images: ["/images/products/Refrigerant-scaled-1.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Refrigerated Gas R-22 | Hitech Aircool Engineers",
  description: "A joint design where one panel edge has a protruding tongue” and the other has a matching “groove.” This creates a tight, interlocking fit that improves structural integrity and thermal continuity at the joints, reducing the chance of air leakage.”",
  image: "/images/products/Refrigerant-scaled-1.webp",
...
export default function Pagerefrigeratedgasr22hitechaircoolengineers() {
  return (
    <>
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  src="/images/products/Refrigerant-scaled-1.webp"
                  alt="Refrigerated Gas R-22 | Hitech Aircool Engineers"
                ...
                <img
                  src="/images/products/Refrigerant-scaled-1.webp"
                  alt="Refrigerated Gas R-22 | Hitech Aircool Engineers - Image 2"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />

                <img
                  src="/images/products/Refrigerant-1-scaled-1.webp"
                  alt="Refrigerated Gas R-22 | Hitech Aircool Engineers - Image 3"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="bg-blue-500/20 text-blue-300 px-3 py-1 rounded-full text-xs font-semibold">Refrigerants</span>
              </div>
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Refrigerated Gas R-22 | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">A joint design where one panel edge has a protruding tongue” and the other has a matching “groove.” This creates a tight, interlocking fit that impro</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%20Refrigerated%20Gas%20R-22%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Heat transfer medium</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Other</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Refrigerated Gas R-22</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Refrigeration Cycle</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>A joint design where one panel edge has a protruding tongue” and the other has a matching “groove.” This creates a tight, interlocking fit that improves structural integrity and thermal continuity at the joints, reducing the chance of air leakage.”</p>
            </div>
            ...
            <div className="mt-8 bg-gray-50 rounded-xl p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                ...
                <div className="flex justify-between py-2 border-b border-gray-200"><span className="text-gray-500">Category</span><span className="font-medium">Refrigerants</span></div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[{"url":"https://www.atlasaircons.com/24x7-hvac-emergency-service-hitech-aircool-engineers/","title":"24X7 Hvac Emergency Service | Hitech Aircool Engineers","price":""},{"url":"https://www.atlasaircons.com/24x7-humidifier-emergency-service-hitech-aircool-engineers/","title":"24X7 Humidifier Emergency Service | Hitech Aircool Engineers","price":""}].map((p: { url: string; title: string; price: string }) => (
