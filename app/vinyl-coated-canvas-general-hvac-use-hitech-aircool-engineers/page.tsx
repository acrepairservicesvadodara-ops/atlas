...
export const metadata: Metadata = {
  title: "Vinyl Coated Canvas (General Hvac Use) | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "A cost-effective option for low-pressure, low-temperature ventilation systems. The vinyl coating provides moderate resistance to moisture and abrasion. ...",
  keywords: ["vinyl coated canvas (general hvac use) | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "duct accessories"],
  alternates: { canonical: "https://atlasaircons.com/vinyl-coated-canvas-general-hvac-use-hitech-aircool-engineers" },
  openGraph: {
    title: "Vinyl Coated Canvas (General Hvac Use) | Hitech Aircool Engineers",
    description: "A cost-effective option for low-pressure, low-temperature ventilation systems. The vinyl coating provides moderate resistance to moisture and abrasion. ...",
    url: "https://atlasaircons.com/vinyl-coated-canvas-general-hvac-use-hitech-aircool-engineers",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Vinyl Coated Canvas (General Hvac Use) | Hitech Aircool Engineers",
  description: "A cost-effective option for low-pressure, low-temperature ventilation systems. The vinyl coating provides moderate resistance to moisture and abrasion. Suitable for connecting residential ductwork, bathroom exhaust fans, or light commercial ventilation where extreme conditions are not a factor.",
...
export default function Pagevinylcoatedcanvasgeneralhvacusehitechair() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  ...
                  alt="Vinyl Coated Canvas (General Hvac Use) | Hitech Aircool Engineers"
                ...
                <img
                  src="/images/products/Canvas-2-scaled-1.webp"
                  alt="Vinyl Coated Canvas (General Hvac Use) | Hitech Aircool Engineers - Image 2"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Vinyl Coated Canvas (General Hvac Use) | Hitech Aircool Engineers - Image 3"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Vinyl Coated Canvas (General Hvac Use) | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">A cost-effective option for low-pressure, low-temperature ventilation systems. The vinyl coating provides moderate resistance to moisture and abrasion</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%20Vinyl%20Coated%20Canvas%20(General%20Hvac%20Use)%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">General HVAC Ducts</span>
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Standard applications</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>A cost-effective option for low-pressure, low-temperature ventilation systems. The vinyl coating provides moderate resistance to moisture and abrasion. Suitable for connecting residential ductwork, bathroom exhaust fans, or light commercial ventilation where extreme conditions are not a factor.</p>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVvinyl coated canvas general hvac use hitech aircool engineerss?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial vinyl coated canvas general hvac use hitech aircool engineers?", a: "Industrial vinyl coated canvas general hvac use hitech aircool engineers costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVvinyl coated canvas general hvac use hitech aircool engineerss?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial vinyl coated canvas general hvac use hitech aircool engineers?", acceptedAnswer: { "@type": "Answer", text: "Industrial vinyl coated canvas general hvac use hitech aircool engineers costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
