...
export const metadata: Metadata = {
  title: "Refrigerator Repair In Vadodara | Atlas Aircon Gujarat",
  description: "Professional refrigerator repair in vadodara by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/refrigerator-repair-in-vadodara-frost-defrost-experts-atlas-aircon" },
  openGraph: {
    title: "Refrigerator Repair In Vadodara | Atlas Aircon",
    description: "Professional refrigerator repair in vadodara by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/refrigerator-repair-in-vadodara-frost-defrost-experts-atlas-aircon",
    type: "website",
  ...
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Refrigerator Repair In Vadodara Frost Defrost Experts Atlas Aircon in Vadodara?", a: "Refrigerator Repair In Vadodara Frost Defrost Experts Atlas Aircon cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Refrigerator Repair In Vadodara Frost Defrost Experts Atlas Aircon?", a: "Atlas Aircon offers same-day Refrigerator Repair In Vadodara Frost Defrost Experts Atlas Aircon across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Refrigerator Repair In Vadodara Frost Defrost Experts Atlas Aircons?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Refrigerator Repair In Vadodara Frost Defrost Experts Atlas Aircons depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Refrigerator Repair In Vadodara Frost Defrost Experts Atlas Aircon available on holidays?", a: "Yes, Atlas Aircon provides Refrigerator Repair In Vadodara Frost Defrost Experts Atlas Aircon 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
              { q: "How long does Refrigerator Repair In Vadodara Frost Defrost Experts Atlas Aircon take?", a: "Most Refrigerator Repair In Vadodara Frost Defrost Experts Atlas Aircons are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Refrigerator Repair In Vadodara Frost Defrost Experts Atlas Aircon in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Refrigerator Repair In Vadodara Frost Defrost Experts Atlas Aircon cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Refrigerator Repair In Vadodara Frost Defrost Experts Atlas Aircon?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Refrigerator Repair In Vadodara Frost Defrost Experts Atlas Aircon across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Refrigerator Repair In Vadodara Frost Defrost Experts Atlas Aircons?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Refrigerator Repair In Vadodara Frost Defrost Experts Atlas Aircons depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Refrigerator Repair In Vadodara Frost Defrost Experts Atlas Aircon available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Refrigerator Repair In Vadodara Frost Defrost Experts Atlas Aircon 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
          { "@type": "Question", name: "How long does Refrigerator Repair In Vadodara Frost Defrost Experts Atlas Aircon take?", acceptedAnswer: { "@type": "Answer", text: "Most Refrigerator Repair In Vadodara Frost Defrost Experts Atlas Aircons are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
