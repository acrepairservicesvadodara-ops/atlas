...
export const metadata: Metadata = {
  title: "Refrigerator Repair In Vadodara | Hitech Aircool Engineers Gujarat",
  description: "Professional refrigerator repair in vadodara by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/refrigerator-repair-in-vadodara-frost-defrost-experts-atlas-aircon" },
  openGraph: {
    title: "Refrigerator Repair In Vadodara | Hitech Aircool Engineers",
    description: "Professional refrigerator repair in vadodara by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/refrigerator-repair-in-vadodara-frost-defrost-experts-atlas-aircon",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Refrigerator Repair In Vadodara",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagerefrigeratorrepairinvadodarafrostdefrost() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Refrigerator Repair In Vadodara</h1>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/Atlas-Aircon-Ac-Service-in-vadodara-2.webp" alt="Refrigerator Repair In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Refrigerator Repair In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Refrigerator Repair In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Refrigerator Repair In Vadodara Frost Defrost Experts Hitech Aircool Engineers in Vadodara?", a: "Refrigerator Repair In Vadodara Frost Defrost Experts Hitech Aircool Engineers cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Refrigerator Repair In Vadodara Frost Defrost Experts Hitech Aircool Engineers?", a: "Hitech Aircool Engineers offers same-day Refrigerator Repair In Vadodara Frost Defrost Experts Hitech Aircool Engineers across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Refrigerator Repair In Vadodara Frost Defrost Experts Hitech Aircool Engineerss?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Refrigerator Repair In Vadodara Frost Defrost Experts Hitech Aircool Engineerss depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Refrigerator Repair In Vadodara Frost Defrost Experts Hitech Aircool Engineers available on holidays?", a: "Yes, Hitech Aircool Engineers provides Refrigerator Repair In Vadodara Frost Defrost Experts Hitech Aircool Engineers 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Refrigerator Repair In Vadodara Frost Defrost Experts Hitech Aircool Engineers take?", a: "Most Refrigerator Repair In Vadodara Frost Defrost Experts Hitech Aircool Engineerss are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Refrigerator Repair In Vadodara Frost Defrost Experts Hitech Aircool Engineers in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Refrigerator Repair In Vadodara Frost Defrost Experts Hitech Aircool Engineers cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Refrigerator Repair In Vadodara Frost Defrost Experts Hitech Aircool Engineers?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Refrigerator Repair In Vadodara Frost Defrost Experts Hitech Aircool Engineers across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Refrigerator Repair In Vadodara Frost Defrost Experts Hitech Aircool Engineerss?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Refrigerator Repair In Vadodara Frost Defrost Experts Hitech Aircool Engineerss depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Refrigerator Repair In Vadodara Frost Defrost Experts Hitech Aircool Engineers available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Refrigerator Repair In Vadodara Frost Defrost Experts Hitech Aircool Engineers 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Refrigerator Repair In Vadodara Frost Defrost Experts Hitech Aircool Engineers take?", acceptedAnswer: { "@type": "Answer", text: "Most Refrigerator Repair In Vadodara Frost Defrost Experts Hitech Aircool Engineerss are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
