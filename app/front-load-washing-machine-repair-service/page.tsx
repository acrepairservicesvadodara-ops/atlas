...
export const metadata: Metadata = {
  title: "Spin Doctor: Front Load Washing Machine Repair Service [2026 Updated] | Hitech Aircool Engineers Gujarat",
  ...
  alternates: { canonical: "https://hitechairconditioning.in/front-load-washing-machine-repair-service" },
  openGraph: {
    title: "Spin Doctor: Front Load Washing Machine Repair Service [2026 Updated] | Hitech Aircool Engineers",
    description: "Front Load Washing Machine Repair Service in Vadodara If you're facing issues with your front load washing machine repair service</stro...",
    url: "https://hitechairconditioning.in/front-load-washing-machine-repair-service",
    type: "website",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Front Load Washing Machine Repair Service in Vadodara If you&apos;re facing issues with your front load washing machine repair service&lt;/stro...</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Front Load Washing Machine Repair Service in Vadodara?", a: "Front Load Washing Machine Repair Service cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Front Load Washing Machine Repair Service?", a: "Hitech Aircool Engineers offers same-day Front Load Washing Machine Repair Service across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Front Load Washing Machine Repair Services?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Front Load Washing Machine Repair Services depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Front Load Washing Machine Repair Service available on holidays?", a: "Yes, Hitech Aircool Engineers provides Front Load Washing Machine Repair Service 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Front Load Washing Machine Repair Service?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Front Load Washing Machine Repair Service across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Front Load Washing Machine Repair Services?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Front Load Washing Machine Repair Services depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Front Load Washing Machine Repair Service available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Front Load Washing Machine Repair Service 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
