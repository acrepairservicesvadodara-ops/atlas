...
export const metadata: Metadata = {
  title: "Air Handling Unit Services Rajkot | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/air-handling-unit-services-rajkot" },
  openGraph: {
    title: "Air Handling Unit Services Rajkot | Atlas Aircon",
    description: "Top-rated Air Handling Unit Services in Rajkot. Expert repair, installation & AMC for industries, malls & offices. Ensure production continuity & clean air. 24/",
    url: "https://atlasaircons.com/air-handling-unit-services-rajkot",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Top-rated Air Handling Unit Services in Rajkot. Expert repair, installation &amp; AMC for industries, malls &amp; offices. Ensure production continuity &amp; clean air. 24/7 Emergency Response. Call Now!</p>
