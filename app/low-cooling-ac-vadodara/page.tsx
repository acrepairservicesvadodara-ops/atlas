...
export const metadata: Metadata = {
  title: "Low Cooling AC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Fix low cooling AC in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Low Cooling AC Vadodara",
    "low cooling ac",
    "Low Cooling AC installation",
    "Low Cooling AC service",
    "Low Cooling AC repair",
    "best Low Cooling AC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/low-cooling-ac-vadodara",
  },
};

const keywordData = {
  title: "Low Cooling AC",
  slug: "low-cooling-ac",
  description: "Fix low cooling AC",
  category: "Problems"
};
...
export default function LowCoolingACPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What low cooling ac vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides low cooling ac vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book low cooling ac vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency low cooling ac vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What low cooling ac vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides low cooling ac vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book low cooling ac vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency low cooling ac vadodara available. Call +91 93289 53665 for immediate assistance." } },
