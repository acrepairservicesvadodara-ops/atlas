...
export const metadata: Metadata = {
  title: "Frequently Asked Questions [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/frequently-asked-questions" },
  openGraph: {
    title: "Frequently Asked Questions [2026 Updated] | Atlas Aircon",
    description: "A FAQ (Frequently Asked Questions) for AC repair service installation should provide concise and accurate answers to common questions related to the installatio",
    url: "https://atlasaircons.com/frequently-asked-questions",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">A FAQ (Frequently Asked Questions) for AC repair service installation should provide concise and accurate answers to common questions related to the installation of air conditioning units.</p>
