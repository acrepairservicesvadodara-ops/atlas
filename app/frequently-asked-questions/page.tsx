...
export const metadata: Metadata = {
  title: "Frequently Asked Questions [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "A FAQ (Frequently Asked Questions) for AC repair service installation should provide concise and accurate answers to common questions related to the installatio",
  alternates: { canonical: "https://hitechairconditioning.in/frequently-asked-questions" },
  openGraph: {
    title: "Frequently Asked Questions [2026 Updated] | Hitech Aircool Engineers",
    description: "A FAQ (Frequently Asked Questions) for AC repair service installation should provide concise and accurate answers to common questions related to the installatio",
    url: "https://hitechairconditioning.in/frequently-asked-questions",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Frequently Asked Questions [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagefrequentlyaskedquestions() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Frequently Asked Questions [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">A FAQ (Frequently Asked Questions) for AC repair service installation should provide concise and accurate answers to common questions related to the installation of air conditioning units.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">A FAQ (Frequently Asked Questions) for AC repair service installation should provide concise and accurate answers to common questions related to the installation of air conditioning units.</p>
          </div>
        </div>
      </section>
