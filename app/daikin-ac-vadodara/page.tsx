...
export const metadata: Metadata = {
  title: "Daikin AC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Daikin AC repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Daikin AC Vadodara",
    "daikin ac",
  ...
  alternates: {
    canonical: "https://hitechairconditioning.in/daikin-ac-vadodara",
  },
};
...
export default function DaikinACPage() {
  return (
    <>
      {/* Hero Section */}
