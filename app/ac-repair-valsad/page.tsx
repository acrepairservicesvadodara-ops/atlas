...
export const metadata: Metadata = {
  title: "⚡ AC Repair Valsad | Hitech Aircool Engineers Gujarat",
  ...
  alternates: { canonical: "https://hitechairconditioning.in/ac-repair-valsad" },
  openGraph: {
    title: "⚡ AC Repair Valsad | Hitech Aircool Engineers",
    description: "Need reliable AC repair in Valsad? Our certified technicians offer same-day service for all AC problems. Honest pricing, 100% satisfaction guarantee. Call now f",
    url: "https://hitechairconditioning.in/ac-repair-valsad",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Need reliable AC repair in Valsad? Our certified technicians offer same-day service for all AC problems. Honest pricing, 100% satisfaction guarantee. Call now for quick relief!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Ac Repair Valsad in Vadodara?", a: "Ac Repair Valsad cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Ac Repair Valsad?", a: "Hitech Aircool Engineers offers same-day Ac Repair Valsad across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Ac Repair Valsads?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Ac Repair Valsads depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Ac Repair Valsad available on holidays?", a: "Yes, Hitech Aircool Engineers provides Ac Repair Valsad 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Ac Repair Valsad in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Ac Repair Valsad cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Ac Repair Valsad?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Ac Repair Valsad across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Ac Repair Valsads?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Ac Repair Valsads depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Ac Repair Valsad available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Ac Repair Valsad 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
