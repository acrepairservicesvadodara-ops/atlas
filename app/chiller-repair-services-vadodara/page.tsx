...
export const metadata: Metadata = {
  title: "24/7 Emergency Breakdown Chiller Repair Services Vadodara [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/chiller-repair-services-vadodara" },
  openGraph: {
    title: "24/7 Emergency Breakdown Chiller Repair Services Vadodara [2026 Updated] | Atlas Aircon",
    description: "Expert Chiller Repair Services Vadodara for industrial & commercial systems. Our certified engineers provide emergency fixes, refrigerant charging, tube cleanin",
    url: "https://atlasaircons.com/chiller-repair-services-vadodara",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert Chiller Repair Services Vadodara for industrial &amp; commercial systems. Our certified engineers provide emergency fixes, refrigerant charging, tube cleaning &amp; maintenance. Guaranteed uptime. Call now!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVchiller repair services vadodaras?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVchiller repair services vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
