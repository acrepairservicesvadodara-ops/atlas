...
export const metadata: Metadata = {
  title: "AC PCB Board & HVAC Circuit Boards: Sales & Repair @ 3500₹ | Atlas Aircon Gujarat",
  description: "Professional ac pcb board & hvac circuit boards: sales & repair @ 3500₹ by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/atlas-aircon-ac-pcb-panel-control-board-sale-repair-service" },
  openGraph: {
    title: "AC PCB Board & HVAC Circuit Boards: Sales & Repair @ 3500₹ | Atlas Aircon",
    description: "Professional ac pcb board & hvac circuit boards: sales & repair @ 3500₹ by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/atlas-aircon-ac-pcb-panel-control-board-sale-repair-service",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">&#123; &quot;@context&quot;: &quot;https://schema.org&quot;, &quot;@type&quot;: &quot;Product&quot;, &quot;name&quot;: &quot;Atlas Aircon ...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">&#123; &quot;@context&quot;: &quot;https://schema.org&quot;, &quot;@type&quot;: &quot;Product&quot;, &quot;name&quot;: &quot;Atlas Aircon ...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Atlas Aircon Ac Pcb Panel Control Board Sale Repair Service in Vadodara?", a: "Atlas Aircon Ac Pcb Panel Control Board Sale Repair Service cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Atlas Aircon Ac Pcb Panel Control Board Sale Repair Service?", a: "Atlas Aircon offers same-day Atlas Aircon Ac Pcb Panel Control Board Sale Repair Service across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Atlas Aircon Ac Pcb Panel Control Board Sale Repair Services?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Atlas Aircon Ac Pcb Panel Control Board Sale Repair Services depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Atlas Aircon Ac Pcb Panel Control Board Sale Repair Service available on holidays?", a: "Yes, Atlas Aircon provides Atlas Aircon Ac Pcb Panel Control Board Sale Repair Service 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
              { q: "How long does Atlas Aircon Ac Pcb Panel Control Board Sale Repair Service take?", a: "Most Atlas Aircon Ac Pcb Panel Control Board Sale Repair Services are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Atlas Aircon Ac Pcb Panel Control Board Sale Repair Service in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon Ac Pcb Panel Control Board Sale Repair Service cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Atlas Aircon Ac Pcb Panel Control Board Sale Repair Service?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Atlas Aircon Ac Pcb Panel Control Board Sale Repair Service across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Atlas Aircon Ac Pcb Panel Control Board Sale Repair Services?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Atlas Aircon Ac Pcb Panel Control Board Sale Repair Services depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Atlas Aircon Ac Pcb Panel Control Board Sale Repair Service available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Atlas Aircon Ac Pcb Panel Control Board Sale Repair Service 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
          { "@type": "Question", name: "How long does Atlas Aircon Ac Pcb Panel Control Board Sale Repair Service take?", acceptedAnswer: { "@type": "Answer", text: "Most Atlas Aircon Ac Pcb Panel Control Board Sale Repair Services are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
