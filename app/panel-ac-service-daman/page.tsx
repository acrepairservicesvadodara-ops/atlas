...
export const metadata: Metadata = {
  title: "Panel AC Service Daman | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/panel-ac-service-daman" },
  openGraph: {
    title: "Panel AC Service Daman | Atlas Aircon",
    description: "Expert Rittal & Schneider panel AC service Daman's hotels, restaurants, and GIDC industries. We provide fast emergency repair, genuine parts, and reliable AMCs ",
    url: "https://atlasaircons.com/panel-ac-service-daman",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert Rittal &amp; Schneider panel AC service Daman&apos;s hotels, restaurants, and GIDC industries. We provide fast emergency repair, genuine parts, and reliable AMCs for smooth operations.</p>
