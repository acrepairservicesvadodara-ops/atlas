...
export const metadata: Metadata = {
  title: "Panel AC Service Daman | Hitech Aircool Engineers Gujarat",
  description: "Expert Rittal & Schneider panel AC service Daman's hotels, restaurants, and GIDC industries. We provide fast emergency repair, genuine parts, and reliable AMCs ",
  alternates: { canonical: "https://hitechairconditioning.in/panel-ac-service-daman" },
  openGraph: {
    title: "Panel AC Service Daman | Hitech Aircool Engineers",
    description: "Expert Rittal & Schneider panel AC service Daman's hotels, restaurants, and GIDC industries. We provide fast emergency repair, genuine parts, and reliable AMCs ",
    url: "https://hitechairconditioning.in/panel-ac-service-daman",
    type: "website",
...
export default function Pagepanelacservicedaman() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Panel AC Service Daman</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Expert Rittal &amp; Schneider panel AC service Daman&apos;s hotels, restaurants, and GIDC industries. We provide fast emergency repair, genuine parts, and reliable AMCs for smooth operations.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Expert Rittal &amp; Schneider panel AC service Daman&apos;s hotels, restaurants, and GIDC industries. We provide fast emergency repair, genuine parts, and reliable AMCs for smooth operations.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/panel-ac-repair-service.webp" alt="Panel AC Service Daman" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Panel AC Service Daman" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
