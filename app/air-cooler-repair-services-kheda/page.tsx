...
export const metadata: Metadata = {
  title: "🔧 5-Star Air Cooler Repair Services Kheda | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/air-cooler-repair-services-kheda" },
  openGraph: {
    title: "🔧 5-Star Air Cooler Repair Services Kheda | Atlas Aircon",
    description: "Experiencing cooler problems in Kheda? Our expert technicians provide reliable air cooler repair services with same-day solutions. Affordable, trusted local ser",
    url: "https://atlasaircons.com/air-cooler-repair-services-kheda",
    type: "website",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Experiencing cooler problems in Kheda? Our expert technicians provide reliable air cooler repair services with same-day solutions. Affordable, trusted local service. Call today!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Air Cooler Repair Services Kheda in Vadodara?", a: "Air Cooler Repair Services Kheda cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Air Cooler Repair Services Kheda?", a: "Atlas Aircon offers same-day Air Cooler Repair Services Kheda across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Air Cooler Repair Services Khedas?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Air Cooler Repair Services Khedas depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Air Cooler Repair Services Kheda available on holidays?", a: "Yes, Atlas Aircon provides Air Cooler Repair Services Kheda 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Air Cooler Repair Services Kheda?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Air Cooler Repair Services Kheda across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Air Cooler Repair Services Khedas?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Air Cooler Repair Services Khedas depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Air Cooler Repair Services Kheda available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Air Cooler Repair Services Kheda 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
