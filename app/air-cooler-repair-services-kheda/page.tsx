...
export const metadata: Metadata = {
  title: "🔧 5-Star Air Cooler Repair Services Kheda | Hitech Aircool Engineers Gujarat",
  description: "Experiencing cooler problems in Kheda? Our expert technicians provide reliable air cooler repair services with same-day solutions. Affordable, trusted local ser",
  alternates: { canonical: "https://hitechairconditioning.in/air-cooler-repair-services-kheda" },
  openGraph: {
    title: "🔧 5-Star Air Cooler Repair Services Kheda | Hitech Aircool Engineers",
    description: "Experiencing cooler problems in Kheda? Our expert technicians provide reliable air cooler repair services with same-day solutions. Affordable, trusted local ser",
    url: "https://hitechairconditioning.in/air-cooler-repair-services-kheda",
    type: "website",
    images: ["/images/products/Air-Cooler-Repair-Service.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "🔧 5-Star Air Cooler Repair Services Kheda",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageaircoolerrepairserviceskheda() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">🔧 5-Star Air Cooler Repair Services Kheda</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Experiencing cooler problems in Kheda? Our expert technicians provide reliable air cooler repair services with same-day solutions. Affordable, trusted local service. Call today!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Experiencing cooler problems in Kheda? Our expert technicians provide reliable air cooler repair services with same-day solutions. Affordable, trusted local service. Call today!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Air-Cooler-Repair-Service.webp" alt="🔧 5-Star Air Cooler Repair Services Kheda" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="🔧 5-Star Air Cooler Repair Services Kheda" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Air Cooler Repair Services Kheda in Vadodara?", a: "Air Cooler Repair Services Kheda cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Air Cooler Repair Services Kheda?", a: "Hitech Aircool Engineers offers same-day Air Cooler Repair Services Kheda across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Air Cooler Repair Services Khedas?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Air Cooler Repair Services Khedas depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Air Cooler Repair Services Kheda available on holidays?", a: "Yes, Hitech Aircool Engineers provides Air Cooler Repair Services Kheda 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Air Cooler Repair Services Kheda take?", a: "Most Air Cooler Repair Services Khedas are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Air Cooler Repair Services Kheda in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Air Cooler Repair Services Kheda cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Air Cooler Repair Services Kheda?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Air Cooler Repair Services Kheda across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Air Cooler Repair Services Khedas?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Air Cooler Repair Services Khedas depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Air Cooler Repair Services Kheda available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Air Cooler Repair Services Kheda 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Air Cooler Repair Services Kheda take?", acceptedAnswer: { "@type": "Answer", text: "Most Air Cooler Repair Services Khedas are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
