...
export const metadata: Metadata = {
  title: "Haier AC Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Haier AC repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Haier AC Service Vadodara",
    "haier ac service",
    "Haier AC Service installation",
    "Haier AC Service service",
    "Haier AC Service repair",
    "best Haier AC Service service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/haier-ac-service-vadodara",
  },
};

const keywordData = {
  title: "Haier AC Service",
  slug: "haier-ac-service",
  description: "Haier AC repair",
  category: "Brands"
};
...
export default function HaierACServicePage() {
  return (
    <>
      {/* Hero Section */}
