...
export const metadata: Metadata = {
  title: "FCU Cleaning in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Fan coil unit cleaning in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "FCU Cleaning Vadodara",
    "fcu cleaning",
    "FCU Cleaning installation",
    "FCU Cleaning service",
    "FCU Cleaning repair",
    "best FCU Cleaning service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/fcu-cleaning-vadodara",
  },
};
...
const keywordData = {
  title: "FCU Cleaning",
  slug: "fcu-cleaning",
  description: "Fan coil unit cleaning",
  category: "Commercial"
};
...
export default function FCUCleaningPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Fcu Cleaning Vadodara include?", a: "Fcu Cleaning Vadodara includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Fcu Cleaning Vadodara cost?", a: "Fcu Cleaning Vadodara starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Fcu Cleaning Vadodara improve cooling?", a: "Yes, proper Fcu Cleaning Vadodara can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Fcu Cleaning Vadodara reduce electricity bills?", a: "Regular Fcu Cleaning Vadodara can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Fcu Cleaning Vadodara take?", a: "Basic Fcu Cleaning Vadodara takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Fcu Cleaning Vadodara remove bad smell?", a: "Yes, Fcu Cleaning Vadodara includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Fcu Cleaning Vadodara?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Fcu Cleaning Vadodara include?", acceptedAnswer: { "@type": "Answer", text: "Fcu Cleaning Vadodara includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Fcu Cleaning Vadodara cost?", acceptedAnswer: { "@type": "Answer", text: "Fcu Cleaning Vadodara starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Fcu Cleaning Vadodara improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Fcu Cleaning Vadodara can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Fcu Cleaning Vadodara reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Fcu Cleaning Vadodara can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Fcu Cleaning Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Basic Fcu Cleaning Vadodara takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Fcu Cleaning Vadodara remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Fcu Cleaning Vadodara includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Fcu Cleaning Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
