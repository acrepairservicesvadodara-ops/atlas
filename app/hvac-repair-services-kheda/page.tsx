...
export const metadata: Metadata = {
  title: "#1 HVAC Repair Services Kheda | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/hvac-repair-services-kheda" },
  openGraph: {
    title: "#1 HVAC Repair Services Kheda | Atlas Aircon",
    description: "Expert HVAC repair services Kheda with certified technicians. Get affordable AC, heating & ventilation solutions across Kheda district. 24/7 emergency support!",
    url: "https://atlasaircons.com/hvac-repair-services-kheda",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert HVAC repair services Kheda with certified technicians. Get affordable AC, heating &amp; ventilation solutions across Kheda district. 24/7 emergency support!</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/cropped-AtlasAircon-Logo.webp" alt="#1 HVAC Repair Services Kheda" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVhvac repair services khedas?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVhvac repair services khedas?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
