...
export const metadata: Metadata = {
  title: "Whirlpool Fridge Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Whirlpool fridge repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Whirlpool Fridge Service Vadodara",
    "whirlpool fridge service",
    "Whirlpool Fridge Service installation",
    "Whirlpool Fridge Service service",
    "Whirlpool Fridge Service repair",
    "best Whirlpool Fridge Service service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/whirlpool-fridge-service-vadodara",
  },
};

const keywordData = {
  title: "Whirlpool Fridge Service",
  slug: "whirlpool-fridge-service",
  description: "Whirlpool fridge repair",
...
export default function WhirlpoolFridgeServicePage() {
  return (
    <>
      {/* Hero Section */}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              ...
              { q: "Do you use genuine parts for WHIRLPOOL?", a: "Yes, we use OEM-quality parts for repairs. For critical components like compressors, we source genuine parts when available." },
              ...
              { q: "Is gas refilling expensive for WHIRLPOOL?", a: "Gas refilling follows standard pricing: R22 from ₹1,500, R32/R410A from ₹2,000. Prices depend on gas type in your specific model." },
              { q: "Can you service inverter AC of WHIRLPOOL?", a: "Yes, we specialize in inverter AC service and repair. Our technicians are trained on variable frequency drive and inverter PCB diagnosis." },
              { q: "Do you provide AMC for WHIRLPOOL?", a: "Yes, AMC plans cover WHIRLPOOL and all other brands. Starting ₹1,999/year for split AC, includes free services, priority support, discounted repairs." },
              { q: "How do I maintain WHIRLPOOL's AC?", a: "Clean filters every 2 weeks, ensure outdoor unit has airflow, run AC at 24-26°C, schedule professional service every 6 months." }
            ].map((faq, i) => (
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "Do you use genuine parts for WHIRLPOOL?", acceptedAnswer: { "@type": "Answer", text: "Yes, we use OEM-quality parts for repairs. For critical components like compressors, we source genuine parts when available." } },
          ...
          { "@type": "Question", name: "Is gas refilling expensive for WHIRLPOOL?", acceptedAnswer: { "@type": "Answer", text: "Gas refilling follows standard pricing: R22 from ₹1,500, R32/R410A from ₹2,000. Prices depend on gas type in your specific model." } },
          { "@type": "Question", name: "Can you service inverter AC of WHIRLPOOL?", acceptedAnswer: { "@type": "Answer", text: "Yes, we specialize in inverter AC service and repair. Our technicians are trained on variable frequency drive and inverter PCB diagnosis." } },
          { "@type": "Question", name: "Do you provide AMC for WHIRLPOOL?", acceptedAnswer: { "@type": "Answer", text: "Yes, AMC plans cover WHIRLPOOL and all other brands. Starting ₹1,999/year for split AC, includes free services, priority support, discounted repairs." } },
          { "@type": "Question", name: "How do I maintain WHIRLPOOL's AC?", acceptedAnswer: { "@type": "Answer", text: "Clean filters every 2 weeks, ensure outdoor unit has airflow, run AC at 24-26°C, schedule professional service every 6 months." } }
        ]
      }) }} />
