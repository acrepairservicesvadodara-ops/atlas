...
export const metadata: Metadata = {
  title: "Low Cooling AC Fix in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC low cooling repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Low Cooling AC Fix Vadodara",
    "low cooling ac fix",
    "Low Cooling AC Fix installation",
    "Low Cooling AC Fix service",
    "Low Cooling AC Fix repair",
    "best Low Cooling AC Fix service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/low-cooling-ac-fix-vadodara",
  },
};

const keywordData = {
  title: "Low Cooling AC Fix",
  slug: "low-cooling-ac-fix",
  description: "AC low cooling repair",
  category: "Problems"
};
...
export default function LowCoolingACFixPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Low Cooling Ac Fix Vadodara in Vadodara?", a: "Low Cooling Ac Fix Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Low Cooling Ac Fix Vadodara?", a: "Hitech Aircool Engineers offers same-day Low Cooling Ac Fix Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Low Cooling Ac Fix Vadodaras?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Low Cooling Ac Fix Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Low Cooling Ac Fix Vadodara available on holidays?", a: "Yes, Hitech Aircool Engineers provides Low Cooling Ac Fix Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Low Cooling Ac Fix Vadodara take?", a: "Most Low Cooling Ac Fix Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Low Cooling Ac Fix Vadodara in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Low Cooling Ac Fix Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Low Cooling Ac Fix Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Low Cooling Ac Fix Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Low Cooling Ac Fix Vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Low Cooling Ac Fix Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Low Cooling Ac Fix Vadodara available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Low Cooling Ac Fix Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Low Cooling Ac Fix Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Most Low Cooling Ac Fix Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
