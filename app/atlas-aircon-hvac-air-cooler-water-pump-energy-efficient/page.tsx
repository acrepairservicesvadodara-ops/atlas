...
export const metadata: Metadata = {
  title: "Hitech Aircool Engineers HVAC & Air Cooler Water Pump | Hitech Aircool Engineers Gujarat",
  description: "Hitech Aircool Engineers HVAC & Air Cooler Water Pump - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/atlas-aircon-hvac-air-cooler-water-pump-energy-efficient" },
  openGraph: {
    title: "Hitech Aircool Engineers HVAC & Air Cooler Water Pump | Hitech Aircool Engineers",
    description: "Hitech Aircool Engineers HVAC & Air Cooler Water Pump - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/atlas-aircon-hvac-air-cooler-water-pump-energy-efficient",
    type: "website",
    images: ["/images/products/air-cooler-water-pump.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Hitech Aircool Engineers HVAC & Air Cooler Water Pump",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageatlasairconhvacaircoolerwaterpumpenergye() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Hitech Aircool Engineers HVAC &amp; Air Cooler Water Pump</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Discover Ne...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Discover Ne...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/air-cooler-water-pump.webp" alt="Hitech Aircool Engineers HVAC & Air Cooler Water Pump" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/water-pump.webp" alt="Hitech Aircool Engineers HVAC & Air Cooler Water Pump" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/air-cooler-pump.webp" alt="Hitech Aircool Engineers HVAC & Air Cooler Water Pump" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/air-cooler-pressure-water-pump.webp" alt="Hitech Aircool Engineers HVAC & Air Cooler Water Pump" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVhitech aircool engineers hvac air cooler water pump energy efficients?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial hitech aircool engineers hvac air cooler water pump energy efficient?", a: "Industrial hitech aircool engineers hvac air cooler water pump energy efficient costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVhitech aircool engineers hvac air cooler water pump energy efficients?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial hitech aircool engineers hvac air cooler water pump energy efficient?", acceptedAnswer: { "@type": "Answer", text: "Industrial hitech aircool engineers hvac air cooler water pump energy efficient costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
