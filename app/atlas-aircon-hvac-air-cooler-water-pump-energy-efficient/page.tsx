...
export const metadata: Metadata = {
  title: "Atlas Aircon HVAC & Air Cooler Water Pump | Atlas Aircon Gujarat",
  description: "Atlas Aircon HVAC & Air Cooler Water Pump - Atlas Aircon Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/atlas-aircon-hvac-air-cooler-water-pump-energy-efficient" },
  openGraph: {
    title: "Atlas Aircon HVAC & Air Cooler Water Pump | Atlas Aircon",
    description: "Atlas Aircon HVAC & Air Cooler Water Pump - Atlas Aircon Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/atlas-aircon-hvac-air-cooler-water-pump-energy-efficient",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Atlas Aircon HVAC & Air Cooler Water Pump",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Atlas Aircon HVAC &amp; Air Cooler Water Pump</h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Discover Ne...</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/air-cooler-water-pump.webp" alt="Atlas Aircon HVAC & Air Cooler Water Pump" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/water-pump.webp" alt="Atlas Aircon HVAC & Air Cooler Water Pump" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/air-cooler-pump.webp" alt="Atlas Aircon HVAC & Air Cooler Water Pump" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/air-cooler-pressure-water-pump.webp" alt="Atlas Aircon HVAC & Air Cooler Water Pump" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVatlas aircon hvac air cooler water pump energy efficients?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial atlas aircon hvac air cooler water pump energy efficient?", a: "Industrial atlas aircon hvac air cooler water pump energy efficient costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVatlas aircon hvac air cooler water pump energy efficients?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial atlas aircon hvac air cooler water pump energy efficient?", acceptedAnswer: { "@type": "Answer", text: "Industrial atlas aircon hvac air cooler water pump energy efficient costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
