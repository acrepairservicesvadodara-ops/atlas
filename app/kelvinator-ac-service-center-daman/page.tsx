...
export const metadata: Metadata = {
  title: "Kelvinator AC Service Center Daman | Professional HVAC Service | Atlas Aircon",
  description: "Kelvinator AC Service Center Daman — Professional service service by Atlas Aircon. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 97272 57141.",
  keywords: ["kelvinator ac service center daman", "service service", "hvac service vadodara", "atlas aircon", "ac service gujarat"],
  alternates: { canonical: "https://atlasaircons.com/kelvinator-ac-service-center-daman" },
  openGraph: { title: "Kelvinator AC Service Center Daman | Atlas Aircon", description: "Professional service service by Atlas Aircon Gujarat.", url: "https://atlasaircons.com/kelvinator-ac-service-center-daman", type: "website" },
};
