...
export const metadata: Metadata = {
  title: "AC Gas Pipe in Vadodara | Installation, Service & Repair | Atlas Aircon",
  description: "AC gas pipe service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 97272 57141",
  keywords: [
    "AC Gas Pipe Vadodara",
    "ac gas pipe",
    "AC Gas Pipe installation",
    "AC Gas Pipe service",
    "AC Gas Pipe repair",
    "best AC Gas Pipe service",
  ],
  alternates: {
    canonical: "https://atlasaircons.com/ac-gas-pipe-vadodara",
  },
};
...
const keywordData = {
  title: "AC Gas Pipe",
  slug: "ac-gas-pipe",
  description: "AC gas pipe service",
  category: "Parts"
};
...
export default function ACGasPipePage() {
  return (
    <>
      {/* Hero Section */}
