...
export const metadata: Metadata = {
  title: "Copper Pipe 5/8″ Hard / Soft 15.88 Mm 20 Swg / 0.9Mm | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "Available in both hard-drawn straight lengths and soft coils. 5/8 OD is a standard suction line size for 2.5 to 3.5-ton residential ACs. The hard-drawn ...",
  keywords: ["copper pipe 5/8″ hard / soft 15.88 mm 20 swg / 0.9mm | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "copper pipe"],
  alternates: { canonical: "https://atlasaircons.com/copper-pipe-5-8-hard-soft-15-88-mm-20-swg-0-9mm-hitech-aircool-engineers" },
  openGraph: {
    title: "Copper Pipe 5/8″ Hard / Soft 15.88 Mm 20 Swg / 0.9Mm | Hitech Aircool Engineers",
    description: "Available in both hard-drawn straight lengths and soft coils. 5/8 OD is a standard suction line size for 2.5 to 3.5-ton residential ACs. The hard-drawn ...",
    url: "https://atlasaircons.com/copper-pipe-5-8-hard-soft-15-88-mm-20-swg-0-9mm-hitech-aircool-engineers",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Copper Pipe 5/8″ Hard / Soft 15.88 Mm 20 Swg / 0.9Mm | Hitech Aircool Engineers",
  description: "Available in both hard-drawn straight lengths and soft coils. 5/8 OD is a standard suction line size for 2.5 to 3.5-ton residential ACs. The hard-drawn version is used where straight, rigid runs are needed; soft coil is for complex routing.”",
...
export default function Pagecopperpipe58hardsoft1588mm20swg09mmhitec() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  ...
                  alt="Copper Pipe 5/8″ Hard / Soft 15.88 Mm 20 Swg / 0.9Mm | Hitech Aircool Engineers"
                ...
                <img
                  src="/images/products/Air-scaled-1.webp"
                  alt="Copper Pipe 5/8″ Hard / Soft 15.88 Mm 20 Swg / 0.9Mm | Hitech Aircool Engineers - Image 2"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Copper Pipe 5/8″ Hard / Soft 15.88 Mm 20 Swg / 0.9Mm | Hitech Aircool Engineers - Image 3"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Copper Pipe 5/8″ Hard / Soft 15.88 Mm 20 Swg / 0.9Mm | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">Available in both hard-drawn straight lengths and soft coils. 5/8 OD is a standard suction line size for 2.5 to 3.5-ton residential ACs. The hard-draw</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%20Copper%20Pipe%205%2F8%E2%80%B3%20Hard%20%2F%20Soft%2015.88%20Mm%2020%20Swg%20%2F%200.9Mm%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Copper Pipe 5/8&quot; Hard / Soft 15.88 Mm 20 Swg / 0.9Mm</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>Available in both hard-drawn straight lengths and soft coils. 5/8 OD is a standard suction line size for 2.5 to 3.5-ton residential ACs. The hard-drawn version is used where straight, rigid runs are needed; soft coil is for complex routing.”</p>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[{"url":"https://www.atlasaircons.com/recirculating-air-curtains-hitech-aircool-engineers/","title":"Recirculating Air Curtains | Hitech Aircool Engineers","price":""},{"url":"https://www.atlasaircons.com/24x7-coldroom-emergency-service-hitech-aircool-engineers/","title":"24X7 Coldroom Emergency Service | Hitech Aircool Engineers","price":""}].map((p: { url: string; title: string; price: string }) => (
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What copper pipe 5 8 hard soft 15 88 mm 20 swg 0 9mm hitech aircool engineerss does Atlas Aircon provide?", a: "Atlas Aircon provides copper pipe 5 8 hard soft 15 88 mm 20 swg 0 9mm hitech aircool engineers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book copper pipe 5 8 hard soft 15 88 mm 20 swg 0 9mm hitech aircool engineers?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency copper pipe 5 8 hard soft 15 88 mm 20 swg 0 9mm hitech aircool engineers available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What copper pipe 5 8 hard soft 15 88 mm 20 swg 0 9mm hitech aircool engineerss does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides copper pipe 5 8 hard soft 15 88 mm 20 swg 0 9mm hitech aircool engineers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book copper pipe 5 8 hard soft 15 88 mm 20 swg 0 9mm hitech aircool engineers?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency copper pipe 5 8 hard soft 15 88 mm 20 swg 0 9mm hitech aircool engineers available. Call +91 97272 57141 for immediate assistance." } },
