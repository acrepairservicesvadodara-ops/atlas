...
export const metadata: Metadata = {
  title: "AC Swing Not Working in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC louver repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC Swing Not Working Vadodara",
    "ac swing not working",
    "AC Swing Not Working installation",
    "AC Swing Not Working service",
    "AC Swing Not Working repair",
    "best AC Swing Not Working service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-swing-not-working-vadodara",
  },
};

const keywordData = {
  title: "AC Swing Not Working",
  slug: "ac-swing-not-working",
  description: "AC louver repair",
  category: "Problems"
};
...
export default function ACSwingNotWorkingPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What ac swing not working vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides ac swing not working vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book ac swing not working vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency ac swing not working vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What ac swing not working vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides ac swing not working vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book ac swing not working vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency ac swing not working vadodara available. Call +91 93289 53665 for immediate assistance." } },
