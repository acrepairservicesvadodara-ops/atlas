...
export const metadata: Metadata = {
  title: "Godrej AC Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Godrej AC repair and service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Godrej AC Service Vadodara",
    "godrej ac service",
    "Godrej AC installation",
    "Godrej AC service",
    "Godrej AC repair",
    "best Godrej AC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/godrej-ac-service-vadodara",
  },
};

const keywordData = {
  title: "Godrej AC Service",
  slug: "godrej-ac-service",
  description: "Godrej AC repair and service",
  category: "Brands"
};
...
export default function GodrejACServicePage() {
  return (
    <>
      {/* Hero Section */}
