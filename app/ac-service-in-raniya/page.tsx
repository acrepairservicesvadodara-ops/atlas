...
export const metadata: Metadata = {
  title: "AC Service In Raniya | Professional HVAC Service | Hitech Aircool Engineers",
  description: "AC Service In Raniya — Professional service service by Hitech Aircool Engineers. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 93289 53665.",
  keywords: ["ac service in raniya", "service service", "hvac service vadodara", "hitech aircool engineers", "ac service gujarat"],
  alternates: { canonical: "https://hitechairconditioning.in/ac-service-in-raniya" },
  openGraph: { title: "AC Service In Raniya | Hitech Aircool Engineers", description: "Professional service service by Hitech Aircool Engineers Gujarat.", url: "https://hitechairconditioning.in/ac-service-in-raniya", type: "website" },
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "AC Service In Raniya",
  provider: { "@type": "LocalBusiness", name: "Hitech Aircool Engineers", telephone: "+919328953665" },
  areaServed: { "@type": "State", name: "Gujarat" },
  serviceType: "AC Service In Raniya",
};

export default function ACServiceInRaniyaPage() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">AC Service In Raniya</h1>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the best AC repair service in Raniya?", a: "Hitech Aircool Engineers is rated 4.9★ for AC repair in Raniya. Our certified technicians provide same-day service with 90-day warranty. Call +91 93289 53665." },
              { q: "What are your service charges in Raniya?", a: "AC service charges are standard: inspection ₹299 (adjusted against repairs), basic service from ₹499, deep cleaning from ₹799. No area surcharges." },
              { q: "How quickly can you reach Raniya?", a: "Our nearest technician can reach within 90 minutes to 3 hours depending on current workload. Emergencies are prioritized." },
              { q: "Do you have technicians in Raniya?", a: "Yes, Hitech Aircool Engineers has servicemen positioned across Vadodara. This ensures faster response times for AC repair and service calls." },
              { q: "Is emergency AC service available in Raniya?", a: "Yes, 24/7 emergency AC repair is available. Call +91 93289 53665 for immediate assistance with AC breakdown or cooling failures." },
              { q: "What AC problems are common in Raniya?", a: "Common issues include gas leakage, water dripping, reduced cooling from dust, and electrical tripping. Regular maintenance prevents most issues." },
              { q: "Do you offer AMC for customers in Raniya?", a: "Yes, AMC plans available from ₹1,999/year. Includes 2-4 free services, priority support, and discounted repairs." },
              { q: "Can you install new AC in Raniya?", a: "Yes, professional AC installation available for all AC types — split, window, cassette, ductable. Includes copper piping and testing." },
              { q: "Do you service office ACs in Raniya?", a: "Yes, we service commercial ACs in offices, shops, showrooms. We handle all types including VRF systems and ducted ACs." },
              { q: "Is service available on weekends in Raniya?", a: "Yes, AC service available 7 days a week including Saturdays and Sundays. Book online or call +91 93289 53665." }
            ].map((faq, i) => (
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the best AC repair service in Raniya?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers is rated 4.9★ for AC repair in Raniya. Our certified technicians provide same-day service with 90-day warranty. Call +91 93289 53665." } },
          { "@type": "Question", name: "What are your service charges in Raniya?", acceptedAnswer: { "@type": "Answer", text: "AC service charges are standard: inspection ₹299 (adjusted against repairs), basic service from ₹499, deep cleaning from ₹799. No area surcharges." } },
          { "@type": "Question", name: "How quickly can you reach Raniya?", acceptedAnswer: { "@type": "Answer", text: "Our nearest technician can reach within 90 minutes to 3 hours depending on current workload. Emergencies are prioritized." } },
          { "@type": "Question", name: "Do you have technicians in Raniya?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers has servicemen positioned across Vadodara. This ensures faster response times for AC repair and service calls." } },
          { "@type": "Question", name: "Is emergency AC service available in Raniya?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency AC repair is available. Call +91 93289 53665 for immediate assistance with AC breakdown or cooling failures." } },
          { "@type": "Question", name: "What AC problems are common in Raniya?", acceptedAnswer: { "@type": "Answer", text: "Common issues include gas leakage, water dripping, reduced cooling from dust, and electrical tripping. Regular maintenance prevents most issues." } },
          { "@type": "Question", name: "Do you offer AMC for customers in Raniya?", acceptedAnswer: { "@type": "Answer", text: "Yes, AMC plans available from ₹1,999/year. Includes 2-4 free services, priority support, and discounted repairs." } },
          { "@type": "Question", name: "Can you install new AC in Raniya?", acceptedAnswer: { "@type": "Answer", text: "Yes, professional AC installation available for all AC types — split, window, cassette, ductable. Includes copper piping and testing." } },
          { "@type": "Question", name: "Do you service office ACs in Raniya?", acceptedAnswer: { "@type": "Answer", text: "Yes, we service commercial ACs in offices, shops, showrooms. We handle all types including VRF systems and ducted ACs." } },
          { "@type": "Question", name: "Is service available on weekends in Raniya?", acceptedAnswer: { "@type": "Answer", text: "Yes, AC service available 7 days a week including Saturdays and Sundays. Book online or call +91 93289 53665." } }
        ]
      }) }} />
