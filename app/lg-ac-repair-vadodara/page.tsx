...
export const metadata: Metadata = {
  title: "LG AC Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "LG AC repair service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "LG AC Repair Vadodara",
    "lg ac repair",
    "LG AC Repair installation",
    "LG AC Repair service",
    "LG AC Repair repair",
    "best LG AC Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/lg-ac-repair-vadodara",
  },
};
...
const keywordData = {
  title: "LG AC Repair",
  slug: "lg-ac-repair",
  description: "LG AC repair service",
  category: "Brands"
};
