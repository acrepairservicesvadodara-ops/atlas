...
export const metadata: Metadata = {
  title: "Volume Control Damper in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "VCD installation in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Volume Control Damper Vadodara",
    "volume control damper",
    "Volume Control Damper installation",
    "Volume Control Damper service",
    "Volume Control Damper repair",
    "best Volume Control Damper service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/volume-control-damper-vadodara",
  },
};
...
export default function VolumeControlDamperPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What volume control damper vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides volume control damper vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book volume control damper vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency volume control damper vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What volume control damper vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides volume control damper vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book volume control damper vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency volume control damper vadodara available. Call +91 93289 53665 for immediate assistance." } },
