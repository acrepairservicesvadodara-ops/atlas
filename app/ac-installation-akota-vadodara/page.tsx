...
export const metadata: Metadata = {
  title: "AC Installation Akota in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC installation Akota in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC Installation Akota Vadodara",
    "ac installation akota",
    "AC Installation Akota installation",
    "AC Installation Akota service",
    "AC Installation Akota repair",
    "best AC Installation Akota service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-installation-akota-vadodara",
  },
};

const keywordData = {
  title: "AC Installation Akota",
  slug: "ac-installation-akota",
  description: "AC installation Akota",
  category: "Area"
};
...
export default function ACInstallationAkotaPage() {
  return (
    <>
      {/* Hero Section */}
