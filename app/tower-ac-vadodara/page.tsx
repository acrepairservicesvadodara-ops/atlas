...
export const metadata: Metadata = {
  title: "Tower AC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Tower AC repair service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Tower AC Vadodara",
    "tower ac",
    ...
    "Tower AC service",
    "Tower AC repair",
    "best Tower AC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/tower-ac-vadodara",
  },
};
...
const keywordData = {
  title: "Tower AC",
  slug: "tower-ac",
  description: "Tower AC repair service",
  category: "ACTypes"
};
...
export default function TowerACPage() {
  return (
    <>
      {/* Hero Section */}
