...
export const metadata: Metadata = {
  title: "O General AC Service Center Bharuch | Professional HVAC Service | Atlas Aircon",
  description: "O General AC Service Center Bharuch — Professional service service by Atlas Aircon. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 97272 57141.",
  keywords: ["o general ac service center bharuch", "service service", "hvac service vadodara", "atlas aircon", "ac service gujarat"],
  alternates: { canonical: "https://atlasaircons.com/o-general-ac-service-center-bharuch" },
  openGraph: { title: "O General AC Service Center Bharuch | Atlas Aircon", description: "Professional service service by Atlas Aircon Gujarat.", url: "https://atlasaircons.com/o-general-ac-service-center-bharuch", type: "website" },
};
