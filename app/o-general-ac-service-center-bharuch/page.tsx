...
export const metadata: Metadata = {
  title: "O General AC Service Center Bharuch | Professional HVAC Service | Hitech Aircool Engineers",
  description: "O General AC Service Center Bharuch — Professional service service by Hitech Aircool Engineers. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 93289 53665.",
  keywords: ["o general ac service center bharuch", "service service", "hvac service vadodara", "hitech aircool engineers", "ac service gujarat"],
  alternates: { canonical: "https://hitechairconditioning.in/o-general-ac-service-center-bharuch" },
  openGraph: { title: "O General AC Service Center Bharuch | Hitech Aircool Engineers", description: "Professional service service by Hitech Aircool Engineers Gujarat.", url: "https://hitechairconditioning.in/o-general-ac-service-center-bharuch", type: "website" },
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "O General AC Service Center Bharuch",
  provider: { "@type": "LocalBusiness", name: "Hitech Aircool Engineers", telephone: "+919328953665" },
  areaServed: { "@type": "State", name: "Gujarat" },
  serviceType: "O General AC Service Center Bharuch",
};

export default function OGeneralACServiceCenterBharuchPage() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">O General AC Service Center Bharuch</h1>
