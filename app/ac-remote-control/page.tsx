...
export const metadata: Metadata = {
  title: "Professional AC Remote Control Dealers And Repair Services [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Professional AC remote control dealers and repair services in Vadodara by Hitech Aircool Engineers If you're living in Vadodara and your air conditioner r...",
  alternates: { canonical: "https://hitechairconditioning.in/ac-remote-control" },
  openGraph: {
    title: "Professional AC Remote Control Dealers And Repair Services [2026 Updated] | Hitech Aircool Engineers",
    description: "Professional AC remote control dealers and repair services in Vadodara by Hitech Aircool Engineers If you're living in Vadodara and your air conditioner r...",
    url: "https://hitechairconditioning.in/ac-remote-control",
    type: "website",
    images: ["/images/products/AC-remote-control-dealers-and-repair-services-in-Vadodara-.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Professional AC Remote Control Dealers And Repair Services [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageacremotecontrol() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Professional AC Remote Control Dealers And Repair Services [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Professional AC remote control dealers and repair services in Vadodara by Hitech Aircool Engineers If you&apos;re living in Vadodara and your air conditioner r...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Professional AC remote control dealers and repair services in Vadodara by Hitech Aircool Engineers If you&apos;re living in Vadodara and your air conditioner r...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/AC-remote-control-dealers-and-repair-services-in-Vadodara-.webp" alt="Professional AC Remote Control Dealers And Repair Services [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Professional AC Remote Control Dealers And Repair Services [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Professional AC Remote Control Dealers And Repair Services [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/AC-remote-control-dealers-and-repair-services-in-Vadodara-.webp" alt="Professional AC Remote Control Dealers And Repair Services [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/AC-remote-control-dealers-and-repair-services-in-Vadodara-.webp" alt="Professional AC Remote Control Dealers And Repair Services [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/AC-remote-control-dealers-and-repair-services-in-Vadodara-.webp" alt="Professional AC Remote Control Dealers And Repair Services [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What ac remote controls does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides ac remote control, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book ac remote control?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency ac remote control available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What ac remote controls does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides ac remote control, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book ac remote control?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency ac remote control available. Call +91 93289 53665 for immediate assistance." } },
