...
export const metadata: Metadata = {
  title: "Refrigerant Gas | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "Also known as PIR (Polyisocyanurate) boards. Similar to PUF but with slightly different fire performance. Used for wall and ceiling insulation in large ...",
  keywords: ["refrigerant gas | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "refrigerants"],
  alternates: { canonical: "https://atlasaircons.com/refrigerant-gas-hitech-aircool-engineers" },
  openGraph: {
    title: "Refrigerant Gas | Hitech Aircool Engineers",
    description: "Also known as PIR (Polyisocyanurate) boards. Similar to PUF but with slightly different fire performance. Used for wall and ceiling insulation in large ...",
    url: "https://atlasaircons.com/refrigerant-gas-hitech-aircool-engineers",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Refrigerant Gas | Hitech Aircool Engineers",
  description: "Also known as PIR (Polyisocyanurate) boards. Similar to PUF but with slightly different fire performance. Used for wall and ceiling insulation in large cold stores. We supply these boards in large sheets for onsite fabrication and installation.",
...
export default function Pagerefrigerantgashitechaircoolengineers() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  ...
                  alt="Refrigerant Gas | Hitech Aircool Engineers"
                ...
                <img
                  src="/images/products/Refrigerant-scaled-1.webp"
                  alt="Refrigerant Gas | Hitech Aircool Engineers - Image 2"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Refrigerant Gas | Hitech Aircool Engineers - Image 3"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Refrigerant Gas | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">Also known as PIR (Polyisocyanurate) boards. Similar to PUF but with slightly different fire performance. Used for wall and ceiling insulation in larg</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%20Refrigerant%20Gas%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">refrigerant gas</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>Also known as PIR (Polyisocyanurate) boards. Similar to PUF but with slightly different fire performance. Used for wall and ceiling insulation in large cold stores. We supply these boards in large sheets for onsite fabrication and installation.</p>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[{"url":"https://www.atlasaircons.com/24x7-air-drier-emergency-service-hitech-aircool-engineers/","title":"24X7 Air Drier Emergency Service | Hitech Aircool Engineers","price":""},{"url":"https://www.atlasaircons.com/24x7-air-conditioner-emergency-service-hitech-aircool-engineers/","title":"24X7 Air Conditioner Emergency Service | Hitech Aircool Engineers","price":""}].map((p: { url: string; title: string; price: string }) => (
