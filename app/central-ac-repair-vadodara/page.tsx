...
export const metadata: Metadata = {
  title: "Central AC Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Central AC repair service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Central AC Repair Vadodara",
    "central ac repair",
    "Central AC Repair installation",
    "Central AC Repair service",
    "Central AC Repair repair",
    "best Central AC Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/central-ac-repair-vadodara",
  },
};

const keywordData = {
  title: "Central AC Repair",
  slug: "central-ac-repair",
  description: "Central AC repair service",
  category: "ACTypes"
};
...
export default function CentralACRepairPage() {
  return (
    <>
      {/* Hero Section */}
