...
export const metadata: Metadata = {
  title: "Trusted AC Service Vadodara | Hitech Aircool Engineers Gujarat",
  description: "Looking for the best AC repair vadodara, AC service vadodara, or AC installation in Vadodara? Hitech Aircool Engineers offers fast, reliable, and affordable cooling solutio",
  alternates: { canonical: "https://hitechairconditioning.in/air-conditioner-maintenance" },
  openGraph: {
    title: "Trusted AC Service Vadodara | Hitech Aircool Engineers",
    description: "Looking for the best AC repair vadodara, AC service vadodara, or AC installation in Vadodara? Hitech Aircool Engineers offers fast, reliable, and affordable cooling solutio",
    url: "https://hitechairconditioning.in/air-conditioner-maintenance",
    type: "website",
    images: ["/images/Airconditioner.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Trusted AC Service Vadodara",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageairconditionermaintenance() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Trusted AC Service Vadodara</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Looking for the best AC repair vadodara, AC service vadodara, or AC installation in Vadodara? Hitech Aircool Engineers offers fast, reliable, and affordable cooling solutions with 24/7 support. Contact us for ac service vadodara free quote.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Looking for the best AC repair vadodara, AC service vadodara, or AC installation in Vadodara? Hitech Aircool Engineers offers fast, reliable, and affordable cooling solutions with 24/7 support. Contact us for ac service vadodara free quote.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/Airconditioner.webp" alt="Trusted AC Service Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Trusted AC Service Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Window-AC-Installation-and-Repairing.webp" alt="Trusted AC Service Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Air Conditioner Maintenance include?", a: "Air Conditioner Maintenance includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Air Conditioner Maintenance cost?", a: "Air Conditioner Maintenance starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Air Conditioner Maintenance improve cooling?", a: "Yes, proper Air Conditioner Maintenance can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Air Conditioner Maintenance reduce electricity bills?", a: "Regular Air Conditioner Maintenance can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Air Conditioner Maintenance take?", a: "Basic Air Conditioner Maintenance takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Air Conditioner Maintenance remove bad smell?", a: "Yes, Air Conditioner Maintenance includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Air Conditioner Maintenance?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Air Conditioner Maintenance include?", acceptedAnswer: { "@type": "Answer", text: "Air Conditioner Maintenance includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Air Conditioner Maintenance cost?", acceptedAnswer: { "@type": "Answer", text: "Air Conditioner Maintenance starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Air Conditioner Maintenance improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Air Conditioner Maintenance can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Air Conditioner Maintenance reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Air Conditioner Maintenance can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Air Conditioner Maintenance take?", acceptedAnswer: { "@type": "Answer", text: "Basic Air Conditioner Maintenance takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Air Conditioner Maintenance remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Air Conditioner Maintenance includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Air Conditioner Maintenance?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
