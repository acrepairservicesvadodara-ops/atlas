...
export const metadata: Metadata = {
  title: "Trusted AC Service Vadodara | Atlas Aircon Gujarat",
  description: "Looking for the best AC repair vadodara, AC service vadodara, or AC installation in Vadodara? Atlas Aircon offers fast, reliable, and affordable cooling solutio",
  alternates: { canonical: "https://atlasaircons.com/air-conditioner-maintenance" },
  openGraph: {
    title: "Trusted AC Service Vadodara | Atlas Aircon",
    description: "Looking for the best AC repair vadodara, AC service vadodara, or AC installation in Vadodara? Atlas Aircon offers fast, reliable, and affordable cooling solutio",
    url: "https://atlasaircons.com/air-conditioner-maintenance",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Looking for the best AC repair vadodara, AC service vadodara, or AC installation in Vadodara? Atlas Aircon offers fast, reliable, and affordable cooling solutions with 24/7 support. Contact us for ac service vadodara free quote.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Looking for the best AC repair vadodara, AC service vadodara, or AC installation in Vadodara? Atlas Aircon offers fast, reliable, and affordable cooling solutions with 24/7 support. Contact us for ac service vadodara free quote.</p>
          </div>
        </div>
      </section>
