...
export const metadata: Metadata = {
  title: "Privacy Policy &raquo; Atlas Aircon [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/privacy-policy" },
  openGraph: {
    title: "Privacy Policy &raquo; Atlas Aircon [2026 Updated] | Atlas Aircon",
    description: "Convenience Cookies: If you leave a comment, you may opt-in to saving your name and email. These last for one year to save you from re-typing details for",
    url: "https://atlasaircons.com/privacy-policy",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Privacy Policy &raquo; Atlas Aircon [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Privacy Policy &amp;raquo; Atlas Aircon [2026 Updated]</h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Convenience Cookies: If you leave a comment, you may opt-in to saving your name and email. These last for one year to save you from re-typing details for</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What privacy policys does Atlas Aircon provide?", a: "Atlas Aircon provides privacy policy, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book privacy policy?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency privacy policy available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What privacy policys does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides privacy policy, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book privacy policy?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency privacy policy available. Call +91 97272 57141 for immediate assistance." } },
