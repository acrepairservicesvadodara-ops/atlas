...
export const metadata: Metadata = {
  title: "Carrier AC Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Carrier AC repair and service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    ...
    "Carrier AC service",
    "Carrier AC repair",
    "best Carrier AC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/carrier-ac-service-vadodara",
  },
};

const keywordData = {
  title: "Carrier AC Service",
  slug: "carrier-ac-service",
  description: "Carrier AC repair and service",
  category: "Brands"
};
...
export default function CarrierACServicePage() {
  return (
    <>
      {/* Hero Section */}
