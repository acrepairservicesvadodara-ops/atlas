...
export const metadata: Metadata = {
  title: "#1 Hi Sense AC Repair Service Center Vadodara | Hitech Aircool Engineers Gujarat",
  ...
  alternates: { canonical: "https://hitechairconditioning.in/hi-sense-ac-repair-service-center-vadodara" },
  openGraph: {
    title: "#1 Hi Sense AC Repair Service Center Vadodara | Hitech Aircool Engineers",
    description: "Expert hi sense AC repair, installation, and service in Vadodara. Get transparent charges, 3-month guarantee, and 24/7 emergency support from certified technici",
    url: "https://hitechairconditioning.in/hi-sense-ac-repair-service-center-vadodara",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Expert hi sense AC repair, installation, and service in Vadodara. Get transparent charges, 3-month guarantee, and 24/7 emergency support from certified technicians. Call Hitech Aircool Engineers now!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Expert hi sense AC repair, installation, and service in Vadodara. Get transparent charges, 3-month guarantee, and 24/7 emergency support from certified technicians. Call Hitech Aircool Engineers now!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Hi Sense Ac Repair Service Center Vadodara in Vadodara?", a: "Hi Sense Ac Repair Service Center Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Hi Sense Ac Repair Service Center Vadodara?", a: "Hitech Aircool Engineers offers same-day Hi Sense Ac Repair Service Center Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Hi Sense Ac Repair Service Center Vadodaras?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Hi Sense Ac Repair Service Center Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Hi Sense Ac Repair Service Center Vadodara available on holidays?", a: "Yes, Hitech Aircool Engineers provides Hi Sense Ac Repair Service Center Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
