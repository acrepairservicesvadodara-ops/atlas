...
export const metadata: Metadata = {
  title: "Water Chiller Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Water chiller service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Water Chiller Repair Vadodara",
    "water chiller repair",
    "Water Chiller Repair installation",
    "Water Chiller Repair service",
    "Water Chiller Repair repair",
    "best Water Chiller Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/water-chiller-repair-vadodara",
  },
};

const keywordData = {
  title: "Water Chiller Repair",
  slug: "water-chiller-repair",
  description: "Water chiller service",
  category: "Commercial"
};
...
export default function WaterChillerRepairPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVwater chiller repair vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial water chiller repair vadodara?", a: "Industrial water chiller repair vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVwater chiller repair vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial water chiller repair vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial water chiller repair vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
