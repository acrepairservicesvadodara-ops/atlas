...
export const metadata: Metadata = {
  title: "👑 AC Service Godhra | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-godhra" },
  openGraph: {
    title: "👑 AC Service Godhra | Atlas Aircon",
    description: "Godhra's trusted AC experts offering royal-grade maintenance & repair services. Free thermal check-up & honest pricing. Serving all Godhra neighborhoods. Call n",
    url: "https://atlasaircons.com/ac-service-godhra",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Godhra&apos;s trusted AC experts offering royal-grade maintenance &amp; repair services. Free thermal check-up &amp; honest pricing. Serving all Godhra neighborhoods. Call now!</p>
