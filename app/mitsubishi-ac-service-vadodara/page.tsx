...
export const metadata: Metadata = {
  title: "Mitsubishi AC Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Mitsubishi AC repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Mitsubishi AC Service Vadodara",
    "mitsubishi ac service",
    "Mitsubishi AC Service installation",
    "Mitsubishi AC Service service",
    "Mitsubishi AC Service repair",
    "best Mitsubishi AC Service service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/mitsubishi-ac-service-vadodara",
  },
};

const keywordData = {
  title: "Mitsubishi AC Service",
  slug: "mitsubishi-ac-service",
  description: "Mitsubishi AC repair",
  category: "Brands"
};
...
export default function MitsubishiACServicePage() {
  return (
    <>
      {/* Hero Section */}
