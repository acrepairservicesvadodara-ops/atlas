...
export const metadata: Metadata = {
  title: "Hitech Aircool Engineerss™ Air Dryer Filter | Hitech Aircool Engineers Gujarat",
  description: "Technical Specifications & Product Attributes <table clas...",
  alternates: { canonical: "https://hitechairconditioning.in/atlas-aircons-high-efficiency-hvac-and-air-conditioner-air-dryer-filter" },
  openGraph: {
    title: "Hitech Aircool Engineerss™ Air Dryer Filter | Hitech Aircool Engineers",
    description: "Technical Specifications & Product Attributes <table clas...",
    url: "https://hitechairconditioning.in/atlas-aircons-high-efficiency-hvac-and-air-conditioner-air-dryer-filter",
    type: "website",
    images: ["/images/products/air-dryer-filter-Gas-Filters.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Hitech Aircool Engineerss™ Air Dryer Filter",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageatlasairconshighefficiencyhvacandaircond() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Hitech Aircool Engineerss™ Air Dryer Filter</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Technical Specifications &amp; Product Attributes &lt;table clas...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Technical Specifications &amp; Product Attributes &lt;table clas...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/air-dryer-filter-Gas-Filters.webp" alt="Hitech Aircool Engineerss™ Air Dryer Filter" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/air-dryer-filter.webp" alt="Hitech Aircool Engineerss™ Air Dryer Filter" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVhitech aircool engineerss high efficiency hvac and air conditioner air dryer filters?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial hitech aircool engineerss high efficiency hvac and air conditioner air dryer filter?", a: "Industrial hitech aircool engineerss high efficiency hvac and air conditioner air dryer filter costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVhitech aircool engineerss high efficiency hvac and air conditioner air dryer filters?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial hitech aircool engineerss high efficiency hvac and air conditioner air dryer filter?", acceptedAnswer: { "@type": "Answer", text: "Industrial hitech aircool engineerss high efficiency hvac and air conditioner air dryer filter costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
