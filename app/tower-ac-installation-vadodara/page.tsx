...
export const metadata: Metadata = {
  title: "Tower AC Installation in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Tower AC installation service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Tower AC Installation Vadodara",
    "tower ac installation",
    "Tower AC Installation installation",
    "Tower AC Installation service",
    "Tower AC Installation repair",
    "best Tower AC Installation service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/tower-ac-installation-vadodara",
  },
};

const keywordData = {
  title: "Tower AC Installation",
  slug: "tower-ac-installation",
  description: "Tower AC installation service",
  category: "ACTypes"
};
...
export default function TowerACInstallationPage() {
  return (
    <>
      {/* Hero Section */}
