...
export const metadata: Metadata = {
  title: "Expert Cassette AC Repair In Vadodara [2026 Updated] | Atlas Aircon Gujarat",
  description: "Professional expert cassette ac repair in vadodara [2026 updated] by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/cassette-ac-repair-in-vadodara-charges" },
  openGraph: {
    title: "Expert Cassette AC Repair In Vadodara [2026 Updated] | Atlas Aircon",
    description: "Professional expert cassette ac repair in vadodara [2026 updated] by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/cassette-ac-repair-in-vadodara-charges",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">/* C...</p>
