...
export const metadata: Metadata = {
  title: "Expert Cassette AC Repair In Vadodara [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Professional expert cassette ac repair in vadodara [2026 updated] by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/cassette-ac-repair-in-vadodara-charges" },
  openGraph: {
    title: "Expert Cassette AC Repair In Vadodara [2026 Updated] | Hitech Aircool Engineers",
    description: "Professional expert cassette ac repair in vadodara [2026 updated] by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/cassette-ac-repair-in-vadodara-charges",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Expert Cassette AC Repair In Vadodara [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagecassetteacrepairinvadodaracharges() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Expert Cassette AC Repair In Vadodara [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">/* C...</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Atlas-Aircon-Vehicle.webp" alt="Expert Cassette AC Repair In Vadodara [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Expert Cassette AC Repair In Vadodara [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Expert Cassette AC Repair In Vadodara [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
