...
export const metadata: Metadata = {
  title: "Capillary Tube | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "The capillary tube is a critical metering device in small refrigeration and AC systems. This fixed-length, small-diameter copper tube creates a pressure...",
  keywords: ["capillary tube | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "plumbing pipe & conduit"],
  alternates: { canonical: "https://atlasaircons.com/capillary-tube-hitech-aircool-engineers" },
  openGraph: {
    title: "Capillary Tube | Hitech Aircool Engineers",
    description: "The capillary tube is a critical metering device in small refrigeration and AC systems. This fixed-length, small-diameter copper tube creates a pressure...",
    url: "https://atlasaircons.com/capillary-tube-hitech-aircool-engineers",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Capillary Tube | Hitech Aircool Engineers",
  description: "The capillary tube is a critical metering device in small refrigeration and AC systems. This fixed-length, small-diameter copper tube creates a pressure drop, regulating refrigerant flow. We supply capillary tubes in precise internal diameters (ID) and lengths to match OEM specifications for accurat",
...
export default function Pagecapillarytubehitechaircoolengineers() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  ...
                  alt="Capillary Tube | Hitech Aircool Engineers"
                ...
                <img
                  src="/images/products/Capilary-1-scaled-1.webp"
                  alt="Capillary Tube | Hitech Aircool Engineers - Image 2"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Capillary Tube | Hitech Aircool Engineers - Image 3"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Capillary Tube | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">The capillary tube is a critical metering device in small refrigeration and AC systems. This fixed-length, small-diameter copper tube creates a pressu</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%20Capillary%20Tube%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Capillary Tube</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>The capillary tube is a critical metering device in small refrigeration and AC systems. This fixed-length, small-diameter copper tube creates a pressure drop, regulating refrigerant flow. We supply capillary tubes in precise internal diameters (ID) and lengths to match OEM specifications for accurate system performance and cooling capacity.</p>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What capillary tube hitech aircool engineerss does Atlas Aircon provide?", a: "Atlas Aircon provides capillary tube hitech aircool engineers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book capillary tube hitech aircool engineers?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency capillary tube hitech aircool engineers available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What capillary tube hitech aircool engineerss does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides capillary tube hitech aircool engineers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book capillary tube hitech aircool engineers?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency capillary tube hitech aircool engineers available. Call +91 97272 57141 for immediate assistance." } },
