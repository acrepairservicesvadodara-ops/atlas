...
export const metadata: Metadata = {
  title: "Hitachi Inverter AC Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Hitachi inverter AC service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Hitachi Inverter AC Service Vadodara",
    "hitachi inverter ac service",
    "Hitachi Inverter AC Service installation",
    "Hitachi Inverter AC Service service",
    "Hitachi Inverter AC Service repair",
    "best Hitachi Inverter AC Service service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/hitachi-inverter-ac-service-vadodara",
  },
};

const keywordData = {
  title: "Hitachi Inverter AC Service",
  slug: "hitachi-inverter-ac-service",
  description: "Hitachi inverter AC service",
  category: "Brands"
};
...
export default function HitachiInverterACServicePage() {
  return (
    <>
      {/* Hero Section */}
