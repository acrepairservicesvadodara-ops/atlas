...
export const metadata: Metadata = {
  title: "High-Performance AC Capacitor | Hitech Aircool Engineers Gujarat",
  description: "❄️ Experience unmatched cooling stability with Hitech Aircool Engineers's premium AC capacitors – the heart of your air conditioning performa...",
  alternates: { canonical: "https://hitechairconditioning.in/high-performance-ac-capacitor-in-vadodara-boost-cooling-efficiency-by-40" },
  openGraph: {
    title: "High-Performance AC Capacitor | Hitech Aircool Engineers",
    description: "❄️ Experience unmatched cooling stability with Hitech Aircool Engineers's premium AC capacitors – the heart of your air conditioning performa...",
    url: "https://hitechairconditioning.in/high-performance-ac-capacitor-in-vadodara-boost-cooling-efficiency-by-40",
    type: "website",
    images: ["/images/products/Starting-Capacitor.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "High-Performance AC Capacitor",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagehighperformanceaccapacitorinvadodaraboos() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">High-Performance AC Capacitor</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">❄️ Experience unmatched cooling stability with Hitech Aircool Engineers&apos;s premium AC capacitors – the heart of your air conditioning performa...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">❄️ Experience unmatched cooling stability with Hitech Aircool Engineers&apos;s premium AC capacitors – the heart of your air conditioning performa...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Starting-Capacitor.webp" alt="High-Performance AC Capacitor" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/running-capacitor.webp" alt="High-Performance AC Capacitor" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What high performance ac capacitor in vadodara boost cooling efficiency by 40s does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides high performance ac capacitor in vadodara boost cooling efficiency by 40, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book high performance ac capacitor in vadodara boost cooling efficiency by 40?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency high performance ac capacitor in vadodara boost cooling efficiency by 40 available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What high performance ac capacitor in vadodara boost cooling efficiency by 40s does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides high performance ac capacitor in vadodara boost cooling efficiency by 40, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book high performance ac capacitor in vadodara boost cooling efficiency by 40?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency high performance ac capacitor in vadodara boost cooling efficiency by 40 available. Call +91 93289 53665 for immediate assistance." } },
