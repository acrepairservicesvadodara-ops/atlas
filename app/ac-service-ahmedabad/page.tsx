...
export const metadata: Metadata = {
  title: "🏆 AC Service Ahmedabad | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-ahmedabad" },
  openGraph: {
    title: "🏆 AC Service Ahmedabad | Atlas Aircon",
    description: "Ahmedabad's most awarded AC service! Professional maintenance, repair & AMC plans from certified technicians. Free diagnostic & 100% satisfaction guarantee. Boo",
    url: "https://atlasaircons.com/ac-service-ahmedabad",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Ahmedabad&apos;s most awarded AC service! Professional maintenance, repair &amp; AMC plans from certified technicians. Free diagnostic &amp; 100% satisfaction guarantee. Book now!</p>
