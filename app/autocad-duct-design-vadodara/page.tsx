...
export const metadata: Metadata = {
  title: "AutoCAD Duct Design in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Duct design service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AutoCAD Duct Design Vadodara",
    "autocad duct design",
    "AutoCAD Duct Design installation",
    "AutoCAD Duct Design service",
    "AutoCAD Duct Design repair",
    "best AutoCAD Duct Design service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/autocad-duct-design-vadodara",
  },
};

const keywordData = {
  title: "AutoCAD Duct Design",
  slug: "autocad-duct-design",
  description: "Duct design service",
...
export default function AutoCADDuctDesignPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What autocad duct design vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides autocad duct design vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book autocad duct design vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency autocad duct design vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What autocad duct design vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides autocad duct design vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book autocad duct design vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency autocad duct design vadodara available. Call +91 93289 53665 for immediate assistance." } },
