...
export const metadata: Metadata = {
  title: "Air Filter Drier 1/4 Inch | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "A critical line component that protects your refrigeration system. The filter drier removes moisture, acid, and solid contaminants (like metal debris fr...",
  keywords: ["air filter drier 1/4 inch | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "heating"],
  alternates: { canonical: "https://atlasaircons.com/air-filter-drier-1-4-inch-hitech-aircool-engineers" },
  openGraph: {
    title: "Air Filter Drier 1/4 Inch | Hitech Aircool Engineers",
    description: "A critical line component that protects your refrigeration system. The filter drier removes moisture, acid, and solid contaminants (like metal debris fr...",
    url: "https://atlasaircons.com/air-filter-drier-1-4-inch-hitech-aircool-engineers",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Air Filter Drier 1/4 Inch | Hitech Aircool Engineers",
  description: "A critical line component that protects your refrigeration system. The filter drier removes moisture, acid, and solid contaminants (like metal debris from a burnout) from the refrigerant. We supply copper shell driers, bi-flow driers for heat pumps, and replaceable core driers. Proper sizing (by ton",
...
export default function Pageairfilterdrier14inchhitechaircoolenginee() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  ...
                  alt="Air Filter Drier 1/4 Inch | Hitech Aircool Engineers"
                ...
                <img
                  src="/images/products/Spare-1-scaled-1.webp"
                  alt="Air Filter Drier 1/4 Inch | Hitech Aircool Engineers - Image 2"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Air Filter Drier 1/4 Inch | Hitech Aircool Engineers - Image 3"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Air Filter Drier 1/4 Inch | Hitech Aircool Engineers - Image 4"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Air Filter Drier 1/4 Inch | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">A critical line component that protects your refrigeration system. The filter drier removes moisture, acid, and solid contaminants (like metal debris</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%20Air%20Filter%20Drier%201%2F4%20Inch%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Air Filter Drier 1/4 Inch</span>
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Line protection for small systems</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Other</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Refrigerators</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>A critical line component that protects your refrigeration system. The filter drier removes moisture, acid, and solid contaminants (like metal debris from a burnout) from the refrigerant. We supply copper shell driers, bi-flow driers for heat pumps, and replaceable core driers. Proper sizing (by tonnage and connection size) and installation (direction of flow) are essential for system health.</p>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[{"url":"https://www.atlasaircons.com/24x7-air-drier-emergency-service-hitech-aircool-engineers/","title":"24X7 Air Drier Emergency Service | Hitech Aircool Engineers","price":""},{"url":"https://www.atlasaircons.com/24x7-gyser-emergency-service-hitech-aircool-engineers/","title":"24X7 Gyser Emergency Service | Hitech Aircool Engineers","price":""}].map((p: { url: string; title: string; price: string }) => (
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What air filter drier 1 4 inch hitech aircool engineerss does Atlas Aircon provide?", a: "Atlas Aircon provides air filter drier 1 4 inch hitech aircool engineers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book air filter drier 1 4 inch hitech aircool engineers?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency air filter drier 1 4 inch hitech aircool engineers available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What air filter drier 1 4 inch hitech aircool engineerss does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides air filter drier 1 4 inch hitech aircool engineers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book air filter drier 1 4 inch hitech aircool engineers?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency air filter drier 1 4 inch hitech aircool engineers available. Call +91 97272 57141 for immediate assistance." } },
