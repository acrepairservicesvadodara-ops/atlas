...
export const metadata: Metadata = {
  title: "HVAC Karelibaug in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "HVAC service Karelibaug in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "HVAC Karelibaug Vadodara",
    "hvac karelibaug",
    "HVAC Karelibaug installation",
    "HVAC Karelibaug service",
    "HVAC Karelibaug repair",
    "best HVAC Karelibaug service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/hvac-karelibaug-vadodara",
  },
};

const keywordData = {
  title: "HVAC Karelibaug",
  slug: "hvac-karelibaug",
  description: "HVAC service Karelibaug",
  category: "Area"
};
...
export default function HVACKarelibaugPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVhvac karelibaug vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial hvac karelibaug vadodara?", a: "Industrial hvac karelibaug vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVhvac karelibaug vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial hvac karelibaug vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial hvac karelibaug vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
