...
export const metadata: Metadata = {
  title: "Fix Your AC! 5-Star Split AC Service & Repair In Vadodara [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/split-ac-service-vadodara" },
  openGraph: {
    title: "Fix Your AC! 5-Star Split AC Service & Repair In Vadodara [2026 Updated] | Atlas Aircon",
    description: "Need reliable split AC service Vadodara? Our expert technicians offer fast repair, gas refill & deep cleaning. Same-day service, genuine spare parts. Call now!",
    url: "https://atlasaircons.com/split-ac-service-vadodara",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Need reliable split AC service Vadodara? Our expert technicians offer fast repair, gas refill &amp; deep cleaning. Same-day service, genuine spare parts. Call now!</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/cropped-AtlasAircon-Logo.webp" alt="Fix Your AC! 5-Star Split AC Service & Repair In Vadodara [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
