...
export const metadata: Metadata = {
  title: "Fix Your AC! 5-Star Split AC Service & Repair In Vadodara [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Need reliable split AC service Vadodara? Our expert technicians offer fast repair, gas refill & deep cleaning. Same-day service, genuine spare parts. Call now!",
  alternates: { canonical: "https://hitechairconditioning.in/split-ac-service-vadodara" },
  openGraph: {
    title: "Fix Your AC! 5-Star Split AC Service & Repair In Vadodara [2026 Updated] | Hitech Aircool Engineers",
    description: "Need reliable split AC service Vadodara? Our expert technicians offer fast repair, gas refill & deep cleaning. Same-day service, genuine spare parts. Call now!",
    url: "https://hitechairconditioning.in/split-ac-service-vadodara",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Fix Your AC! 5-Star Split AC Service & Repair In Vadodara [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagesplitacservicevadodara() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Fix Your AC! 5-Star Split AC Service &amp; Repair In Vadodara [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Need reliable split AC service Vadodara? Our expert technicians offer fast repair, gas refill &amp; deep cleaning. Same-day service, genuine spare parts. Call now!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Need reliable split AC service Vadodara? Our expert technicians offer fast repair, gas refill &amp; deep cleaning. Same-day service, genuine spare parts. Call now!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/hitech-logo.webp" alt="Fix Your AC! 5-Star Split AC Service & Repair In Vadodara [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Fix Your AC! 5-Star Split AC Service & Repair In Vadodara [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
