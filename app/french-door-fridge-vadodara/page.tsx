...
export const metadata: Metadata = {
  title: "French Door Fridge in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "French door fridge repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "French Door Fridge Vadodara",
    "french door fridge",
    "French Door Fridge installation",
    "French Door Fridge service",
    "French Door Fridge repair",
    "best French Door Fridge service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/french-door-fridge-vadodara",
  },
};

const keywordData = {
  title: "French Door Fridge",
  slug: "french-door-fridge",
  description: "French door fridge repair",
...
export default function FrenchDoorFridgePage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What french door fridge vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides french door fridge vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book french door fridge vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency french door fridge vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What french door fridge vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides french door fridge vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book french door fridge vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency french door fridge vadodara available. Call +91 93289 53665 for immediate assistance." } },
