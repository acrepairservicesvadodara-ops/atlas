...
export const metadata: Metadata = {
  title: "Professional Standard AC Installation Service &raquo; 9727257141 [2026 Updated] | Atlas Aircon Gujarat",
  description: "body { font-family: 'Inter...",
  alternates: { canonical: "https://atlasaircons.com/professional-standard-ac-installation-service" },
  openGraph: {
    title: "Professional Standard AC Installation Service &raquo; 9727257141 [2026 Updated] | Atlas Aircon",
    description: "body { font-family: 'Inter...",
    url: "https://atlasaircons.com/professional-standard-ac-installation-service",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Professional Standard AC Installation Service &raquo; 9727257141 [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Professional Standard AC Installation Service &amp;raquo; 9727257141 [2026 Updated]</h1>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Professional-AC-Maintenance-Services.webp" alt="Professional Standard AC Installation Service &raquo; 9727257141 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Professional Standard AC Installation Service &raquo; 9727257141 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Professional Standard AC Installation Service &raquo; 9727257141 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
