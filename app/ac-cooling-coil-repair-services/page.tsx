...
export const metadata: Metadata = {
  title: "Call Now Expert AC Cooling Coil Repair Services In Vadodara [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-cooling-coil-repair-services" },
  openGraph: {
    title: "Call Now Expert AC Cooling Coil Repair Services In Vadodara [2026 Updated] | Atlas Aircon",
    description: "Trustworthy AC cooling coil repair services in Vadodara | Expert AC cooling coil repair services in Vadodara | Experienced AC cooling coil repair sp...",
    url: "https://atlasaircons.com/ac-cooling-coil-repair-services",
    type: "website",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Trustworthy AC cooling coil repair services in Vadodara | Expert AC cooling coil repair services in Vadodara | Experienced AC cooling coil repair sp...</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Ac Cooling Coil Repair Services in Vadodara?", a: "Ac Cooling Coil Repair Services cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Ac Cooling Coil Repair Services?", a: "Atlas Aircon offers same-day Ac Cooling Coil Repair Services across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Ac Cooling Coil Repair Servicess?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Ac Cooling Coil Repair Servicess depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Ac Cooling Coil Repair Services available on holidays?", a: "Yes, Atlas Aircon provides Ac Cooling Coil Repair Services 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Ac Cooling Coil Repair Services?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Ac Cooling Coil Repair Services across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Ac Cooling Coil Repair Servicess?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Ac Cooling Coil Repair Servicess depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Ac Cooling Coil Repair Services available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Ac Cooling Coil Repair Services 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
