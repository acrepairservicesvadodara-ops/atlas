...
export const metadata: Metadata = {
  title: "Call Now Expert AC Cooling Coil Repair Services In Vadodara [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Trustworthy AC cooling coil repair services in Vadodara | Expert AC cooling coil repair services in Vadodara | Experienced AC cooling coil repair sp...",
  alternates: { canonical: "https://hitechairconditioning.in/ac-cooling-coil-repair-services" },
  openGraph: {
    title: "Call Now Expert AC Cooling Coil Repair Services In Vadodara [2026 Updated] | Hitech Aircool Engineers",
    description: "Trustworthy AC cooling coil repair services in Vadodara | Expert AC cooling coil repair services in Vadodara | Experienced AC cooling coil repair sp...",
    url: "https://hitechairconditioning.in/ac-cooling-coil-repair-services",
    type: "website",
    images: ["/images/products/Air-Conditioner-Indoor-cooling-coil.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Call Now Expert AC Cooling Coil Repair Services In Vadodara [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageaccoolingcoilrepairservices() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Call Now Expert AC Cooling Coil Repair Services In Vadodara [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Trustworthy AC cooling coil repair services in Vadodara | Expert AC cooling coil repair services in Vadodara | Experienced AC cooling coil repair sp...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Trustworthy AC cooling coil repair services in Vadodara | Expert AC cooling coil repair services in Vadodara | Experienced AC cooling coil repair sp...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Air-Conditioner-Indoor-cooling-coil.webp" alt="Call Now Expert AC Cooling Coil Repair Services In Vadodara [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Call Now Expert AC Cooling Coil Repair Services In Vadodara [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Call Now Expert AC Cooling Coil Repair Services In Vadodara [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Air-Conditioner-Indoor-cooling-coil.webp" alt="Call Now Expert AC Cooling Coil Repair Services In Vadodara [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Air-Conditioner-Indoor-cooling-coil.webp" alt="Call Now Expert AC Cooling Coil Repair Services In Vadodara [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Air-Conditioner-Indoor-cooling-coil.webp" alt="Call Now Expert AC Cooling Coil Repair Services In Vadodara [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Ac Cooling Coil Repair Services in Vadodara?", a: "Ac Cooling Coil Repair Services cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Ac Cooling Coil Repair Services?", a: "Hitech Aircool Engineers offers same-day Ac Cooling Coil Repair Services across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Ac Cooling Coil Repair Servicess?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Ac Cooling Coil Repair Servicess depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Ac Cooling Coil Repair Services available on holidays?", a: "Yes, Hitech Aircool Engineers provides Ac Cooling Coil Repair Services 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Ac Cooling Coil Repair Services take?", a: "Most Ac Cooling Coil Repair Servicess are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Ac Cooling Coil Repair Services in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Ac Cooling Coil Repair Services cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Ac Cooling Coil Repair Services?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Ac Cooling Coil Repair Services across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Ac Cooling Coil Repair Servicess?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Ac Cooling Coil Repair Servicess depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Ac Cooling Coil Repair Services available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Ac Cooling Coil Repair Services 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Ac Cooling Coil Repair Services take?", acceptedAnswer: { "@type": "Answer", text: "Most Ac Cooling Coil Repair Servicess are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
