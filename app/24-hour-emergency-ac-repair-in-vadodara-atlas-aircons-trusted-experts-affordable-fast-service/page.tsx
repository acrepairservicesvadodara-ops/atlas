...
export const metadata: Metadata = {
  title: "24 Hour Emergency AC Repairing | Hitech Aircool Engineers Gujarat",
  description: "Professional 24 hour emergency ac repairing by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/24-hour-emergency-ac-repair-in-vadodara-atlas-aircons-trusted-experts-affordable-fast-service" },
  openGraph: {
    title: "24 Hour Emergency AC Repairing | Hitech Aircool Engineers",
    description: "Professional 24 hour emergency ac repairing by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/24-hour-emergency-ac-repair-in-vadodara-atlas-aircons-trusted-experts-affordable-fast-service",
    type: "website",
    images: ["/images/products/emergency-ac-repairing.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "24 Hour Emergency AC Repairing",
  provider: {
    "@type": "LocalBusiness",
...
export default function Page24houremergencyacrepairinvadodaraatlasai() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">24 Hour Emergency AC Repairing</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">&#123; &quot;@context&quot;: &quot;https://schema.org&quot;, &quot;@type&quot;: &quot;LocalBusiness&quot;, &quot;name&quot;: &quot;Hitech Aircool Engineers&quot;, &quot;image&quot;: [ &quot;...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">&#123; &quot;@context&quot;: &quot;https://schema.org&quot;, &quot;@type&quot;: &quot;LocalBusiness&quot;, &quot;name&quot;: &quot;Hitech Aircool Engineers&quot;, &quot;image&quot;: [ &quot;...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/emergency-ac-repairing.webp" alt="24 Hour Emergency AC Repairing" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/emergency-24hrs-7-days-ac-repairing.webp" alt="24 Hour Emergency AC Repairing" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/24X7-ac-repairing.webp" alt="24 Hour Emergency AC Repairing" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of 24 Hour Emergency Ac Repair In Vadodara Hitech Aircool Engineerss Trusted Experts Affordable Fast Service in Vadodara?", a: "24 Hour Emergency Ac Repair In Vadodara Hitech Aircool Engineerss Trusted Experts Affordable Fast Service cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for 24 Hour Emergency Ac Repair In Vadodara Hitech Aircool Engineerss Trusted Experts Affordable Fast Service?", a: "Hitech Aircool Engineers offers same-day 24 Hour Emergency Ac Repair In Vadodara Hitech Aircool Engineerss Trusted Experts Affordable Fast Service across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on 24 Hour Emergency Ac Repair In Vadodara Hitech Aircool Engineerss Trusted Experts Affordable Fast Services?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on 24 Hour Emergency Ac Repair In Vadodara Hitech Aircool Engineerss Trusted Experts Affordable Fast Services depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency 24 Hour Emergency Ac Repair In Vadodara Hitech Aircool Engineerss Trusted Experts Affordable Fast Service available on holidays?", a: "Yes, Hitech Aircool Engineers provides 24 Hour Emergency Ac Repair In Vadodara Hitech Aircool Engineerss Trusted Experts Affordable Fast Service 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does 24 Hour Emergency Ac Repair In Vadodara Hitech Aircool Engineerss Trusted Experts Affordable Fast Service take?", a: "Most 24 Hour Emergency Ac Repair In Vadodara Hitech Aircool Engineerss Trusted Experts Affordable Fast Services are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of 24 Hour Emergency Ac Repair In Vadodara Hitech Aircool Engineerss Trusted Experts Affordable Fast Service in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "24 Hour Emergency Ac Repair In Vadodara Hitech Aircool Engineerss Trusted Experts Affordable Fast Service cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for 24 Hour Emergency Ac Repair In Vadodara Hitech Aircool Engineerss Trusted Experts Affordable Fast Service?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day 24 Hour Emergency Ac Repair In Vadodara Hitech Aircool Engineerss Trusted Experts Affordable Fast Service across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on 24 Hour Emergency Ac Repair In Vadodara Hitech Aircool Engineerss Trusted Experts Affordable Fast Services?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on 24 Hour Emergency Ac Repair In Vadodara Hitech Aircool Engineerss Trusted Experts Affordable Fast Services depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency 24 Hour Emergency Ac Repair In Vadodara Hitech Aircool Engineerss Trusted Experts Affordable Fast Service available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 24 Hour Emergency Ac Repair In Vadodara Hitech Aircool Engineerss Trusted Experts Affordable Fast Service 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does 24 Hour Emergency Ac Repair In Vadodara Hitech Aircool Engineerss Trusted Experts Affordable Fast Service take?", acceptedAnswer: { "@type": "Answer", text: "Most 24 Hour Emergency Ac Repair In Vadodara Hitech Aircool Engineerss Trusted Experts Affordable Fast Services are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
