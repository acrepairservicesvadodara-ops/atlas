...
export const metadata: Metadata = {
  title: "Panel AC Service Rajpipla | Hitech Aircool Engineers Gujarat",
  ...
  alternates: { canonical: "https://hitechairconditioning.in/panel-ac-service-rajpipla" },
  openGraph: {
    title: "Panel AC Service Rajpipla | Hitech Aircool Engineers",
    description: "Expert panel AC service Rajpipla for industrial units, government offices, and towns across Narmada district. 24/7 emergency repair, AMCs, and service for Ritta",
    url: "https://hitechairconditioning.in/panel-ac-service-rajpipla",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Expert panel AC service Rajpipla for industrial units, government offices, and towns across Narmada district. 24/7 emergency repair, AMCs, and service for Rittal, Schneider units.</p>
