...
export const metadata: Metadata = {
  title: "5-Star Same-Day Expert Deep Freezer Repair Services Rajkot [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/deep-freezer-repair-services-rajkot" },
  openGraph: {
    title: "5-Star Same-Day Expert Deep Freezer Repair Services Rajkot [2026 Updated] | Atlas Aircon",
    description: "Urgent deep freezer repair services Rajkot by certified technicians. ✅ Free diagnosis ✅ Genuine parts ✅ 6-month warranty. Residential & commercial service acros",
    url: "https://atlasaircons.com/deep-freezer-repair-services-rajkot",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Urgent deep freezer repair services Rajkot by certified technicians. ✅ Free diagnosis ✅ Genuine parts ✅ 6-month warranty. Residential &amp; commercial service across all areas. Call now!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVdeep freezer repair services rajkots?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVdeep freezer repair services rajkots?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
