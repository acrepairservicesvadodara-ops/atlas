...
export const metadata: Metadata = {
  title: "5-Star Same-Day Expert Deep Freezer Repair Services Rajkot [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Urgent deep freezer repair services Rajkot by certified technicians. ✅ Free diagnosis ✅ Genuine parts ✅ 6-month warranty. Residential & commercial service acros",
  alternates: { canonical: "https://hitechairconditioning.in/deep-freezer-repair-services-rajkot" },
  openGraph: {
    title: "5-Star Same-Day Expert Deep Freezer Repair Services Rajkot [2026 Updated] | Hitech Aircool Engineers",
    description: "Urgent deep freezer repair services Rajkot by certified technicians. ✅ Free diagnosis ✅ Genuine parts ✅ 6-month warranty. Residential & commercial service acros",
    url: "https://hitechairconditioning.in/deep-freezer-repair-services-rajkot",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "5-Star Same-Day Expert Deep Freezer Repair Services Rajkot [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagedeepfreezerrepairservicesrajkot() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">5-Star Same-Day Expert Deep Freezer Repair Services Rajkot [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Urgent deep freezer repair services Rajkot by certified technicians. ✅ Free diagnosis ✅ Genuine parts ✅ 6-month warranty. Residential &amp; commercial service across all areas. Call now!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Urgent deep freezer repair services Rajkot by certified technicians. ✅ Free diagnosis ✅ Genuine parts ✅ 6-month warranty. Residential &amp; commercial service across all areas. Call now!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVdeep freezer repair services rajkots?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial deep freezer repair services rajkot?", a: "Industrial deep freezer repair services rajkot costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVdeep freezer repair services rajkots?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial deep freezer repair services rajkot?", acceptedAnswer: { "@type": "Answer", text: "Industrial deep freezer repair services rajkot costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
