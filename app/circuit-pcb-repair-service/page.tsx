...
export const metadata: Metadata = {
  title: "Ac Circuit PCB Repair Service » Call Expert On +919328953665 [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Professional ac circuit pcb repair service » call expert on +919328953665 [2026 updated] by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/circuit-pcb-repair-service" },
  openGraph: {
    title: "Ac Circuit PCB Repair Service » Call Expert On +919328953665 [2026 Updated] | Hitech Aircool Engineers",
    description: "Professional ac circuit pcb repair service » call expert on +919328953665 [2026 updated] by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/circuit-pcb-repair-service",
    type: "website",
    images: ["/images/products/Circuit-PCB-Repair-Service.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Ac Circuit PCB Repair Service » Call Expert On +919328953665 [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagecircuitpcbrepairservice() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Ac Circuit PCB Repair Service » Call Expert On +919328953665 [2026 Updated]</h1>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Circuit-PCB-Repair-Service.webp" alt="Ac Circuit PCB Repair Service » Call Expert On +919328953665 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Ac Circuit PCB Repair Service » Call Expert On +919328953665 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Ac Circuit PCB Repair Service » Call Expert On +919328953665 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Circuit Pcb Repair Service in Vadodara?", a: "Circuit Pcb Repair Service cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Circuit Pcb Repair Service?", a: "Hitech Aircool Engineers offers same-day Circuit Pcb Repair Service across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Circuit Pcb Repair Services?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Circuit Pcb Repair Services depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Circuit Pcb Repair Service available on holidays?", a: "Yes, Hitech Aircool Engineers provides Circuit Pcb Repair Service 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Circuit Pcb Repair Service take?", a: "Most Circuit Pcb Repair Services are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Circuit Pcb Repair Service in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Circuit Pcb Repair Service cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Circuit Pcb Repair Service?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Circuit Pcb Repair Service across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Circuit Pcb Repair Services?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Circuit Pcb Repair Services depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Circuit Pcb Repair Service available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Circuit Pcb Repair Service 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Circuit Pcb Repair Service take?", acceptedAnswer: { "@type": "Answer", text: "Most Circuit Pcb Repair Services are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
