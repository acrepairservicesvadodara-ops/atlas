...
export default function Pagetopacserviceinvadodaraquickreliableaffor() {
  return (
    <>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Window-ac-repair-service.webp" alt="Top AC Service In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Window-ac-repair-service.webp" alt="Top AC Service In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Window-ac-service-center.webp" alt="Top AC Service In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
