...
export const metadata: Metadata = {
  title: "HVAC Contractor in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "HVAC contractor services in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "HVAC Contractor Vadodara",
    "hvac contractor",
    "HVAC Contractor installation",
    "HVAC Contractor service",
    "HVAC Contractor repair",
    "best HVAC Contractor service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/hvac-contractor-vadodara",
  },
};
...
const keywordData = {
  ...
  description: "HVAC contractor services",
  category: "Core"
};
  ...
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVhvac contractor vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial hvac contractor vadodara?", a: "Industrial hvac contractor vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVhvac contractor vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial hvac contractor vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial hvac contractor vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
