...
export const metadata: Metadata = {
  title: "AC Vibration Isolator in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Vibration isolator fitting in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC Vibration Isolator Vadodara",
    "ac vibration isolator",
    "AC Vibration Isolator installation",
    "AC Vibration Isolator service",
    "AC Vibration Isolator repair",
    "best AC Vibration Isolator service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-vibration-isolator-vadodara",
  },
};

const keywordData = {
  title: "AC Vibration Isolator",
  slug: "ac-vibration-isolator",
  description: "Vibration isolator fitting",
  category: "Parts"
};
...
export default function ACVibrationIsolatorPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What ac vibration isolator vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides ac vibration isolator vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book ac vibration isolator vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency ac vibration isolator vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What ac vibration isolator vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides ac vibration isolator vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book ac vibration isolator vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency ac vibration isolator vadodara available. Call +91 93289 53665 for immediate assistance." } },
