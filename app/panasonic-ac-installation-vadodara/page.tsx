...
export const metadata: Metadata = {
  title: "Panasonic AC Installation in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Panasonic AC installation in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Panasonic AC Installation Vadodara",
    "panasonic ac installation",
    "Panasonic AC Installation installation",
    "Panasonic AC Installation service",
    "Panasonic AC Installation repair",
    "best Panasonic AC Installation service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/panasonic-ac-installation-vadodara",
  },
};

const keywordData = {
  title: "Panasonic AC Installation",
  slug: "panasonic-ac-installation",
  description: "Panasonic AC installation",
  category: "Brands"
};
...
export default function PanasonicACInstallationPage() {
  return (
    <>
      {/* Hero Section */}
