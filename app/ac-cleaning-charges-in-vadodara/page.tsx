...
export const metadata: Metadata = {
  title: "AC Cleaning Charges In Vadodara | Professional HVAC Service | Atlas Aircon",
  description: "AC Cleaning Charges In Vadodara — Professional cleaning service by Atlas Aircon. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 97272 57141.",
  keywords: ["ac cleaning charges in vadodara", "cleaning service", "hvac service vadodara", "atlas aircon", "ac service gujarat"],
  alternates: { canonical: "https://atlasaircons.com/ac-cleaning-charges-in-vadodara" },
  openGraph: { title: "AC Cleaning Charges In Vadodara | Atlas Aircon", description: "Professional cleaning service by Atlas Aircon Gujarat.", url: "https://atlasaircons.com/ac-cleaning-charges-in-vadodara", type: "website" },
};
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                Professional cleaning service by Atlas Aircon / Hitech Aircool Engineers. Our certified technicians deliver expert cleaning solutions for all HVAC, refrigeration, and cooling equipment. Available across Vadodara, Gujarat &amp; all GIDC industrial zones.
              </p>
