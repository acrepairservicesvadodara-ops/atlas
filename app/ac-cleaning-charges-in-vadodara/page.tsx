...
export const metadata: Metadata = {
  title: "AC Cleaning Charges In Vadodara | Professional HVAC Service | Hitech Aircool Engineers",
  description: "AC Cleaning Charges In Vadodara — Professional cleaning service by Hitech Aircool Engineers. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 93289 53665.",
  keywords: ["ac cleaning charges in vadodara", "cleaning service", "hvac service vadodara", "hitech aircool engineers", "ac service gujarat"],
  alternates: { canonical: "https://hitechairconditioning.in/ac-cleaning-charges-in-vadodara" },
  openGraph: { title: "AC Cleaning Charges In Vadodara | Hitech Aircool Engineers", description: "Professional cleaning service by Hitech Aircool Engineers Gujarat.", url: "https://hitechairconditioning.in/ac-cleaning-charges-in-vadodara", type: "website" },
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "AC Cleaning Charges In Vadodara",
  provider: { "@type": "LocalBusiness", name: "Hitech Aircool Engineers", telephone: "+919328953665" },
  areaServed: { "@type": "State", name: "Gujarat" },
  serviceType: "AC Cleaning Charges In Vadodara",
};

export default function ACCleaningChargesInVadodaraPage() {
  return (
    <>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur px-4 py-2 rounded-full text-sm mb-6">
                <Wrench className="w-4 h-4" /><span>Cleaning</span>
              </div>
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">AC Cleaning Charges In Vadodara</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">
                Professional cleaning service by Hitech Aircool Engineers / Hitech Aircool Engineers. Our certified technicians deliver expert cleaning solutions for all HVAC, refrigeration, and cooling equipment. Available across Vadodara, Gujarat &amp; all GIDC industrial zones.
              </p>
            ...
            <div className="hidden md:block"><BookingForm title={"Book Cleaning Service"} /></div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <p className="text-gray-600">
              AC Cleaning Charges In Vadodara is one of the specialized services offered by Hitech Aircool Engineers / Hitech Aircool Engineers. With over 20 years of experience in the HVAC industry, we provide expert cleaning solutions that extend equipment life, improve efficiency, and reduce operating costs. Our team serves residential, commercial, and industrial clients across Gujarat.
            </p>
            <p className="text-gray-600">
              Our certified technicians use professional-grade equipment and genuine parts for every job. Whether it&apos;s a routine cleaning visit or an emergency call, we maintain the same high standards of quality and professionalism. All work is backed by our Hitech Aircool Engineers Service Guarantee for your complete peace of mind.
            </p>
            <p className="text-gray-600">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Ac Cleaning Charges In Vadodara include?", a: "Ac Cleaning Charges In Vadodara includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Ac Cleaning Charges In Vadodara cost?", a: "Ac Cleaning Charges In Vadodara starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Ac Cleaning Charges In Vadodara improve cooling?", a: "Yes, proper Ac Cleaning Charges In Vadodara can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Ac Cleaning Charges In Vadodara reduce electricity bills?", a: "Regular Ac Cleaning Charges In Vadodara can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Ac Cleaning Charges In Vadodara take?", a: "Basic Ac Cleaning Charges In Vadodara takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Ac Cleaning Charges In Vadodara remove bad smell?", a: "Yes, Ac Cleaning Charges In Vadodara includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Ac Cleaning Charges In Vadodara?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Ac Cleaning Charges In Vadodara include?", acceptedAnswer: { "@type": "Answer", text: "Ac Cleaning Charges In Vadodara includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Ac Cleaning Charges In Vadodara cost?", acceptedAnswer: { "@type": "Answer", text: "Ac Cleaning Charges In Vadodara starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Ac Cleaning Charges In Vadodara improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Ac Cleaning Charges In Vadodara can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Ac Cleaning Charges In Vadodara reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Ac Cleaning Charges In Vadodara can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Ac Cleaning Charges In Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Basic Ac Cleaning Charges In Vadodara takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Ac Cleaning Charges In Vadodara remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Ac Cleaning Charges In Vadodara includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Ac Cleaning Charges In Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
...
{/* CTA */}
      <section className="py-16 bg-teal-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Book Cleaning Service Now</h2>
