...
export const metadata: Metadata = {
  title: "AC Installation Ahmedabad | Hitech Aircool Engineers Gujarat",
  description: "Professional AC installation service in Ahmedabad. Get expert setup, timely repair, and maintenance for all brands. Free site survey. Call for best price & serv",
  alternates: { canonical: "https://hitechairconditioning.in/ac-installation-ahmedabad" },
  openGraph: {
    title: "AC Installation Ahmedabad | Hitech Aircool Engineers",
    description: "Professional AC installation service in Ahmedabad. Get expert setup, timely repair, and maintenance for all brands. Free site survey. Call for best price & serv",
    url: "https://hitechairconditioning.in/ac-installation-ahmedabad",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "AC Installation Ahmedabad",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageacinstallationahmedabad() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">AC Installation Ahmedabad</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Professional AC installation service in Ahmedabad. Get expert setup, timely repair, and maintenance for all brands. Free site survey. Call for best price &amp; service!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Professional AC installation service in Ahmedabad. Get expert setup, timely repair, and maintenance for all brands. Free site survey. Call for best price &amp; service!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/24X7-ac-repairing.webp" alt="AC Installation Ahmedabad" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="AC Installation Ahmedabad" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
