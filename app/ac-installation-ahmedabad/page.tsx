...
export const metadata: Metadata = {
  title: "AC Installation Ahmedabad | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-installation-ahmedabad" },
  openGraph: {
    title: "AC Installation Ahmedabad | Atlas Aircon",
    description: "Professional AC installation service in Ahmedabad. Get expert setup, timely repair, and maintenance for all brands. Free site survey. Call for best price & serv",
    url: "https://atlasaircons.com/ac-installation-ahmedabad",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Professional AC installation service in Ahmedabad. Get expert setup, timely repair, and maintenance for all brands. Free site survey. Call for best price &amp; service!</p>
