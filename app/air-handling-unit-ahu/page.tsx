...
export const metadata: Metadata = {
  title: "Excellent Standard Quality Air Handling Unit (ahu) | Atlas Aircon Gujarat",
  description: "Atlas Aircons™ High-Efficiency Air Handling Unit (AHU) - SKU: AT-BRC-1214 <img style=\"width: 100%; max-width: 600px; display: blo...",
  alternates: { canonical: "https://atlasaircons.com/air-handling-unit-ahu" },
  openGraph: {
    title: "Excellent Standard Quality Air Handling Unit (ahu) | Atlas Aircon",
    description: "Atlas Aircons™ High-Efficiency Air Handling Unit (AHU) - SKU: AT-BRC-1214 <img style=\"width: 100%; max-width: 600px; display: blo...",
    url: "https://atlasaircons.com/air-handling-unit-ahu",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Atlas Aircons™ High-Efficiency Air Handling Unit (AHU) - SKU: AT-BRC-1214 &lt;img style=&quot;width: 100%; max-width: 600px; display: blo...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Atlas Aircons™ High-Efficiency Air Handling Unit (AHU) - SKU: AT-BRC-1214 &lt;img style=&quot;width: 100%; max-width: 600px; display: blo...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVair handling unit ahus?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVair handling unit ahus?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
