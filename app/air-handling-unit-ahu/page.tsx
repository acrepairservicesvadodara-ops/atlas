...
export const metadata: Metadata = {
  title: "Excellent Standard Quality Air Handling Unit (ahu) | Hitech Aircool Engineers Gujarat",
  description: "Hitech Aircool Engineerss™ High-Efficiency Air Handling Unit (AHU) - SKU: AT-BRC-1214 <img style=\"width: 100%; max-width: 600px; display: blo...",
  alternates: { canonical: "https://hitechairconditioning.in/air-handling-unit-ahu" },
  openGraph: {
    title: "Excellent Standard Quality Air Handling Unit (ahu) | Hitech Aircool Engineers",
    description: "Hitech Aircool Engineerss™ High-Efficiency Air Handling Unit (AHU) - SKU: AT-BRC-1214 <img style=\"width: 100%; max-width: 600px; display: blo...",
    url: "https://hitechairconditioning.in/air-handling-unit-ahu",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Excellent Standard Quality Air Handling Unit (ahu)",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageairhandlingunitahu() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Excellent Standard Quality Air Handling Unit (ahu)</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Hitech Aircool Engineerss™ High-Efficiency Air Handling Unit (AHU) - SKU: AT-BRC-1214 &lt;img style=&quot;width: 100%; max-width: 600px; display: blo...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Hitech Aircool Engineerss™ High-Efficiency Air Handling Unit (AHU) - SKU: AT-BRC-1214 &lt;img style=&quot;width: 100%; max-width: 600px; display: blo...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/air-handling-units.webp" alt="Excellent Standard Quality Air Handling Unit (ahu)" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/air-handling-units.webp" alt="Excellent Standard Quality Air Handling Unit (ahu)" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/air-handling-unit.webp" alt="Excellent Standard Quality Air Handling Unit (ahu)" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/air-handling-units-manufactures.webp" alt="Excellent Standard Quality Air Handling Unit (ahu)" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/ahu-manufacturers-in-vadodara.webp" alt="Excellent Standard Quality Air Handling Unit (ahu)" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVair handling unit ahus?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial air handling unit ahu?", a: "Industrial air handling unit ahu costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVair handling unit ahus?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial air handling unit ahu?", acceptedAnswer: { "@type": "Answer", text: "Industrial air handling unit ahu costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
