...
export const metadata: Metadata = {
  title: "⚡ 7 Fast Air Cooler Repair Services Rajpipla | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/air-cooler-repair-services-rajpipla" },
  openGraph: {
    title: "⚡ 7 Fast Air Cooler Repair Services Rajpipla | Atlas Aircon",
    description: "Is your air cooler broken in Rajpipla's heat? Get same-day repair service for all brands. Expert technicians, affordable rates & 100% satisfaction guarantee. Ca",
    url: "https://atlasaircons.com/air-cooler-repair-services-rajpipla",
    type: "website",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Is your air cooler broken in Rajpipla&apos;s heat? Get same-day repair service for all brands. Expert technicians, affordable rates &amp; 100% satisfaction guarantee. Call now!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Air Cooler Repair Services Rajpipla in Vadodara?", a: "Air Cooler Repair Services Rajpipla cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Air Cooler Repair Services Rajpipla?", a: "Atlas Aircon offers same-day Air Cooler Repair Services Rajpipla across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Air Cooler Repair Services Rajpiplas?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Air Cooler Repair Services Rajpiplas depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Air Cooler Repair Services Rajpipla available on holidays?", a: "Yes, Atlas Aircon provides Air Cooler Repair Services Rajpipla 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Air Cooler Repair Services Rajpipla?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Air Cooler Repair Services Rajpipla across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Air Cooler Repair Services Rajpiplas?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Air Cooler Repair Services Rajpiplas depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Air Cooler Repair Services Rajpipla available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Air Cooler Repair Services Rajpipla 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
