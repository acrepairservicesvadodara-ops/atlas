...
export const metadata: Metadata = {
  title: "Urgent AC Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Urgent AC service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Urgent AC Repair Vadodara",
    "urgent ac repair",
    "Urgent AC Repair installation",
    "Urgent AC Repair service",
    "Urgent AC Repair repair",
    "best Urgent AC Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/urgent-ac-repair-vadodara",
  },
};

const keywordData = {
  title: "Urgent AC Repair",
  slug: "urgent-ac-repair",
  description: "Urgent AC service",
  category: "Emergency"
};
...
export default function UrgentACRepairPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Urgent Ac Repair Vadodara in Vadodara?", a: "Urgent Ac Repair Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Urgent Ac Repair Vadodara?", a: "Hitech Aircool Engineers offers same-day Urgent Ac Repair Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Urgent Ac Repair Vadodaras?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Urgent Ac Repair Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Urgent Ac Repair Vadodara available on holidays?", a: "Yes, Hitech Aircool Engineers provides Urgent Ac Repair Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Urgent Ac Repair Vadodara take?", a: "Most Urgent Ac Repair Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Urgent Ac Repair Vadodara in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Urgent Ac Repair Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Urgent Ac Repair Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Urgent Ac Repair Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Urgent Ac Repair Vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Urgent Ac Repair Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Urgent Ac Repair Vadodara available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Urgent Ac Repair Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Urgent Ac Repair Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Most Urgent Ac Repair Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
