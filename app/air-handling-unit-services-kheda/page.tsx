...
export const metadata: Metadata = {
  title: "Air Handling Unit Services Kheda | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/air-handling-unit-services-kheda" },
  openGraph: {
    title: "Air Handling Unit Services Kheda | Atlas Aircon",
    description: "Trusted Air Handling Unit Services Kheda. Expert repair, maintenance & installation for factories, cold storage & homes. Improve efficiency, ensure clean air & ",
    url: "https://atlasaircons.com/air-handling-unit-services-kheda",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Trusted Air Handling Unit Services Kheda. Expert repair, maintenance &amp; installation for factories, cold storage &amp; homes. Improve efficiency, ensure clean air &amp; reduce bills. Free Consultation Today!</p>
