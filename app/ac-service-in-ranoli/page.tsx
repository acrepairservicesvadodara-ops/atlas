...
export const metadata: Metadata = {
  title: "AC Service In Ranoli | Professional HVAC Service | Hitech Aircool Engineers",
  description: "AC Service In Ranoli — Professional service service by Hitech Aircool Engineers. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 93289 53665.",
  keywords: ["ac service in ranoli", "service service", "hvac service vadodara", "hitech aircool engineers", "ac service gujarat"],
  alternates: { canonical: "https://hitechairconditioning.in/ac-service-in-ranoli" },
  openGraph: { title: "AC Service In Ranoli | Hitech Aircool Engineers", description: "Professional service service by Hitech Aircool Engineers Gujarat.", url: "https://hitechairconditioning.in/ac-service-in-ranoli", type: "website" },
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "AC Service In Ranoli",
  provider: { "@type": "LocalBusiness", name: "Hitech Aircool Engineers", telephone: "+919328953665" },
  areaServed: { "@type": "State", name: "Gujarat" },
  serviceType: "AC Service In Ranoli",
};

export default function ACServiceInRanoliPage() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">AC Service In Ranoli</h1>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the best AC repair service in Ranoli?", a: "Hitech Aircool Engineers is rated 4.9★ for AC repair in Ranoli. Our certified technicians provide same-day service with 90-day warranty. Call +91 93289 53665." },
              { q: "What are your service charges in Ranoli?", a: "AC service charges are standard: inspection ₹299 (adjusted against repairs), basic service from ₹499, deep cleaning from ₹799. No area surcharges." },
              { q: "How quickly can you reach Ranoli?", a: "Our nearest technician can reach within 90 minutes to 3 hours depending on current workload. Emergencies are prioritized." },
              { q: "Do you have technicians in Ranoli?", a: "Yes, Hitech Aircool Engineers has servicemen positioned across Vadodara. This ensures faster response times for AC repair and service calls." },
              { q: "Is emergency AC service available in Ranoli?", a: "Yes, 24/7 emergency AC repair is available. Call +91 93289 53665 for immediate assistance with AC breakdown or cooling failures." },
              { q: "What AC problems are common in Ranoli?", a: "Common issues include gas leakage, water dripping, reduced cooling from dust, and electrical tripping. Regular maintenance prevents most issues." },
              { q: "Do you offer AMC for customers in Ranoli?", a: "Yes, AMC plans available from ₹1,999/year. Includes 2-4 free services, priority support, and discounted repairs." },
              { q: "Can you install new AC in Ranoli?", a: "Yes, professional AC installation available for all AC types — split, window, cassette, ductable. Includes copper piping and testing." },
              { q: "Do you service office ACs in Ranoli?", a: "Yes, we service commercial ACs in offices, shops, showrooms. We handle all types including VRF systems and ducted ACs." },
              { q: "Is service available on weekends in Ranoli?", a: "Yes, AC service available 7 days a week including Saturdays and Sundays. Book online or call +91 93289 53665." }
            ].map((faq, i) => (
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the best AC repair service in Ranoli?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers is rated 4.9★ for AC repair in Ranoli. Our certified technicians provide same-day service with 90-day warranty. Call +91 93289 53665." } },
          { "@type": "Question", name: "What are your service charges in Ranoli?", acceptedAnswer: { "@type": "Answer", text: "AC service charges are standard: inspection ₹299 (adjusted against repairs), basic service from ₹499, deep cleaning from ₹799. No area surcharges." } },
          { "@type": "Question", name: "How quickly can you reach Ranoli?", acceptedAnswer: { "@type": "Answer", text: "Our nearest technician can reach within 90 minutes to 3 hours depending on current workload. Emergencies are prioritized." } },
          { "@type": "Question", name: "Do you have technicians in Ranoli?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers has servicemen positioned across Vadodara. This ensures faster response times for AC repair and service calls." } },
          { "@type": "Question", name: "Is emergency AC service available in Ranoli?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency AC repair is available. Call +91 93289 53665 for immediate assistance with AC breakdown or cooling failures." } },
          { "@type": "Question", name: "What AC problems are common in Ranoli?", acceptedAnswer: { "@type": "Answer", text: "Common issues include gas leakage, water dripping, reduced cooling from dust, and electrical tripping. Regular maintenance prevents most issues." } },
          { "@type": "Question", name: "Do you offer AMC for customers in Ranoli?", acceptedAnswer: { "@type": "Answer", text: "Yes, AMC plans available from ₹1,999/year. Includes 2-4 free services, priority support, and discounted repairs." } },
          { "@type": "Question", name: "Can you install new AC in Ranoli?", acceptedAnswer: { "@type": "Answer", text: "Yes, professional AC installation available for all AC types — split, window, cassette, ductable. Includes copper piping and testing." } },
          { "@type": "Question", name: "Do you service office ACs in Ranoli?", acceptedAnswer: { "@type": "Answer", text: "Yes, we service commercial ACs in offices, shops, showrooms. We handle all types including VRF systems and ducted ACs." } },
          { "@type": "Question", name: "Is service available on weekends in Ranoli?", acceptedAnswer: { "@type": "Answer", text: "Yes, AC service available 7 days a week including Saturdays and Sundays. Book online or call +91 93289 53665." } }
        ]
      }) }} />
