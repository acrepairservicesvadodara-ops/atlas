...
export const metadata: Metadata = {
  title: "24/7 Geyser Repair In Vadodara | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/geyser-repair-vadodara-2" },
  openGraph: {
    title: "24/7 Geyser Repair In Vadodara | Atlas Aircon",
    description: "Need geyser repair in Vadodara? Our expert technicians provide same-day, doorstep service for all brands. Get a free estimate & genuine spare parts. Call for in",
    url: "https://atlasaircons.com/geyser-repair-vadodara-2",
    type: "website",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Need geyser repair in Vadodara? Our expert technicians provide same-day, doorstep service for all brands. Get a free estimate &amp; genuine spare parts. Call for instant help!</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/cropped-AtlasAircon-Logo.webp" alt="24/7 Geyser Repair In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Geyser Repair Vadodara 2 in Vadodara?", a: "Geyser Repair Vadodara 2 cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Geyser Repair Vadodara 2?", a: "Atlas Aircon offers same-day Geyser Repair Vadodara 2 across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Geyser Repair Vadodara 2s?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Geyser Repair Vadodara 2s depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Geyser Repair Vadodara 2 available on holidays?", a: "Yes, Atlas Aircon provides Geyser Repair Vadodara 2 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Geyser Repair Vadodara 2?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Geyser Repair Vadodara 2 across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Geyser Repair Vadodara 2s?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Geyser Repair Vadodara 2s depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Geyser Repair Vadodara 2 available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Geyser Repair Vadodara 2 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
