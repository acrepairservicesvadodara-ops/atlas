...
export const metadata: Metadata = {
  title: "24/7 Geyser Repair In Vadodara | Hitech Aircool Engineers Gujarat",
  description: "Need geyser repair in Vadodara? Our expert technicians provide same-day, doorstep service for all brands. Get a free estimate & genuine spare parts. Call for in",
  alternates: { canonical: "https://hitechairconditioning.in/geyser-repair-vadodara-2" },
  openGraph: {
    title: "24/7 Geyser Repair In Vadodara | Hitech Aircool Engineers",
    description: "Need geyser repair in Vadodara? Our expert technicians provide same-day, doorstep service for all brands. Get a free estimate & genuine spare parts. Call for in",
    url: "https://hitechairconditioning.in/geyser-repair-vadodara-2",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "24/7 Geyser Repair In Vadodara",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagegeyserrepairvadodara2() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">24/7 Geyser Repair In Vadodara</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Need geyser repair in Vadodara? Our expert technicians provide same-day, doorstep service for all brands. Get a free estimate &amp; genuine spare parts. Call for instant help!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Need geyser repair in Vadodara? Our expert technicians provide same-day, doorstep service for all brands. Get a free estimate &amp; genuine spare parts. Call for instant help!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/hitech-logo.webp" alt="24/7 Geyser Repair In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="24/7 Geyser Repair In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Geyser Repair Vadodara 2 in Vadodara?", a: "Geyser Repair Vadodara 2 cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Geyser Repair Vadodara 2?", a: "Hitech Aircool Engineers offers same-day Geyser Repair Vadodara 2 across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Geyser Repair Vadodara 2s?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Geyser Repair Vadodara 2s depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Geyser Repair Vadodara 2 available on holidays?", a: "Yes, Hitech Aircool Engineers provides Geyser Repair Vadodara 2 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Geyser Repair Vadodara 2 take?", a: "Most Geyser Repair Vadodara 2s are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Geyser Repair Vadodara 2 in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Geyser Repair Vadodara 2 cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Geyser Repair Vadodara 2?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Geyser Repair Vadodara 2 across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Geyser Repair Vadodara 2s?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Geyser Repair Vadodara 2s depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Geyser Repair Vadodara 2 available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Geyser Repair Vadodara 2 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Geyser Repair Vadodara 2 take?", acceptedAnswer: { "@type": "Answer", text: "Most Geyser Repair Vadodara 2s are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
