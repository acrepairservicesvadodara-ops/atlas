...
export const metadata: Metadata = {
  title: "Reliable Window AC Service Bharuch: Same-Day Repair & 60-Day Guarantee [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Expert window AC service, repair & gas filling in Bharuch. Our local technicians offer 24/7 emergency support with a 60-day service warranty. Free check-up avai",
  alternates: { canonical: "https://hitechairconditioning.in/window-ac-service-bharuch" },
  openGraph: {
    title: "Reliable Window AC Service Bharuch: Same-Day Repair & 60-Day Guarantee [2026 Updated] | Hitech Aircool Engineers",
    description: "Expert window AC service, repair & gas filling in Bharuch. Our local technicians offer 24/7 emergency support with a 60-day service warranty. Free check-up avai",
    url: "https://hitechairconditioning.in/window-ac-service-bharuch",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Reliable Window AC Service Bharuch: Same-Day Repair & 60-Day Guarantee [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagewindowacservicebharuch() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Reliable Window AC Service Bharuch: Same-Day Repair &amp; 60-Day Guarantee [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Expert window AC service, repair &amp; gas filling in Bharuch. Our local technicians offer 24/7 emergency support with a 60-day service warranty. Free check-up available!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Expert window AC service, repair &amp; gas filling in Bharuch. Our local technicians offer 24/7 emergency support with a 60-day service warranty. Free check-up available!</p>
          </div>
        </div>
      </section>
