...
export const metadata: Metadata = {
  title: "Reliable Window AC Service Bharuch: Same-Day Repair & 60-Day Guarantee [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/window-ac-service-bharuch" },
  openGraph: {
    title: "Reliable Window AC Service Bharuch: Same-Day Repair & 60-Day Guarantee [2026 Updated] | Atlas Aircon",
    description: "Expert window AC service, repair & gas filling in Bharuch. Our local technicians offer 24/7 emergency support with a 60-day service warranty. Free check-up avai",
    url: "https://atlasaircons.com/window-ac-service-bharuch",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert window AC service, repair &amp; gas filling in Bharuch. Our local technicians offer 24/7 emergency support with a 60-day service warranty. Free check-up available!</p>
