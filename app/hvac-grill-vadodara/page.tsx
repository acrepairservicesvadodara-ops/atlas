...
export const metadata: Metadata = {
  title: "HVAC Grill in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "HVAC grill installation in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "HVAC Grill Vadodara",
    "hvac grill",
    "HVAC Grill installation",
    "HVAC Grill service",
    "HVAC Grill repair",
    "best HVAC Grill service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/hvac-grill-vadodara",
  },
};
...
const keywordData = {
  title: "HVAC Grill",
  slug: "hvac-grill",
  description: "HVAC grill installation",
  category: "HVAC"
};
...
export default function HVACGrillPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVhvac grill vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial hvac grill vadodara?", a: "Industrial hvac grill vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVhvac grill vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial hvac grill vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial hvac grill vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
