...
export const metadata: Metadata = {
  title: "Service | Atlas Aircon Gujarat",
  description: "Atlas Aircon - Vadodara's trusted AC repair & HVAC service company. Professional air conditioning solutions across Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/locations.kml" },
  openGraph: {
    title: "Service | Atlas Aircon",
    description: "Atlas Aircon - Vadodara's trusted AC repair & HVAC service company. Professional air conditioning solutions across Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/locations.kml",
    type: "website",
...
export default function Pagelocationskml() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Service</h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Professional HVAC service by Atlas Aircon. Certified technicians, genuine parts, same-day service across Vadodara and Gujarat.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Professional HVAC and air conditioning service by Atlas Aircon. Our certified engineers serve Vadodara and all of Gujarat with 20+ years of hands-on experience.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What locations.kmls does Atlas Aircon provide?", a: "Atlas Aircon provides locations.kml, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book locations.kml?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency locations.kml available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What locations.kmls does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides locations.kml, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book locations.kml?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency locations.kml available. Call +91 97272 57141 for immediate assistance." } },
