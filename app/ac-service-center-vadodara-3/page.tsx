...
export const metadata: Metadata = {
  title: "Premium AC Service Center » Certified AC Repair In Vadodara [2026 Updated] | Atlas Aircon Gujarat",
  description: "Professional premium ac service center » certified ac repair in vadodara [2026 updated] by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/ac-service-center-vadodara-3" },
  openGraph: {
    title: "Premium AC Service Center » Certified AC Repair In Vadodara [2026 Updated] | Atlas Aircon",
    description: "Professional premium ac service center » certified ac repair in vadodara [2026 updated] by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/ac-service-center-vadodara-3",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">&lt;/...</p>
