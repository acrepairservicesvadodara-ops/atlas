...
export const metadata: Metadata = {
  title: "PPR Piping HVAC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "PPR piping for HVAC in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "PPR Piping HVAC Vadodara",
    "ppr piping hvac",
    "PPR Piping HVAC installation",
    "PPR Piping HVAC service",
    "PPR Piping HVAC repair",
    "best PPR Piping HVAC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ppr-piping-hvac-vadodara",
  },
};

const keywordData = {
  title: "PPR Piping HVAC",
  slug: "ppr-piping-hvac",
  description: "PPR piping for HVAC",
  category: "HVAC"
};
...
export default function PPRPipingHVACPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVppr piping hvac vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial ppr piping hvac vadodara?", a: "Industrial ppr piping hvac vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVppr piping hvac vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial ppr piping hvac vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial ppr piping hvac vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
