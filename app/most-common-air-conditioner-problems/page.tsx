...
export const metadata: Metadata = {
  title: "Most Common Air Conditioner Problems | Atlas Aircon Blog",
  ...
  alternates: { canonical: "https://atlasaircons.com/most-common-air-conditioner-problems" },
  openGraph: {
    title: "Most Common Air Conditioner Problems | Atlas Aircon",
    description: "The summer months are not the time to suffer from common AC issues within Vadodara, Gujarat. Although we may not be the acride...",
    url: "https://atlasaircons.com/most-common-air-conditioner-problems",
    type: "article",
...
const jsonLd = {
  ...
  mainEntityOfPage: "https://atlasaircons.com/most-common-air-conditioner-problems",
  ...
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What most common air conditioner problemss does Atlas Aircon provide?", a: "Atlas Aircon provides most common air conditioner problems, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book most common air conditioner problems?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency most common air conditioner problems available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What most common air conditioner problemss does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides most common air conditioner problems, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book most common air conditioner problems?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency most common air conditioner problems available. Call +91 97272 57141 for immediate assistance." } },
