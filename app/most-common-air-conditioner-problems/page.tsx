...
export const metadata: Metadata = {
  title: "Most Common Air Conditioner Problems | Hitech Aircool Engineers Blog",
  description: "The summer months are not the time to suffer from common AC issues within Vadodara, Gujarat. Although we may not be the acride...",
  alternates: { canonical: "https://hitechairconditioning.in/most-common-air-conditioner-problems" },
  openGraph: {
    title: "Most Common Air Conditioner Problems | Hitech Aircool Engineers",
    description: "The summer months are not the time to suffer from common AC issues within Vadodara, Gujarat. Although we may not be the acride...",
    url: "https://hitechairconditioning.in/most-common-air-conditioner-problems",
    type: "article",
    images: ["/images/products/Most-Common-AC-Problems-Require-Repair.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Article",
  headline: "Most Common Air Conditioner Problems",
  ...
  mainEntityOfPage: "https://hitechairconditioning.in/most-common-air-conditioner-problems",
  image: "/images/products/Most-Common-AC-Problems-Require-Repair.webp",
};

export default function Pagemostcommonairconditionerproblems() {
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-gray-900 via-gray-800 to-teal-900 text-white py-12 md:py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">Most Common Air Conditioner Problems</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <img src="/images/products/Most-Common-AC-Problems-Require-Repair.webp" alt="Most Common Air Conditioner Problems" className="w-full h-auto rounded-xl mb-8" />
            <p className="text-gray-600 mb-4">The summer months are not the time to suffer from common AC issues within Vadodara, Gujarat. Although we may not be the acride...</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What most common air conditioner problemss does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides most common air conditioner problems, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book most common air conditioner problems?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency most common air conditioner problems available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What most common air conditioner problemss does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides most common air conditioner problems, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book most common air conditioner problems?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency most common air conditioner problems available. Call +91 93289 53665 for immediate assistance." } },
