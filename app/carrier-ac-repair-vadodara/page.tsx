...
export const metadata: Metadata = {
  title: "Carrier AC Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Carrier AC repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Carrier AC Repair Vadodara",
    "carrier ac repair",
    "Carrier AC Repair installation",
    "Carrier AC Repair service",
    "Carrier AC Repair repair",
    "best Carrier AC Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/carrier-ac-repair-vadodara",
  },
};

const keywordData = {
  title: "Carrier AC Repair",
  slug: "carrier-ac-repair",
  description: "Carrier AC repair",
  category: "Brands"
};
