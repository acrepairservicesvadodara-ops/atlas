...
export const metadata: Metadata = {
  title: "Fast Refrigerator Repair In Vadodara | Atlas Aircon Gujarat",
  description: "Professional fast refrigerator repair in vadodara by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/fast-refrigerator-repair-in-vadodara" },
  openGraph: {
    title: "Fast Refrigerator Repair In Vadodara | Atlas Aircon",
    description: "Professional fast refrigerator repair in vadodara by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/fast-refrigerator-repair-in-vadodara",
    type: "website",
    ...
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Fast Refrigerator Repair In Vadodara in Vadodara?", a: "Fast Refrigerator Repair In Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Fast Refrigerator Repair In Vadodara?", a: "Atlas Aircon offers same-day Fast Refrigerator Repair In Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Fast Refrigerator Repair In Vadodaras?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Fast Refrigerator Repair In Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Fast Refrigerator Repair In Vadodara available on holidays?", a: "Yes, Atlas Aircon provides Fast Refrigerator Repair In Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Fast Refrigerator Repair In Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Fast Refrigerator Repair In Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Fast Refrigerator Repair In Vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Fast Refrigerator Repair In Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Fast Refrigerator Repair In Vadodara available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Fast Refrigerator Repair In Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
