...
export const metadata: Metadata = {
  title: "Walk In Cooler in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Walk in cooler repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Walk In Cooler Vadodara",
    "walk in cooler",
    "Walk In Cooler installation",
    "Walk In Cooler service",
    "Walk In Cooler repair",
    "best Walk In Cooler service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/walk-in-cooler-vadodara",
  },
};
...
const keywordData = {
  ...
  slug: "walk-in-cooler",
  description: "Walk in cooler repair",
  category: "Commercial"
};
...
export default function WalkInCoolerPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVwalk in cooler vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial walk in cooler vadodara?", a: "Industrial walk in cooler vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVwalk in cooler vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial walk in cooler vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial walk in cooler vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
