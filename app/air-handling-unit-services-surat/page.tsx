...
export const metadata: Metadata = {
  title: "Air Handling Unit Services Surat | Hitech Aircool Engineers Gujarat",
  description: "Expert Air Handling Unit Services in Surat. Specialized AHU repair & maintenance for textile mills, diamond units & commercial hubs. Ensure precision air qualit",
  alternates: { canonical: "https://hitechairconditioning.in/air-handling-unit-services-surat" },
  openGraph: {
    title: "Air Handling Unit Services Surat | Hitech Aircool Engineers",
    description: "Expert Air Handling Unit Services in Surat. Specialized AHU repair & maintenance for textile mills, diamond units & commercial hubs. Ensure precision air qualit",
    url: "https://hitechairconditioning.in/air-handling-unit-services-surat",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Air Handling Unit Services Surat",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageairhandlingunitservicessurat() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Air Handling Unit Services Surat</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Expert Air Handling Unit Services in Surat. Specialized AHU repair &amp; maintenance for textile mills, diamond units &amp; commercial hubs. Ensure precision air quality, reduce downtime &amp; save energy. Call Now!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Expert Air Handling Unit Services in Surat. Specialized AHU repair &amp; maintenance for textile mills, diamond units &amp; commercial hubs. Ensure precision air quality, reduce downtime &amp; save energy. Call Now!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/air-handling-units.webp" alt="Air Handling Unit Services Surat" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Air Handling Unit Services Surat" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Air Handling Unit Services Surat include?", a: "Air Handling Unit Services Surat includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Air Handling Unit Services Surat cost?", a: "Air Handling Unit Services Surat starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Air Handling Unit Services Surat improve cooling?", a: "Yes, proper Air Handling Unit Services Surat can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Air Handling Unit Services Surat reduce electricity bills?", a: "Regular Air Handling Unit Services Surat can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Air Handling Unit Services Surat take?", a: "Basic Air Handling Unit Services Surat takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Air Handling Unit Services Surat remove bad smell?", a: "Yes, Air Handling Unit Services Surat includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Air Handling Unit Services Surat?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Air Handling Unit Services Surat include?", acceptedAnswer: { "@type": "Answer", text: "Air Handling Unit Services Surat includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Air Handling Unit Services Surat cost?", acceptedAnswer: { "@type": "Answer", text: "Air Handling Unit Services Surat starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Air Handling Unit Services Surat improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Air Handling Unit Services Surat can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Air Handling Unit Services Surat reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Air Handling Unit Services Surat can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Air Handling Unit Services Surat take?", acceptedAnswer: { "@type": "Answer", text: "Basic Air Handling Unit Services Surat takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Air Handling Unit Services Surat remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Air Handling Unit Services Surat includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Air Handling Unit Services Surat?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
