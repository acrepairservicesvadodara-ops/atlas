...
export const metadata: Metadata = {
  title: "Air Handling Unit Services Surat | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/air-handling-unit-services-surat" },
  openGraph: {
    title: "Air Handling Unit Services Surat | Atlas Aircon",
    description: "Expert Air Handling Unit Services in Surat. Specialized AHU repair & maintenance for textile mills, diamond units & commercial hubs. Ensure precision air qualit",
    url: "https://atlasaircons.com/air-handling-unit-services-surat",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert Air Handling Unit Services in Surat. Specialized AHU repair &amp; maintenance for textile mills, diamond units &amp; commercial hubs. Ensure precision air quality, reduce downtime &amp; save energy. Call Now!</p>
