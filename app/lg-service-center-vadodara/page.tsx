...
export const metadata: Metadata = {
  title: "LG Service Center in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "LG AC service center in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "LG Service Center Vadodara",
    "lg service center",
    "LG Service Center installation",
    "LG Service Center service",
    "LG Service Center repair",
    "best LG Service Center service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/lg-service-center-vadodara",
  },
};
...
const keywordData = {
  ...
  description: "LG AC service center",
  category: "Brands"
};
...
export default function LGServiceCenterPage() {
  return (
    <>
      {/* Hero Section */}
