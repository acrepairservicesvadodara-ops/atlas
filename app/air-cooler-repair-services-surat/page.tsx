...
export const metadata: Metadata = {
  title: "🔥 #1 Air Cooler Repair Services Surat | Hitech Aircool Engineers Gujarat",
  description: "Broken air cooler in Surat's heat? Get same-day repair service for all brands. Expert technicians, affordable rates & 100% satisfaction guarantee. Emergency ser",
  alternates: { canonical: "https://hitechairconditioning.in/air-cooler-repair-services-surat" },
  openGraph: {
    title: "🔥 #1 Air Cooler Repair Services Surat | Hitech Aircool Engineers",
    description: "Broken air cooler in Surat's heat? Get same-day repair service for all brands. Expert technicians, affordable rates & 100% satisfaction guarantee. Emergency ser",
    url: "https://hitechairconditioning.in/air-cooler-repair-services-surat",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "🔥 #1 Air Cooler Repair Services Surat",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageaircoolerrepairservicessurat() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">🔥 #1 Air Cooler Repair Services Surat</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Broken air cooler in Surat&apos;s heat? Get same-day repair service for all brands. Expert technicians, affordable rates &amp; 100% satisfaction guarantee. Emergency service available!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Broken air cooler in Surat&apos;s heat? Get same-day repair service for all brands. Expert technicians, affordable rates &amp; 100% satisfaction guarantee. Emergency service available!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/water-cooler-repair-service.webp" alt="🔥 #1 Air Cooler Repair Services Surat" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="🔥 #1 Air Cooler Repair Services Surat" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Air Cooler Repair Services Surat in Vadodara?", a: "Air Cooler Repair Services Surat cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Air Cooler Repair Services Surat?", a: "Hitech Aircool Engineers offers same-day Air Cooler Repair Services Surat across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Air Cooler Repair Services Surats?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Air Cooler Repair Services Surats depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Air Cooler Repair Services Surat available on holidays?", a: "Yes, Hitech Aircool Engineers provides Air Cooler Repair Services Surat 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Air Cooler Repair Services Surat take?", a: "Most Air Cooler Repair Services Surats are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Air Cooler Repair Services Surat in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Air Cooler Repair Services Surat cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Air Cooler Repair Services Surat?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Air Cooler Repair Services Surat across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Air Cooler Repair Services Surats?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Air Cooler Repair Services Surats depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Air Cooler Repair Services Surat available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Air Cooler Repair Services Surat 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Air Cooler Repair Services Surat take?", acceptedAnswer: { "@type": "Answer", text: "Most Air Cooler Repair Services Surats are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
