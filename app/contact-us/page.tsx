...
export const metadata: Metadata = {
  title: "Contact AC Repair In Vadodara Gujarat [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Best AC Repair Service Provider in Gujarat, leading air conditioner repairing service center. High quality ac repair service. 100% satisfaction guranteed.",
  alternates: { canonical: "https://hitechairconditioning.in/contact-us" },
  openGraph: {
    title: "Contact AC Repair In Vadodara Gujarat [2026 Updated] | Hitech Aircool Engineers",
    description: "Best AC Repair Service Provider in Gujarat, leading air conditioner repairing service center. High quality ac repair service. 100% satisfaction guranteed.",
    url: "https://hitechairconditioning.in/contact-us",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Contact AC Repair In Vadodara Gujarat [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Contact AC Repair In Vadodara Gujarat [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Best AC Repair Service Provider in Gujarat, leading air conditioner repairing service center. High quality ac repair service. 100% satisfaction guranteed.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Best AC Repair Service Provider in Gujarat, leading air conditioner repairing service center. High quality ac repair service. 100% satisfaction guranteed.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What contact uss does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides contact us, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book contact us?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency contact us available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What contact uss does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides contact us, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book contact us?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency contact us available. Call +91 93289 53665 for immediate assistance." } },
