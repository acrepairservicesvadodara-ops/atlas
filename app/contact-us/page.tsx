...
export const metadata: Metadata = {
  title: "Contact AC Repair In Vadodara Gujarat [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/contact-us" },
  openGraph: {
    title: "Contact AC Repair In Vadodara Gujarat [2026 Updated] | Atlas Aircon",
    description: "Best AC Repair Service Provider in Gujarat, leading air conditioner repairing service center. High quality ac repair service. 100% satisfaction guranteed.",
    url: "https://atlasaircons.com/contact-us",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Best AC Repair Service Provider in Gujarat, leading air conditioner repairing service center. High quality ac repair service. 100% satisfaction guranteed.</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What contact uss does Atlas Aircon provide?", a: "Atlas Aircon provides contact us, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book contact us?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency contact us available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What contact uss does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides contact us, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book contact us?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency contact us available. Call +91 97272 57141 for immediate assistance." } },
