...
export const metadata: Metadata = {
  title: "Fast 24/7 Split AC Repair & Service In Bharuch | Hitech Aircool Engineers Gujarat",
  description: "Expert split AC service in Bharuch for Daikin, Voltas & more. Emergency repair, gas refill, installation & genuine spare parts. Same-day service available. Call",
  alternates: { canonical: "https://hitechairconditioning.in/split-ac-service-bharuch" },
  openGraph: {
    title: "Fast 24/7 Split AC Repair & Service In Bharuch | Hitech Aircool Engineers",
    description: "Expert split AC service in Bharuch for Daikin, Voltas & more. Emergency repair, gas refill, installation & genuine spare parts. Same-day service available. Call",
    url: "https://hitechairconditioning.in/split-ac-service-bharuch",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Fast 24/7 Split AC Repair & Service In Bharuch",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagesplitacservicebharuch() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Fast 24/7 Split AC Repair &amp; Service In Bharuch</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Expert split AC service in Bharuch for Daikin, Voltas &amp; more. Emergency repair, gas refill, installation &amp; genuine spare parts. Same-day service available. Call now!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Expert split AC service in Bharuch for Daikin, Voltas &amp; more. Emergency repair, gas refill, installation &amp; genuine spare parts. Same-day service available. Call now!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/Split-Air-Conditioner.webp" alt="Fast 24/7 Split AC Repair & Service In Bharuch" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Fast 24/7 Split AC Repair & Service In Bharuch" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
