...
export const metadata: Metadata = {
  title: "Fast 24/7 Split AC Repair & Service In Bharuch | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/split-ac-service-bharuch" },
  openGraph: {
    title: "Fast 24/7 Split AC Repair & Service In Bharuch | Atlas Aircon",
    description: "Expert split AC service in Bharuch for Daikin, Voltas & more. Emergency repair, gas refill, installation & genuine spare parts. Same-day service available. Call",
    url: "https://atlasaircons.com/split-ac-service-bharuch",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert split AC service in Bharuch for Daikin, Voltas &amp; more. Emergency repair, gas refill, installation &amp; genuine spare parts. Same-day service available. Call now!</p>
