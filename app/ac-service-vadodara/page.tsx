...
export const metadata: Metadata = {
  title: "⭐ AC Service Vadodara | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-vadodara" },
  openGraph: {
    title: "⭐ AC Service Vadodara | Atlas Aircon",
    description: "Get 5-star AC service in Vadodara! Professional maintenance, repair & AMC plans from Baroda's most trusted technicians. Free check-up & genuine parts guarantee.",
    url: "https://atlasaircons.com/ac-service-vadodara",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Get 5-star AC service in Vadodara! Professional maintenance, repair &amp; AMC plans from Baroda&apos;s most trusted technicians. Free check-up &amp; genuine parts guarantee. Call!</p>
