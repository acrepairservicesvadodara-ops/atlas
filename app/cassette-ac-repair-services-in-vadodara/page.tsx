...
export const metadata: Metadata = {
  title: "Cassette AC Repair Services In Vadodara | Atlas Aircon Gujarat",
  description: "Professional cassette ac repair services in vadodara by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/cassette-ac-repair-services-in-vadodara" },
  openGraph: {
    title: "Cassette AC Repair Services In Vadodara | Atlas Aircon",
    description: "Professional cassette ac repair services in vadodara by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/cassette-ac-repair-services-in-vadodara",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">&lt;script src=&quot;https://kit.fontawesome.com/...</p>
