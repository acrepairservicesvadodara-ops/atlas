...
export const metadata: Metadata = {
  title: "Cassette AC Repair Services In Vadodara | Hitech Aircool Engineers Gujarat",
  description: "Professional cassette ac repair services in vadodara by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/cassette-ac-repair-services-in-vadodara" },
  openGraph: {
    title: "Cassette AC Repair Services In Vadodara | Hitech Aircool Engineers",
    description: "Professional cassette ac repair services in vadodara by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/cassette-ac-repair-services-in-vadodara",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Cassette AC Repair Services In Vadodara",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagecassetteacrepairservicesinvadodara() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Cassette AC Repair Services In Vadodara</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">&lt;script src=&quot;https://kit.fontawesome.com/...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">&lt;script src=&quot;https://kit.fontawesome.com/...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Cassette-AC-Repair-Service-Vadodara.webp" alt="Cassette AC Repair Services In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Cassette AC Repair Services In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Cassette AC Repair Services In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
