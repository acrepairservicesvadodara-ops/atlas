...
export default function Pagecarrieracinstallationandrepairservice() {
  return (
    <>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Expert Carrier AC Installation and Repair Service Provider | Stay Cool All Year Round with Carrier AC Services | Maximizing Your Comfort wit...</p>
          </div>
        </div>
      </section>
