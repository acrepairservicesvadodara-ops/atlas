...
export const metadata: Metadata = {
  title: "Same-Day Water Cooler Repair Services Surat | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/water-cooler-repair-services-surat" },
  openGraph: {
    title: "Same-Day Water Cooler Repair Services Surat | Atlas Aircon",
    description: "Expert water cooler repair & service in Surat. Certified technicians fix not cooling, leaks & all faults at your home. Free diagnosis, AMC plans & genuine spare",
    url: "https://atlasaircons.com/water-cooler-repair-services-surat",
    type: "website",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert water cooler repair &amp; service in Surat. Certified technicians fix not cooling, leaks &amp; all faults at your home. Free diagnosis, AMC plans &amp; genuine spare parts. Book online or call for urgent service! Water Cooler Repair services Surat</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Water Cooler Repair Services Surat in Vadodara?", a: "Water Cooler Repair Services Surat cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Water Cooler Repair Services Surat?", a: "Atlas Aircon offers same-day Water Cooler Repair Services Surat across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Water Cooler Repair Services Surats?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Water Cooler Repair Services Surats depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Water Cooler Repair Services Surat available on holidays?", a: "Yes, Atlas Aircon provides Water Cooler Repair Services Surat 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "Is emergency Water Cooler Repair Services Surat available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Water Cooler Repair Services Surat 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
