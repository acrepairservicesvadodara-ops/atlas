...
export const metadata: Metadata = {
  title: "AC Fitting in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC installation service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC Fitting Vadodara",
    "ac fitting",
    ...
    "AC Fitting service",
    "AC Fitting repair",
    "best AC Fitting service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-fitting-vadodara",
  },
};
...
export default function ACFittingPage() {
  return (
    <>
      {/* Hero Section */}
