...
export const metadata: Metadata = {
  title: "Fast Refrigerated Truck Repair In Daman | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/refrigerated-truck-repair-daman" },
  openGraph: {
    title: "Fast Refrigerated Truck Repair In Daman | Atlas Aircon",
    description: "Need emergency reefer truck repair in Daman? We offer 24/7 mobile service, genuine parts & expert repair for all cold chain transport in Daman & Diu. Call now!",
    url: "https://atlasaircons.com/refrigerated-truck-repair-daman",
    type: "website",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Need emergency reefer truck repair in Daman? We offer 24/7 mobile service, genuine parts &amp; expert repair for all cold chain transport in Daman &amp; Diu. Call now!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Refrigerated Truck Repair Daman in Vadodara?", a: "Refrigerated Truck Repair Daman cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Refrigerated Truck Repair Daman?", a: "Atlas Aircon offers same-day Refrigerated Truck Repair Daman across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Refrigerated Truck Repair Damans?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Refrigerated Truck Repair Damans depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Refrigerated Truck Repair Daman available on holidays?", a: "Yes, Atlas Aircon provides Refrigerated Truck Repair Daman 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Refrigerated Truck Repair Daman?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Refrigerated Truck Repair Daman across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Refrigerated Truck Repair Damans?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Refrigerated Truck Repair Damans depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Refrigerated Truck Repair Daman available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Refrigerated Truck Repair Daman 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
