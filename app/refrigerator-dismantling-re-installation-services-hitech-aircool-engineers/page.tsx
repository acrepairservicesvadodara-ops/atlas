...
export const metadata: Metadata = {
  title: "Refrigerator Dismantling & Re-Installation Services | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "Moving a refrigerator, especially a built-in or commercial model, requires care. We disconnect power and water lines (if applicable), secure doors and i...",
  keywords: ["refrigerator dismantling & re-installation services | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "installation"],
  alternates: { canonical: "https://atlasaircons.com/refrigerator-dismantling-re-installation-services-hitech-aircool-engineers" },
  openGraph: {
    title: "Refrigerator Dismantling & Re-Installation Services | Hitech Aircool Engineers",
    description: "Moving a refrigerator, especially a built-in or commercial model, requires care. We disconnect power and water lines (if applicable), secure doors and i...",
    url: "https://atlasaircons.com/refrigerator-dismantling-re-installation-services-hitech-aircool-engineers",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Refrigerator Dismantling & Re-Installation Services | Hitech Aircool Engineers",
  description: "Moving a refrigerator, especially a built-in or commercial model, requires care. We disconnect power and water lines (if applicable), secure doors and internal components, and transport it upright to prevent compressor oil migration. At the new location, we level it, reconnect, and let it settle bef",
...
export default function Pagerefrigeratordismantlingreinstallationser() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  ...
                  alt="Refrigerator Dismantling & Re-Installation Services | Hitech Aircool Engineers"
                ...
                <img
                  ...
                  alt="Refrigerator Dismantling & Re-Installation Services | Hitech Aircool Engineers - Image 2"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Refrigerator Dismantling & Re-Installation Services | Hitech Aircool Engineers - Image 3"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Refrigerator Dismantling & Re-Installation Services | Hitech Aircool Engineers - Image 4"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Refrigerator Dismantling &amp; Re-Installation Services | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">Moving a refrigerator, especially a built-in or commercial model, requires care. We disconnect power and water lines (if applicable), secure doors and</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%20Refrigerator%20Dismantling%20%26%20Re-Installation%20Services%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Refrigerator Dismantling &amp; Re-Installation Services</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>Moving a refrigerator, especially a built-in or commercial model, requires care. We disconnect power and water lines (if applicable), secure doors and internal components, and transport it upright to prevent compressor oil migration. At the new location, we level it, reconnect, and let it settle before powering on.</p>
            </div>
