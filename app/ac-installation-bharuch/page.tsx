...
export const metadata: Metadata = {
  title: "AC Installation Bharuch | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-installation-bharuch" },
  openGraph: {
    title: "AC Installation Bharuch | Atlas Aircon",
    description: "Expert AC installation in Bharuch. Professional split & window AC fitting, gas charging & bracket fixing. Free site survey & best price guarantee. Call now!",
    url: "https://atlasaircons.com/ac-installation-bharuch",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert AC installation in Bharuch. Professional split &amp; window AC fitting, gas charging &amp; bracket fixing. Free site survey &amp; best price guarantee. Call now!</p>
