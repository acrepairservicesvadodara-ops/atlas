...
export const metadata: Metadata = {
  title: "Ultimate Guide: 5 Flawless AC Blower Motors | Hitech Aircool Engineers Gujarat",
  description: "Ultimate Guide: 5 Flawless AC Blower Motors - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/ac-blower-motor" },
  openGraph: {
    title: "Ultimate Guide: 5 Flawless AC Blower Motors | Hitech Aircool Engineers",
    description: "Ultimate Guide: 5 Flawless AC Blower Motors - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/ac-blower-motor",
    type: "website",
    images: ["/images/products/ac-blower-motor.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Ultimate Guide: 5 Flawless AC Blower Motors",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageacblowermotor() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Ultimate Guide: 5 Flawless AC Blower Motors</h1>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/ac-blower-motor.webp" alt="Ultimate Guide: 5 Flawless AC Blower Motors" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Ultimate Guide: 5 Flawless AC Blower Motors" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Ultimate Guide: 5 Flawless AC Blower Motors" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What ac blower motors does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides ac blower motor, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book ac blower motor?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency ac blower motor available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What ac blower motors does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides ac blower motor, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book ac blower motor?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency ac blower motor available. Call +91 93289 53665 for immediate assistance." } },
