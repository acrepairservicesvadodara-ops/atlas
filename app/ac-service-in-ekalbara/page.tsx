...
export const metadata: Metadata = {
  title: "AC Service & Repair in Ekalbara, Vadodara | Expert Technicians | Atlas Aircon",
  description: "Best AC service in Ekalbara, Vadodara. Professional AC repair, installation, gas refilling & deep cleaning. 24/7 emergency support. 1-year warranty. Starting \u20B9499. Call +91 97272 57141.",
  keywords: [
    "ac service ekalbara",
  ...
  alternates: {
    canonical: "https://atlasaircons.com/ac-service-in-ekalbara",
  },
  openGraph: {
    title: "AC Service & Repair in Ekalbara | Atlas Aircon Vadodara",
    description: "Professional AC repair, installation & maintenance in Ekalbara. 24/7 emergency service, 1-year warranty.",
    url: "https://atlasaircons.com/ac-service-in-ekalbara",
    type: "website",
  },
};
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "Do you provide 24/7 emergency AC repair in Ekalbara?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides round-the-clock emergency AC repair across Ekalbara and all of Vadodara. Our technicians can reach you within 45-60 minutes." } },
...
export default function ACServiceInEkalbaraPage() {
  return (
    <>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                Looking for reliable AC service in Ekalbara? Atlas Aircon delivers fast, professional AC repair, installation and maintenance for all brands.
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Why Ekalbara Residents Trust Atlas Aircon</h2>
