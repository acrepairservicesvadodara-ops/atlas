...
export const metadata: Metadata = {
  title: "Get Quick And Reliable Refrigerator Repairs At Your Doorstep [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Refrigerators are one of the most essential appliances in our homes and workplaces. When they break down, it can lead to food s...",
  alternates: { canonical: "https://hitechairconditioning.in/refrigerator-repairs-at-your-doorstep" },
  openGraph: {
    title: "Get Quick And Reliable Refrigerator Repairs At Your Doorstep [2026 Updated] | Hitech Aircool Engineers",
    description: "Refrigerators are one of the most essential appliances in our homes and workplaces. When they break down, it can lead to food s...",
    url: "https://hitechairconditioning.in/refrigerator-repairs-at-your-doorstep",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Get Quick And Reliable Refrigerator Repairs At Your Doorstep [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagerefrigeratorrepairsatyourdoorstep() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Get Quick And Reliable Refrigerator Repairs At Your Doorstep [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Refrigerators are one of the most essential appliances in our homes and workplaces. When they break down, it can lead to food s...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Refrigerators are one of the most essential appliances in our homes and workplaces. When they break down, it can lead to food s...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Atlas-Aircon-1.webp" alt="Get Quick And Reliable Refrigerator Repairs At Your Doorstep [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Get Quick And Reliable Refrigerator Repairs At Your Doorstep [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Get Quick And Reliable Refrigerator Repairs At Your Doorstep [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Walkin-Freezer-Repair-Service.webp" alt="Get Quick And Reliable Refrigerator Repairs At Your Doorstep [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Walkin-Freezer-Repair-Service.webp" alt="Get Quick And Reliable Refrigerator Repairs At Your Doorstep [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Walkin-Freezer-Repair-Service.webp" alt="Get Quick And Reliable Refrigerator Repairs At Your Doorstep [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Refrigerator Repairs At Your Doorstep in Vadodara?", a: "Refrigerator Repairs At Your Doorstep cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Refrigerator Repairs At Your Doorstep?", a: "Hitech Aircool Engineers offers same-day Refrigerator Repairs At Your Doorstep across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Refrigerator Repairs At Your Doorsteps?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Refrigerator Repairs At Your Doorsteps depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Refrigerator Repairs At Your Doorstep available on holidays?", a: "Yes, Hitech Aircool Engineers provides Refrigerator Repairs At Your Doorstep 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Refrigerator Repairs At Your Doorstep take?", a: "Most Refrigerator Repairs At Your Doorsteps are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Refrigerator Repairs At Your Doorstep in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Refrigerator Repairs At Your Doorstep cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Refrigerator Repairs At Your Doorstep?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Refrigerator Repairs At Your Doorstep across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Refrigerator Repairs At Your Doorsteps?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Refrigerator Repairs At Your Doorsteps depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Refrigerator Repairs At Your Doorstep available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Refrigerator Repairs At Your Doorstep 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Refrigerator Repairs At Your Doorstep take?", acceptedAnswer: { "@type": "Answer", text: "Most Refrigerator Repairs At Your Doorsteps are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
