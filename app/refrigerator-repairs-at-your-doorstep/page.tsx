...
export const metadata: Metadata = {
  title: "Get Quick And Reliable Refrigerator Repairs At Your Doorstep [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/refrigerator-repairs-at-your-doorstep" },
  openGraph: {
    title: "Get Quick And Reliable Refrigerator Repairs At Your Doorstep [2026 Updated] | Atlas Aircon",
    description: "Refrigerators are one of the most essential appliances in our homes and workplaces. When they break down, it can lead to food s...",
    url: "https://atlasaircons.com/refrigerator-repairs-at-your-doorstep",
    type: "website",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Refrigerators are one of the most essential appliances in our homes and workplaces. When they break down, it can lead to food s...</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Refrigerator Repairs At Your Doorstep in Vadodara?", a: "Refrigerator Repairs At Your Doorstep cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Refrigerator Repairs At Your Doorstep?", a: "Atlas Aircon offers same-day Refrigerator Repairs At Your Doorstep across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Refrigerator Repairs At Your Doorsteps?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Refrigerator Repairs At Your Doorsteps depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Refrigerator Repairs At Your Doorstep available on holidays?", a: "Yes, Atlas Aircon provides Refrigerator Repairs At Your Doorstep 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Refrigerator Repairs At Your Doorstep?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Refrigerator Repairs At Your Doorstep across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Refrigerator Repairs At Your Doorsteps?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Refrigerator Repairs At Your Doorsteps depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Refrigerator Repairs At Your Doorstep available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Refrigerator Repairs At Your Doorstep 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
