...
export const metadata: Metadata = {
  title: "AC Gas Refill Cost in Vadodara | Installation, Service & Repair | Atlas Aircon",
  description: "AC gas refilling charges in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 97272 57141",
  keywords: [
    "AC Gas Refill Cost Vadodara",
    "ac gas refill cost",
    "AC Gas Refill Cost installation",
    "AC Gas Refill Cost service",
    "AC Gas Refill Cost repair",
    "best AC Gas Refill Cost service",
  ],
  alternates: {
    canonical: "https://atlasaircons.com/ac-gas-refill-cost-vadodara",
  },
};

const keywordData = {
  title: "AC Gas Refill Cost",
  slug: "ac-gas-refill-cost",
  description: "AC gas refilling charges",
  category: "Core"
};
...
export default function ACGasRefillCostPage() {
  return (
    <>
      {/* Hero Section */}
