...
export default function Pageaircoolerrepairservicesnearme() {
  return (
    <>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Air Cooler Repair &amp; Services near me &lt;a style=&quot;font-size: 16px;&quot; href=&quot;https:/...</p>
          </div>
        </div>
      </section>
