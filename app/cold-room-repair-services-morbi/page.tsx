...
export const metadata: Metadata = {
  title: "Industrial Cold Room Repair Services Morbi: 0% Downtime! [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/cold-room-repair-services-morbi" },
  openGraph: {
    title: "Industrial Cold Room Repair Services Morbi: 0% Downtime! [2026 Updated] | Atlas Aircon",
    description: "Critical cold room repair services Morbi for ceramic, tile & sanitaryware manufacturing plants. Prevent production loss with our 24/7 emergency repair, industri",
    url: "https://atlasaircons.com/cold-room-repair-services-morbi",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Critical cold room repair services Morbi for ceramic, tile &amp; sanitaryware manufacturing plants. Prevent production loss with our 24/7 emergency repair, industrial AMC &amp; expert technicians. Call now!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVcold room repair services morbis?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVcold room repair services morbis?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
