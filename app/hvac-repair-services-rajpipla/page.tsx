...
export const metadata: Metadata = {
  title: "#1 HVAC Repair Services Rajpipla | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/hvac-repair-services-rajpipla" },
  openGraph: {
    title: "#1 HVAC Repair Services Rajpipla | Atlas Aircon",
    description: "Professional HVAC repair services Rajpipla with certified technicians. Get affordable AC, heating & ventilation solutions. 24/7 emergency support available!",
    url: "https://atlasaircons.com/hvac-repair-services-rajpipla",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Professional HVAC repair services Rajpipla with certified technicians. Get affordable AC, heating &amp; ventilation solutions. 24/7 emergency support available!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVhvac repair services rajpiplas?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVhvac repair services rajpiplas?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
