...
export const metadata: Metadata = {
  title: "#1 Washing Machine Repair Vadodara | Hitech Aircool Engineers Gujarat",
  description: "Fast & affordable washing machine repair Vadodara and dryer repair service in Vadodara. ✅ Same-Day Service for all brands like LG, Samsung, IFB, Bosch. Call +91",
  alternates: { canonical: "https://hitechairconditioning.in/washing-machine-repair-vadodara" },
  openGraph: {
    title: "#1 Washing Machine Repair Vadodara | Hitech Aircool Engineers",
    description: "Fast & affordable washing machine repair Vadodara and dryer repair service in Vadodara. ✅ Same-Day Service for all brands like LG, Samsung, IFB, Bosch. Call +91",
    url: "https://hitechairconditioning.in/washing-machine-repair-vadodara",
    type: "website",
    images: ["/images/products/Washing-Machine-Service.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "#1 Washing Machine Repair Vadodara",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagewashingmachinerepairvadodara() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">#1 Washing Machine Repair Vadodara</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Fast &amp; affordable washing machine repair Vadodara and dryer repair service in Vadodara. ✅ Same-Day Service for all brands like LG, Samsung, IFB, Bosch. Call +91-9328953665 for expert Top Load, Front Load, and Dryer repair.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Fast &amp; affordable washing machine repair Vadodara and dryer repair service in Vadodara. ✅ Same-Day Service for all brands like LG, Samsung, IFB, Bosch. Call +91-9328953665 for expert Top Load, Front Load, and Dryer repair.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Washing-Machine-Service.webp" alt="#1 Washing Machine Repair Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="#1 Washing Machine Repair Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Washing Machine Repair Vadodara in Vadodara?", a: "Washing Machine Repair Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Washing Machine Repair Vadodara?", a: "Hitech Aircool Engineers offers same-day Washing Machine Repair Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Washing Machine Repair Vadodaras?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Washing Machine Repair Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Washing Machine Repair Vadodara available on holidays?", a: "Yes, Hitech Aircool Engineers provides Washing Machine Repair Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Washing Machine Repair Vadodara take?", a: "Most Washing Machine Repair Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Washing Machine Repair Vadodara in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Washing Machine Repair Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Washing Machine Repair Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Washing Machine Repair Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Washing Machine Repair Vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Washing Machine Repair Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Washing Machine Repair Vadodara available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Washing Machine Repair Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Washing Machine Repair Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Most Washing Machine Repair Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
