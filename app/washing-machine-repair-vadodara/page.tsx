...
export const metadata: Metadata = {
  title: "#1 Washing Machine Repair Vadodara | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/washing-machine-repair-vadodara" },
  openGraph: {
    title: "#1 Washing Machine Repair Vadodara | Atlas Aircon",
    description: "Fast & affordable washing machine repair Vadodara and dryer repair service in Vadodara. ✅ Same-Day Service for all brands like LG, Samsung, IFB, Bosch. Call +91",
    url: "https://atlasaircons.com/washing-machine-repair-vadodara",
    type: "website",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Fast &amp; affordable washing machine repair Vadodara and dryer repair service in Vadodara. ✅ Same-Day Service for all brands like LG, Samsung, IFB, Bosch. Call +91-9727257141 for expert Top Load, Front Load, and Dryer repair.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Fast &amp; affordable washing machine repair Vadodara and dryer repair service in Vadodara. ✅ Same-Day Service for all brands like LG, Samsung, IFB, Bosch. Call +91-9727257141 for expert Top Load, Front Load, and Dryer repair.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Washing Machine Repair Vadodara in Vadodara?", a: "Washing Machine Repair Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Washing Machine Repair Vadodara?", a: "Atlas Aircon offers same-day Washing Machine Repair Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Washing Machine Repair Vadodaras?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Washing Machine Repair Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Washing Machine Repair Vadodara available on holidays?", a: "Yes, Atlas Aircon provides Washing Machine Repair Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Washing Machine Repair Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Washing Machine Repair Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Washing Machine Repair Vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Washing Machine Repair Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Washing Machine Repair Vadodara available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Washing Machine Repair Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
