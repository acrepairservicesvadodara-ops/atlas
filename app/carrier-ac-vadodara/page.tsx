...
export const metadata: Metadata = {
  title: "Carrier AC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Carrier AC service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Carrier AC Vadodara",
    "carrier ac",
  ...
  alternates: {
    canonical: "https://hitechairconditioning.in/carrier-ac-vadodara",
  },
};
...
const keywordData = {
  title: "Carrier AC",
  slug: "carrier-ac",
  description: "Carrier AC service",
  category: "Brands"
};
...
export default function CarrierACPage() {
  return (
    <>
      {/* Hero Section */}
