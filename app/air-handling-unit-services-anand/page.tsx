...
export const metadata: Metadata = {
  title: "Air Handling Unit Services Anand | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/air-handling-unit-services-anand" },
  openGraph: {
    title: "Air Handling Unit Services Anand | Atlas Aircon",
    description: "Professional Air Handling Unit Services in Anand. 24/7 repair, AMC, & installation for dairy, pharmaceutical & industrial plants. Maximize uptime, ensure hygien",
    url: "https://atlasaircons.com/air-handling-unit-services-anand",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Professional Air Handling Unit Services in Anand. 24/7 repair, AMC, &amp; installation for dairy, pharmaceutical &amp; industrial plants. Maximize uptime, ensure hygiene &amp; cut energy costs. Get a Free Audit!</p>
