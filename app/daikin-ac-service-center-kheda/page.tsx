...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "daikin ac service kheda",
    "daikin split ac repair kheda",
    "daikin ac gas charging kheda",
    "daikin ac pcb repair kheda",
    "daikin ac installation kheda",
    "daikin ac not cooling kheda",
...
export default function DaikinServiceCenterKhedaPage() {
  return (
    <>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">Daikin AC Repair Price List — Kheda</h2>
