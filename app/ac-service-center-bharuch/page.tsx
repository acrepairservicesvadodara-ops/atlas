...
export const metadata: Metadata = {
  title: "AC Service Center Bharuch | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-center-bharuch" },
  openGraph: {
    title: "AC Service Center Bharuch | Atlas Aircon",
    description: "Professional AC service center in Bharuch offering expert repair, maintenance & AMC plans. Certified technicians, genuine parts & same-day service. Visit our ce",
    url: "https://atlasaircons.com/ac-service-center-bharuch",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Professional AC service center in Bharuch offering expert repair, maintenance &amp; AMC plans. Certified technicians, genuine parts &amp; same-day service. Visit our center today!</p>
