...
export const metadata: Metadata = {
  title: "Data Center AC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Data center cooling in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Data Center AC Vadodara",
    "data center ac",
    "Data Center AC installation",
    "Data Center AC service",
    "Data Center AC repair",
    "best Data Center AC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/data-center-ac-vadodara",
  },
};

const keywordData = {
  title: "Data Center AC",
  slug: "data-center-ac",
...
export default function DataCenterACPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What data center ac vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides data center ac vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book data center ac vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency data center ac vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What data center ac vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides data center ac vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book data center ac vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency data center ac vadodara available. Call +91 93289 53665 for immediate assistance." } },
