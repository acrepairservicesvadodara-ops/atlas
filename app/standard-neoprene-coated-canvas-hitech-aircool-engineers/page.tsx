...
export const metadata: Metadata = {
  title: "Standard Neoprene Coated Canvas | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "Our most common canvas connector, featuring a strong fabric base coated with neoprene rubber. It offers good flexibility, moisture resistance, and durab...",
  keywords: ["standard neoprene coated canvas | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "duct accessories"],
  alternates: { canonical: "https://atlasaircons.com/standard-neoprene-coated-canvas-hitech-aircool-engineers" },
  openGraph: {
    title: "Standard Neoprene Coated Canvas | Hitech Aircool Engineers",
    description: "Our most common canvas connector, featuring a strong fabric base coated with neoprene rubber. It offers good flexibility, moisture resistance, and durab...",
    url: "https://atlasaircons.com/standard-neoprene-coated-canvas-hitech-aircool-engineers",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Standard Neoprene Coated Canvas | Hitech Aircool Engineers",
  description: "Our most common canvas connector, featuring a strong fabric base coated with neoprene rubber. It offers good flexibility, moisture resistance, and durability for general HVAC applications up to moderate temperatures (typically 250??F). Ideal for connecting supply/return air ducts to AHUs and fans in",
...
export default function Pagestandardneoprenecoatedcanvashitechaircoo() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  ...
                  alt="Standard Neoprene Coated Canvas | Hitech Aircool Engineers"
                ...
                <img
                  src="/images/products/Canvas-2-scaled-1.webp"
                  alt="Standard Neoprene Coated Canvas | Hitech Aircool Engineers - Image 2"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Standard Neoprene Coated Canvas | Hitech Aircool Engineers - Image 3"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Standard Neoprene Coated Canvas | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">Our most common canvas connector, featuring a strong fabric base coated with neoprene rubber. It offers good flexibility, moisture resistance, and dur</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%20Standard%20Neoprene%20Coated%20Canvas%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">airtight connections</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">AMC</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Duct Connections</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Flexible</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">General HVAC</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>Our most common canvas connector, featuring a strong fabric base coated with neoprene rubber. It offers good flexibility, moisture resistance, and durability for general HVAC applications up to moderate temperatures (typically 250??F). Ideal for connecting supply/return air ducts to AHUs and fans in commercial buildings.</p>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What standard neoprene coated canvas hitech aircool engineerss does Atlas Aircon provide?", a: "Atlas Aircon provides standard neoprene coated canvas hitech aircool engineers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book standard neoprene coated canvas hitech aircool engineers?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency standard neoprene coated canvas hitech aircool engineers available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What standard neoprene coated canvas hitech aircool engineerss does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides standard neoprene coated canvas hitech aircool engineers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book standard neoprene coated canvas hitech aircool engineers?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency standard neoprene coated canvas hitech aircool engineers available. Call +91 97272 57141 for immediate assistance." } },
