...
export const metadata: Metadata = {
  title: "Non Comprehensive AMC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Basic AC AMC in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Non Comprehensive AMC Vadodara",
    "non comprehensive amc",
    "Non Comprehensive AMC installation",
    "Non Comprehensive AMC service",
    "Non Comprehensive AMC repair",
    "best Non Comprehensive AMC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/non-comprehensive-amc-vadodara",
  },
};

const keywordData = {
  title: "Non Comprehensive AMC",
  slug: "non-comprehensive-amc",
  description: "Basic AC AMC",
...
export default function NonComprehensiveAMCPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Non Comprehensive Amc Vadodara include?", a: "Non Comprehensive Amc Vadodara includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Non Comprehensive Amc Vadodara cost?", a: "Non Comprehensive Amc Vadodara starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Non Comprehensive Amc Vadodara improve cooling?", a: "Yes, proper Non Comprehensive Amc Vadodara can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Non Comprehensive Amc Vadodara reduce electricity bills?", a: "Regular Non Comprehensive Amc Vadodara can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Non Comprehensive Amc Vadodara take?", a: "Basic Non Comprehensive Amc Vadodara takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Non Comprehensive Amc Vadodara remove bad smell?", a: "Yes, Non Comprehensive Amc Vadodara includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Non Comprehensive Amc Vadodara?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Non Comprehensive Amc Vadodara include?", acceptedAnswer: { "@type": "Answer", text: "Non Comprehensive Amc Vadodara includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Non Comprehensive Amc Vadodara cost?", acceptedAnswer: { "@type": "Answer", text: "Non Comprehensive Amc Vadodara starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Non Comprehensive Amc Vadodara improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Non Comprehensive Amc Vadodara can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Non Comprehensive Amc Vadodara reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Non Comprehensive Amc Vadodara can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Non Comprehensive Amc Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Basic Non Comprehensive Amc Vadodara takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Non Comprehensive Amc Vadodara remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Non Comprehensive Amc Vadodara includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Non Comprehensive Amc Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
