...
export const metadata: Metadata = {
  title: "AHU Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Air handling unit repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AHU Repair Vadodara",
    "ahu repair",
    "AHU Repair installation",
    "AHU Repair service",
    "AHU Repair repair",
    "best AHU Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ahu-repair-vadodara",
  },
};
...
const keywordData = {
  title: "AHU Repair",
  slug: "ahu-repair",
  description: "Air handling unit repair",
  category: "Commercial"
};
...
export default function AHURepairPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVahu repair vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial ahu repair vadodara?", a: "Industrial ahu repair vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVahu repair vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial ahu repair vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial ahu repair vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
