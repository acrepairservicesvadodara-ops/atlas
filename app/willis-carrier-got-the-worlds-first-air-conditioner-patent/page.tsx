...
export const metadata: Metadata = {
  title: "Willis Carrier Got The World's First Air Conditioner Patent [2026 Updated] | Hitech Aircool Engineers Blog",
  description: "Willis Carrier Got The World's First Air Conditioner Patent <img class=\"alignnone size-full wp-image-245\" src=\"https://atlasai...",
  alternates: { canonical: "https://hitechairconditioning.in/willis-carrier-got-the-worlds-first-air-conditioner-patent" },
  openGraph: {
    title: "Willis Carrier Got The World's First Air Conditioner Patent [2026 Updated] | Hitech Aircool Engineers",
    description: "Willis Carrier Got The World's First Air Conditioner Patent <img class=\"alignnone size-full wp-image-245\" src=\"https://atlasai...",
    url: "https://hitechairconditioning.in/willis-carrier-got-the-worlds-first-air-conditioner-patent",
    type: "article",
    images: ["/images/products/Willis-Carrier-Father-Of-Modern-Air-Conditioner.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Article",
  headline: "Willis Carrier Got The World's First Air Conditioner Patent [2026 Updated]",
  ...
  mainEntityOfPage: "https://hitechairconditioning.in/willis-carrier-got-the-worlds-first-air-conditioner-patent",
  image: "/images/products/Willis-Carrier-Father-Of-Modern-Air-Conditioner.webp",
};

export default function Pagewilliscarriergottheworldsfirstairconditi() {
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-gray-900 via-gray-800 to-teal-900 text-white py-12 md:py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">Willis Carrier Got The World&apos;s First Air Conditioner Patent [2026 Updated]</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <img src="/images/products/Willis-Carrier-Father-Of-Modern-Air-Conditioner.webp" alt="Willis Carrier Got The World's First Air Conditioner Patent [2026 Updated]" className="w-full h-auto rounded-xl mb-8" />
            <p className="text-gray-600 mb-4">Willis Carrier Got The World&apos;s First Air Conditioner Patent &lt;img class=&quot;alignnone size-full wp-image-245&quot; src=&quot;https://atlasai...</p>
