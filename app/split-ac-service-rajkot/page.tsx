...
export const metadata: Metadata = {
  title: "Expert Split AC Service & Repair In Rajkot | Hitech Aircool Engineers Gujarat",
  description: "Professional split AC service Rajkot for repair, gas refill & installation. Same-day service, genuine spare parts & certified technicians. Call now for free dia",
  alternates: { canonical: "https://hitechairconditioning.in/split-ac-service-rajkot" },
  openGraph: {
    title: "Expert Split AC Service & Repair In Rajkot | Hitech Aircool Engineers",
    description: "Professional split AC service Rajkot for repair, gas refill & installation. Same-day service, genuine spare parts & certified technicians. Call now for free dia",
    url: "https://hitechairconditioning.in/split-ac-service-rajkot",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Expert Split AC Service & Repair In Rajkot",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagesplitacservicerajkot() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Expert Split AC Service &amp; Repair In Rajkot</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Professional split AC service Rajkot for repair, gas refill &amp; installation. Same-day service, genuine spare parts &amp; certified technicians. Call now for free diagnosis!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Professional split AC service Rajkot for repair, gas refill &amp; installation. Same-day service, genuine spare parts &amp; certified technicians. Call now for free diagnosis!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/Split-Air-Conditioner.webp" alt="Expert Split AC Service & Repair In Rajkot" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Expert Split AC Service & Repair In Rajkot" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
