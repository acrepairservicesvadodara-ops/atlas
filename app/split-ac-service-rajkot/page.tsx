...
export const metadata: Metadata = {
  title: "Expert Split AC Service & Repair In Rajkot | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/split-ac-service-rajkot" },
  openGraph: {
    title: "Expert Split AC Service & Repair In Rajkot | Atlas Aircon",
    description: "Professional split AC service Rajkot for repair, gas refill & installation. Same-day service, genuine spare parts & certified technicians. Call now for free dia",
    url: "https://atlasaircons.com/split-ac-service-rajkot",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Professional split AC service Rajkot for repair, gas refill &amp; installation. Same-day service, genuine spare parts &amp; certified technicians. Call now for free diagnosis!</p>
