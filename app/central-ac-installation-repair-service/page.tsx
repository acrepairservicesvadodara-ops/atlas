...
export const metadata: Metadata = {
  title: "Keeping Cooling: Central AC Installation Repair Service [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "body { font-family: 'Inter', sans-serif; } ...",
  alternates: { canonical: "https://hitechairconditioning.in/central-ac-installation-repair-service" },
  openGraph: {
    title: "Keeping Cooling: Central AC Installation Repair Service [2026 Updated] | Hitech Aircool Engineers",
    description: "body { font-family: 'Inter', sans-serif; } ...",
    url: "https://hitechairconditioning.in/central-ac-installation-repair-service",
    type: "website",
    images: ["/images/products/Central-Ac-Installation-repair-service.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Keeping Cooling: Central AC Installation Repair Service [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagecentralacinstallationrepairservice() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Keeping Cooling: Central AC Installation Repair Service [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">body &#123; font-family: &apos;Inter&apos;, sans-serif; &#125; ...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">body &#123; font-family: &apos;Inter&apos;, sans-serif; &#125; ...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Central-Ac-Installation-repair-service.webp" alt="Keeping Cooling: Central AC Installation Repair Service [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Keeping Cooling: Central AC Installation Repair Service [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Keeping Cooling: Central AC Installation Repair Service [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
