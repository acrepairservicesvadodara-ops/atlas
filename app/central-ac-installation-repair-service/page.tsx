...
export const metadata: Metadata = {
  title: "Keeping Cooling: Central AC Installation Repair Service [2026 Updated] | Atlas Aircon Gujarat",
  description: "body { font-family: 'Inter', sans-serif; } ...",
  alternates: { canonical: "https://atlasaircons.com/central-ac-installation-repair-service" },
  openGraph: {
    title: "Keeping Cooling: Central AC Installation Repair Service [2026 Updated] | Atlas Aircon",
    description: "body { font-family: 'Inter', sans-serif; } ...",
    url: "https://atlasaircons.com/central-ac-installation-repair-service",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">body &#123; font-family: &apos;Inter&apos;, sans-serif; &#125; ...</p>
