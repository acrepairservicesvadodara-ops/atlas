...
export const metadata: Metadata = {
  title: "#1 Package AC Service Across Gujarat | Hitech Aircool Engineers Gujarat",
  description: "Gujarat's leading network for professional package AC installation, repair & maintenance. From Ahmedabad to Surat, we offer fast, reliable service with certifie",
  alternates: { canonical: "https://hitechairconditioning.in/package-ac-service-gujarat" },
  openGraph: {
    title: "#1 Package AC Service Across Gujarat | Hitech Aircool Engineers",
    description: "Gujarat's leading network for professional package AC installation, repair & maintenance. From Ahmedabad to Surat, we offer fast, reliable service with certifie",
    url: "https://hitechairconditioning.in/package-ac-service-gujarat",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "#1 Package AC Service Across Gujarat",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagepackageacservicegujarat() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">#1 Package AC Service Across Gujarat</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Gujarat&apos;s leading network for professional package AC installation, repair &amp; maintenance. From Ahmedabad to Surat, we offer fast, reliable service with certified technicians &amp; genuine parts. Get a quote!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Gujarat&apos;s leading network for professional package AC installation, repair &amp; maintenance. From Ahmedabad to Surat, we offer fast, reliable service with certified technicians &amp; genuine parts. Get a quote!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/package-ac-service-vadodara-near-me.webp" alt="#1 Package AC Service Across Gujarat" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="#1 Package AC Service Across Gujarat" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
