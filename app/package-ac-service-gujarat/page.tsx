...
export const metadata: Metadata = {
  title: "#1 Package AC Service Across Gujarat | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/package-ac-service-gujarat" },
  openGraph: {
    title: "#1 Package AC Service Across Gujarat | Atlas Aircon",
    description: "Gujarat's leading network for professional package AC installation, repair & maintenance. From Ahmedabad to Surat, we offer fast, reliable service with certifie",
    url: "https://atlasaircons.com/package-ac-service-gujarat",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Gujarat&apos;s leading network for professional package AC installation, repair &amp; maintenance. From Ahmedabad to Surat, we offer fast, reliable service with certified technicians &amp; genuine parts. Get a quote!</p>
