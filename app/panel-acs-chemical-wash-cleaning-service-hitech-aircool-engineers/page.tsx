...
export const metadata: Metadata = {
  title: "Panel Acs Chemical Wash Cleaning Service | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "Ceiling cassette ACs accumulate dust in their hidden evaporators and drain pans. Our chemical wash involves carefully accessing the unit, applying clean...",
  keywords: ["panel acs chemical wash cleaning service | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "cleaning"],
  alternates: { canonical: "https://atlasaircons.com/panel-acs-chemical-wash-cleaning-service-hitech-aircool-engineers" },
  openGraph: {
    title: "Panel Acs Chemical Wash Cleaning Service | Hitech Aircool Engineers",
    description: "Ceiling cassette ACs accumulate dust in their hidden evaporators and drain pans. Our chemical wash involves carefully accessing the unit, applying clean...",
    url: "https://atlasaircons.com/panel-acs-chemical-wash-cleaning-service-hitech-aircool-engineers",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Panel Acs Chemical Wash Cleaning Service | Hitech Aircool Engineers",
  description: "Ceiling cassette ACs accumulate dust in their hidden evaporators and drain pans. Our chemical wash involves carefully accessing the unit, applying cleaner to the coil, and flushing out debris. This prevents water leakage, improves cooling, and eliminates musty odors often associated with dirty panel",
...
export default function Pagepanelacschemicalwashcleaningservicehitec() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  ...
                  alt="Panel Acs Chemical Wash Cleaning Service | Hitech Aircool Engineers"
                ...
                <img
                  ...
                  alt="Panel Acs Chemical Wash Cleaning Service | Hitech Aircool Engineers - Image 2"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Panel Acs Chemical Wash Cleaning Service | Hitech Aircool Engineers - Image 3"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
                ...
                <img
                  ...
                  alt="Panel Acs Chemical Wash Cleaning Service | Hitech Aircool Engineers - Image 4"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Panel Acs Chemical Wash Cleaning Service | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">Ceiling cassette ACs accumulate dust in their hidden evaporators and drain pans. Our chemical wash involves carefully accessing the unit, applying cle</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%20Panel%20Acs%20Chemical%20Wash%20Cleaning%20Service%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                ...
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Panel Acs Chemical Wash Cleaning Service</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>Ceiling cassette ACs accumulate dust in their hidden evaporators and drain pans. Our chemical wash involves carefully accessing the unit, applying cleaner to the coil, and flushing out debris. This prevents water leakage, improves cooling, and eliminates musty odors often associated with dirty panel ACs.</p>
            </div>
