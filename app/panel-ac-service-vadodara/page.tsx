...
export const metadata: Metadata = {
  title: "Expert Rittal & Panel AC Service Vadodara | Hitech Aircool Engineers Gujarat",
  description: "24/7 expert repair for Rittal, Schneider, and all Panel ACs across Vadodara's GIDC industrial zones. Trusted technicians provide fast service, genuine parts, an",
  alternates: { canonical: "https://hitechairconditioning.in/panel-ac-service-vadodara" },
  openGraph: {
    title: "Expert Rittal & Panel AC Service Vadodara | Hitech Aircool Engineers",
    description: "24/7 expert repair for Rittal, Schneider, and all Panel ACs across Vadodara's GIDC industrial zones. Trusted technicians provide fast service, genuine parts, an",
    url: "https://hitechairconditioning.in/panel-ac-service-vadodara",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Expert Rittal & Panel AC Service Vadodara",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagepanelacservicevadodara() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Expert Rittal &amp; Panel AC Service Vadodara</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">24/7 expert repair for Rittal, Schneider, and all Panel ACs across Vadodara&apos;s GIDC industrial zones. Trusted technicians provide fast service, genuine parts, and a warranty on repairs</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">24/7 expert repair for Rittal, Schneider, and all Panel ACs across Vadodara&apos;s GIDC industrial zones. Trusted technicians provide fast service, genuine parts, and a warranty on repairs</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/panel-ac-repair-service.webp" alt="Expert Rittal & Panel AC Service Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Expert Rittal & Panel AC Service Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
