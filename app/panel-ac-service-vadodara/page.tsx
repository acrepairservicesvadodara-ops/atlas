...
export const metadata: Metadata = {
  title: "Expert Rittal & Panel AC Service Vadodara | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/panel-ac-service-vadodara" },
  openGraph: {
    title: "Expert Rittal & Panel AC Service Vadodara | Atlas Aircon",
    description: "24/7 expert repair for Rittal, Schneider, and all Panel ACs across Vadodara's GIDC industrial zones. Trusted technicians provide fast service, genuine parts, an",
    url: "https://atlasaircons.com/panel-ac-service-vadodara",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">24/7 expert repair for Rittal, Schneider, and all Panel ACs across Vadodara&apos;s GIDC industrial zones. Trusted technicians provide fast service, genuine parts, and a warranty on repairs</p>
