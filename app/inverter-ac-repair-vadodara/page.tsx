...
export const metadata: Metadata = {
  title: "Inverter AC Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Inverter AC repair specialist in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Inverter AC Repair Vadodara",
    "inverter ac repair",
    "Inverter AC Repair installation",
    "Inverter AC Repair service",
    "Inverter AC Repair repair",
    "best Inverter AC Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/inverter-ac-repair-vadodara",
  },
};

const keywordData = {
  title: "Inverter AC Repair",
  slug: "inverter-ac-repair",
  description: "Inverter AC repair specialist",
  category: "ACTypes"
};
...
export default function InverterACRepairPage() {
  return (
    <>
      {/* Hero Section */}
