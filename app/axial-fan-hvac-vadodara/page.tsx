...
export const metadata: Metadata = {
  title: "Axial Fan HVAC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Axial fan service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Axial Fan HVAC Vadodara",
    "axial fan hvac",
    "Axial Fan HVAC installation",
    "Axial Fan HVAC service",
    "Axial Fan HVAC repair",
    "best Axial Fan HVAC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/axial-fan-hvac-vadodara",
  },
};

const keywordData = {
  title: "Axial Fan HVAC",
  slug: "axial-fan-hvac",
  description: "Axial fan service",
  category: "Parts"
};
...
export default function AxialFanHVACPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVaxial fan hvac vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial axial fan hvac vadodara?", a: "Industrial axial fan hvac vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVaxial fan hvac vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial axial fan hvac vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial axial fan hvac vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
