...
export const metadata: Metadata = {
  title: "Panel Air Conditioners Manufacter And Supplier &raquo; 9727257141 | Atlas Aircon Gujarat",
  description: "body { font-family: 'Inter', sans-serif; } ...",
  alternates: { canonical: "https://atlasaircons.com/panel-air-conditioner" },
  openGraph: {
    title: "Panel Air Conditioners Manufacter And Supplier &raquo; 9727257141 | Atlas Aircon",
    description: "body { font-family: 'Inter', sans-serif; } ...",
    url: "https://atlasaircons.com/panel-air-conditioner",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Panel Air Conditioners Manufacter And Supplier &raquo; 9727257141",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Panel Air Conditioners Manufacter And Supplier &amp;raquo; 9727257141</h1>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Atlas-Aircon-Panel-Ac-3.webp" alt="Panel Air Conditioners Manufacter And Supplier &raquo; 9727257141" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Atlas-Aircon-Panel-Ac-2.webp" alt="Panel Air Conditioners Manufacter And Supplier &raquo; 9727257141" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Atlas-Aircon-Panel-Ac.webp" alt="Panel Air Conditioners Manufacter And Supplier &raquo; 9727257141" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What panel air conditioners does Atlas Aircon provide?", a: "Atlas Aircon provides panel air conditioner, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book panel air conditioner?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency panel air conditioner available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What panel air conditioners does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides panel air conditioner, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book panel air conditioner?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency panel air conditioner available. Call +91 97272 57141 for immediate assistance." } },
