...
export const metadata: Metadata = {
  title: "Panel Air Conditioners Manufacter And Supplier &raquo; 9328953665 | Hitech Aircool Engineers Gujarat",
  description: "body { font-family: 'Inter', sans-serif; } ...",
  alternates: { canonical: "https://hitechairconditioning.in/panel-air-conditioner" },
  openGraph: {
    title: "Panel Air Conditioners Manufacter And Supplier &raquo; 9328953665 | Hitech Aircool Engineers",
    description: "body { font-family: 'Inter', sans-serif; } ...",
    url: "https://hitechairconditioning.in/panel-air-conditioner",
    type: "website",
    images: ["/images/products/Atlas-Aircon-Panel-Ac-3.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Panel Air Conditioners Manufacter And Supplier &raquo; 9328953665",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagepanelairconditioner() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Panel Air Conditioners Manufacter And Supplier &amp;raquo; 9328953665</h1>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Atlas-Aircon-Panel-Ac-3.webp" alt="Panel Air Conditioners Manufacter And Supplier &raquo; 9328953665" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Atlas-Aircon-Panel-Ac-2.webp" alt="Panel Air Conditioners Manufacter And Supplier &raquo; 9328953665" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Atlas-Aircon-Panel-Ac.webp" alt="Panel Air Conditioners Manufacter And Supplier &raquo; 9328953665" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What panel air conditioners does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides panel air conditioner, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book panel air conditioner?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency panel air conditioner available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What panel air conditioners does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides panel air conditioner, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book panel air conditioner?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency panel air conditioner available. Call +91 93289 53665 for immediate assistance." } },
