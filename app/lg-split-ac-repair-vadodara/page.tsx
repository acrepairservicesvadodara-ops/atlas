...
export const metadata: Metadata = {
  title: "LG Split AC Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "LG split AC repair service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "LG Split AC Repair Vadodara",
    "lg split ac repair",
    "LG Split AC Repair installation",
    "LG Split AC Repair service",
    "LG Split AC Repair repair",
    "best LG Split AC Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/lg-split-ac-repair-vadodara",
  },
};

const keywordData = {
  title: "LG Split AC Repair",
  slug: "lg-split-ac-repair",
  description: "LG split AC repair service",
  category: "ACTypes"
};
...
export default function LGSplitACRepairPage() {
  return (
    <>
      {/* Hero Section */}
