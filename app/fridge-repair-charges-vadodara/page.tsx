...
export const metadata: Metadata = {
  title: "Fridge Repair Charges in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Refrigerator repair cost in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Fridge Repair Charges Vadodara",
    "fridge repair charges",
    "Fridge Repair Charges installation",
    "Fridge Repair Charges service",
    "Fridge Repair Charges repair",
    "best Fridge Repair Charges service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/fridge-repair-charges-vadodara",
  },
};

const keywordData = {
  title: "Fridge Repair Charges",
  slug: "fridge-repair-charges",
  description: "Refrigerator repair cost",
...
export default function FridgeRepairChargesPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Fridge Repair Charges Vadodara in Vadodara?", a: "Fridge Repair Charges Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Fridge Repair Charges Vadodara?", a: "Hitech Aircool Engineers offers same-day Fridge Repair Charges Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Fridge Repair Charges Vadodaras?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Fridge Repair Charges Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Fridge Repair Charges Vadodara available on holidays?", a: "Yes, Hitech Aircool Engineers provides Fridge Repair Charges Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Fridge Repair Charges Vadodara take?", a: "Most Fridge Repair Charges Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Fridge Repair Charges Vadodara in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Fridge Repair Charges Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Fridge Repair Charges Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Fridge Repair Charges Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Fridge Repair Charges Vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Fridge Repair Charges Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Fridge Repair Charges Vadodara available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Fridge Repair Charges Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Fridge Repair Charges Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Most Fridge Repair Charges Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
