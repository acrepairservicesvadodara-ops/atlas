...
export const metadata: Metadata = {
  title: "Air Conditioner Maintenance Tips | Hitech Aircool Engineers Gujarat",
  description: "Making sure your air conditioner is running effectively isn't just a matter of comfort, and it's an issue of safety and health....",
  alternates: { canonical: "https://hitechairconditioning.in/home-air-conditioner-maintenance-tips" },
  openGraph: {
    title: "Air Conditioner Maintenance Tips | Hitech Aircool Engineers",
    description: "Making sure your air conditioner is running effectively isn't just a matter of comfort, and it's an issue of safety and health....",
    url: "https://hitechairconditioning.in/home-air-conditioner-maintenance-tips",
    type: "website",
    images: ["/images/products/Home-Air-Conditioner-Maintenance-Tips.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Air Conditioner Maintenance Tips",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagehomeairconditionermaintenancetips() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Air Conditioner Maintenance Tips</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Making sure your air conditioner is running effectively isn&apos;t just a matter of comfort, and it&apos;s an issue of safety and health....</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Making sure your air conditioner is running effectively isn&apos;t just a matter of comfort, and it&apos;s an issue of safety and health....</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Home-Air-Conditioner-Maintenance-Tips.webp" alt="Air Conditioner Maintenance Tips" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Air Conditioner Maintenance Tips" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Air Conditioner Maintenance Tips" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Home Air Conditioner Maintenance Tips include?", a: "Home Air Conditioner Maintenance Tips includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Home Air Conditioner Maintenance Tips cost?", a: "Home Air Conditioner Maintenance Tips starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Home Air Conditioner Maintenance Tips improve cooling?", a: "Yes, proper Home Air Conditioner Maintenance Tips can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Home Air Conditioner Maintenance Tips reduce electricity bills?", a: "Regular Home Air Conditioner Maintenance Tips can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Home Air Conditioner Maintenance Tips take?", a: "Basic Home Air Conditioner Maintenance Tips takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Home Air Conditioner Maintenance Tips remove bad smell?", a: "Yes, Home Air Conditioner Maintenance Tips includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Home Air Conditioner Maintenance Tips?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Home Air Conditioner Maintenance Tips include?", acceptedAnswer: { "@type": "Answer", text: "Home Air Conditioner Maintenance Tips includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Home Air Conditioner Maintenance Tips cost?", acceptedAnswer: { "@type": "Answer", text: "Home Air Conditioner Maintenance Tips starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Home Air Conditioner Maintenance Tips improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Home Air Conditioner Maintenance Tips can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Home Air Conditioner Maintenance Tips reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Home Air Conditioner Maintenance Tips can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Home Air Conditioner Maintenance Tips take?", acceptedAnswer: { "@type": "Answer", text: "Basic Home Air Conditioner Maintenance Tips takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Home Air Conditioner Maintenance Tips remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Home Air Conditioner Maintenance Tips includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Home Air Conditioner Maintenance Tips?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
