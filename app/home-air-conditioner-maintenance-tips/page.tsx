...
export const metadata: Metadata = {
  title: "Air Conditioner Maintenance Tips | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/home-air-conditioner-maintenance-tips" },
  openGraph: {
    title: "Air Conditioner Maintenance Tips | Atlas Aircon",
    description: "Making sure your air conditioner is running effectively isn't just a matter of comfort, and it's an issue of safety and health....",
    url: "https://atlasaircons.com/home-air-conditioner-maintenance-tips",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Making sure your air conditioner is running effectively isn&apos;t just a matter of comfort, and it&apos;s an issue of safety and health....</p>
