...
export const metadata: Metadata = {
  title: "Hitachi AC Service Center Gujarat | Out-of-Warranty Repair Expert | Hitech Aircool Engineers",
  description: "Independent Hitachi AC service center in Gujarat. Expert out-of-warranty split AC repair, gas charging, PCB repair, deep cleaning & compressor overhaul. Same-day service. Call +91 93289 53665.",
  keywords: [
  ...
  alternates: { canonical: "https://hitechairconditioning.in/hitachi-ac-service-center-gujarat" },
  openGraph: {
    title: "Hitachi AC Service Center Gujarat | Hitech Aircool Engineers",
    description: "Independent out-of-warranty Hitachi AC repair specialist in Gujarat. Same-day service, 90-day guarantee.",
    url: "https://hitechairconditioning.in/hitachi-ac-service-center-gujarat",
    type: "website",
  },
};
...
const faqJsonLd = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "Is Hitech Aircool Engineers an authorized Hitachi service center in Gujarat?", acceptedAnswer: { "@type": "Answer", text: "No. Hitech Aircool Engineers is an independent service provider specializing in high-quality out-of-warranty repairs. If your Hitachi AC is under official warranty, contact Hitachi directly." } },
