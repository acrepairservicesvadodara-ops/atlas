...
export const metadata: Metadata = {
  title: "Expert Split AC Repair & Service In Daman | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/split-ac-service-daman" },
  openGraph: {
    title: "Expert Split AC Repair & Service In Daman | Atlas Aircon",
    description: "Top-rated split AC service Daman. Fast repair, installation & gas refill. Same-day service, genuine spare parts & 30-day warranty. Free diagnosis. Call for inst",
    url: "https://atlasaircons.com/split-ac-service-daman",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Top-rated split AC service Daman. Fast repair, installation &amp; gas refill. Same-day service, genuine spare parts &amp; 30-day warranty. Free diagnosis. Call for instant help!</p>
