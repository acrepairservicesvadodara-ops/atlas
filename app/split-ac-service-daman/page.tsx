...
export const metadata: Metadata = {
  title: "Expert Split AC Repair & Service In Daman | Hitech Aircool Engineers Gujarat",
  description: "Top-rated split AC service Daman. Fast repair, installation & gas refill. Same-day service, genuine spare parts & 30-day warranty. Free diagnosis. Call for inst",
  alternates: { canonical: "https://hitechairconditioning.in/split-ac-service-daman" },
  openGraph: {
    title: "Expert Split AC Repair & Service In Daman | Hitech Aircool Engineers",
    description: "Top-rated split AC service Daman. Fast repair, installation & gas refill. Same-day service, genuine spare parts & 30-day warranty. Free diagnosis. Call for inst",
    url: "https://hitechairconditioning.in/split-ac-service-daman",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Expert Split AC Repair & Service In Daman",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagesplitacservicedaman() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Expert Split AC Repair &amp; Service In Daman</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Top-rated split AC service Daman. Fast repair, installation &amp; gas refill. Same-day service, genuine spare parts &amp; 30-day warranty. Free diagnosis. Call for instant help!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Top-rated split AC service Daman. Fast repair, installation &amp; gas refill. Same-day service, genuine spare parts &amp; 30-day warranty. Free diagnosis. Call for instant help!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/Split-Air-Conditioner.webp" alt="Expert Split AC Repair & Service In Daman" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Expert Split AC Repair & Service In Daman" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
