...
export const metadata: Metadata = {
  title: "Split AC Service In Vadodara | Hitech Aircool Engineers Gujarat",
  description: "Professional split ac service in vadodara by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/split-ac-service-in-vadodara-reliable-affordable-split-air-conditioner-repair" },
  openGraph: {
    title: "Split AC Service In Vadodara | Hitech Aircool Engineers",
    description: "Professional split ac service in vadodara by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/split-ac-service-in-vadodara-reliable-affordable-split-air-conditioner-repair",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Split AC Service In Vadodara",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagesplitacserviceinvadodarareliableaffordab() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Split AC Service In Vadodara</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">&lt;div class=&quot;split-ac-wrapper&quot; style=&quot;background-color: #f8...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">&lt;div class=&quot;split-ac-wrapper&quot; style=&quot;background-color: #f8...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/Split-Air-Conditioner.webp" alt="Split AC Service In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Split-Air-Conditioner-vadodara.webp" alt="Split AC Service In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Split-Air-Conditioner-repair-service.webp" alt="Split AC Service In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
