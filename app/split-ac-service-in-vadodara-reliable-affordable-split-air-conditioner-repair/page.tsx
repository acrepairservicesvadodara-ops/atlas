...
export const metadata: Metadata = {
  title: "Split AC Service In Vadodara | Atlas Aircon Gujarat",
  description: "Professional split ac service in vadodara by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/split-ac-service-in-vadodara-reliable-affordable-split-air-conditioner-repair" },
  openGraph: {
    title: "Split AC Service In Vadodara | Atlas Aircon",
    description: "Professional split ac service in vadodara by Atlas Aircon. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/split-ac-service-in-vadodara-reliable-affordable-split-air-conditioner-repair",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">&lt;div class=&quot;split-ac-wrapper&quot; style=&quot;background-color: #f8...</p>
