...
export const metadata: Metadata = {
  title: "Godrej Fridge Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Godrej fridge repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Godrej Fridge Service Vadodara",
    "godrej fridge service",
    "Godrej Fridge Service installation",
    "Godrej Fridge Service service",
    "Godrej Fridge Service repair",
    "best Godrej Fridge Service service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/godrej-fridge-service-vadodara",
  },
};

const keywordData = {
  title: "Godrej Fridge Service",
  slug: "godrej-fridge-service",
  description: "Godrej fridge repair",
...
export default function GodrejFridgeServicePage() {
  return (
    <>
      {/* Hero Section */}
