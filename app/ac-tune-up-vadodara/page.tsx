...
export const metadata: Metadata = {
  title: "AC Tune Up in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC performance tune up in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC Tune Up Vadodara",
    "ac tune up",
    "AC Tune Up installation",
    "AC Tune Up service",
    "AC Tune Up repair",
    "best AC Tune Up service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-tune-up-vadodara",
  },
};
...
const keywordData = {
  title: "AC Tune Up",
  slug: "ac-tune-up",
  description: "AC performance tune up",
  category: "Core"
};
...
export default function ACTuneUpPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What ac tune up vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides ac tune up vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book ac tune up vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency ac tune up vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What ac tune up vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides ac tune up vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book ac tune up vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency ac tune up vadodara available. Call +91 93289 53665 for immediate assistance." } },
