...
export const metadata: Metadata = {
  title: "Cold Room And Walkin Freezer | Atlas Aircon Blog",
  description: "Cold Room And Walkin Freezer - Atlas Aircon Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/cold-room-and-walkin-freezer-efficient-durable-1st-choice" },
  openGraph: {
    title: "Cold Room And Walkin Freezer | Atlas Aircon",
    description: "Cold Room And Walkin Freezer - Atlas Aircon Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/cold-room-and-walkin-freezer-efficient-durable-1st-choice",
    type: "article",
...
const jsonLd = {
  ...
  mainEntityOfPage: "https://atlasaircons.com/cold-room-and-walkin-freezer-efficient-durable-1st-choice",
  ...
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVcold room and walkin freezer efficient durable 1st choices?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVcold room and walkin freezer efficient durable 1st choices?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
