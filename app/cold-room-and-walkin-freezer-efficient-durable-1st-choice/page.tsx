...
export const metadata: Metadata = {
  title: "Cold Room And Walkin Freezer | Hitech Aircool Engineers Blog",
  description: "Cold Room And Walkin Freezer - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/cold-room-and-walkin-freezer-efficient-durable-1st-choice" },
  openGraph: {
    title: "Cold Room And Walkin Freezer | Hitech Aircool Engineers",
    description: "Cold Room And Walkin Freezer - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/cold-room-and-walkin-freezer-efficient-durable-1st-choice",
    type: "article",
    images: ["/images/products/cold-room-and-walkin-freezer.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Article",
  headline: "Cold Room And Walkin Freezer",
  ...
  mainEntityOfPage: "https://hitechairconditioning.in/cold-room-and-walkin-freezer-efficient-durable-1st-choice",
  image: "/images/products/cold-room-and-walkin-freezer.webp",
};

export default function Pagecoldroomandwalkinfreezerefficientdurable() {
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-gray-900 via-gray-800 to-teal-900 text-white py-12 md:py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">Cold Room And Walkin Freezer</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <img src="/images/products/cold-room-and-walkin-freezer.webp" alt="Cold Room And Walkin Freezer" className="w-full h-auto rounded-xl mb-8" />
            <p className="text-gray-600 mb-4">&#123; &quot;@context&quot;: &quot;https://schema.org&quot;, &quot;@g...</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVcold room and walkin freezer efficient durable 1st choices?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial cold room and walkin freezer efficient durable 1st choice?", a: "Industrial cold room and walkin freezer efficient durable 1st choice costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVcold room and walkin freezer efficient durable 1st choices?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial cold room and walkin freezer efficient durable 1st choice?", acceptedAnswer: { "@type": "Answer", text: "Industrial cold room and walkin freezer efficient durable 1st choice costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
