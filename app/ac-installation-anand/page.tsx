...
export const metadata: Metadata = {
  title: "AC Installation Anand | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-installation-anand" },
  openGraph: {
    title: "AC Installation Anand | Atlas Aircon",
    description: "Expert AC installation services in Anand. Professional split & window AC fitting, gas charging & electrical work. Free site survey. Call for pricing & booking!",
    url: "https://atlasaircons.com/ac-installation-anand",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Expert AC installation services in Anand. Professional split &amp; window AC fitting, gas charging &amp; electrical work. Free site survey. Call for pricing &amp; booking!</p>
