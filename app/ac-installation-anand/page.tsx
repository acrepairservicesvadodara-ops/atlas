...
export const metadata: Metadata = {
  title: "AC Installation Anand | Hitech Aircool Engineers Gujarat",
  description: "Expert AC installation services in Anand. Professional split & window AC fitting, gas charging & electrical work. Free site survey. Call for pricing & booking!",
  alternates: { canonical: "https://hitechairconditioning.in/ac-installation-anand" },
  openGraph: {
    title: "AC Installation Anand | Hitech Aircool Engineers",
    description: "Expert AC installation services in Anand. Professional split & window AC fitting, gas charging & electrical work. Free site survey. Call for pricing & booking!",
    url: "https://hitechairconditioning.in/ac-installation-anand",
    type: "website",
...
export default function Pageacinstallationanand() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">AC Installation Anand</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Expert AC installation services in Anand. Professional split &amp; window AC fitting, gas charging &amp; electrical work. Free site survey. Call for pricing &amp; booking!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Expert AC installation services in Anand. Professional split &amp; window AC fitting, gas charging &amp; electrical work. Free site survey. Call for pricing &amp; booking!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Split-Ac-Installation-and-Repair-Service-1.webp" alt="AC Installation Anand" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="AC Installation Anand" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
