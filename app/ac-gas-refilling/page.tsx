...
export const metadata: Metadata = {
  title: "Stay Cool With Professional AC Gas Refilling Services @ 2500 [2026 Updated] | Atlas Aircon Gujarat",
  description: "Stay Cool With Professional AC Gas Refilling Services @ 2500 [2026 Updated] - Atlas Aircon Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/ac-gas-refilling" },
  openGraph: {
    title: "Stay Cool With Professional AC Gas Refilling Services @ 2500 [2026 Updated] | Atlas Aircon",
    description: "Stay Cool With Professional AC Gas Refilling Services @ 2500 [2026 Updated] - Atlas Aircon Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/ac-gas-refilling",
    type: "website",
    images: ["/images/products/Air-Conditioner-Gas-Refilling.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Stay Cool With Professional AC Gas Refilling Services @ 2500 [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
...
export default function Pageacgasrefilling() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Stay Cool With Professional AC Gas Refilling Services @ 2500 [2026 Updated]</h1>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Air-Conditioner-Gas-Refilling.webp" alt="Stay Cool With Professional AC Gas Refilling Services @ 2500 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Stay Cool With Professional AC Gas Refilling Services @ 2500 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Stay Cool With Professional AC Gas Refilling Services @ 2500 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
