...
export const metadata: Metadata = {
  title: "HVAC & Air Conditioner Grills | Hitech Aircool Engineers Gujarat",
  description: "HVAC & Air Conditioner Grills - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/hvac-air-conditioner-grills-energy-efficient-durable" },
  openGraph: {
    title: "HVAC & Air Conditioner Grills | Hitech Aircool Engineers",
    description: "HVAC & Air Conditioner Grills - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/hvac-air-conditioner-grills-energy-efficient-durable",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "HVAC & Air Conditioner Grills",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagehvacairconditionergrillsenergyefficientd() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">HVAC &amp; Air Conditioner Grills</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">&#123; &quot;@context&quot;: &quot;https://schema.org/&quot;, &quot;@type&quot;: &quot;Product&quot;, &quot;name&quot;: &quot;Hvac &amp; Air Conditioner Grills&quot;, &quot;imag...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">&#123; &quot;@context&quot;: &quot;https://schema.org/&quot;, &quot;@type&quot;: &quot;Product&quot;, &quot;name&quot;: &quot;Hvac &amp; Air Conditioner Grills&quot;, &quot;imag...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/ac-grills.webp" alt="HVAC & Air Conditioner Grills" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/aluminium-grills.webp" alt="HVAC & Air Conditioner Grills" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/hvac-grills.webp" alt="HVAC & Air Conditioner Grills" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/vent-grills.webp" alt="HVAC & Air Conditioner Grills" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVhvac air conditioner grills energy efficient durables?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial hvac air conditioner grills energy efficient durable?", a: "Industrial hvac air conditioner grills energy efficient durable costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVhvac air conditioner grills energy efficient durables?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial hvac air conditioner grills energy efficient durable?", acceptedAnswer: { "@type": "Answer", text: "Industrial hvac air conditioner grills energy efficient durable costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
