...
export const metadata: Metadata = {
  title: "Rittal Panel AC Service Bharuch | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/panel-ac-service-bharuch" },
  openGraph: {
    title: "Rittal Panel AC Service Bharuch | Atlas Aircon",
    description: "Specialized panel AC service bharuch for chemical & refinery plants in Bharuch's GIDCs. We service Rittal, Schneider units in Dahej, Ankleshwar, Jhagadia with 2",
    url: "https://atlasaircons.com/panel-ac-service-bharuch",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Specialized panel AC service bharuch for chemical &amp; refinery plants in Bharuch&apos;s GIDCs. We service Rittal, Schneider units in Dahej, Ankleshwar, Jhagadia with 24/7 emergency support &amp; AMCs.</p>
