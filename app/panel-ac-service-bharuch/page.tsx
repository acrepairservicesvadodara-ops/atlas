...
export const metadata: Metadata = {
  title: "Rittal Panel AC Service Bharuch | Hitech Aircool Engineers Gujarat",
  description: "Specialized panel AC service bharuch for chemical & refinery plants in Bharuch's GIDCs. We service Rittal, Schneider units in Dahej, Ankleshwar, Jhagadia with 2",
  alternates: { canonical: "https://hitechairconditioning.in/panel-ac-service-bharuch" },
  openGraph: {
    title: "Rittal Panel AC Service Bharuch | Hitech Aircool Engineers",
    description: "Specialized panel AC service bharuch for chemical & refinery plants in Bharuch's GIDCs. We service Rittal, Schneider units in Dahej, Ankleshwar, Jhagadia with 2",
    url: "https://hitechairconditioning.in/panel-ac-service-bharuch",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Rittal Panel AC Service Bharuch",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagepanelacservicebharuch() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Rittal Panel AC Service Bharuch</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Specialized panel AC service bharuch for chemical &amp; refinery plants in Bharuch&apos;s GIDCs. We service Rittal, Schneider units in Dahej, Ankleshwar, Jhagadia with 24/7 emergency support &amp; AMCs.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Specialized panel AC service bharuch for chemical &amp; refinery plants in Bharuch&apos;s GIDCs. We service Rittal, Schneider units in Dahej, Ankleshwar, Jhagadia with 24/7 emergency support &amp; AMCs.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/panel-ac-repair-service.webp" alt="Rittal Panel AC Service Bharuch" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Rittal Panel AC Service Bharuch" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
