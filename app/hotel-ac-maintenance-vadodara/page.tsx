...
export const metadata: Metadata = {
  title: "Hotel AC Maintenance in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Hotel AC service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Hotel AC Maintenance Vadodara",
    "hotel ac maintenance",
    "Hotel AC Maintenance installation",
    "Hotel AC Maintenance service",
    "Hotel AC Maintenance repair",
    "best Hotel AC Maintenance service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/hotel-ac-maintenance-vadodara",
  },
};

const keywordData = {
  title: "Hotel AC Maintenance",
  slug: "hotel-ac-maintenance",
  description: "Hotel AC service",
  category: "Commercial"
};
...
export default function HotelACMaintenancePage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Hotel Ac Maintenance Vadodara include?", a: "Hotel Ac Maintenance Vadodara includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Hotel Ac Maintenance Vadodara cost?", a: "Hotel Ac Maintenance Vadodara starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Hotel Ac Maintenance Vadodara improve cooling?", a: "Yes, proper Hotel Ac Maintenance Vadodara can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Hotel Ac Maintenance Vadodara reduce electricity bills?", a: "Regular Hotel Ac Maintenance Vadodara can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Hotel Ac Maintenance Vadodara take?", a: "Basic Hotel Ac Maintenance Vadodara takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Hotel Ac Maintenance Vadodara remove bad smell?", a: "Yes, Hotel Ac Maintenance Vadodara includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Hotel Ac Maintenance Vadodara?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Hotel Ac Maintenance Vadodara include?", acceptedAnswer: { "@type": "Answer", text: "Hotel Ac Maintenance Vadodara includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Hotel Ac Maintenance Vadodara cost?", acceptedAnswer: { "@type": "Answer", text: "Hotel Ac Maintenance Vadodara starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Hotel Ac Maintenance Vadodara improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Hotel Ac Maintenance Vadodara can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Hotel Ac Maintenance Vadodara reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Hotel Ac Maintenance Vadodara can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Hotel Ac Maintenance Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Basic Hotel Ac Maintenance Vadodara takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Hotel Ac Maintenance Vadodara remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hotel Ac Maintenance Vadodara includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Hotel Ac Maintenance Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
