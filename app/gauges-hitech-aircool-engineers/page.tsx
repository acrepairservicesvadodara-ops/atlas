...
export const metadata: Metadata = {
  title: "Gauges | Hitech Aircool Engineers | Buy Online | Atlas Aircon Gujarat",
  description: "A refrigerated air dryer low on gas will not achieve its dew point. We can top up the charge temporarily to keep compressed air dry while planning a rep...",
  keywords: ["gauges | hitech aircool engineers", "hitech aircool engineers", "hvac parts vadodara", "ac spare parts gujarat", "pressure gauges"],
  alternates: { canonical: "https://atlasaircons.com/gauges-hitech-aircool-engineers" },
  openGraph: {
    title: "Gauges | Hitech Aircool Engineers",
    description: "A refrigerated air dryer low on gas will not achieve its dew point. We can top up the charge temporarily to keep compressed air dry while planning a rep...",
    url: "https://atlasaircons.com/gauges-hitech-aircool-engineers",
    type: "website",
    images: ["/images/products/central-ac-repair-service-gas-charge.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Product",
  name: "Gauges | Hitech Aircool Engineers",
  description: "A refrigerated air dryer low on gas will not achieve its dew point. We can top up the charge temporarily to keep compressed air dry while planning a repair of the often tiny leaks in the dryer’s circuit.",
  image: "/images/products/central-ac-repair-service-gas-charge.webp",
...
export default function Pagegaugeshitechaircoolengineers() {
  return (
    <>
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-4 md:p-8">
              <div className="space-y-4">
                <img
                  src="/images/products/central-ac-repair-service-gas-charge.webp"
                  alt="Gauges | Hitech Aircool Engineers"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="eager"
                />

                <img
                  src="/images/products/Deep-Freezer-Repair-Service-gas-charge.webp"
                  alt="Gauges | Hitech Aircool Engineers - Image 2"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />

                <img
                  src="/images/products/Refrigerator-repair-service-gas-charging.webp"
                  alt="Gauges | Hitech Aircool Engineers - Image 3"
                  className="w-full h-auto rounded-lg object-cover"
                  loading="lazy"
                />
              </div>
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Gauges | Hitech Aircool Engineers</h1>
              <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">A refrigerated air dryer low on gas will not achieve its dew point. We can top up the charge temporarily to keep compressed air dry while planning a r</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <a href="https://wa.me/919727257141?text=I%20want%20to%20order%3A%20Gauges%20%7C%20Hitech%20Aircool%20Engineers" className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 transition">
                  WhatsApp Order
                </a>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">All HVACR Service Work</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">AMC</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Gauges</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Gujarat</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Maintenance</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Other</span>
                <span className="bg-gray-700 text-gray-300 text-xs px-3 py-1 rounded-full">Pressure/temperature monitoring</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg text-gray-600 max-w-none">
              <p>A refrigerated air dryer low on gas will not achieve its dew point. We can top up the charge temporarily to keep compressed air dry while planning a repair of the often tiny leaks in the dryer’s circuit.</p>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What gauges hitech aircool engineerss does Atlas Aircon provide?", a: "Atlas Aircon provides gauges hitech aircool engineers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book gauges hitech aircool engineers?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency gauges hitech aircool engineers available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What gauges hitech aircool engineerss does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides gauges hitech aircool engineers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book gauges hitech aircool engineers?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency gauges hitech aircool engineers available. Call +91 97272 57141 for immediate assistance." } },
