...
export const metadata: Metadata = {
  title: "Kelvinator AC Service Center Rajpipla | Professional HVAC Service | Hitech Aircool Engineers",
  description: "Kelvinator AC Service Center Rajpipla — Professional service service by Hitech Aircool Engineers. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 93289 53665.",
  keywords: ["kelvinator ac service center rajpipla", "service service", "hvac service vadodara", "hitech aircool engineers", "ac service gujarat"],
  alternates: { canonical: "https://hitechairconditioning.in/kelvinator-ac-service-center-rajpipla" },
  openGraph: { title: "Kelvinator AC Service Center Rajpipla | Hitech Aircool Engineers", description: "Professional service service by Hitech Aircool Engineers Gujarat.", url: "https://hitechairconditioning.in/kelvinator-ac-service-center-rajpipla", type: "website" },
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Kelvinator AC Service Center Rajpipla",
  provider: { "@type": "LocalBusiness", name: "Hitech Aircool Engineers", telephone: "+919328953665" },
  areaServed: { "@type": "State", name: "Gujarat" },
  serviceType: "Kelvinator AC Service Center Rajpipla",
};

export default function KelvinatorACServiceCenterRajpiplaPage() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Kelvinator AC Service Center Rajpipla</h1>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Kelvinator Ac Service Center Rajpipla include?", a: "Kelvinator Ac Service Center Rajpipla includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Kelvinator Ac Service Center Rajpipla cost?", a: "Kelvinator Ac Service Center Rajpipla starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Kelvinator Ac Service Center Rajpipla improve cooling?", a: "Yes, proper Kelvinator Ac Service Center Rajpipla can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Kelvinator Ac Service Center Rajpipla reduce electricity bills?", a: "Regular Kelvinator Ac Service Center Rajpipla can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Kelvinator Ac Service Center Rajpipla take?", a: "Basic Kelvinator Ac Service Center Rajpipla takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Kelvinator Ac Service Center Rajpipla remove bad smell?", a: "Yes, Kelvinator Ac Service Center Rajpipla includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Kelvinator Ac Service Center Rajpipla?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Kelvinator Ac Service Center Rajpipla include?", acceptedAnswer: { "@type": "Answer", text: "Kelvinator Ac Service Center Rajpipla includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Kelvinator Ac Service Center Rajpipla cost?", acceptedAnswer: { "@type": "Answer", text: "Kelvinator Ac Service Center Rajpipla starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Kelvinator Ac Service Center Rajpipla improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Kelvinator Ac Service Center Rajpipla can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Kelvinator Ac Service Center Rajpipla reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Kelvinator Ac Service Center Rajpipla can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Kelvinator Ac Service Center Rajpipla take?", acceptedAnswer: { "@type": "Answer", text: "Basic Kelvinator Ac Service Center Rajpipla takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Kelvinator Ac Service Center Rajpipla remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Kelvinator Ac Service Center Rajpipla includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Kelvinator Ac Service Center Rajpipla?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
