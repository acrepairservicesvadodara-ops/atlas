...
export const metadata: Metadata = {
  title: "(AMAZING) Trusted Used Air Conditioner, HVAC, Chiller Unit | Atlas Aircon Gujarat",
  description: "AMAZING Deals on Used ...",
  alternates: { canonical: "https://atlasaircons.com/buy-sell-old-and-used-air-conditioner-atlas-aircon" },
  openGraph: {
    title: "(AMAZING) Trusted Used Air Conditioner, HVAC, Chiller Unit | Atlas Aircon",
    description: "AMAZING Deals on Used ...",
    url: "https://atlasaircons.com/buy-sell-old-and-used-air-conditioner-atlas-aircon",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">AMAZING Deals on Used ...</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What buy sell old and used air conditioner atlas aircons does Atlas Aircon provide?", a: "Atlas Aircon provides buy sell old and used air conditioner atlas aircon, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book buy sell old and used air conditioner atlas aircon?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency buy sell old and used air conditioner atlas aircon available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What buy sell old and used air conditioner atlas aircons does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides buy sell old and used air conditioner atlas aircon, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book buy sell old and used air conditioner atlas aircon?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency buy sell old and used air conditioner atlas aircon available. Call +91 97272 57141 for immediate assistance." } },
