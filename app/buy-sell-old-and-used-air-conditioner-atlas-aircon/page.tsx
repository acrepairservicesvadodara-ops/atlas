...
export const metadata: Metadata = {
  title: "(AMAZING) Trusted Used Air Conditioner, HVAC, Chiller Unit | Hitech Aircool Engineers Gujarat",
  description: "AMAZING Deals on Used ...",
  alternates: { canonical: "https://hitechairconditioning.in/buy-sell-old-and-used-air-conditioner-atlas-aircon" },
  openGraph: {
    title: "(AMAZING) Trusted Used Air Conditioner, HVAC, Chiller Unit | Hitech Aircool Engineers",
    description: "AMAZING Deals on Used ...",
    url: "https://hitechairconditioning.in/buy-sell-old-and-used-air-conditioner-atlas-aircon",
    type: "website",
    images: ["/images/products/ac-grills.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "(AMAZING) Trusted Used Air Conditioner, HVAC, Chiller Unit",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagebuyselloldandusedairconditioneratlasairc() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">(AMAZING) Trusted Used Air Conditioner, HVAC, Chiller Unit</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">AMAZING Deals on Used ...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">AMAZING Deals on Used ...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/ac-grills.webp" alt="(AMAZING) Trusted Used Air Conditioner, HVAC, Chiller Unit" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/an-outdoor-AC-condenser-unit-perhaps-one-that-is-visibly-dirty-with-leaves-or-a-technician-inspecting-the-fan.webp" alt="(AMAZING) Trusted Used Air Conditioner, HVAC, Chiller Unit" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What buy sell old and used air conditioner hitech aircool engineerss does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides buy sell old and used air conditioner hitech aircool engineers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book buy sell old and used air conditioner hitech aircool engineers?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency buy sell old and used air conditioner hitech aircool engineers available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What buy sell old and used air conditioner hitech aircool engineerss does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides buy sell old and used air conditioner hitech aircool engineers, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book buy sell old and used air conditioner hitech aircool engineers?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency buy sell old and used air conditioner hitech aircool engineers available. Call +91 93289 53665 for immediate assistance." } },
