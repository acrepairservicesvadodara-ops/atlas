...
export const metadata: Metadata = {
  title: "Breakdown Coastal Resort Chiller Repair Services Daman | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/chiller-repair-services-daman" },
  openGraph: {
    title: "Breakdown Coastal Resort Chiller Repair Services Daman | Atlas Aircon",
    description: "Chiller Repair Services Daman for beach resorts, hotels & restaurants. Our salt-air corrosion experts handle emergency compressor, tube & condenser repair to pr",
    url: "https://atlasaircons.com/chiller-repair-services-daman",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Chiller Repair Services Daman for beach resorts, hotels &amp; restaurants. Our salt-air corrosion experts handle emergency compressor, tube &amp; condenser repair to protect guest comfort. Fast response guaranteed.</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVchiller repair services damans?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVchiller repair services damans?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
