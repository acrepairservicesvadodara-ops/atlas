...
export const metadata: Metadata = {
  title: "Voltas AC Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Voltas AC service center in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Voltas AC Service Vadodara",
    "voltas ac service",
    "Voltas AC Service installation",
    "Voltas AC Service service",
    "Voltas AC Service repair",
    "best Voltas AC Service service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/voltas-ac-service-vadodara",
  },
};

const keywordData = {
  title: "Voltas AC Service",
  slug: "voltas-ac-service",
...
export default function VoltasACServicePage() {
  return (
    <>
      {/* Hero Section */}
