...
export const metadata: Metadata = {
  title: "🚨 24/7 Air Cooler Repair Services Bharuch | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/air-cooler-repair-services-bharuch" },
  openGraph: {
    title: "🚨 24/7 Air Cooler Repair Services Bharuch | Atlas Aircon",
    description: "Is your air cooler broken in Bharuch's heat? We provide same-day repair service for all brands. Expert technicians, affordable pricing & 100% satisfaction. Call",
    url: "https://atlasaircons.com/air-cooler-repair-services-bharuch",
    type: "website",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Is your air cooler broken in Bharuch&apos;s heat? We provide same-day repair service for all brands. Expert technicians, affordable pricing &amp; 100% satisfaction. Call now for quick relief!</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/cropped-AtlasAircon-Logo.webp" alt="🚨 24/7 Air Cooler Repair Services Bharuch" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Air Cooler Repair Services Bharuch in Vadodara?", a: "Air Cooler Repair Services Bharuch cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Air Cooler Repair Services Bharuch?", a: "Atlas Aircon offers same-day Air Cooler Repair Services Bharuch across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Air Cooler Repair Services Bharuchs?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Air Cooler Repair Services Bharuchs depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Air Cooler Repair Services Bharuch available on holidays?", a: "Yes, Atlas Aircon provides Air Cooler Repair Services Bharuch 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Air Cooler Repair Services Bharuch?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Air Cooler Repair Services Bharuch across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Air Cooler Repair Services Bharuchs?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Air Cooler Repair Services Bharuchs depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Air Cooler Repair Services Bharuch available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Air Cooler Repair Services Bharuch 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
