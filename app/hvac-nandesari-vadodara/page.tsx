...
export const metadata: Metadata = {
  title: "HVAC Nandesari in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "HVAC service Nandesari in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "HVAC Nandesari Vadodara",
    "hvac nandesari",
    "HVAC Nandesari installation",
    "HVAC Nandesari service",
    "HVAC Nandesari repair",
    "best HVAC Nandesari service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/hvac-nandesari-vadodara",
  },
};

const keywordData = {
  title: "HVAC Nandesari",
  slug: "hvac-nandesari",
  description: "HVAC service Nandesari",
  category: "Area"
};
...
export default function HVACNandesariPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVhvac nandesari vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial hvac nandesari vadodara?", a: "Industrial hvac nandesari vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVhvac nandesari vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial hvac nandesari vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial hvac nandesari vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
