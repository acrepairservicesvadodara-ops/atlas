...
export const metadata: Metadata = {
  title: "Choose Best Critical Panel Ac Centrifugal Fan Cooling Solved [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Choose Best Critical Panel Ac Centrifugal Fan Cooling Solved [2026 Updated] - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/panel-ac-centrifugal-fan" },
  openGraph: {
    title: "Choose Best Critical Panel Ac Centrifugal Fan Cooling Solved [2026 Updated] | Hitech Aircool Engineers",
    description: "Choose Best Critical Panel Ac Centrifugal Fan Cooling Solved [2026 Updated] - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/panel-ac-centrifugal-fan",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Choose Best Critical Panel Ac Centrifugal Fan Cooling Solved [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagepanelaccentrifugalfan() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Choose Best Critical Panel Ac Centrifugal Fan Cooling Solved [2026 Updated]</h1>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/centrifugal-fan.webp" alt="Choose Best Critical Panel Ac Centrifugal Fan Cooling Solved [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Choose Best Critical Panel Ac Centrifugal Fan Cooling Solved [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Choose Best Critical Panel Ac Centrifugal Fan Cooling Solved [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
