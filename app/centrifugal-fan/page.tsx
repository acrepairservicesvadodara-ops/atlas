...
export const metadata: Metadata = {
  title: "Top-Rated Centrifugal Fan For Panel Air Condition At 6500/- | Hitech Aircool Engineers Gujarat",
  description: "Top-Rated Centrifugal Fan For Panel Air Condition At 6500/- - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/centrifugal-fan" },
  openGraph: {
    title: "Top-Rated Centrifugal Fan For Panel Air Condition At 6500/- | Hitech Aircool Engineers",
    description: "Top-Rated Centrifugal Fan For Panel Air Condition At 6500/- - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/centrifugal-fan",
    type: "website",
    images: ["/images/products/centrifugal-fan.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Top-Rated Centrifugal Fan For Panel Air Condition At 6500/-",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagecentrifugalfan() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Top-Rated Centrifugal Fan For Panel Air Condition At 6500/-</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">&lt;img style=&quot;max-width: 100%; border-radius: ...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">&lt;img style=&quot;max-width: 100%; border-radius: ...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/centrifugal-fan.webp" alt="Top-Rated Centrifugal Fan For Panel Air Condition At 6500/-" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/panel-ac-centrifugal-fan.webp" alt="Top-Rated Centrifugal Fan For Panel Air Condition At 6500/-" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What centrifugal fans does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides centrifugal fan, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book centrifugal fan?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency centrifugal fan available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What centrifugal fans does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides centrifugal fan, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book centrifugal fan?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency centrifugal fan available. Call +91 93289 53665 for immediate assistance." } },
