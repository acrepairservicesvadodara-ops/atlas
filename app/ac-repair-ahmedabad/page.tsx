...
export const metadata: Metadata = {
  title: "✅ Expert AC Repair Ahmedabad | Atlas Aircon Gujarat",
  description: "Struggling with a faulty AC? Get prompt & professional AC repair in Ahmedabad. Expert technicians, same-day service & 100% guarantee on all repairs. Call!",
  alternates: { canonical: "https://atlasaircons.com/ac-repair-ahmedabad" },
  openGraph: {
    title: "✅ Expert AC Repair Ahmedabad | Atlas Aircon",
    description: "Struggling with a faulty AC? Get prompt & professional AC repair in Ahmedabad. Expert technicians, same-day service & 100% guarantee on all repairs. Call!",
    url: "https://atlasaircons.com/ac-repair-ahmedabad",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "✅ Expert AC Repair Ahmedabad",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
...
export default function Pageacrepairahmedabad() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">✅ Expert AC Repair Ahmedabad</h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Struggling with a faulty AC? Get prompt &amp; professional AC repair in Ahmedabad. Expert technicians, same-day service &amp; 100% guarantee on all repairs. Call!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Struggling with a faulty AC? Get prompt &amp; professional AC repair in Ahmedabad. Expert technicians, same-day service &amp; 100% guarantee on all repairs. Call!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/emergency-24hrs-7-days-ac-repairing.webp" alt="✅ Expert AC Repair Ahmedabad" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="✅ Expert AC Repair Ahmedabad" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Ac Repair Ahmedabad in Vadodara?", a: "Ac Repair Ahmedabad cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Ac Repair Ahmedabad?", a: "Atlas Aircon offers same-day Ac Repair Ahmedabad across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Ac Repair Ahmedabads?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Ac Repair Ahmedabads depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Ac Repair Ahmedabad available on holidays?", a: "Yes, Atlas Aircon provides Ac Repair Ahmedabad 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
              { q: "How long does Ac Repair Ahmedabad take?", a: "Most Ac Repair Ahmedabads are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Ac Repair Ahmedabad in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Ac Repair Ahmedabad cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Ac Repair Ahmedabad?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Ac Repair Ahmedabad across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Ac Repair Ahmedabads?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Ac Repair Ahmedabads depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Ac Repair Ahmedabad available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Ac Repair Ahmedabad 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
          { "@type": "Question", name: "How long does Ac Repair Ahmedabad take?", acceptedAnswer: { "@type": "Answer", text: "Most Ac Repair Ahmedabads are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
