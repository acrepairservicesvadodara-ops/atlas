...
export const metadata: Metadata = {
  title: "Energy Saving AC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Energy efficient AC service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Energy Saving AC Vadodara",
    "energy saving ac",
    "Energy Saving AC installation",
    "Energy Saving AC service",
    "Energy Saving AC repair",
    "best Energy Saving AC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/energy-saving-ac-vadodara",
  },
};

const keywordData = {
  title: "Energy Saving AC",
  slug: "energy-saving-ac",
  description: "Energy efficient AC service",
  category: "Commercial"
};
...
export default function EnergySavingACPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What energy saving ac vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides energy saving ac vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book energy saving ac vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency energy saving ac vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What energy saving ac vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides energy saving ac vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book energy saving ac vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency energy saving ac vadodara available. Call +91 93289 53665 for immediate assistance." } },
