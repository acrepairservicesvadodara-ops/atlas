...
export const metadata: Metadata = {
  title: "Voltas AC Service Center Vadodara | Professional HVAC Service | Hitech Aircool Engineers",
  description: "Voltas AC Service Center Vadodara — Professional service service by Hitech Aircool Engineers. Certified technicians, genuine parts, warranty included. Serving Vadodara, Gujarat & all GIDC zones. Call +91 93289 53665.",
  keywords: ["voltas ac service center vadodara", "service service", "hvac service vadodara", "hitech aircool engineers", "ac service gujarat"],
  alternates: { canonical: "https://hitechairconditioning.in/voltas-ac-service-center-vadodara" },
  openGraph: { title: "Voltas AC Service Center Vadodara | Hitech Aircool Engineers", description: "Professional service service by Hitech Aircool Engineers Gujarat.", url: "https://hitechairconditioning.in/voltas-ac-service-center-vadodara", type: "website" },
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Voltas AC Service Center Vadodara",
  provider: { "@type": "LocalBusiness", name: "Hitech Aircool Engineers", telephone: "+919328953665" },
  areaServed: { "@type": "State", name: "Gujarat" },
  serviceType: "Voltas AC Service Center Vadodara",
};

export default function VoltasACServiceCenterVadodaraPage() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Voltas AC Service Center Vadodara</h1>
