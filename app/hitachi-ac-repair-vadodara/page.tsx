...
export const metadata: Metadata = {
  title: "Hitachi AC Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Hitachi AC repair service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Hitachi AC Repair Vadodara",
    "hitachi ac repair",
    "Hitachi AC Repair installation",
    "Hitachi AC Repair service",
    "Hitachi AC Repair repair",
    "best Hitachi AC Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/hitachi-ac-repair-vadodara",
  },
};

const keywordData = {
  title: "Hitachi AC Repair",
  slug: "hitachi-ac-repair",
  description: "Hitachi AC repair service",
  category: "Brands"
};
...
export default function HitachiACRepairPage() {
  return (
    <>
      {/* Hero Section */}
