...
export const metadata: Metadata = {
  title: "🏭 AC Service Morbi | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ac-service-morbi" },
  openGraph: {
    title: "🏭 AC Service Morbi | Atlas Aircon",
    description: "Morbi's industrial AC experts! Specialized service for ceramic factories, tile plants & showrooms. 24/7 industrial-grade maintenance & commercial AC repair. Cal",
    url: "https://atlasaircons.com/ac-service-morbi",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Morbi&apos;s industrial AC experts! Specialized service for ceramic factories, tile plants &amp; showrooms. 24/7 industrial-grade maintenance &amp; commercial AC repair. Call now!</p>
