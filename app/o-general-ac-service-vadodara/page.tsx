...
export const metadata: Metadata = {
  ...
  description: "O General AC repair and service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    ...
    "O General AC service",
    "O General AC repair",
    "best O General AC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/o-general-ac-service-vadodara",
  },
};

const keywordData = {
  title: "O General AC Service",
  slug: "o-general-ac-service",
  description: "O General AC repair and service",
  category: "Brands"
};
