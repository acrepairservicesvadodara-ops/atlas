...
export const metadata: Metadata = {
  title: "Scroll Chiller Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Scroll chiller service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Scroll Chiller Repair Vadodara",
    "scroll chiller repair",
    "Scroll Chiller Repair installation",
    "Scroll Chiller Repair service",
    "Scroll Chiller Repair repair",
    "best Scroll Chiller Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/scroll-chiller-repair-vadodara",
  },
};

const keywordData = {
  title: "Scroll Chiller Repair",
  slug: "scroll-chiller-repair",
  description: "Scroll chiller service",
  category: "Commercial"
};
...
export default function ScrollChillerRepairPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVscroll chiller repair vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial scroll chiller repair vadodara?", a: "Industrial scroll chiller repair vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVscroll chiller repair vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial scroll chiller repair vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial scroll chiller repair vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
