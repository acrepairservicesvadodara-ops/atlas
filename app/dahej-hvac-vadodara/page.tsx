...
export const metadata: Metadata = {
  title: "Dahej HVAC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "HVAC service in Dahej in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Dahej HVAC Vadodara",
    "dahej hvac",
    "Dahej HVAC installation",
    "Dahej HVAC service",
    "Dahej HVAC repair",
    "best Dahej HVAC service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/dahej-hvac-vadodara",
  },
};
...
const keywordData = {
  title: "Dahej HVAC",
  slug: "dahej-hvac",
  description: "HVAC service in Dahej",
  category: "OutCity"
};
...
export default function DahejHVACPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVdahej hvac vadodaras?", a: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
              ...
              { q: "What is cost of industrial dahej hvac vadodara?", a: "Industrial dahej hvac vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVdahej hvac vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
          ...
          { "@type": "Question", name: "What is cost of industrial dahej hvac vadodara?", acceptedAnswer: { "@type": "Answer", text: "Industrial dahej hvac vadodara costs vary by equipment type and issue. We provide free inspection and detailed quotation before proceeding." } },
