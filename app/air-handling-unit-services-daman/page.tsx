...
export const metadata: Metadata = {
  title: "Air Handling Unit Services Daman | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/air-handling-unit-services-daman" },
  openGraph: {
    title: "Air Handling Unit Services Daman | Atlas Aircon",
    description: "Reliable Air Handling Unit Services in Daman. Expert AHU repair, maintenance & installation for factories, hotels & casinos. Ensure compliance, guest comfort & ",
    url: "https://atlasaircons.com/air-handling-unit-services-daman",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Reliable Air Handling Unit Services in Daman. Expert AHU repair, maintenance &amp; installation for factories, hotels &amp; casinos. Ensure compliance, guest comfort &amp; lower costs. Schedule On-Site Today!</p>
