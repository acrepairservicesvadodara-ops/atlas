...
export const metadata: Metadata = {
  title: "Hitachi AC in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Hitachi AC service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Hitachi AC Vadodara",
    "hitachi ac",
  ...
  alternates: {
    canonical: "https://hitechairconditioning.in/hitachi-ac-vadodara",
  },
};
...
const keywordData = {
  title: "Hitachi AC",
  slug: "hitachi-ac",
  description: "Hitachi AC service",
  category: "Brands"
};
...
export default function HitachiACPage() {
  return (
    <>
      {/* Hero Section */}
