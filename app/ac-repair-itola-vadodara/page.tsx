...
export const metadata: Metadata = {
  title: "AC Repair Itola in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "AC repair in Itola in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "AC Repair Itola Vadodara",
    "ac repair itola",
    "AC Repair Itola installation",
    "AC Repair Itola service",
    "AC Repair Itola repair",
    "best AC Repair Itola service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/ac-repair-itola-vadodara",
  },
};

const keywordData = {
  title: "AC Repair Itola",
  slug: "ac-repair-itola",
  description: "AC repair in Itola",
  category: "Area"
};
...
export default function ACRepairItolaPage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Ac Repair Itola Vadodara in Vadodara?", a: "Ac Repair Itola Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Ac Repair Itola Vadodara?", a: "Hitech Aircool Engineers offers same-day Ac Repair Itola Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." },
              { q: "Do you provide warranty on Ac Repair Itola Vadodaras?", a: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Ac Repair Itola Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Ac Repair Itola Vadodara available on holidays?", a: "Yes, Hitech Aircool Engineers provides Ac Repair Itola Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." },
              { q: "How long does Ac Repair Itola Vadodara take?", a: "Most Ac Repair Itola Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What is the cost of Ac Repair Itola Vadodara in Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Ac Repair Itola Vadodara cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Hitech Aircool Engineers provides upfront pricing with no hidden charges." } },
          { "@type": "Question", name: "How quickly can you come for Ac Repair Itola Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers offers same-day Ac Repair Itola Vadodara across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 93289 53665." } },
          { "@type": "Question", name: "Do you provide warranty on Ac Repair Itola Vadodaras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides 30 to 90 days warranty on Ac Repair Itola Vadodaras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Ac Repair Itola Vadodara available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Hitech Aircool Engineers provides Ac Repair Itola Vadodara 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 93289 53665." } },
          { "@type": "Question", name: "How long does Ac Repair Itola Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Most Ac Repair Itola Vadodaras are completed within 1-2 hours. Complex repairs involving compressor replacement or major parts may take 3-4 hours. Our technician provides estimated time upfront." } },
