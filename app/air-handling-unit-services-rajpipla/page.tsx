...
export const metadata: Metadata = {
  title: "Air Handling Unit Services Rajpipla | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/air-handling-unit-services-rajpipla" },
  openGraph: {
    title: "Air Handling Unit Services Rajpipla | Atlas Aircon",
    description: "Trusted Air Handling Unit Services in Rajpipla. Expert repair, maintenance & installation for factories, hotels & hospitals. Reliable, local technicians ensure ",
    url: "https://atlasaircons.com/air-handling-unit-services-rajpipla",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Trusted Air Handling Unit Services in Rajpipla. Expert repair, maintenance &amp; installation for factories, hotels &amp; hospitals. Reliable, local technicians ensure clean air &amp; maximum efficiency. Call Now!</p>
