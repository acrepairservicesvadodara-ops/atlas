...
export const metadata: Metadata = {
  title: "Air Handling Unit Services Rajpipla | Hitech Aircool Engineers Gujarat",
  description: "Trusted Air Handling Unit Services in Rajpipla. Expert repair, maintenance & installation for factories, hotels & hospitals. Reliable, local technicians ensure ",
  alternates: { canonical: "https://hitechairconditioning.in/air-handling-unit-services-rajpipla" },
  openGraph: {
    title: "Air Handling Unit Services Rajpipla | Hitech Aircool Engineers",
    description: "Trusted Air Handling Unit Services in Rajpipla. Expert repair, maintenance & installation for factories, hotels & hospitals. Reliable, local technicians ensure ",
    url: "https://hitechairconditioning.in/air-handling-unit-services-rajpipla",
    type: "website",
    images: ["/images/products/air-handling-unit.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Air Handling Unit Services Rajpipla",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageairhandlingunitservicesrajpipla() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Air Handling Unit Services Rajpipla</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Trusted Air Handling Unit Services in Rajpipla. Expert repair, maintenance &amp; installation for factories, hotels &amp; hospitals. Reliable, local technicians ensure clean air &amp; maximum efficiency. Call Now!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Trusted Air Handling Unit Services in Rajpipla. Expert repair, maintenance &amp; installation for factories, hotels &amp; hospitals. Reliable, local technicians ensure clean air &amp; maximum efficiency. Call Now!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/air-handling-unit.webp" alt="Air Handling Unit Services Rajpipla" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Air Handling Unit Services Rajpipla" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does Air Handling Unit Services Rajpipla include?", a: "Air Handling Unit Services Rajpipla includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does Air Handling Unit Services Rajpipla cost?", a: "Air Handling Unit Services Rajpipla starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will Air Handling Unit Services Rajpipla improve cooling?", a: "Yes, proper Air Handling Unit Services Rajpipla can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does Air Handling Unit Services Rajpipla reduce electricity bills?", a: "Regular Air Handling Unit Services Rajpipla can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does Air Handling Unit Services Rajpipla take?", a: "Basic Air Handling Unit Services Rajpipla takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can Air Handling Unit Services Rajpipla remove bad smell?", a: "Yes, Air Handling Unit Services Rajpipla includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in Air Handling Unit Services Rajpipla?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does Air Handling Unit Services Rajpipla include?", acceptedAnswer: { "@type": "Answer", text: "Air Handling Unit Services Rajpipla includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does Air Handling Unit Services Rajpipla cost?", acceptedAnswer: { "@type": "Answer", text: "Air Handling Unit Services Rajpipla starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will Air Handling Unit Services Rajpipla improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper Air Handling Unit Services Rajpipla can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does Air Handling Unit Services Rajpipla reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular Air Handling Unit Services Rajpipla can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does Air Handling Unit Services Rajpipla take?", acceptedAnswer: { "@type": "Answer", text: "Basic Air Handling Unit Services Rajpipla takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can Air Handling Unit Services Rajpipla remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, Air Handling Unit Services Rajpipla includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in Air Handling Unit Services Rajpipla?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
