...
export const metadata: Metadata = {
  title: "AC Size Calculator &raquo; Atlas Aircon [2026 Updated] | Atlas Aircon Gujarat",
  description: "Don't buy the wrong AC. Calculate the exact tonnage for your room.",
  alternates: { canonical: "https://atlasaircons.com/ac-tonnage-calculator" },
  openGraph: {
    title: "AC Size Calculator &raquo; Atlas Aircon [2026 Updated] | Atlas Aircon",
    description: "Don't buy the wrong AC. Calculate the exact tonnage for your room.",
    url: "https://atlasaircons.com/ac-tonnage-calculator",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "AC Size Calculator &raquo; Atlas Aircon [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">AC Size Calculator &amp;raquo; Atlas Aircon [2026 Updated]</h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Don&apos;t buy the wrong AC. Calculate the exact tonnage for your room.</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What ac tonnage calculators does Atlas Aircon provide?", a: "Atlas Aircon provides ac tonnage calculator, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book ac tonnage calculator?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency ac tonnage calculator available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What ac tonnage calculators does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides ac tonnage calculator, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book ac tonnage calculator?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency ac tonnage calculator available. Call +91 97272 57141 for immediate assistance." } },
