...
export const metadata: Metadata = {
  title: "24/7 Emergency Statewide Chiller Repair Services Gujarat [2026 Updated] | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/chiller-repair-services-gujarat" },
  openGraph: {
    title: "24/7 Emergency Statewide Chiller Repair Services Gujarat [2026 Updated] | Atlas Aircon",
    description: "Chiller Repair Services Gujarat - Expert network for factories, cold storage & IT parks. Fast emergency repair, compressor, tube cleaning & AMC in all districts",
    url: "https://atlasaircons.com/chiller-repair-services-gujarat",
    type: "website",
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Chiller Repair Services Gujarat - Expert network for factories, cold storage &amp; IT parks. Fast emergency repair, compressor, tube cleaning &amp; AMC in all districts. Prevent costly downtime. Call now!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "Do you provide industrial HVchiller repair services gujarats?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "Do you provide industrial HVchiller repair services gujarats?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC." } },
