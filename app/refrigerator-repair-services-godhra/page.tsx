...
export const metadata: Metadata = {
  title: "Trusted 24/7 Refrigerator Repair Services Godhra | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/refrigerator-repair-services-godhra" },
  openGraph: {
    title: "Trusted 24/7 Refrigerator Repair Services Godhra | Atlas Aircon",
    description: "Fridge broken in Godhra? Get reliable, same-day repair at home by expert technicians for LG, Samsung & all brands. Free check-up, genuine parts & warranty. Call",
    url: "https://atlasaircons.com/refrigerator-repair-services-godhra",
    type: "website",
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Fridge broken in Godhra? Get reliable, same-day repair at home by expert technicians for LG, Samsung &amp; all brands. Free check-up, genuine parts &amp; warranty. Call now for quick service!</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What is the cost of Refrigerator Repair Services Godhra in Vadodara?", a: "Refrigerator Repair Services Godhra cost starts from ₹299 for inspection. Gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
              { q: "How quickly can you come for Refrigerator Repair Services Godhra?", a: "Atlas Aircon offers same-day Refrigerator Repair Services Godhra across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
              { q: "Do you provide warranty on Refrigerator Repair Services Godhras?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on Refrigerator Repair Services Godhras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
              ...
              { q: "Is emergency Refrigerator Repair Services Godhra available on holidays?", a: "Yes, Atlas Aircon provides Refrigerator Repair Services Godhra 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How quickly can you come for Refrigerator Repair Services Godhra?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon offers same-day Refrigerator Repair Services Godhra across Vadodara. Our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." } },
          { "@type": "Question", name: "Do you provide warranty on Refrigerator Repair Services Godhras?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides 30 to 90 days warranty on Refrigerator Repair Services Godhras depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." } },
          ...
          { "@type": "Question", name: "Is emergency Refrigerator Repair Services Godhra available on holidays?", acceptedAnswer: { "@type": "Answer", text: "Yes, Atlas Aircon provides Refrigerator Repair Services Godhra 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." } },
