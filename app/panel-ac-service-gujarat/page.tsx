...
export const metadata: Metadata = {
  title: "Industrial Panel AC Service Gujarat | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/panel-ac-service-gujarat" },
  openGraph: {
    title: "Industrial Panel AC Service Gujarat | Atlas Aircon",
    description: "Gujarat's leading industrial panel AC service gujarat network. Expert service for Rittal, Schneider units in all major GIDCs - Ahmedabad, Vadodara, Surat, Bharu",
    url: "https://atlasaircons.com/panel-ac-service-gujarat",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Gujarat&apos;s leading industrial panel AC service gujarat network. Expert service for Rittal, Schneider units in all major GIDCs - Ahmedabad, Vadodara, Surat, Bharuch, Rajkot, Vapi. 24/7 Statewide Support.</p>
