...
export const metadata: Metadata = {
  title: "Industrial Panel AC Service Gujarat | Hitech Aircool Engineers Gujarat",
  description: "Gujarat's leading industrial panel AC service gujarat network. Expert service for Rittal, Schneider units in all major GIDCs - Ahmedabad, Vadodara, Surat, Bharu",
  alternates: { canonical: "https://hitechairconditioning.in/panel-ac-service-gujarat" },
  openGraph: {
    title: "Industrial Panel AC Service Gujarat | Hitech Aircool Engineers",
    description: "Gujarat's leading industrial panel AC service gujarat network. Expert service for Rittal, Schneider units in all major GIDCs - Ahmedabad, Vadodara, Surat, Bharu",
    url: "https://hitechairconditioning.in/panel-ac-service-gujarat",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Industrial Panel AC Service Gujarat",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pagepanelacservicegujarat() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Industrial Panel AC Service Gujarat</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Gujarat&apos;s leading industrial panel AC service gujarat network. Expert service for Rittal, Schneider units in all major GIDCs - Ahmedabad, Vadodara, Surat, Bharuch, Rajkot, Vapi. 24/7 Statewide Support.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Gujarat&apos;s leading industrial panel AC service gujarat network. Expert service for Rittal, Schneider units in all major GIDCs - Ahmedabad, Vadodara, Surat, Bharuch, Rajkot, Vapi. 24/7 Statewide Support.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/panel-ac-repair-service.webp" alt="Industrial Panel AC Service Gujarat" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Industrial Panel AC Service Gujarat" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
