...
export const metadata: Metadata = {
  title: "5 Ton AC Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "5 ton AC service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "5 Ton AC Service Vadodara",
    "5 ton ac service",
    "5 Ton AC Service installation",
    "5 Ton AC Service service",
    "5 Ton AC Service repair",
    "best 5 Ton AC Service service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/5-ton-ac-service-vadodara",
  },
};

const keywordData = {
  title: "5 Ton AC Service",
  slug: "5-ton-ac-service",
  description: "5 ton AC service",
  category: "Tonnage"
};
...
export default function AC5TonACServicePage() {
  return (
    <>
      {/* Hero Section */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What does 5 Ton Ac Service Vadodara include?", a: "5 Ton Ac Service Vadodara includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." },
              { q: "How much does 5 Ton Ac Service Vadodara cost?", a: "5 Ton Ac Service Vadodara starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." },
              ...
              { q: "Will 5 Ton Ac Service Vadodara improve cooling?", a: "Yes, proper 5 Ton Ac Service Vadodara can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." },
              { q: "Does 5 Ton Ac Service Vadodara reduce electricity bills?", a: "Regular 5 Ton Ac Service Vadodara can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." },
              { q: "How long does 5 Ton Ac Service Vadodara take?", a: "Basic 5 Ton Ac Service Vadodara takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." },
              { q: "Can 5 Ton Ac Service Vadodara remove bad smell?", a: "Yes, 5 Ton Ac Service Vadodara includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." },
              { q: "Is gas top-up included in 5 Ton Ac Service Vadodara?", a: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What does 5 Ton Ac Service Vadodara include?", acceptedAnswer: { "@type": "Answer", text: "5 Ton Ac Service Vadodara includes filter cleaning, coil jet wash, drain pipe clearing, gas pressure check, electrical inspection, fan motor check, and performance testing." } },
          { "@type": "Question", name: "How much does 5 Ton Ac Service Vadodara cost?", acceptedAnswer: { "@type": "Answer", text: "5 Ton Ac Service Vadodara starts from ₹499 for basic service. Deep jet cleaning is ₹799 for split AC, ₹599 for window AC. Chemical wash starts from ₹999." } },
          ...
          { "@type": "Question", name: "Will 5 Ton Ac Service Vadodara improve cooling?", acceptedAnswer: { "@type": "Answer", text: "Yes, proper 5 Ton Ac Service Vadodara can improve cooling efficiency by 20-30%. Dirty filters and coils reduce airflow and heat exchange." } },
          { "@type": "Question", name: "Does 5 Ton Ac Service Vadodara reduce electricity bills?", acceptedAnswer: { "@type": "Answer", text: "Regular 5 Ton Ac Service Vadodara can reduce electricity consumption by 15-25%. A well-maintained AC runs more efficiently, saving power." } },
          { "@type": "Question", name: "How long does 5 Ton Ac Service Vadodara take?", acceptedAnswer: { "@type": "Answer", text: "Basic 5 Ton Ac Service Vadodara takes 30-45 minutes. Deep cleaning with jet wash takes 1-1.5 hours. Chemical foam cleaning takes about 2 hours." } },
          { "@type": "Question", name: "Can 5 Ton Ac Service Vadodara remove bad smell?", acceptedAnswer: { "@type": "Answer", text: "Yes, 5 Ton Ac Service Vadodara includes cleaning of filters, coils, and drain pan which removes bacteria and mold causing odors. Anti-bacterial spray applied." } },
          { "@type": "Question", name: "Is gas top-up included in 5 Ton Ac Service Vadodara?", acceptedAnswer: { "@type": "Answer", text: "Basic service includes gas pressure check. If gas is low, top-up is charged separately — R22 from ₹1,500, R32/R410A from ₹2,000." } },
