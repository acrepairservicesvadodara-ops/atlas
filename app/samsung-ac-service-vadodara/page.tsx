...
export const metadata: Metadata = {
  title: "Samsung AC Service in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Samsung AC repair in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Samsung AC Service Vadodara",
    "samsung ac service",
    "Samsung AC Service installation",
    "Samsung AC Service service",
    "Samsung AC Service repair",
    "best Samsung AC Service service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/samsung-ac-service-vadodara",
  },
};

const keywordData = {
  title: "Samsung AC Service",
  slug: "samsung-ac-service",
  description: "Samsung AC repair",
  category: "Brands"
};
...
export default function SamsungACServicePage() {
  return (
    <>
      {/* Hero Section */}
