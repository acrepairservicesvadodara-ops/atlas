...
export const metadata: Metadata = {
  title: "Ductable AC Service Rajpipla | Atlas Aircon Gujarat",
  ...
  alternates: { canonical: "https://atlasaircons.com/ductable-ac-service-rajpipla" },
  openGraph: {
    title: "Ductable AC Service Rajpipla | Atlas Aircon",
    description: "Your local Ductable AC service Rajpipla. ✅ Reliable installation, urgent repair & affordable maintenance for homes, shops & offices. Fast service by certified t",
    url: "https://atlasaircons.com/ductable-ac-service-rajpipla",
    type: "website",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">Your local Ductable AC service Rajpipla. ✅ Reliable installation, urgent repair &amp; affordable maintenance for homes, shops &amp; offices. Fast service by certified technicians. Call now for an estimate!</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/cropped-AtlasAircon-Logo.webp" alt="Ductable AC Service Rajpipla" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
