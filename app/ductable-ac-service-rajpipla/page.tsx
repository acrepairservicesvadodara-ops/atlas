...
export const metadata: Metadata = {
  title: "Ductable AC Service Rajpipla | Hitech Aircool Engineers Gujarat",
  description: "Your local Ductable AC service Rajpipla. ✅ Reliable installation, urgent repair & affordable maintenance for homes, shops & offices. Fast service by certified t",
  alternates: { canonical: "https://hitechairconditioning.in/ductable-ac-service-rajpipla" },
  openGraph: {
    title: "Ductable AC Service Rajpipla | Hitech Aircool Engineers",
    description: "Your local Ductable AC service Rajpipla. ✅ Reliable installation, urgent repair & affordable maintenance for homes, shops & offices. Fast service by certified t",
    url: "https://hitechairconditioning.in/ductable-ac-service-rajpipla",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Ductable AC Service Rajpipla",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageductableacservicerajpipla() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Ductable AC Service Rajpipla</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">Your local Ductable AC service Rajpipla. ✅ Reliable installation, urgent repair &amp; affordable maintenance for homes, shops &amp; offices. Fast service by certified technicians. Call now for an estimate!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">Your local Ductable AC service Rajpipla. ✅ Reliable installation, urgent repair &amp; affordable maintenance for homes, shops &amp; offices. Fast service by certified technicians. Call now for an estimate!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/hitech-logo.webp" alt="Ductable AC Service Rajpipla" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Ductable AC Service Rajpipla" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
