...
export const metadata: Metadata = {
  title: "#1 Advance Panel AC & Chiller Repair Service Center [2026 Updated] | Hitech Aircool Engineers Gujarat",
  description: "Professional #1 advance panel ac & chiller repair service center [2026 updated] by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/advance-panel-ac-service-center" },
  openGraph: {
    title: "#1 Advance Panel AC & Chiller Repair Service Center [2026 Updated] | Hitech Aircool Engineers",
    description: "Professional #1 advance panel ac & chiller repair service center [2026 updated] by Hitech Aircool Engineers. Certified technicians, same-day service, transparent pricing. Serving Vadodara & Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/advance-panel-ac-service-center",
    type: "website",
    images: ["/images/products/panel-ac-centrifugal-fan.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "#1 Advance Panel AC & Chiller Repair Service Center [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageadvancepanelacservicecenter() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">#1 Advance Panel AC &amp; Chiller Repair Service Center [2026 Updated]</h1>
              <p className="text-xl text-teal-100 mb-8 leading-relaxed">&lt;script src=&quot;https://cdn.jsdelivr.net/npm/lucide-react@0...</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p className="text-gray-600 mb-4">&lt;script src=&quot;https://cdn.jsdelivr.net/npm/lucide-react@0...</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/panel-ac-centrifugal-fan.webp" alt="#1 Advance Panel AC & Chiller Repair Service Center [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/panel-ac-centrifugal-fan.webp" alt="#1 Advance Panel AC & Chiller Repair Service Center [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="#1 Advance Panel AC & Chiller Repair Service Center [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="#1 Advance Panel AC & Chiller Repair Service Center [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
