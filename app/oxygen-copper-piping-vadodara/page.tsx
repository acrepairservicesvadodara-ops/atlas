...
export const metadata: Metadata = {
  title: "#1 Expert Oxygen Copper Piping In Vadodara | Atlas Aircon Gujarat",
  description: "#1 Expert Oxygen Copper Piping In Vadodara - Atlas Aircon Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 97272 57141.",
  alternates: { canonical: "https://atlasaircons.com/oxygen-copper-piping-vadodara" },
  openGraph: {
    title: "#1 Expert Oxygen Copper Piping In Vadodara | Atlas Aircon",
    description: "#1 Expert Oxygen Copper Piping In Vadodara - Atlas Aircon Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 97272 57141.",
    url: "https://atlasaircons.com/oxygen-copper-piping-vadodara",
    type: "website",
  ...
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What oxygen copper piping vadodaras does Atlas Aircon provide?", a: "Atlas Aircon provides oxygen copper piping vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book oxygen copper piping vadodara?", a: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency oxygen copper piping vadodara available. Call +91 97272 57141 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What oxygen copper piping vadodaras does Atlas Aircon provide?", acceptedAnswer: { "@type": "Answer", text: "Atlas Aircon provides oxygen copper piping vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book oxygen copper piping vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 97272 57141, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency oxygen copper piping vadodara available. Call +91 97272 57141 for immediate assistance." } },
