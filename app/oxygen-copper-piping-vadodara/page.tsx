...
export const metadata: Metadata = {
  title: "#1 Expert Oxygen Copper Piping In Vadodara | Hitech Aircool Engineers Gujarat",
  description: "#1 Expert Oxygen Copper Piping In Vadodara - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
  alternates: { canonical: "https://hitechairconditioning.in/oxygen-copper-piping-vadodara" },
  openGraph: {
    title: "#1 Expert Oxygen Copper Piping In Vadodara | Hitech Aircool Engineers",
    description: "#1 Expert Oxygen Copper Piping In Vadodara - Hitech Aircool Engineers Vadodara. Professional AC repair, installation & maintenance services across Gujarat. Call +91 93289 53665.",
    url: "https://hitechairconditioning.in/oxygen-copper-piping-vadodara",
    type: "website",
    images: ["/images/products/Ac-Copper-Piping.webp"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "#1 Expert Oxygen Copper Piping In Vadodara",
  provider: {
    "@type": "LocalBusiness",
...
export default function Pageoxygencopperpipingvadodara() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">#1 Expert Oxygen Copper Piping In Vadodara</h1>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Ac-Copper-Piping.webp" alt="#1 Expert Oxygen Copper Piping In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="#1 Expert Oxygen Copper Piping In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="#1 Expert Oxygen Copper Piping In Vadodara" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
        </div>
      </section>
      {/* Why Choose */}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: "What oxygen copper piping vadodaras does Hitech Aircool Engineers provide?", a: "Hitech Aircool Engineers provides oxygen copper piping vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." },
              { q: "How do I book oxygen copper piping vadodara?", a: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." },
              ...
              { q: "Is emergency service available?", a: "Yes, 24/7 emergency oxygen copper piping vadodara available. Call +91 93289 53665 for immediate assistance." },
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "FAQPage",
        mainEntity: [
          { "@type": "Question", name: "What oxygen copper piping vadodaras does Hitech Aircool Engineers provide?", acceptedAnswer: { "@type": "Answer", text: "Hitech Aircool Engineers provides oxygen copper piping vadodara, service, installation, AMC, gas refilling, and maintenance for all brands and types in Vadodara." } },
          { "@type": "Question", name: "How do I book oxygen copper piping vadodara?", acceptedAnswer: { "@type": "Answer", text: "Call +91 93289 53665, WhatsApp us, or book online. Same-day service available across Vadodara." } },
          ...
          { "@type": "Question", name: "Is emergency service available?", acceptedAnswer: { "@type": "Answer", text: "Yes, 24/7 emergency oxygen copper piping vadodara available. Call +91 93289 53665 for immediate assistance." } },
