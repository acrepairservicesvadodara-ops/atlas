...
export const metadata: Metadata = {
  title: "Window AC Repair in Vadodara | Installation, Service & Repair | Hitech Aircool Engineers",
  description: "Window AC repair service in Vadodara. Expert AC installation, service & repair. 20+ years experience, 90-day warranty. Call +91 93289 53665",
  keywords: [
    "Window AC Repair Vadodara",
    "window ac repair",
    "Window AC Repair installation",
    "Window AC Repair service",
    "Window AC Repair repair",
    "best Window AC Repair service",
  ],
  alternates: {
    canonical: "https://hitechairconditioning.in/window-ac-repair-vadodara",
  },
};
...
const keywordData = {
  ...
  description: "Window AC repair service",
  category: "ACTypes"
};
...
export default function WindowACRepairPage() {
  return (
    <>
      {/* Hero Section */}
