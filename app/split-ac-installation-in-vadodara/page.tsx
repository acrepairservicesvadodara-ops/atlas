...
export const metadata: Metadata = {
  title: "Split AC Installation Service In Vadodara &raquo; +91-9727257141 [2026 Updated] | Atlas Aircon Gujarat",
  description: "The Ultimate Guide to Split AC Installation service in Vadodara: A Com...",
  alternates: { canonical: "https://atlasaircons.com/split-ac-installation-in-vadodara" },
  openGraph: {
    title: "Split AC Installation Service In Vadodara &raquo; +91-9727257141 [2026 Updated] | Atlas Aircon",
    description: "The Ultimate Guide to Split AC Installation service in Vadodara: A Com...",
    url: "https://atlasaircons.com/split-ac-installation-in-vadodara",
    type: "website",
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Split AC Installation Service In Vadodara &raquo; +91-9727257141 [2026 Updated]",
  provider: {
    "@type": "LocalBusiness",
    name: "Atlas Aircon",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Split AC Installation Service In Vadodara &amp;raquo; +91-9727257141 [2026 Updated]</h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">The Ultimate Guide to Split AC Installation service in Vadodara: A Com...</p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              <img src="/images/products/Split-Ac-Repair-Service.webp" alt="Split AC Installation Service In Vadodara &raquo; +91-9727257141 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/atlas-aircon-logo.webp" alt="Split AC Installation Service In Vadodara &raquo; +91-9727257141 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/Installation-Process-of-Window-Air-conditioner-by-Atlas-Aircon-AC-Repair-Serivce-Vadodara.webp" alt="Split AC Installation Service In Vadodara &raquo; +91-9727257141 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Split-Ac-Repair-Service.webp" alt="Split AC Installation Service In Vadodara &raquo; +91-9727257141 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Split-Ac-Repair-Service.webp" alt="Split AC Installation Service In Vadodara &raquo; +91-9727257141 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
              <img src="/images/products/Split-Ac-Repair-Service.webp" alt="Split AC Installation Service In Vadodara &raquo; +91-9727257141 [2026 Updated]" className="w-full h-48 object-cover rounded-xl" loading="lazy" />
          </div>
