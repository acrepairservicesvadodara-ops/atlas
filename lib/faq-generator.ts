// FAQ Generation System for Atlas Aircon
...
const serviceTemplates = {
  repair: [
    { q: "What is the cost of {service} in {area}?", a: "The cost of {service} in {area} starts from ₹299 for inspection. Actual repair costs depend on the issue — gas refilling from ₹1,500, PCB repair from ₹1,200, compressor repair from ₹3,500. Atlas Aircon provides upfront pricing with no hidden charges." },
    { q: "How quickly can you come for {service}?", a: "Atlas Aircon offers same-day {service} across {area}. In most cases, our certified technician reaches within 90 minutes to 3 hours of booking. For emergencies, call +91 97272 57141." },
    { q: "Do you provide warranty on {service}?", a: "Yes, Atlas Aircon provides 30 to 90 days warranty on {service} depending on the work performed. Spare parts like compressors, PCBs, and motors come with manufacturer warranty." },
    ...
    { q: "Is {service} available on Sundays and holidays?", a: "Yes, Atlas Aircon provides {service} 7 days a week including Sundays and public holidays. Our 24/7 emergency service is available at +91 97272 57141." },
    ...
    { q: "What if my AC problem returns after {service}?", a: "If the same issue recurs within the warranty period after {service}, we'll fix it free of charge. Simply call us at +91 97272 57141 and reference your previous service." },
    { q: "Are your technicians certified for {service}?", a: "Yes, all Atlas Aircon technicians are factory-trained and certified for {service}. They undergo regular training on new AC technologies and brands." },
  ],
  installation: [
    ...
    { q: "Do you provide the AC unit or only {service}?", a: "Atlas Aircon provides {service} only. We can recommend and help you purchase AC units at discounted prices from authorized dealers." },
    ...
    { q: "What warranty do you provide on {service}?", a: "Atlas Aircon provides 1-year warranty on {service} workmanship. Any installation-related issues within this period are fixed free of charge." },
    ...
    { q: "What happens if there's an issue after {service}?", a: "Any {service} related issues within warranty period are fixed free. Our service team is available at +91 97272 57141 for immediate support." },
  ],
  service: [
    ...
    { q: "Do you provide a service report after {service}?", a: "Yes, Atlas Aircon provides a detailed service report after {service} listing work done, issues found, gas pressure readings, and recommendations." },
...
const areaTemplates = [
  ...
  { q: "Do you have technicians located in {area}?", a: "Yes, Atlas Aircon has servicemen positioned across Vadodara including near {area}. This ensures faster response times for AC repair and service calls." },
  { q: "Is emergency AC service available in {area}?", a: "Yes, 24/7 emergency AC repair is available in {area}. Call +91 97272 57141 for immediate assistance with AC breakdown, gas leaks, or cooling failures." },
  ...
  { q: "Do you service office ACs in {area}?", a: "Yes, Atlas Aircon services commercial ACs in {area} offices, shops, showrooms, and businesses. We handle all types including VRF systems and ducted ACs." },
  ...
  { q: "Is your service available on weekends in {area}?", a: "Yes, AC service is available in {area} 7 days a week including Saturdays and Sundays. Book online or call +91 97272 57141." },
...
const brandTemplates = [
  { q: "Do you provide authorized service for {brand} AC?", a: "Atlas Aircon provides multi-brand AC service including {brand}. While we're not an authorized service center, our technicians are trained on {brand} AC systems and use genuine parts." },
...
const acTypeTemplates = {
  ...
  central: [
    { q: "Do you repair central AC systems?", a: "Yes, Atlas Aircon repairs central AC systems including AHUs, ductwork, chillers, and controls. Commercial central AC is our specialty for offices and buildings." },
...
const industrialTemplates = [
  { q: "Do you provide industrial HVAC services?", a: "Yes, Atlas Aircon specializes in industrial HVAC including chiller repair, AHU service, cooling tower maintenance, VRF systems, and panel AC for factories across Gujarat." },
  { q: "What is the response time for industrial AC breakdown?", a: "For industrial emergencies, we prioritize response within 2-4 hours. 24/7 helpline available at +91 97272 57141 for chiller breakdowns and critical cooling failures." },
